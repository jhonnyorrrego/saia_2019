        ...
        <div class="row">
            <div class="col-lg-7 fileupload-buttonbar">
                ...
                <span class="btn btn-success fileinput-button">
                    ...
                    <span>Add files...</span>
                    <input type="file" name="anexo_formato[]" multiple>
                    <input type="hidden" name="fu_idformato[]" value="388">
                    <input type="hidden" name="fu_idcampos_formato[]" value="4611">
                </span>
                <!-- Extra file input start /-->
                <span class="btn fileinput-button">
                    <i class="glyphicon glyphicon-plus"></i>
                    <span>Add files...</span>
                    <input type="file" name="anexos2[]" multiple>
                    <input type="hidden" name="fu_idformato[]" value="400">
                    <input type="hidden" name="fu_idcampos_formato[]" value="4797">
                </span>
