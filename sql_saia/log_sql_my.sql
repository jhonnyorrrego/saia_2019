...
ALTER TABLE expediente ADD indice_uno VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER agrupador, ADD indice_dos VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER indice_uno, ADD indice_tres VARCHAR(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL AFTER indice_dos;

UPDATE busqueda SET campos = 'a.fecha,a.nombre,a.descripcion,a.cod_arbol,a.estado_cierre,a.nombre_serie,a.propietario,a.fecha_extrema_i,a.fecha_extrema_f,a.no_unidad_conservacion,a.no_folios,a.no_carpeta,a.soporte,a.notas_transf,a.tomo_no,a.indice_uno,a.indice_dos,a.indice_tres' WHERE busqueda.idbusqueda = 115;

UPDATE busqueda SET etiqueta = 'Inventario Documental' WHERE busqueda.idbusqueda = 115;

UPDATE busqueda_componente SET etiqueta = 'Inventario Documental' WHERE busqueda_componente.idbusqueda_componente = 320;

UPDATE busqueda_componente SET info = 'CODIGO|{*cod_arbol*}|left|80|-|Nombre de la serie subserie o asuntos|{*descripcion*}|left|200|-|Fecha Extrema Inicial|{*fecha_extrema_i*}|left|150|-|Fecha Extrema Final|{*fecha_extrema_f*}|left|150|-|Unidad de conservacion|{*no_unidad_conservacion*}|left|180|-|Folios|{*no_folios*}|left|80|-|Soporte|{*soporte*}|left|80|-|Notas|{*notas_transf*}|left|180|' WHERE busqueda_componente.idbusqueda_componente = 320;

UPDATE busqueda SET cantidad_registros = '100' WHERE busqueda.idbusqueda = 115;

UPDATE busqueda_condicion SET codigo_where = '1=1 and agrupador=0 {*filtro_cod_arbol*}' WHERE busqueda_condicion.idbusqueda_condicion = 245;
...
UPDATE busqueda_componente SET direccion = 'asc',ordenado_por='a.fecha' WHERE busqueda_componente.idbusqueda_componente = 321;

UPDATE busqueda_componente SET info = 'Radicado|{*radicado_exp_doc@documento_iddocumento*}|left|200|-|Tipo de documento|{*tipo_doc@documento_iddocumento*}|left|200|-|Descripcion|{*descripcion_doc@documento_iddocumento*}|left|200|-|Fecha|{*fecha*}|left' WHERE busqueda_componente.idbusqueda_componente = 321;

UPDATE busqueda SET etiqueta = 'Indice de Expediente' WHERE busqueda.idbusqueda = 116;

UPDATE busqueda_componente SET etiqueta = 'Indice de Expediente' WHERE busqueda_componente.idbusqueda_componente = 321;
...
UPDATE busqueda_condicion SET codigo_where = '1=1 and agrupador=0 {*filtro_cod_arbol*}{*tipo_expediente*}' WHERE busqueda_condicion.idbusqueda_condicion = 245;

UPDATE busqueda SET campos = 'a.nombre,a.codigo_numero,a.nombre_serie,a.fecha_extrema_i,a.fecha_extrema_f,a.indice_uno,a.indice_dos,a.indice_tres,a.no_folios,a.no_unidad_conservacion,a.soporte,a.notas_transf' WHERE busqueda.idbusqueda = 115;

UPDATE busqueda_componente SET info = 'CODIGO|{*codigo_numero*}|left|80|-|NOMBRE DEL EXPEDIENTE|{*direcciona_nombre@idexpediente,nombre*}|left|200|-|SERIE|{*nombre_serie*}|left|200|-|FECHA INICIAL|{*fecha_extrema_i*}|center|80|-|FECHA FINAL|{*fecha_extrema_f*}|center|80|-|INDICE 1|{*indice_uno*}|left|130|-|INDICE 2|{*indice_dos*}|left|130|-|INDICE 3|{*indice_tres*}|left|130|-|FOLIOS|{*no_folios*}|center|80|-|UNID CONSERV|{*no_unidad_conservacion*}|left|80|SOPORTE 3|{*soporte*}|left|80|-|NOTAS|{*notas_transf*}|left|200|' WHERE busqueda_componente.idbusqueda_componente = 320;

UPDATE busqueda_componente SET info = 'Radicado|{*radicado_exp_doc@documento_iddocumento*}|left|80|-|Tipo de documento|{*tipo_doc@documento_iddocumento*}|left|180|-|Descripcion|{*descripcion_doc@documento_iddocumento*}|left|220|-|Fecha|{*fecha*}|center' WHERE busqueda_componente.idbusqueda_componente = 321;
