...
class Version20190109143516 extends AbstractMigration {
    ...
    public function down(Schema $schema): void {
        ...
        $schema->dropTable("wf_evento_notificacion");
        $schema->dropTable("wf_flujo");
        $schema->dropTable("wf_formato_flujo");
        $schema->dropTable("wf_notificacion");
        $schema->dropTable("wf_tipo_destinatario");
        $schema->dropTable("wf_actividad");
        $schema->dropTable("wf_actividad_notificacion");
        $schema->dropTable("wf_adjunto_notificacion");
        $schema->dropTable("wf_dest_notificacion");
        $schema->dropTable("wf_destinatario_saia");
        $schema->dropTable("wf_responsable_actividad");
        $schema->dropTable("wf_tarea_actividad");
        $schema->dropTable("wf_destinatario_externo");
        $schema->dropTable("wf_destinatario_formato");}
