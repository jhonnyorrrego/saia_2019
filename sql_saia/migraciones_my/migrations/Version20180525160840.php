...
class Version20180525160840 extends AbstractMigration {
    ...
    public function up(Schema $schema) {
        ...
        $funcion = "CREATE FUNCTION func_inc_var_session() RETURNS INT(11) COMMENT 'Se usa para generar IDs unicos de filas en vistas' NOT DETERMINISTIC NO SQL SQL SECURITY DEFINER begin SET @var := IFNULL(@var,0) + 1; return @var; end";
