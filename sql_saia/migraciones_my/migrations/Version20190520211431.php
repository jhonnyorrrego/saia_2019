...
final class Version20190520211431 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $campos_formato = ['idcampos_formato' => '8319', 'formato_idformato' => '353', 'nombre' => 'ventanilla', 'etiqueta' => 'VENTANILLA', 'tipo_dato' => 'varchar', 'longitud' => '255', 'obligatoriedad' => '1', 'valor' => '1,Array', 'acciones' => 'a,e,b', 'ayuda' => '', 'predeterminado' => '', 'banderas' => '', 'etiqueta_html' => 'select', 'orden' => '14', 'mascara' => '', 'adicionales' => '', 'autoguardado' => '1', 'fila_visible' => '1', 'placeholder' => 'seleccionar..', 'longitud_vis' => NULL, 'opciones' => '[{"llave":1,"item":"Sin ventanilla"}]', 'estilo' => NULL];

        $conn->insert('campos_formato', $campos_formato);

        $campos_formato = ['idcampos_formato' => '8318', 'formato_idformato' => '3', 'nombre' => 'distribuid_entre_sedes', 'etiqueta' => 'DISTRIBUIDO ENTRE SEDES', 'tipo_dato' => 'varchar', 'longitud' => '255', 'obligatoriedad' => '1', 'valor' => '1,Array;2,Array', 'acciones' => 'a,e,b', 'ayuda' => '', 'predeterminado' => '', 'banderas' => '', 'etiqueta_html' => 'radio', 'orden' => '8', 'mascara' => '', 'adicionales' => '', 'autoguardado' => '1', 'fila_visible' => '1', 'placeholder' => 'Campo texto', 'longitud_vis' => NULL, 'opciones' => '[{"llave":"1","item":"Si"},{"llave":"2","item":"No"}]', 'estilo' => NULL];
        $conn->insert('campos_formato', $campos_formato);
