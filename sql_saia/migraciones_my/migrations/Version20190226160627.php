...
(1, 'Sin Ventanilla', NULL, NULL, NULL, NULL, NULL, 1)");
        ...
        //Busqueda
        $this->connection->update('busqueda', ['campos' => 'a.tipo_origen,a.origen,a.tipo_destino,a.destino,a.numero_distribucion,a.estado_distribucion,a.estado_recogida,a.ruta_origen,a.ruta_destino,b.iddocumento,b.fecha,b.descripcion,c.ventanilla_radicacion,d.nombre as ventanilla'], ["nombre" => "reporte_distribucion_general"]);
