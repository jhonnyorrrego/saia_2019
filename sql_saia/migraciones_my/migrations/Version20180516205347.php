...
class Version20180516205347 extends AbstractMigration {
    ...
    public function up(Schema $schema) {
        ...
        $librerias=$busqueda["librerias"];
        if(strpos("pantallas/pantalla/librerias.php",$librerias)===false){
        	$this->addSql("UPDATE busqueda SET ".$librerias.",pantallas/pantallas/librerias.php' WHERE idbusqueda=".$idbusq);
        }
        $componente1 = [
    ...
    private function buscar_busqueda($nombre) {
        ...
        $result = $conn->fetchAll("select idbusqueda,librerias from busqueda where nombre = :nombre", [
            'nombre' => $nombre
        ]);
