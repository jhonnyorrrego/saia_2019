...
"orden"=>"3","info"=>"<div title=\"Reporte Retenci&oacute;n\" data-load='{\"kConnector\":\"iframe\",\"url\":\"../pantallas/serie/busqueda_reporte_series_dependencias.php?idbusqueda_componente=272\",\"kTitle\":\"Retencion\",\"kWidth\":\"320px\"}' class=\"items navigable\">\r\n<div class=\"head\"></div>\r\n<div class=\"label\">Tabla de retenci&oacute;n</div>\r\n<div class=\"tail\"></div>\r\n</div>",
...
"enlace_adicionar"=>null,"encabezado_grillas"=>null,"llave"=>""];
	$conn->insert('busqueda_componente', $datos);
    }
