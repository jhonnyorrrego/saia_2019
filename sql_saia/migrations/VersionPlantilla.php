...
class Version20170915184511 extends AbstractMigration {
	...
	public function postUp(Schema $schema) {
		...
		$cond1 = ["fk_busqueda_componente" => $idcmp1, "codigo_where" => "a.documento_iddocumento=b.iddocumento AND lower(b.estado)='aprobado' AND a.estado_distribucion=0 {*condicion_adicional_distribucion*}", "etiqueta_condicion" => "condicion_reporte_distribucion_general_sinrecogida"];
		$cond2 = ["fk_busqueda_componente" => $idcmp2, "codigo_where" => "a.documento_iddocumento=b.iddocumento AND lower(b.estado)='aprobado' AND a.estado_distribucion=3 {*condicion_adicional_distribucion*}", "etiqueta_condicion" => "condicion_reporte_distribucion_general_finalizado"];
		$cond3 = ["fk_busqueda_componente" => $idcmp3, "codigo_where" => "a.documento_iddocumento=b.iddocumento AND lower(b.estado)='aprobado' AND a.estado_distribucion=2 {*condicion_adicional_distribucion*}", "etiqueta_condicion" => "condicion_reporte_distribucion_general_endistribucion"];
		$cond4 = ["fk_busqueda_componente" => $idcmp4, "codigo_where" => "a.documento_iddocumento=b.iddocumento AND lower(b.estado)='aprobado' AND a.estado_distribucion=1 {*condicion_adicional_distribucion*}", "etiqueta_condicion" => "condicion_reporte_distribucion_general_pordistribuir"];
	...
	private function guardar_busqueda($datos) {
		...
		$result = $conn -> fetchAll("select idbusqueda from busqueda where nombre = :nombre", ['nombre' => $datos["nombre"]]);
	...
	private function guardar_componente($datos) {
		...
		$result = $conn -> fetchAll("select idbusqueda_componente from busqueda_componente where nombre = :nombre", ['nombre' => $datos["nombre"]]);
	...
	private function guardar_condicion($datos) {
		...
		$result = $conn -> fetchAll("select idbusqueda_condicion from busqueda_condicion where etiqueta_condicion  = :etiqueta_condicion", ['etiqueta_condicion' => $datos["etiqueta_condicion"]]);
