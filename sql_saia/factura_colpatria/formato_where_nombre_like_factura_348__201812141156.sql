...
('facturas_obras','RADICACI&Oacute;N FACTURAS DE OBRA',0,1,'ft_facturas_obras','mostrar_facturas_obras.php','editar_facturas_obras.php','adicionar_facturas_obras.php',NULL,NULL,NULL,'1','<p>{*cargar_datos_rad_obras*}</p>
