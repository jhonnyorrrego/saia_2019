...
if(!defined("DB"))
  define("DB", "saia_elastic_local");//INSTANCIA
define("MOTOR","MySql");
if(!defined("BASEDATOS"))
  define("BASEDATOS","saia_elastic_local");//BASE DE DATOS
if(!defined("TABLESPACE"))
  define("TABLESPACE","saia_elastic_local");//TABLESPACE
if(!defined("PORT")) {
  define("PORT", 3306);
  //amazon cloud
  //define("PORT", 3308);
...
define("LLAVE_SAIA","SAIA_ELASTIC");
