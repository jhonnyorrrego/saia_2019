...
$.ajax({
  ...
  data: "funcion=enviar_email_pantalla($destino,$copia,$copia_oculta,$asunto,$contenido)&idpantalla=<?php echo($idpantalla[0]["pantalla_idpantalla"]);?>&ruta=<?php echo($ruta_db_superior);?>pantallas/lib/librerias_comunicacion_saia.php&rand="+Math.round(Math.random()*100000),
