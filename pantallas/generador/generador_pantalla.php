...
if ($formatId) {
    ...
    $camposNucleo = " and A.nombre not in('" . implode("', '", camposNucleo($formatId)) . "')";
    ...
    $consulta_formato = busca_filtro_tabla("cuerpo,encabezado,pie_pagina,publicar,nombre", "formato f", "idformato=" . $formatId, "", $conn);
...
<head>
    ...
    <?= validate() ?>
    <?= notificacion() ?>
    <link href="<?= $ruta_db_superior ?>pantallas/generador/css/generador_pantalla.css" rel="stylesheet">
    <?php
...
<body>
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-md-9">
                                                    ...
                                                    <form name="formulario_editor_encabezado" id="formulario_editor_encabezado" action="">
                                                        ...
                                                        <input type="hidden" name="idformato" id="idformato" value="<?= $formatId ?>">
                                            ...
                                            <div class="row px-0 mx-0 pt-3">
                                                <div class="mx-0 px-0 col-9" style="position:relative;display:inline-block;vertical-align:top">
                                                    <ul id="contenedorComponentes" class="sortable boxy px-4" style="margin-left: 1em;">
                                                        ...
                                                        <?php
                                                        $formatosCampo = load_pantalla($formatId);
                                                        if ($formatosCampo) : ?>
                                                            <?= $formatosCampo;  ?>
                                                        <?php endif; ?>
                                                    </ul>
    ...
    <script type="text/javascript" data-params='<?= $params ?>' id="script_generador_pantalla">
        $(document).ready(function() {
            ...
            var idpantalla = params.formatId;
            var guardarPaso1 = 0;
            ...
            $.ajax({
                type: 'POST',
                url: `${params.baseUrl}pantallas/generador/librerias_formato.php`,
                data: {
            ...
            $('#cambiar_nav_basico').on('click', function() {
                $.ajax({
                    type: 'POST',
                    url: `${params.baseUrl}pantallas/generador/librerias.php`,
                    data: {
            ...
            function generar_pantalla(nombre_accion, permisosPerfil) {
                ...
                $.ajax({
                    type: 'POST',
                    url: params.baseUrl + ruta_generar,
                    data: datos,
                    beforeSend: function() {
                    ...
                    success: function(html) {
                        ...
                        if (html) {
                            ...
                            if (objeto.publicar == 0 && objeto.exito == true) {
                                ...
                                top.notification({
                                    type: 'error',
                                    message: "Se a producido un error por favor comuniquese con el administrador"
                                });
                                setTimeout(function() {
            ...
            $("#seleccionar_archivo").click(function() {
                ...
                if (ruta_archivo != '') {
                    $.ajax({
                        type: 'POST',
                        url: `${params.baseUrl}pantallas/generador/librerias.php?ejecutar_pantalla_campo=incluir_librerias_pantalla`,
            ...
            $('a[data-toggle="tab"]').on('shown.bs.tab', function(e) {
                ...
                switch (id[1]) {
                    ...
                    case 'datos_formulario-tab':
                        ...
                        $("#cambiar_nav,#cambiar_vista,#cambiar_nav_basico,#cambiar_nav_permiso").hide();
                        break;
                }
            });
            ...
            $(".eliminar_libreria").on("click", function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: `${params.baseUrl}pantallas/generador/librerias.php?ejecutar_pantalla_campo=eliminar_archivo_incluido`,
            ...
            $("#tipo_pantalla_busqueda").change(function() {
                $("#frame_tipo_listado").html(`<img src='${params.baseUrl}assets/images/cargando.gif'>`);

                if ($(this).val()) {
                    $("#frame_tipo_listado").load(
                        `${params.baseUrl}pantallas/generador/esquemas_busqueda_saia/` + $(
                            "#tipo_pantalla_busqueda option:selected").attr("nombre") + ".php", {
                            tipo_busqueda: $(this).val(),
                            idpantalla: params.formatId
                        });
                } else {
