...
function funciones_nucleo($pantalla_idpantalla, $tipo)
{
    ...
    $texto = '<div class="accordion mx-5 my-3" id="acordion_componentes" style="margin-bottom: 5px;">
     <div class="accordion-group">
     <div class="accordion-heading">
     <a class="accordion-toggle" data-toggle="collapse" data-parent="#acordion_componentes"  style="position:relative;left:-60px;" href="#categoria_1">Funciones de nucleo</a></div>';
    ...
    if ($campos["numcampos"]) {
     ...
     <a class="accordion-toggle" data-toggle="collapse" data-parent="#acordion_componentes" href="#categoria_1" style="position:relative;left:-50px;">Elementos del formato</a></div>';
