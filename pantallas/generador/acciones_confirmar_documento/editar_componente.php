...
$.ajax({
  ...
  data: "funcion=confirmar_documento($iddocumento)&idpantalla=<?php echo($idpantalla[0]["pantalla_idpantalla"]);?>&ruta=<?php echo($ruta_db_superior);?>pantallas/transferencia/funciones_transferencia_documento.php&rand="+Math.round(Math.random()*100000),
