...
if(@$_REQUEST["idpantalla_campos"]){    
  ...
  $valor=explode(";",$pantalla_campos[0]["valor"]);
  $valor_mostrar=$valor[0];
  $valor_almacenar=$valor[1];
  $obligatoriedad_si='';
  $obligatoriedad_no='';    
...
if($pantalla_campos[0]["nombre"]=="id".$pantalla_campos[0]["tabla"]){
	echo "Se&ntilde;or usuario, este campo no se puede modificar ya que este corresponde a la llave primaria de la pantalla.";
	die();
}
?>
...
?>
  ...
  <div class="control-group">
    ...
    <div class="controls">
    	<input type="text" name="fs_longitud" id="longitud" value="<?php echo (@$pantalla_campos[0]["longitud"]); ?>">
    </div>
  </div>
  ...
  <div class="control-group">
    <label class="control-label" for="valor_mostrar">Campos a mostrar</label>
    <div class="controls">
      <input type="text" name="valor_mostrar" id="valor_mostrar" placeholder="valor a mostrar" value="<?php echo(@$valor_mostrar);?>">
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="valor_almacenar">Campo almacenado </label>
    <div class="controls">
      <input type="text" name="valor_almacenar" id="valor_almacenar" placeholder="valor almacenar" value="<?php echo(@$valor_almacenar);?>">
      <input type="hidden" name="fs_valor" id="valor" placeholder="valor " value="">
    </div>
  </div>
  <div class="control-group">
...
$(document).ready(function(){
    ...
    $("#valor").val($("#valor_almacenar").val()+";"+$("#valor_mostrar").val());
		if(formulario.valid()){
