...
$(document).ready(function(){
  $(".barra_progreso_pantalla").each(function(){
    ...
    var listado_generar_pantallas= new Array("generar_clase", "generar_tablas", "generar_adicionar", "generar_editar",  "generar_eliminar", "generar_version_pantalla", "generar_pantalla_libreria", "generar_buscar", "generar_modulo", "generar_archivos_ignorados");
