...
$padre_independiente0='checked';
$padre_independiente1='';
...
if($pantalla_campos[0]["valor"]){
	...
	$padre_independiente0='';
	$padre_independiente1='';
	if($valores[8]==1)$padre_independiente0='checked';
	if($valores[8]==2)$padre_independiente1='checked';
...
<form method="POST" action="" class="form-horizontal" name="editar_pantalla_campo" id="editar_pantalla_campo">
  ...
  <div class="control-group">
    <label class="control-label" for="valor">Seleccion de padre</label>
    <div class="controls">
    	<label class="radio inline" for="almacenar">        
        <input type="radio" name="padre_independiente" id="padre_independiente_1" value="1" <?php echo $padre_independiente0; ?>>
        Si selecciona el padre, se seleccionan los hijos
      </label>
      <label class="radio inline" for="almacenar">        
        <input type="radio" name="padre_independiente" id="padre_independiente_2" value="2" <?php echo $padre_independiente1; ?>>
        Si selecciona el padre, no se seleccionan los hijos
      </label>
    </div>
  </div>
