...
$.ajax({
  ...
  data: "ejecutar_generador=insert_busqueda_temp_generador&tipo_retorno=1&rand="+Math.round(Math.random()*100000)+"&"+formulario_generador.serialize(),
