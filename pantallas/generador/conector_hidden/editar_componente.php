...
<form method="POST" action="" class="form-horizontal" name="editar_pantalla_campo" id="editar_pantalla_campo">
  ...
  <div class="control-group">
    <label class="control-label" for="predeterminado">Tipo</label>
    <div class="controls">
      <select name="tipo" id="tipo"><option value="">Por favor seleccione...</option>
      	<option value="1" <?php echo($tipo1); ?>>Sesión</option>
      	<option value="2" <?php echo($tipo2); ?>>Request</option>
      	<!--option value="3" <?php echo($tipo3); ?>>Webservice</option-->
      </select>
    </div>
  </div>
  
  <div class="control-group">
    <label class="control-label" for="nombre">Nombre parametro a recibir*</label>
    <div class="controls">
      <input type="text" name="nombre_recibir" id="nombre_recibir" value="<?php echo($nombre_recibir);?>" required>
    </div>
  </div>
...
function parsear_items(){
	var tipo=$("#tipo").val();
	var nombre_param=$("#nombre_recibir").val();
	$("#valor").val(tipo+"|"+nombre_param);
}
</script>