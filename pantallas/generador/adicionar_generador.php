...
<?php include_once($ruta_db_superior . "pantallas/generador/hidden/procesar_componente.php"); ?><?php
                                                                                                ...
                                                                                                ?>
<form class="<?php echo ($tipo_form); ?>" name="formulario_generador" id="formulario_generador" method="post" enctype="multipart/form-data"><?php echo (procesar_hidden(2289, $generador->get_valor_generador("generador", "idgenerador"), "adicionar", $generador->get_campo_generador("idgenerador"))); ?>
  <div class="control-group element" idpantalla_componente="7" idpantalla_campo="2292" id="pc_2292" nombre="select"><label class="control-label" for="tipo"><b>Tipo *</b></label>
    <div class="controls"><?php echo (procesar_select(2292, $generador->get_valor_generador("generador", "tipo"), "adicionar", $generador->get_campo_generador("tipo"))); ?>
    </div>
  </div>
  <div class="control-group element" idpantalla_componente="1" idpantalla_campo="2293" id="pc_2293" nombre="text"><label class="control-label" for="primer_nombre"><b>Primer Nombre *</b></label>
    <div class="controls"><input type="text" name="primer_nombre" maxlength="255" class="elemento_formulario" placeholder="" idpantalla_campos="2293" value="<?php echo (procesar_texto(2293, $generador->get_valor_generador("generador", "primer_nombre"), "adicionar", $generador->get_campo_generador("primer_nombre"))); ?>
" id="primer_nombre" /><?php echo (procesar_opcion_buscar(2293, $generador->get_valor_generador("generador", "primer_nombre"), "adicionar", $generador->get_campo_generador("primer_nombre"))); ?>
    </div>
  </div>
  <div class="control-group element" idpantalla_componente="1" idpantalla_campo="2294" id="pc_2294" nombre="text"><label class="control-label" for="campo_texto_856139374"><b>Campo de texto </b></label>
    <div class="controls"><input type="text" name="campo_texto_856139374" maxlength="255" class="elemento_formulario" placeholder="Campo texto" idpantalla_campos="2294" value="<?php echo (procesar_texto(2294, $generador->get_valor_generador("generador", "campo_texto_856139374"), "adicionar", $generador->get_campo_generador("campo_texto_856139374"))); ?>
" id="campo_texto_856139374" /><?php echo (procesar_opcion_buscar(2294, $generador->get_valor_generador("generador", "campo_texto_856139374"), "adicionar", $generador->get_campo_generador("campo_texto_856139374"))); ?>
    </div>
  </div>
  <div class="control-group element" idpantalla_componente="1" idpantalla_campo="2295" id="pc_2295" nombre="text"><label class="control-label" for="campo_texto_1744857069"><b>Campo de texto *</b></label>
    <div class="controls"><input type="text" name="campo_texto_1744857069" maxlength="255" class="elemento_formulario" placeholder="Campo texto" idpantalla_campos="2295" value="<?php echo (procesar_texto(2295, $generador->get_valor_generador("generador", "campo_texto_1744857069"), "adicionar", $generador->get_campo_generador("campo_texto_1744857069"))); ?>
" id="campo_texto_1744857069" /><?php echo (procesar_opcion_buscar(2295, $generador->get_valor_generador("generador", "campo_texto_1744857069"), "adicionar", $generador->get_campo_generador("campo_texto_1744857069"))); ?>
    </div>
  </div>
  <div class="control-group element" idpantalla_componente="1" idpantalla_campo="2296" id="pc_2296" nombre="text"><label class="control-label" for="campo_texto_1634717074"><b>Campo de texto *</b></label>
    <div class="controls"><input type="text" name="campo_texto_1634717074" maxlength="255" class="elemento_formulario" placeholder="Campo texto" idpantalla_campos="2296" value="<?php echo (procesar_texto(2296, $generador->get_valor_generador("generador", "campo_texto_1634717074"), "adicionar", $generador->get_campo_generador("campo_texto_1634717074"))); ?>
" id="campo_texto_1634717074" /><?php echo (procesar_opcion_buscar(2296, $generador->get_valor_generador("generador", "campo_texto_1634717074"), "adicionar", $generador->get_campo_generador("campo_texto_1634717074"))); ?>
    </div>
  </div><input type="hidden" name="key_formulario_saia" value="<?php echo (generar_llave_md5_saia()); ?>"><input type="hidden" name="fk_idbpmni" value="<?php echo ($_REQUEST["bpmni"]); ?>"><input type="hidden" name="fk_idbpmn_tarea" value="<?php echo ($_REQUEST["idbpmn_tarea"]); ?>"><input type="hidden" id="fk_documento_anterior" name="fk_documento_anterior" value="<?php echo ($_REQUEST["fk_documento_anterior"]); ?>">
...
<script type="text/javascript">
  $(document).ready(function() {
    var formulario_generador = $("#formulario_generador");
    $("#submit_formulario_generador").click(function() {
      ...
      if (formulario_generador.valid()) {
        ...
        $.ajax({
          ...
          data: "ejecutar_generador=set_generador&tipo_retorno=1&rand=" + Math.round(Math.random() * 100000) + "&" + formulario_generador.serialize(),
