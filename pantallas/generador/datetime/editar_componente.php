...
<form method="POST" action="" class="form-horizontal" name="editar_pantalla_campo" id="editar_pantalla_campo">
  ...
  <div class="control-group">
    <label class="control-label" for="valor">formato fecha</label>
    <div class="controls">
      <textarea name="valor1" id="valor1" placeholder="valor de llenado"><?php echo(@$valor1);?></textarea>
    </div>
  </div>
  <div class="control-group">
    <label class="control-label" for="valor">Valor de llenado</label>
    <div class="controls">
      <textarea name="valor2" id="valor2" placeholder="valor de llenado"><?php echo(@$valor2);?></textarea>
    </div>
  </div>
  <div class="control-group">
