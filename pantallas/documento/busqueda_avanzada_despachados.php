    ...
    <div class="container master-container">
       ...
       <form accept-charset="UTF-8" id="kformulario_saia" name="kformulario_saia" method="post" >
        ...
        <div class="control-group">
          <label class="string required control-label" for="radicado_despacho">
						<strong>Consecutivo despacho fisico</strong>
						<input type="hidden" name="bksaiacondicion_b@radicado_despacho" id="bksaiacondicion_b@radicado_despacho" value="=">
          </label>
          <div class="controls">
            <input id="bqsaia_b@radicado_despacho" name="bqsaia_b@radicado_despacho" size="50" type="text">
          </div>
        </div>
