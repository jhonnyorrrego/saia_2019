...
$texto.='<div class="btn-group pull" >
  ...
  <button type="button" class="btn btn-mini '.$clase_info.' tooltip_saia" conector="iframe" onClick=" " enlace="ordenar.php?accion=mostrar&mostrar_formato=1&key='.$iddoc.'" title="No.'.$numero.'" idregistro="'.$iddoc.'"><i class="icon-info-sign"></i></button>
