...
if($ok&&@$busqueda["numcampos"]){
	?>
				<li>
					<button type="button" class="btn btn-primary btn-mini link kenlace_saia" enlace="pantallas/documento/busqueda_avanzada_documento.php?idbusqueda_componente=159" conector="iframe" titulo="Busqueda por series" title="Busqueda por series">
  	        	Buscar por series
  	      </button>
				</li>
				<li class="divider-vertical">
