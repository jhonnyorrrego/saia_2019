...
<div id="busqueda_general" class="busqueda_general">   
        ...
        <strong>Asunto o descripci&oacute;n</strong>
            <input type="hidden" name="bksaiacondicion_A@descripcion" id="bksaiacondicion_A@descripcion" value="like">
        <div class="controls" >
        ...
        <legend style="font-size:9pt;color:#0885C8;line-height:15px" id="contenido"><strong>B&uacute;squeda por contenido del documento</strong></legend>
        <strong>Plantilla</strong>
        <?php 
        $nombre_arbol[1]="plantilla";
        echo arbol("bqsaia_plantilla",$nombre_arbol[1],"test_formatos2.php","","","","","radio"); ?>
        <input type="hidden" name="bksaiacondicion_plantilla" id="bksaiacondicion_plantilla" value="in">
        <input type="hidden" name="bqsaiaenlace_A@plantilla" id="bqsaiaenlace_A@plantilla" value="y" />
        <br>
        <div id="muestra_plantilla" style="font-size:9pt;">
        </div>
        <!--hr width="75%" color="black" style="text-align:left"/-->
        
        <div id="gestion_mostrar">
        <legend style="font-size:9pt;color:#0885C8;line-height:15px" id="gestion"><strong>B&uacute;squeda por tipo de gesti&oacute;n del documento</strong></legend>
        <div></div>
        <?php
        $name="bqsaia";
		...
		<input type="hidden" name="<?php echo $namenlace; ?>_z@nombre__2" value="y">
		<br>
		<!--hr width="75%" color="black" style="text-align:left"/-->
		
			<strong>Elaborado por</strong>
		<input type="hidden" name="<?php echo $namecon; ?>_a@ejecutor" id="bksaiacondicion_a@ejecutor" value="in">
		<div class="controls">
			<?php 
			$nombre_arbol[4]="ejecutor";
			echo arbol($name."_a@ejecutor",$nombre_arbol[4],"test.php?inactivos=1",0,1,1,array('a-ejecutor','in',"'borrador'")); ?>
		</div>
		
		<input type="hidden" name="<?php echo $namenlace; ?>_a@ejecutor" value="y">
		<br>
		<!--hr width="75%" color="black" style="text-align:left"/-->
		
		
			<strong>Aprobado por</strong>
		<input type="hidden" name="<?php echo $namecon; ?>_z@origen__3" id="bksaiacondicion_z@origen__3" value="in">

		<div class="controls">
			<?php 
			$nombre_arbol[5]="bqsaia_origen3";
			echo arbol($name."_z@origen__3",$nombre_arbol[5],"test.php?inactivos=1",0,1,1,array('z-nombre__4','in',"'aprobado'")); ?>
		</div>
		
		<input type="hidden" name="<?php echo $namenlace; ?>_z@origen__3" value="y">
		</div>
		
		<input type="hidden" name="<?php echo $namecon; ?>_z@nombre__4" id="bksaiacondicion_z-nombre__4" value="">
		<input type="hidden" id="bqsaia_z-nombre__4" name="<?php echo $name; ?>_z@nombre__4" value="">
...
$("#ksubmit_saia").click(function(){
	...
	if((valor1!=''&&valor1!=undefined)||(valor2!=''&&valor2!=undefined)||(valor3!=''&&valor3!=undefined)||(valor4!=''&&valor4!=undefined)){
