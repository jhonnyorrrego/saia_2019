...
function chkPass(pwd) {
    ...
    /*
		...
		if (nScore >= 0 && nScore < 10) { sComplexity = "Debil"; }
		else if (nScore >= 10 && nScore < 20) { sComplexity = "Buena"; }
		else if (nScore >= 20 ) { sComplexity = "Optima"; nScore=20; }
    
    
		/* Display updated score criteria to client */
		oScorebar.style.backgroundPosition = "-" + parseInt(nScore * 20) + "px";
		oScore.innerHTML = nScore + "%";
		oComplexity.innerHTML = sComplexity;
    document.getElementById("nscore").value=nScore;
	}
	else {
