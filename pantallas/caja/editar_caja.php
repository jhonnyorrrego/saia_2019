...
<div class="control-group element">
  ...
  <div class="controls"> 
    <input type="text" name="codigo" id="codigo" value="<?php echo($datos[0]["codigo"]); ?>">
  </div>
</div>
...
<div class="control-group element">
  ...
  <div class="controls"> 
    <input type="text" name="no_carpetas" id="no_carpetas" value="<?php echo($datos[0]["no_carpetas"]); ?>">
  </div>
</div>
...
<div class="control-group element">
  ...
  <div class="controls"> 
    <input type="text" name="no_correlativo" id="no_correlativo" value="<?php echo($datos[0]["no_correlativo"]); ?>">
  </div>
</div>
...
<div class="control-group element">
  ...
  <div class="controls"> 
    <input type="text" name="estanteria" id="estanteria" value="<?php echo($datos[0]["estanteria"]); ?>">
  </div>
</div>
...
<div class="control-group element">
  ...
  <div class="controls"> 
    <input type="text" name="material" id="material" value="<?php echo($datos[0]["material"]); ?>">
  </div>
</div>
  ...
  $("#submit_formulario_caja").click(function(){  
    if(formulario_caja.valid()){
      ...
      $.ajax({
        ...
        data: "ejecutar_caja=update_caja&tipo_retorno=1&rand="+Math.round(Math.random()*100000)+"&"+formulario_caja.serialize(),
