...
$expedientes=busca_filtro_tabla("a.idexpediente,a.estado_archivo,a.serie_idserie,".fecha_db_obtener('a.fecha_cierre','Y-m-d')." AS fecha_inicial","expediente a","a.fecha_cierre IS NOT NULL AND a.estado_archivo IN(1,2) AND  ","",$conn);
