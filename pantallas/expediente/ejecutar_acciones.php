...
function set_expediente(){
    ...
    $exito=0;
    $campos=array("nombre","descripcion","cod_padre","codigo","fecha", "serie_idserie", "codigo_numero", "fondo", "proceso", "fecha_extrema_i", "fecha_extrema_f", "no_unidad_conservacion", "no_folios", "no_carpeta", "soporte", "frecuencia_consulta", "ubicacion", "unidad_admin", "estado_archivo", "estado_cierre","fk_idcaja","notas_transferencia");
    $valores=array();
