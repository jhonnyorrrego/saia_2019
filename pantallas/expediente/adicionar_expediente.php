...
<div id="datos_adicionales" class="datos_adicionales collapse opcion_informacion clase_sin_capas">
	...
	<div class="control-group element">
	  ...
	  <div class="controls">
	     <input name="codigo_numero_dependencia" id="codigo_numero_dependencia"  style="width:15%;" readonly> - 
	    <input name="codigo_numero_serie" id="codigo_numero_serie" value="<?php echo($datos[0]["codigo_numero"]); ?>" style="width:15%;" readonly> - 
