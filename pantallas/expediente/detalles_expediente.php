  		    ...
  		    <script>
  		        $(document).ready(function(){
  		            $('.cambiar_responsable_expediente').click(function(){
                        ...
                        hs.htmlExpand(this, { objectType: 'iframe',width: 400, height: 150,contentId:'cuerpo_paso', 		preserveContent:false, src:enlace,outlineType: 'rounded-white',wrapperClassName:'highslide-wrapper drag-header'});
  		            });
  		        });
  		    </script>
  	</td>
