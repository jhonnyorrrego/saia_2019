...
function menu_principal_formatos($idformato){
	...
	$texto='';
	$texto.='<div class="btn btn-mini btn-info kenlace_saia_propio" enlace="' . $ruta_db_superior . FORMATOS_SAIA . 'formatoadd.php" conector="iframe" titulo="Adicionar formato" id="fomatoadd">Adicionar</div>';
