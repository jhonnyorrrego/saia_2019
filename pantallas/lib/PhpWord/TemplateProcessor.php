...
class TemplateProcessor
{
    ...
    public function save()
    {
        ...
        $this->zipClass->addFromString('word/_rels/document.xml.rels', $this->_rels); #erap 07/07/2015
        $this->zipClass->addFromString('[Content_Types].xml', $this->_types); #erap 07/07/2015
