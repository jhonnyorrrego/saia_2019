...
class elasticsearch_saia{
    ...
    function connect(){
        ...
        if(!file_exists($ruta_db_superior.'pantallas/lib/elasticsearch/vendor/autoload.php')){
            $this->install_elasticsearch();
        }
        require $ruta_db_superior.'pantallas/lib/elasticsearch/vendor/autoload.php';
