...
function encrypt_blowfish($data, $key) {
    ...
    if (function_exists("mcrypt_encrypt")) {
        ...
        $encoded_openssl = openssl_blowfish_encrypt_hex_cbc($key, $data);
...
function decrypt_blowfish($data, $key) {
    ...
    if (function_exists("mcrypt_decrypt")) {
        ...
        $res = openssl_blowfish_decrypt_hex_cbc($key, $data);
    }
    return trim($res);
}
...
function openssl_blowfish_encrypt_hex_cbc($key, $str) {
    $blockSize = 8;
    $len = strlen($str);
...
function openssl_blowfish_decrypt_hex_cbc($key, $hex) {
