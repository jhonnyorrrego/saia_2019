  ...
  <body>
    ...
    <div class="container master-container">
       <form accept-charset="UTF-8" id="kformulario_saia" method="post">  
        <legend>Filtrar estructura de hoja de vida</legend>  
        ...
        <div class="row">
          <div class="control-group radio_buttons span4">
            <label class="radio_buttons optional control-label">Obligatoriedad
            <input type="hidden" name="bksaiacondicion_obligatoriedad" id="bksaiacondicion_obligatoriedad" value="=">
            </label>
            <div class="controls">
              <label class="radio inline">
                <input class="radio_buttons optional" id="bqsaia_estado1" name="bqsaia_obligatoriedad" type="radio" value="1">Si
              </label>
              <label class="radio inline">
                <input class="radio_buttons optional" id="bqsaia_obligatoriedad2" name="bqsaia_obligatoriedad" type="radio" value="0">No
              </label>
            </div>          
          </div> 
        </div> 
