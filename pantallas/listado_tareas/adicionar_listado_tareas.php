...
if($_REQUEST['guardar']==1){
	$sql="INSERT INTO listado_tareas (nombre_lista,descripcion_lista,cliente_proyecto,creador_lista,macro_proceso) VALUES('".htmlentities($_REQUEST['nombre_lista'])."','".htmlentities($_REQUEST['descripcion'])."','".$_REQUEST['cliente_proyecto']."',".usuario_actual("idfuncionario").",'".$_REQUEST['macro_proceso']."')";
	phpmkr_query($sql);
