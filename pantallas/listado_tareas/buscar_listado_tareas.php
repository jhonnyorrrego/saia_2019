       ...
       <form accept-charset="UTF-8" id="kformulario_saia" method="post">  
        ...
        <div class="control-group">
          <label class="string required control-label" for="nombre">
			Nombre de la Lista:
			<input type="hidden" name="bksaiacondicion_nombre_lista" id="bksaiacondicion_nombre_lista" value="like_total">
			<input type="hidden" name="bqsaiaenlace_nombre_lista" id="bqsaiaenlace_nombre_lista" value="y" />    
          </label>
          <div class="controls">
            <input id="bqsaia_nombre_lista" name="bqsaia_nombre_lista" size="50" type="text">
          </div>
        </div>


        <div class="control-group">
          <label class="string required control-label" for="bksaiacondicion_macro_proceso">
			Macroproceso/Proceso:
			<input type="hidden" name="bksaiacondicion_macro_proceso" id="bksaiacondicion_macro_proceso" value="in">
			<input type="hidden" name="bqsaiaenlace_macro_proceso" id="bqsaiaenlace_macro_proceso" value="y" />   
			<input type="hidden" name="bqsaiaaviso" id="bqsaiaaviso" value="1" />  
          </label>
          <div class="controls">
            <input id="bqsaia_macro_proceso" name="bqsaia_macro_proceso" size="50" type="text">
          </div>
        </div>
