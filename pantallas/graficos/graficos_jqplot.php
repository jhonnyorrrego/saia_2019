...
<script type="text/javascript" src="<?php echo($ruta_db_superior);?>js/jqplot_plugins/jqplot.pieRenderer.min.js"></script>
<script type="text/javascript" src="<?php echo($ruta_db_superior);?>js/jqplot_plugins/jqplot.donutRenderer.min.js"></script>
<script  type="text/javascript" >
$(document).ready(function(){    
    $.ajax({      
      async: false,
      url: "<?php echo($ruta_db_superior)?>pantallas/graficos/datos_graficos.php?<?php echo(implode("&",$filtro));?>",
      dataType:"json",
      success: function(data) {        
    		var plot2 = $.jqplot('grafico_<?php echo($graficos[0]["idbusqueda_grafico"]);?>', data.datos,{
