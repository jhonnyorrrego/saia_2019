...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'accept_file_types' => 'La extencion no esta permitida', //Filetype not allowed
    ...
    protected function get_file_object($file_name) {
        if ($this->is_valid_file_object($file_name)) {
            ...
            //se realiza un comentario de las lineas siguientes para evitar informacion base de la ubicacion del archivo cargado
	...
	public function get_resultado_carga($tipo_retorno = 0){//si el tipo_retorno = 1 retorna array si no retorna json			
		if(!$tipo_retorno){
			return ($this->resultado_carga);	
		}else{
			return (json_decode($this->resultado_carga));
		}			
	}
	
	public function set_resultado_carga($str){		
		$this->resultado_carga = $str;			
	}
