    ...
    <ul class="nav pull-left">                             
      ...
      <!-- /btn-group -->    
        <?php if(@$datos_busqueda[0]["enlace_adicionar"]){
        		$clase_info="enlace_adicionar_categoria_formato";
        		if ($_SESSION["tipo_dispositivo"] == "movil") {
							$clase_info = "kenlace_saia";
						}
        	?>
        	<li class="divider-vertical"></li><li><div class="btn-group">
        <button class="btn btn-mini btn-primary <?php echo $clase_info;?>" conector="iframe" titulo="adicionar" enlace="<?php echo($datos_busqueda[0]["enlace_adicionar"]); ?>">Adicionar Categoria</button></div></li>
        	<?php
        }
        ?>      
      </li>
