...
LoadData(@$_REQUEST["idpaso_condicional_admin"],$conn);
        ...
        <div class="controls">
          ...
          <select name="orden" id="orden">
            ...
            for($i=0;$i<$orden["numcampos"];$i++){
              ...
              if($i==($orden["numcampos"]-1) && $x_orden==''){
                echo(" selected ");
              }
              if(($x_orden || $x_orden===0) && $x_orden==$orden[$i]["orden"]){
              	echo(" selected ");
              }
...
global $idpaso_condicional_admin, $fk_paso_condicional, $fk_campos_formato, $comparacion, $valor, $habilitar_pasos_si, $habilitar_pasos_no, $estado, $x_orden;
