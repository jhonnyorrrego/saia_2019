...
<div id="main_button">
	<br>
	<br>
		<span id="tool_export" style="cursor:pointer" title="Guardar">
			<div></div>
			
		</span>
	
	<div id="main_icon" class="tool_button" title="Main Menu" style="display:none">
		<span>SVG-Edit</span>
		<div id="logo"></div>
...
<div id="tools_left" class="tools_panel">
	...
	<div class="tool_button" id="tool_line" title="Line Tool" style="display:none"></div>
	<div class="tool_button flyout_current" id="tools_rect_show" title="Square/Rect Tool" style="display:none">
		<div class="flyout_arrow_horiz" style="display:none"></div>
	</div>
	<div class="tool_button flyout_current" id="tools_ellipse_show" title="Ellipse/Circle Tool" style="display:none">
		<div class="flyout_arrow_horiz" style="display:none"></div>
	</div>
	<div class="tool_button" id="tool_path" title="Path Tool" style="display:none"></div>
	<div class="tool_button" id="tool_text" title="Text Tool" style="display:none"></div>
	<div class="tool_button" id="tool_image" title="Image Tool" style="display:none"></div>
	<div class="tool_button" id="tool_zoom" title="Zoom Tool [Ctrl+Up/Down]" style="display:none"></div>
	
	<!--div style="display: none">
		<div id="tool_rect" title="Rectangle" style="display:none"></div>
		<div id="tool_square" title="Square" style="display:none"></div>
		<div id="tool_fhrect" title="Free-Hand Rectangle" style="display:none"></div>
		<div id="tool_ellipse" title="Ellipse" style="display:none"></div>
		<div id="tool_circle" title="Circle" style="display:none"></div>
		<div id="tool_fhellipse" title="Free-Hand Ellipse" style="display:none"></div>
	</div-->
</div> <!-- tools_left -->
...
<div id="tools_bottom" class="tools_panel" style="display:none">
    ...
    <!-- Zoom buttons -->
	<div id="zoom_panel" class="toolset" title="Change zoom level" style="display:none">
		<label>
...
<div id="option_lists" class="dropdown" style="display:none">
	<ul id="linejoin_opts">
...
<div id="svg_source_editor" style="display:none">
...
<input type="hidden" name="ruta_retorno" id="ruta_retorno" value="<?php echo $_REQUEST["ruta_retorno"]; ?>">
<input type="hidden" name="campo_modificar" id="campo_modificar" value="<?php echo $_REQUEST["campo_modificar"]; ?>">

<input type="hidden" name="tabla" id="tabla" value="<?php echo $_REQUEST["tabla"]; ?>">
<input type="hidden" name="campo_tabla" id="campo_tabla" value="<?php echo $_REQUEST["campo_tabla"]; ?>">
<input type="hidden" name="llave_modificar" id="llave_modificar" value="<?php echo $_REQUEST["llave_modificar"]; ?>">
<input type="hidden" name="confirmar" id="confirmar" value="<?php echo $_REQUEST["confirmar"]; ?>">
</body>
</html>
