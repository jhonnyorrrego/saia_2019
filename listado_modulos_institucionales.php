...
for($i=0,$j=0;$i<$modulos["numcampos"];$i++){
  ...
  if($ok && $modulos[$i]["enlace"]<>"#"){
    $texto.='<td title="'.$modulos[$i]["ayuda"].'" align="center" ><a href="'.$modulos[$i]["enlace"].$adicional.'" target="'.$modulos[$i]["destino"].'"><b>'.$modulos[$i]["etiqueta"].'</b><br /><br /><img src="'.$modulos[$i]["imagen"].'" border="0px";></td>';
    $j++;
