...
<div class="card card-default">
		<div class="card-body">
            <h5 style="display:none;">&nbsp;&nbsp;<b>ADICI&Oacute;N DE P&Aacute;GINAS AL DOCUMENTO</b></h5>
            <form name="paginaadd" id="paginaadd" action="paginaadd.php" method="POST" onSubmit="return EW_checkMyForm(this);">
				...
				<div class="form-group" id="tr_escanear">
					...
					<div class="radio radio-success">
						<input type="radio" name="x_escaneo" value="1" id="x_escaneo_si">
						<label for="x_escaneo_si">SI</label>
						<input type="radio" name="x_escaneo" value="0" id="x_escaneo_no">
						<label for="x_escaneo_no">NO</label>
					</div>
				</div>
				<div class="form-group" id="tr_submit">
					<input type="submit" name="Action" class="btn btn-complete" value="CONTINUAR" />
...
<?php encriptar_sqli("paginaadd",1); ?>
