<?php
include_once("db.php");
$datos=busca_filtro_tabla("","busquedas","idbusquedas=3","",$conn);
$funciones=busca_filtro_tabla("idfunciones_busqueda","funciones_busqueda","busquedas_idbusqueda=3","",$conn);
if($funciones<>"")
...
<input type="hidden" name="tabla" value="cargo">
