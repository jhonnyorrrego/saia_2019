<?php
include_once("db.php");
$datos=busca_filtro_tabla("","busquedas","idbusquedas=49","",$conn);
$funciones=busca_filtro_tabla("idfunciones_busqueda","funciones_busqueda","busquedas_idbusqueda=49","",$conn);
...
<input type="hidden" name="adicionales" value="iddoc,<?php echo $_REQUEST["iddoc"]?>">
...
<input type="hidden" name="tabla" value="expediente">
...
<input type="hidden" name="no_encabezado" value="1">
