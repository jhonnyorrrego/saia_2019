...
<p>
	<span class="internos">ADICIONAR CARGOS</span>
</p>
<form name="cargoadd" id="cargoadd" action="cargoadd.php" method="post">
	<p>
	...
	<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
		...
		<tr>
			...
			<td bgcolor="#F5F5F5">
    			<span class="phpmaker">
    				<input type="text" name="x_nombre" id="x_nombre" size="30" maxlength="255" class="required" value="<?php echo htmlspecialchars(@$x_nombre) ?>">
    			</span>
    		</td>
		</tr>
		<tr>
			<td class="encabezado">
				<span class="phpmaker" style="color: #FFFFFF;">TIPO CARGO</span>
			</td>
		...
		<tr>
			<td class="encabezado">
				<span class="phpmaker" style="color: #FFFFFF;">CARGO PADRE</span>
			</td>
			<td bgcolor="#F5F5F5"><span class="phpmaker">
...
function AddData($conn) {
    ...
    $strsql .= ")";
    phpmkr_query($strsql) or die("Falla en la base de datos" . phpmkr_error() . ' SQL:' . $strsql);
...
<input type="hidden" maxlength="11" class="required"
	name="<?php echo $campo; ?>" id="<?php echo $campo; ?>" value="">
<label style="display: none" class="error" for="<?php echo $campo; ?>">Campo obligatorio. </label>
<script type="text/javascript">
                  <!--
                      var browserType;
