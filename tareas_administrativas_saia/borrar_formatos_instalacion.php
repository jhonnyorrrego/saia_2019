...
$busca_formatos_eliminar = busca_filtro_tabla("idformato,nombre", "formato", "nombre not in('carta','memorando','radicacion_entrada','vision_calidad','mision_calidad','politica_calidad','objetivos_calidad','proceso','caracterizacion','procedimientos','formatos_proceso','indicadores','instructivos','guias','manuales','otros','radicacion_salida')", "", $conn);
//Formatos base en la instalacion
