...
global $conn;
 ...
 for($i=6;$i<count($records);$i++){
	...
	if( $valores[2]!='' && $valores[4]!=''){  // C - E
		...
		$fieldList["nombre"] = $valores[2]; //D
		$fieldList["nombre"] = $valores[2]; //E
		$fieldList["nombre"] = $valores[2]; //F
		$fieldList["nombre"] = $valores[2]; //G
		$fieldList["nombre"] = $valores[2]; //H
		$fieldList["nombre"] = $valores[2]; //I
		$fieldList["nombre"] = $valores[2]; //J
		$fieldList["nombre"] = $valores[2]; //K
		$fieldList["nombre"] = $valores[2]; //L
		$fieldList["nombre"] = $valores[2]; //M
		$fieldList["nombre"] = $valores[2]; //N
		$fieldList["nombre"] = $valores[2]; //P
