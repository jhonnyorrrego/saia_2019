...
$conn -> Ejecutar_Sql("TRUNCATE TABLE distribucion");
...
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_accion_plan_mejoramiento");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_acciones_riesgo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_acta_reunion");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_actividades_contrato");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_adicionar_inducc");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_analisis_pqrsf");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_apertura_cierre_acta");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_bases_calidad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_beneficios_vida");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_calificacion_qrsf");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_carta");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_certificado_laboral");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_clasificacion_pqrsf");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_contexto_extrategico");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_control_documentos");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_control_riesgos");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_correo_saia");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_cuotas_extraor");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_cuotas_ordinarias");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_dar_baja_activo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_dependencias_ruta");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_despacho_fisico");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_despacho_ingresados");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_destino_radicacion");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_detalle_gasto_legalizacion");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_distribucion_fisica");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_educacion");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_encuesta_ingreso");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_entrega_prestamo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_entrevista_retiro");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_evaluacion_periodo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_experiencia");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_factores_competencia");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_formato");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_formula_indicador");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_funcionarios_ruta");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_garantia_activo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_gastos_viaje");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_grupo_familiar");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_guia");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_hallazgo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_historial_inventario");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_hoja_vida");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_identifica_contrato");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_indicadores_calidad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_informe_contraloria");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_ingreso_personal");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_instructivo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_add_solicit");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_afiliaciones");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_aprobaciones");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_capacitacion");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_causas_pqrsf");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_conclusiones");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_control_versio");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_despacho_ingres");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_endeudamiento");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_facturas");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_invitado");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_lista_actividad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_participantes");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_item_recibidos");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_legalizacion_gastos_viaje");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_lista_verifica_perso");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_macroproceso_calidad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_manual");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_memorando");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_monitoreo_revision");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_novedad_cesantias");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_novedad_despacho");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_novedad_permiso");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_novedad_prestamo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_oficio_word");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_otros_calidad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_otrosi_contrato");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_plan_calidad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_plan_induccion");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_plan_mejoramiento");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_politicas_proceso");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_polizas");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_pqrsf");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_procedimiento");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_proceso");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_prog_calidad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_radicacion_entrada");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_radicacion_facturas");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_radicacion_salida");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_registro_activos_fijos");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_registro_incapacidad");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_reservar_documento");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_respuesta_pqrsf");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_riesgos_proceso");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_ruta_distribucion");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_seguimiento");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_seguimiento_indicador");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_certificado");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_cesantias");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_mantenimiento");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_permisos");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_personal");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_prestamo");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_prestamos");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_solicitud_vacaciones");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_tema_acta");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_transferencia_doc");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_ubicacion_activos");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_validacion_tramite");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_variable_indicador");
$conn -> Ejecutar_Sql("TRUNCATE TABLE ft_vincular_doc_expedie");
