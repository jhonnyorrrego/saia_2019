...
<div class="control-group element">
  ...
  <div class="controls">
      <input id="fecha_limite" name="fecha_limite" style="width:100px" type="text" value="0000-00-00" ><input type="button" onclick="document.getElementById('fecha_limite').value='0000-00-00'" />
