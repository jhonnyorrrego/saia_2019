...
function SetUpSortOrder()
{
	...
	if (strlen(@$HTTP_GET_VARS["order"]) > 0) {
		...
		if ($sOrder == "asunto") {
			...
			if (@$HTTP_SESSION_VARS["pretexto_x_asunto_Sort"] <> "") {
				@$HTTP_SESSION_VARS["pretexto_x_asunto_Sort"] = "";
			}
		}
		...
		if ($sOrder == "imagen") {
			...
			if (@$HTTP_SESSION_VARS["pretexto_x_imagen_Sort"] <> "") {
				@$HTTP_SESSION_VARS["pretexto_x_imagen_Sort"] = "";
			}
		}
