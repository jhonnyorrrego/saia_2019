  ...
  <!--
      ...
      if (window.navigator.userAgent.toLowerCase().match("gecko")) {
         browserType= "gecko"
			...
			tree2.setXMLAutoLoading("test_expediente_serie.php?tabla=dependencia&admin=1&estado=1&carga_partes_serie=1&sin_padre_expediente=1&sin_padre=1");
			tree2.loadXML("test_expediente_serie.php?tabla=dependencia&admin=1&estado=1&carga_partes_serie=1&sin_padre_expediente=1&sin_padre=1");
