...
<div style="padding-top: 50px;">
    <form action="<?php echo($ruta_db_superior);?>pantallas/funcionario/fotografia/upload_foto.php" class="dropzone" id="my-dropzone-container" method="post" enctype="multipart/form-data">
        <div class="fallback">
