...
class CoinGeneratorController extends ComponentFormGeneratorController implements IComponentGenerator
{
    ...
    public function generateAditionComponent()
    {
        ...
        $texto[] = "<div class='form-group form-group-default input-group {$this->getRequiredClass()} col-12 {$options->clase}' id='group_{$campo["nombre"]}'>";
