	...
	public function imprimir()
	{
		...
		if ($campos_pdfa['numcampos']) {
			for ($i = 0; $i < $campos_pdfa['numcampos']; $i++) {
				$this->pdf->SetExtraMetadata($campos_pdfa[$i]['etiqueta'], ComponentFormGeneratorController::callShowValue($this->formato[0]['idformato'], $this->documento[0]["iddocumento"]),$campos_pdfa[$i]['nombre']);
			}
		}
		//
