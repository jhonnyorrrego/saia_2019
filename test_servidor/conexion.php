...
*/
   function  Conectar_Mysql()
    {
     $this->conn = mysqli_connect($this->Host.":" . $this->Puerto, $this->Usuario,$this->Pass) or die("NO SE PUEDE CONECTAR A LA BASE DE DATOS");
     ((bool)mysqli_query($this->conn, "USE " . $this->Db));
    }
    function  Conectar_SqlServer(){
      if($this->Puerto)
        ...
        $conecta=$this->Host;     
     $this->conn = sqlsrv_connect($conecta, array("UID"=>$this->Usuario,"PWD"=>$this->Pass,"Database"=>$this->Db))or die("NO SE PUEDE CONECTAR A LA BASE DE DATOS ".implode("<br />",sqlsrv_errors()));
