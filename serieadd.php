...
<input type="text" name="x_nombre" id="x_nombre" value="<?php echo htmlspecialchars(@$x_nombre) ?>">
  ...
  <!--
    ...
    //tree2.setOnClickHandler(onNodeSelect);
      ...
      tree2.setXMLAutoLoading("test_serie.php?tabla=serie&admin=1&arbol_series=1&categoria=2&solo_series=1");
      tree2.loadXML("test_serie.php?tabla=serie&admin=1&arbol_series=1&categoria=2&solo_series=1");
