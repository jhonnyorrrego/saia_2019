...
include_once("db.php");
global $conn;
$datos=busca_filtro_tabla("","busquedas","idbusquedas=5","",$conn);
$funciones=busca_filtro_tabla("idfunciones_busqueda","funciones_busqueda","busquedas_idbusqueda=5","",$conn);
if($funciones<>"")
...
<input type="hidden" name="tabla" value="ejecutor,datos_ejecutor">
