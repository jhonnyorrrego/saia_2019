...
if(!$_REQUEST['no_fondos']){ 
  ...
  echo "</item>\n";
  echo "<item style=\"font-family:verdana; font-size:7pt;\" text=\"SISTEMA GENERAL DE REGALIAS\" id=\"17416\">\n"; 
  echo "</item>\n";
}
echo("</tree>\n");
$activo = "";
...
if($papas["numcampos"]){
    ...
    echo(" text='DESPACHO DEL GOBERNADOR' id='17496'");	
	...
	if($_REQUEST["atencion_comunidad"] == 1){
		echo("<item style='font-family:verdana; font-size:7pt;'");
	    echo(" text='PROMOTORA DE VIVIENDA' id='17116'");
