...
if (!isset($_REQUEST["URL"])) {
	...
	$_REQUEST["URL"] = PROTOCOLO_CONEXION . RUTA_PDF . "/formatos/" . $_REQUEST["plantilla"] . "/mostrar_" . $_REQUEST["plantilla"] . ".php?tipo=5&iddoc=" . $_REQUEST["iddoc"] . "&output=2&idfunc=" . usuario_actual("funcionario_codigo");
...
function encabezado_pie_pagina($plantilla, $doc, $vista = 0) {
	...
	if (!$mostrar[0][0]) {$header[0]["encabezado"] = "";
		$header[0]["pie_pagina"] = "";
	}
