...
$base_url=PROTOCOLO_CONEXION.RUTA_PDF;  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/../images/'; // path from base_url to base of upload folder (with start and final /)
$current_path = $ruta_db_superior.'../images/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $ruta_db_superior.'../thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
