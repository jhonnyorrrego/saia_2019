  ...
  else
    {
     if(isset($_REQUEST["firmado"]) && $_REQUEST["firmado"]=="varias")
       ...
       if($formato_doc["numcampos"])
		...
		abrir_url("formatos/".$nom_formato."/detalles_mostrar_".$nom_formato.".php?form_info=".encrypt_blowfish("idformato=".$formato_doc[0]["idformato"]."&iddoc=".$_POST["iddoc"],LLAVE_SAIA_CRYPTO),"_self123");
        die();
        }
       }
    }
