...
function transferir_archivo_prueba($datos,$destino,$adicionales)
{
 ...
 if(array_key_exists("ruta_idruta",$datos) && ($datos["nombre"]=="TRANSFERIDO"||$datos["nombre"]=="COPIA"))
    {
     $bloqueante=busca_filtro_tabla("A.orden,A.restrictivo,B.idtransferencia as trans","ruta A, buzon_entrada B","B.ruta_idruta=A.idruta and B.nombre in ('TRANSFERIDO','COPIA') and B.origen=".$origen." and B.archivo_idarchivo=$idarchivo","B.idtransferencia desc", $conn);
