...
$datos=busca_filtro_tabla("","busquedas","idbusquedas=95","",$conn);
$funciones=busca_filtro_tabla("idfunciones_busqueda","funciones_busqueda","busquedas_idbusqueda=95","orden asc",$conn);
