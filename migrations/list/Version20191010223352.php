...
final class Version20191010223352 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->connection->update('busqueda_condicion', [
            'codigo_where' => "a.documento_iddocumento=b.iddocumento AND lower(b.estado)='aprobado' AND a.estado_distribucion IN (0,1) AND b.ejecutor=c.funcionario_codigo AND c.ventanilla_radicacion=d.idcf_ventanilla AND b.ventanilla_radicacion=e.idcf_ventanilla {*condicion_adicional_distribucion*}"
        ], [
