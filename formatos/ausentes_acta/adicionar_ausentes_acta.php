  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_funcionario_ausente.findItem(htmlentities(document.getElementById('stext_funcionario_ausente').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_funcionario_ausente"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_funcionario_ausente" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="funcionario_ausente" id="funcionario_ausente"   value="" ><label style="display:none" class="error" for="funcionario_ausente">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
