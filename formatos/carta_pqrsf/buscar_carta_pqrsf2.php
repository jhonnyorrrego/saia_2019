<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato 3. Carta PQRSF</legend><br /><br /><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="fecha_carta"><b>Fecha de Creacion<input type="hidden" name="bksaiacondicion_g@fecha_carta" id="bksaiacondicion_g@fecha_carta" value="date"></b></label><div class="controls">
		  ...
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_g@fecha_carta',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_g@fecha_carta" id="bqsaiaenlace_g@fecha_carta" value="y" />
		</div></div></div>
                <fieldset>
		  ...
		  <input type="hidden" name="bqsaiaenlace_g@despedida" id="bqsaiaenlace_g@despedida" value="y" />
		</div></div></div><div class="control-group"><div class="controls"><b>Con Copia Interna A<input type="hidden" name="bksaiacondicion_copiainterna" id="bksaiacondicion_copiainterna" value="="></b><div id="esperando_copiainterna"><img src="../../imagenes/cargando.gif"></div><div id="seleccionados"></div><input type="text" id="stext_copiainterna" placeholder="Buscar" width="200px" size="25">
                   ...
                   <a href="javascript:void(0)" onclick="tree_copiainterna.findItem(htmlentities(document.getElementById('stext_copiainterna').value),0,1)"><img src="../../botones/general/buscar.png"border="0px"></a>
                          ...
                          <br /><br /><div id="treeboxbox_copiainterna" height=""></div><input type="hidden" maxlength="11"  name="g@copiainterna" id="copiainterna"   value="" ><label style="display:none" class="error" for="copiainterna">Campo obligatorio.</b></label><script type="text/javascript">
                  <!--
                      var browserType;
