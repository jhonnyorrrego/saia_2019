<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato 3. Carta PQRSF</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="fecha_carta"><b>Fecha de Creacion<input type="hidden" name="bksaiacondicion_g@fecha_carta" id="bksaiacondicion_g@fecha_carta" value="date"></b></label><div class="controls">
