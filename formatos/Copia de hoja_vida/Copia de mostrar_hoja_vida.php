<?php include_once("funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header.php"); ?><?php include_once("../../class_transferencia.php"); ?><tr><td><table class="tabla_no_borde" border="1" cellspacing="0" cellpadding="0" width="70%">
<tbody>
<tr>
<td style="text-align: center;" rowspan="5"><?php foto_hoja_vida(71,$_REQUEST['iddoc']);?><br /></td>
<td class="encabezado" width="30%"><span style="color: #ffffff;">Documento Identidad:</span></td>
<td class="phpmaker" style="width: 70%;"><?php mostrar_valor_campo('documento_identidad',71,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
...
<tr>
<td colspan="3"><?php mostrar_estado_proceso(71,$_REQUEST['iddoc'],'mostrar_'.$_REQUEST['plantilla'],$_REQUEST['iddoc']);?></td>
</tr>
</tbody>
