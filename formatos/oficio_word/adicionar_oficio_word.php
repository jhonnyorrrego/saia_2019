<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:ADICIONAR DOCUMENTOS EN FORMATO (WORD):.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(400,4802);?></div><div class="form-group" id="tr_tipo_radicado">
                                        ...
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="asunto_word" name="asunto_word" required value="<?php echo(validar_valor_campo(6698)); ?>">
                                       </div><div class="form-group" id="tr_clasifica_expediente">
                                <label title="">CLASIFICAR EN EXPEDIENTE*</label><div class="form-control"><div id="seleccionados"><?php if(isset($_REQUEST["iddoc"])){mostrar_seleccionados(400,6700,'4',$_REQUEST['iddoc']);}?></div><br/><input type="hidden" maxlength="255"  class="required"  name="clasifica_expediente" id="clasifica_expediente"   value="" ><label style="display:none" class="error" for="clasifica_expediente">Campo obligatorio.</label><div id="esperando_clasifica_expediente">
                                ...
                                function cargando_clasifica_expediente() {
                                    ...
                                    document.poppedLayer.style.display = "";
                                }</script></div></div><input type="hidden" name="fk_idexpediente" value="<?php echo(validar_valor_campo(6701)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4796)); ?>"><div class="form-group" id="tr_anexo_word">
                                       ...
                                       <div class="card-body no-scroll no-padding"><div id="dz_campo_4797" class="saia_dz dropzone no-margin" data-nombre-campo="anexo_word" data-idformato="400" data-idcampo-formato="4797" data-extensiones=".docx, .DOCX" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div><input type="hidden" class="required" id="anexo_word" name="anexo_word" value=""></div></div></div><div class="form-group" id="tr_anexo_csv">
...
5. Recuerde que en la plantilla de WORD  deben aparecer los textos que escribi&oacute; como encabezado de las columnas pero adicionando los s&iacute;mbolos <b>$</b> y <b>{ }</b> al inicio y final.  Ejemplo:  <b>${Nombre del Destino}</b>,  <b>${Direccion}</b>, <b>${Telefono}</b>, etc.">CARGAR ARCHIVO DE EXCEL (PARA COMBINAR CORRESPONDENCIA)</label>
                                       ...
                                       <div class="card-body no-scroll no-padding"><div id="dz_campo_4944" class="saia_dz dropzone no-margin" data-nombre-campo="anexo_csv" data-idformato="400" data-idcampo-formato="4944" data-extensiones=".csv, .CSV, .xls, .XLS, .xlsx, .XLSX" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div></div></div></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(4803)); ?>"><input type="hidden" name="idft_oficio_word" value="<?php echo(validar_valor_campo(4800)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(4804)); ?>"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(4795)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4801)); ?>"><?php asignar_responsables(400,NULL);?><?php add_edit_oficio_word(400,NULL);?><input type="hidden" name="campo_descripcion" value="6698"><tr><td colspan='2'><?php submit_formato(400);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
