                  ...
                  <div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                      ...
                      <div class="card card-default">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(400,4802,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_tipo_radicado">
                                        ...
                                        <input class="form-control" required maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="asunto_word" name="asunto_word" required value="<?php echo(mostrar_valor_campo('asunto_word',400,$_REQUEST['iddoc'])); ?>">
                                       </div><div class="form-group" id="tr_clasifica_expediente">
                                <label title="">CLASIFICAR EN EXPEDIENTE*</label><div class="form-controls"><div id="seleccionados"><?php if(isset($_REQUEST["iddoc"])){mostrar_seleccionados(400,6700,'4',$_REQUEST['iddoc']);}?></div><br/><input type="hidden" maxlength="255"  class="required"  name="clasifica_expediente" id="clasifica_expediente"   value="<?php if(isset($_REQUEST["iddoc"])){cargar_seleccionados(400,6700,1,$_REQUEST['iddoc']);}?>" ><div id="esperando_clasifica_expediente">
