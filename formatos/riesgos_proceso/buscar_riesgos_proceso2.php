<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Riesgos</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="identificacion_riesgo"><b>IDENTIFICACION DEL RIESGO<input type="hidden" name="bksaiacondicion_identificacion_riesgo" id="bksaiacondicion_identificacion_riesgo" value="like_total"></b></label></div><div class="control-group">
		...
		</div></div></div><div class="control-group"><b>N&Uacute;MERO<input type="hidden" name="bksaiacondicion_g@consecutivo" id="bksaiacondicion_g@consecutivo" value="="></b><div class="controls"><input type="text" id="consecutivo" name="bqsaia_g@consecutivo"><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><b>Riesgo<input type="hidden" name="bksaiacondicion_g@riesgo" id="bksaiacondicion_g@riesgo" value="like_total"></b><div class="controls"><textarea  maxlength="4000"   id="riesgo" name="bqsaia_g@riesgo"  style="width:500px;height:100px"></textarea><div class="btn-group" data-toggle="buttons-radio" >
