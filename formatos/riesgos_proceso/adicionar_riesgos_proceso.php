<html><title>.:ADICIONAR RIESGOS:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("funciones.php"); ?><?php include_once("../riesgos_proceso/funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="STYLESHEET" type="text/css" href="../../css/dhtmlXTree.css"><script type='text/javascript'>
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">RIESGOS</td></tr><input type="hidden" name="riesgo_antiguo" value="<?php echo(validar_valor_campo(4679)); ?>"><tr>
                     ...
                     <?php buscar_dependencia(393,4681);?></tr><tr>
                     <td class="encabezado" width="20%" title="">FECHA*</td>
                     <?php fecha_bloqueada(393,4682);?></tr><tr id="tr_estado" >
                     <td class="encabezado" width="20%" title="Estado Actual: ELABORACION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(393,4683,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4684)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">N&Uacute;MERO*</td>
                     <?php consecutivo_riesgo(393,4685);?></tr><tr>
                     <td class="encabezado" width="20%" title="Actividad">ACTIVIDAD*</td>
                     <td class="celda_transparente"><textarea  tabindex='1'  name="nombre" id="nombre" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(4686)); ?></textarea></td>
                    </tr><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="riesgo" id="riesgo" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(4688)); ?></textarea></td>
                    </tr><input type="hidden" name="controles" value="<?php echo(validar_valor_campo(4689)); ?>"><tr>
                     <td class="encabezado" width="20%" title="Descripci&oacute;n del riesgo">DESCRIPCI&Oacute;N DEL RIESGO*</td>
                     <td class="celda_transparente"><textarea  tabindex='4'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(4690)); ?></textarea></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='5'  name="fuente_causa" id="fuente_causa" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(4692)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Consecuencia">CONSECUENCIA O EFECTO*</td>
                     <td class="celda_transparente"><textarea  tabindex='6'  name="consecuencia" id="consecuencia" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(4693)); ?></textarea></td>
                    </tr><input type="hidden" name="opciones_manejo" value="<?php echo(validar_valor_campo(4694)); ?>"><input type="hidden" name="acciones" value="<?php echo(validar_valor_campo(4695)); ?>"><tr>
                     <td class="encabezado" width="20%" title="" colspan="2"><h1><center><strong>ANALISIS DE RIESGO</strong></center></h1></td>
                    </tr><input type="hidden" name="responsables" value="<?php echo(validar_valor_campo(4697)); ?>"><tr id="tr_probabilidad" >
                     <td class="encabezado" width="20%" title="Probabilidad">PROBABILIDAD*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(393,4698,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="indicador" value="<?php echo(validar_valor_campo(4699)); ?>"><input type="hidden" name="cronograma" value="<?php echo(validar_valor_campo(4700)); ?>"><tr id="tr_impacto" >
                     <td class="encabezado" width="20%" title="Impacto">IMPACTO</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(393,4701,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(4702)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(4703)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4704)); ?>"><input type="hidden" name="idft_riesgos_proceso" value="<?php echo(validar_valor_campo(4705)); ?>"><?php selecion_tipo_riesgo(393,NULL);?><?php validar_edicion_adicion_formatos_riesgo_aprobados(393,NULL);?><?php validar_revision_aprobacion(393,NULL);?><input type="hidden" name="campo_descripcion" value="4688"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><input type="hidden" name="accion" value="guardar_detalle" ><tr><td colspan='2'><?php submit_formato(393);?></td></tr></table></form></body></html>