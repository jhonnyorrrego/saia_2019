...
function SetUpSortOrder()
{
	...
	if (strlen(@$_GET["order"]) > 0) {
		...
		if ($sOrder == "idvista_formato") {
			...
			if (@$_SESSION["vista_formato_Sort"] <> "") {
				@$_SESSION["vista_formato_Sort"] = "";
			}
		}
		...
		if ($sOrder == "nombre") {
			...
			if (@$_SESSION["vista_x_nombre_Sort"] <> "") {
				@$_SESSION["vista_x_nombre_Sort"] = "";
			}
		}
		...
		if ($sOrder == "etiqueta") {
			...
			if (@$_SESSION["vista_x_etiqueta_Sort"] <> "") {
				@$_SESSION["vista_x_etiqueta_Sort"] = "";
			}
		}
		...
		if ($sOrder == "contador_idcontador") {
			...
			if (@$_SESSION["vista_x_contador_idcontador_Sort"] <> "") {
				@$_SESSION["vista_x_contador_idcontador_Sort"] = "";
			}
		}
		...
		if ($sOrder == "margenes") {
			...
			if (@$_SESSION["vista_x_margenes_Sort"] <> "") {
				@$_SESSION["vista_x_margenes_Sort"] = "";
			}
		}
		...
		if ($sOrder == "orientacion") {
			...
			if (@$_SESSION["vista_x_orientacion_Sort"] <> "") {
				@$_SESSION["vista_x_orientacion_Sort"] = "";
			}
		}
		...
		if ($sOrder == "papel") {
			...
			if (@$_SESSION["vista_x_papel_Sort"] <> "") {
				@$_SESSION["vista_x_papel_Sort"] = "";
			}
		}
		...
		if ($sOrder == "exportar") {
			...
			if (@$_SESSION["vista_x_exportar_Sort"] <> "") {
				@$_SESSION["vista_x_exportar_Sort"] = "";
			}
		}
