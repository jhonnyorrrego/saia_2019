<html><title>.:BUSCAR FORMULA DEL INDICADOR:.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script>
			<link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/>
                    ...
                    </tr><tr id="tr_observacion"><td class="encabezado">&nbsp;<select name="condicion_observacion" id="condicion_observacion"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr id="tr_periocidad"><td class="encabezado">&nbsp;<select name="condicion_periocidad" id="condicion_periocidad"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="Tiempo en el cual se debe evaluar el indicador">PERIODICIDAD</td><td class="encabezado">&nbsp;<select name="compara_periocidad" id="compara_periocidad"> <option value="LIKE|%|%">Similar</option><option value="LIKE|%|@">Inicia Con</option><option value="LIKE|@|%">Finaliza Con</option></select></td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(488,6202,'',1);?></td></tr><tr id="tr_unidad"><td class="encabezado">&nbsp;<select name="condicion_unidad" id="condicion_unidad"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr id="tr_tipo_rango"><td class="encabezado">&nbsp;<select name="condicion_tipo_rango" id="condicion_tipo_rango"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">LA MEJORA ES CRECIENTE O DECRECIENTE?</td><td class="encabezado">&nbsp;<select name="compara_tipo_rango" id="compara_tipo_rango"> <option value="=|@|@">Igual</option><option value="-|@|@">Menor</option><option value="+|@|@">Mayor</option><option value="!|@|@">Diferente</option></select></td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(488,6205,'',1);?></td></tr><input type="hidden" name="campo_descripcion" value="6200"><?php submit_formato(488);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
