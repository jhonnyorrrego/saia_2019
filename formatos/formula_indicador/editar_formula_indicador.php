<html><title>.:EDITAR FORMULA DEL INDICADOR:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">FORMULA DEL INDICADOR</td></tr><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(488,6196,$_REQUEST['iddoc']);?></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',488,$_REQUEST['iddoc'])); ?>"><tr id="tr_naturaleza" >
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="observacion" id="observacion" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('observacion',488,$_REQUEST['iddoc'])); ?></textarea></td></tr><tr id="tr_periocidad" >
                    ...
                    </tr><tr id="tr_rango_colores"><td class="encabezado" width="20%" title="">RANGO EN EL CUAL EL RESULTADO SE CONSIDERA SATISFACTORIO*</td><?php rango_formula(488,6204,$_REQUEST['iddoc']);?></tr><tr id="tr_tipo_rango" >
