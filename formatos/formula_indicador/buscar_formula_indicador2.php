<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Formula del indicador</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="naturaleza"><b>Naturaleza<input type="hidden" name="bksaiacondicion_g@naturaleza" id="bksaiacondicion_g@naturaleza" value="like_total"></b></label><div class="controls"><?php genera_campo_listados_editar(381,4510,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><label class="string control-label" style="font-size:9pt" for="periocidad"><b>Periocidad<input type="hidden" name="bksaiacondicion_g@periocidad" id="bksaiacondicion_g@periocidad" value="like_total"></b></label><div class="controls"><?php genera_campo_listados_editar(381,4513,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
