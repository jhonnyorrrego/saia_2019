	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input  maxlength="15"  class="required"   tabindex='2'  type="text" size="100" id="valor_accesorio" name="valor_accesorio"  value="<?php echo(validar_valor_campo(2947)); ?>"></td>
                    </tr><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_datos_vehiculo"  value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden"  name="idpadre"  value="<?php echo $_REQUEST["idpadre"]; ?>"><?php } ?><tr><td class="encabezado">ACCION A SEGUIR LUEGO DE GUARDAR</td><td ><input type="radio" name="opcion_item" value="adicionar">Adicionar otro&nbsp;&nbsp;<input type="radio" name="opcion_item" value="terminar">Terminar</td></tr><?php separar_miles_valor_accesorio(259,NULL);?><input type="hidden" name="campo_descripcion" value="2946"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="formato" value="accesorios_vehiculo"><input type="hidden" name="accion" value="guardar_item" ><tr><td colspan='2'><?php submit_formato(259);?></td></tr></table></form></body></html>