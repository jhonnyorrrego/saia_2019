<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Fecha<input type="hidden" name="bksaiacondicion_g@fecha_confirmacion" id="bksaiacondicion_g@fecha_confirmacion" value="like_total"></b><div class="controls"><input type="text" id="fecha_confirmacion" name="bqsaia_g@fecha_confirmacion"><div class="btn-group" data-toggle="buttons-radio" >
