	...
	<div class="container master-container">
      ...
      <input type="hidden" name="adicionar_consulta" id="adicionar_consulta" value="1">
			<div class="control-group">
				<label class="string required control-label" for="rango_fecha">
					
				</label>        
			</div>
			<input type="hidden" name="idbusqueda_componente" id="idbusqueda_componente" value="131" componente="131">		              
</form>
</div>
