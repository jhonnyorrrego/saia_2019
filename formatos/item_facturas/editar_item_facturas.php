<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>formatos/librerias/funciones_item.php" enctype="multipart/form-data"><input type="hidden" name="transferido" value="<?php echo(mostrar_valor_campo('transferido',425,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="posterior_adicionar" value="<?php echo(mostrar_valor_campo('posterior_adicionar',425,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(425,7055,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_clasificacion_fact">
	                        <label title="">CLASIFICACI&Oacute;N*</label>
                                     <?php genera_campo_listados_editar(425,7054,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_pago_desde">
	                        <label title="">PAGO REALIZADO DESDE*</label>
                                     <?php genera_campo_listados_editar(425,7061,$_REQUEST['iddoc']);?></div><div class="form-group form-group-default required"  id="tr_valor_factura">
                                        <label title="">VALOR DE LA FACTURA</label>
                                        <input class="form-control"  maxlength="11"  class="required"   tabindex='1'  type="text"  size="100" id="valor_factura" name="valor_factura" required value="<?php echo(mostrar_valor_campo('valor_factura',425,$_REQUEST['iddoc'])); ?>">
                                       </div><div class="form-group form-group form-group-default id="tr_fecha_programada">
<label title="">FECHA PROGRAMADA DE PAGO*</label>
<div class="input-group">
<input  tabindex="2 " type="text" class="form-control"  id="fecha_programada"  required name="fecha_programada">
<span class="input-group-text"><i class="fa fa-calendar"></i></span>
</div>
<script type="text/javascript">
            $(function () {
                var configuracion={"defaultDate":"<?php echo(mostrar_valor_campo('fecha_programada',425,$_REQUEST['iddoc'])); ?>","format":"YYYY-MM-DD","locale":"es","useCurrent":true};
                ...
                $("#content_container").height($(window).height());
	                        ...
	                        <label title="1,Baja;2,Media;3,Alta">PRIORIDAD</label>
                                     <?php genera_campo_listados_editar(425,7063,$_REQUEST['iddoc']);?></div><div class="form-group form-group-default required"  id="tr_numero_orden">
                                        <label title="">N&Uacute;MERO ORDEN COMPRA / CONTRATO</label>
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='3'  type="text"  size="100" id="numero_orden" name="numero_orden" required value="<?php echo(mostrar_valor_campo('numero_orden',425,$_REQUEST['iddoc'])); ?>">
