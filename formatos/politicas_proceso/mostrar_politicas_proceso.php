...
<td><?php mostrar_valor_campo('nombre',369,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado_list" style="text-align: left;">Descripcion</td>
<td><?php mostrar_valor_campo('descripcion',369,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado_list" style="text-align: left;">Soporte</td>
<td><?php mostrar_valor_campo('soporte',369,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado_list" style="text-align: left;">Estado</td>
<td><?php mostrar_valor_campo('estado',369,$_REQUEST['iddoc']);?></td>
</tr>
</tbody>
