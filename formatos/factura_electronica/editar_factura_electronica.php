<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">FACTURA ELECTRÓNICA</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],438,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',438,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',438,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',438,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="idft_factura_electronica" value="<?php echo(mostrar_valor_campo('idft_factura_electronica',438,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(mostrar_valor_campo('serie_idserie',438,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="dependencia" value="<?php echo(mostrar_valor_campo('dependencia',438,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_proveedor">
                                        <label title="">PROVEEDOR*</label>
                                        <input type="hidden" maxlength="255"  class="required"  name="proveedor" id="proveedor" value="<?php echo(mostrar_valor_campo('proveedor',438,$_REQUEST['iddoc'])); ?>"><?php componente_ejecutor("7189",@$_REQUEST["iddoc"]); ?></div><div class="form-group form-group-default required"  id="tr_num_factura">
                                        <label title="">N&Uacute;MERO DE FACTURA</label>
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="num_factura" name="num_factura" required value="<?php echo(mostrar_valor_campo('num_factura',438,$_REQUEST['iddoc'])); ?>">
                                       </div><div class="form-group form-group-default required"  id="tr_total_factura">
                                        <label title="">TOTAL FACTURA</label>
                                        <input class="form-control"  maxlength="50"   tabindex='2'  type="text"  size="100" id="total_factura" name="total_factura" required value="<?php echo(mostrar_valor_campo('total_factura',438,$_REQUEST['iddoc'])); ?>">
                                       ...
                                       <div class="card-body no-scroll no-padding"><?php echo '<div class="textwrapper">
                                            <a href="../../anexosdigitales/anexos_documento_edit.php?key='.$_REQUEST["iddoc"].'&idformato=438&idcampo=7178" id="anexo_admin" class="highslide" onclick="return hs.htmlExpand( this, {
                                            objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
                                            outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
                                            </div>'; ?></div></div><div class="form-group" id="tr_fecha_factura">
<label for="fecha_factura">FECHA FACTURA</label>

<div class="input-group date">
<input  tabindex="4 " type="text" class="form-control"  id="fecha_factura"   name="fecha_factura" />
<div class="input-group-append">
<span class="input-group-text"><i class="fa fa-calendar"></i></span>
</div>
<script type="text/javascript">
            $(function () {
                var configuracion={"defaultDate":"<?php echo(mostrar_valor_campo('fecha_factura',438,$_REQUEST['iddoc'])); ?>","format":"YYYY-MM-DD LT","locale":"es","useCurrent":true};
                $("#fecha_factura").datetimepicker(configuracion);
                $("#content_container").height($(window).height());
            });
        </script>
</div>
</div><input type="hidden" name="fk_datos_factura" value="<?php echo(mostrar_valor_campo('fk_datos_factura',438,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_info_proveedor">
                                        <label title="">INFORMACI&Oacute;N ADICIONAL DEL PROVEEDOR</label>
                                        <div class="celda_transparente"><textarea  tabindex='5'  name="info_proveedor" id="info_proveedor" cols="53" rows="3" class="form-control"><?php echo(mostrar_valor_campo('info_proveedor',438,$_REQUEST['iddoc'])); ?></textarea></div></div><input type="hidden" name="campo_descripcion" value="<?php echo('7188'); ?>"><input type="hidden" name="formato" value="438"><tr><td colspan='2'><?php submit_formato(438,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
