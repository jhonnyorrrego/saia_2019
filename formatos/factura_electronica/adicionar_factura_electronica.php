<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(7180)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(7181)); ?>"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(7182)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(7184)); ?>"><input type="hidden" name="idft_factura_electronica" value="<?php echo(validar_valor_campo(7186)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(7190)); ?>"><input type="hidden" name="dependencia" value="<?php echo(validar_valor_campo(7179)); ?>"><div class="form-group" id="tr_proveedor">
                                        <label title="">PROVEEDOR*</label>
                                        <input type="hidden" maxlength="255"  class="required"  name="proveedor" id="proveedor" value="1"><?php componente_ejecutor("7189",@$_REQUEST["iddoc"]); ?></div><div class="form-group form-group-default required"  id="tr_num_factura">
                                        <label title="">N&Uacute;MERO DE FACTURA</label>
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="num_factura" name="num_factura" required value="<?php echo(validar_valor_campo(7188)); ?>">
                                       </div><div class="form-group form-group-default required"  id="tr_total_factura">
                                        <label title="">TOTAL FACTURA</label>
                                        <input class="form-control"  maxlength="50"   tabindex='2'  type="text"  size="100" id="total_factura" name="total_factura" required value="<?php echo(validar_valor_campo(7191)); ?>">
                                       ...
                                       <div class="card-body no-scroll no-padding"><div id="dz_campo_7178" class="saia_dz dropzone no-margin" data-nombre-campo="anexos" data-idformato="438" data-idcampo-formato="7178" data-extensiones="<?php echo $extensiones;?>" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div></div></div></div><div class="form-group" id="tr_fecha_factura">
...
</div><input type="hidden" name="fk_datos_factura" value="<?php echo(validar_valor_campo(7185)); ?>"><div class="form-group" id="tr_info_proveedor">
                                        <label title="">INFORMACI&Oacute;N ADICIONAL DEL PROVEEDOR</label>
                                        <div class="celda_transparente"><textarea  tabindex='5'  name="info_proveedor" id="info_proveedor" cols="53" rows="3" class="form-control"><?php echo(validar_valor_campo(7187)); ?></textarea></div></div><input type="hidden" name="campo_descripcion" value="7188"><tr><td colspan='2'><?php submit_formato(438);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body>
      <script type="text/javascript">
      setInterval("auto_save('proveedor','factura_electronica')",300000);
