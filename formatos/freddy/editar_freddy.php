<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">FREDDY</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],430,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="idft_freddy" value="<?php echo(mostrar_valor_campo('idft_freddy',430,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',430,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(430,7115,$_REQUEST['iddoc']);?></div><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',430,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',430,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',430,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(mostrar_valor_campo('serie_idserie',430,$_REQUEST['iddoc'])); ?>"><div class="form-group form-group-default "  style="width:25%;"  id="tr_prueba">
                                        <label title="123">PRUEBA</label>
                                        <input class="form-control"  maxlength="11"   tabindex='1'  type="text"  style="width:25%;"  size="100" id="prueba" name="prueba"  value="<?php echo(mostrar_valor_campo('prueba',430,$_REQUEST['iddoc'])); ?>">
                                       </div><input type="hidden" name="campo_descripcion" value="<?php echo('7121'); ?>"><input type="hidden" name="formato" value="430"><tr><td colspan='2'><?php submit_formato(430,$_REQUEST['iddoc']);?></td></tr></table></form></body>
