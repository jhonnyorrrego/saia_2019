<html><title>.: FREDDY:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../../pantallas/qr/librerias.php"); ?><?php include_once("../../formatos/librerias/funciones_cliente.php"); ?><?php include_once("../../formatos/librerias/funciones_cliente.php"); ?><?php include_once("../../formatos/librerias/funciones_cliente.php"); ?><?php include_once("../../formatos/librerias/funciones_cliente.php"); ?><?php include_once("../../formatos/librerias/funciones_cliente.php"); ?><?php include_once("../../formatos/librerias/encabezado_pie_pagina.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA FREDDY</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_idft_freddy"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_freddy',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_freddy',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_freddy" id="bqsaiaenlace_idft_freddy" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">FREDDY</td><input type="hidden" name="bksaiacondicion_idft_freddy" id="bksaiacondicion_idft_freddy" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_freddy" name="idft_freddy"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_freddy").fcbkcomplete({
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                    ...
                    </tr><tr id="tr_arbol_fancytree_1498165134"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_arbol_fancytree_1498165134',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_arbol_fancytree_1498165134',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_arbol_fancytree_1498165134" id="bqsaiaenlace_arbol_fancytree_1498165134" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">&Aacute;RBOL DE SELECCI&Oacute;N</td><input type="hidden" name="bksaiacondicion_arbol_fancytree_1498165134" id="bksaiacondicion_arbol_fancytree_1498165134" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="arbol_fancytree_1498165134" name="arbol_fancytree_1498165134"></select><script>
                     $(document).ready(function()
                      {
                      $("#arbol_fancytree_1498165134").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><?php submit_formato(430);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
