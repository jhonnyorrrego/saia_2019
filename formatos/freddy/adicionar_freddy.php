<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="idft_freddy" value="<?php echo(validar_valor_campo(7113)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(7114)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(430,7115);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(7116)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(7117)); ?>"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(7118)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(7120)); ?>"><div class="form-group form-group-default "  style="width:25%;"  id="tr_prueba">
                                        <label title="123">PRUEBA</label>
                                        <input class="form-control"  maxlength="11"   tabindex='1'  type="text"  style="width:25%;"  size="100" id="prueba" name="prueba"  value="<?php echo(validar_valor_campo(7121)); ?>">
                                       </div><input type="hidden" name="campo_descripcion" value="7121"><tr><td colspan='2'><?php submit_formato(430);?></td></tr></table></form></body>
