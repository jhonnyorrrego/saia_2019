...
<html>
  <body>
       ...
       <form accept-charset="UTF-8" id="kformulario_saia"  method="post" >  
        <div class="control-group">
          <label class="string required control-label" for="ubicacion">
			...
			<input type="hidden" name="bksaiacondicion_a@ubicacion" id="bksaiacondicion_a-ubicacion" value="like">
          </label>
          <div class="controls">
            <input id="bqsaia_a-ubicacion" name="bqsaia_a@ubicacion" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_a@ubicacion" id="bqsaiaenlace_a-ubicacion" value="y">
          </div>
        </div> 
    ...
    <br>
       ...
       <form accept-charset="UTF-8" id="kformulario_saia"  method="post" >  
        <div class="control-group">
          <label class="string required control-label" for="numero_caja">
			<b>No. Caja</b>
			<input type="hidden" name="bksaiacondicion_a@numero_caja" id="bksaiacondicion_a-numero_caja" value="=">
          </label>
          <div class="controls">
            <input id="bqsaia_a-numero_caja" name="bqsaia_a@numero_caja" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_a@numero_caja" id="bqsaiaenlace_a-numero_caja" value="y">
          </div>
        </div> 
    ...
    <br>
       ...
       <form accept-charset="UTF-8" id="kformulario_saia"  method="post" >  
        <div class="control-group">
          <label class="string required control-label" for="nombre_completo">
			<b>Nombre:</b>
			<input type="hidden" name="bksaiacondicion_a@nombre_completo" id="bksaiacondicion_a-nombre_completo" value="like">
          </label>
          <div class="controls">
            <input id="bqsaia_a-nombre_completo" name="bqsaia_a@nombre_completo" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_a@nombre_completo" id="bqsaiaenlace_a-nombre_completo" value="y">
          </div>
        </div> 
    ...
    <br>
       ...
       <form accept-charset="UTF-8" id="kformulario_saia"  method="post" >  
        <div class="control-group">
          <label class="string required control-label" for="primer_apellido">
			<b>1er. Apellido:</b>
			<input type="hidden" name="bksaiacondicion_a@primer_apellido" id="bksaiacondicion_a-primer_apellido" value="like">
          </label>
          <div class="controls">
            <input id="bqsaia_a-primer_apellido" name="bqsaia_a@primer_apellido" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_a@primer_apellido" id="bqsaiaenlace_a-primer_apellido" value="y">
          </div>
        </div> 
    ...
    <br>
       ...
       <form accept-charset="UTF-8" id="kformulario_saia"  method="post" >  
        <div class="control-group">
          <label class="string required control-label" for="segundo_apellido">
			<b>2do. Apellido:</b>
			<input type="hidden" name="bksaiacondicion_a@segundo_apellido" id="bksaiacondicion_a-segundo_apellido" value="like">
          </label>
          <div class="controls">
            <input id="bqsaia_a-segundo_apellido" name="bqsaia_a@segundo_apellido" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_a@segundo_apellido" id="bqsaiaenlace_a-segundo_apellido" value="y">
          </div>
        </div> 
    ...
    <br>
       ...
       <form accept-charset="UTF-8" id="kformulario_saia"  method="post" >  
        <div class="control-group">
          <label class="string required control-label" for="num_identificacion">
			<b>Identificaci&oacute;n:</b>
			<input type="hidden" name="bksaiacondicion_a@num_identificacion" id="bksaiacondicion_a-num_identificacion" value="like">
          </label>
          <div class="controls">
            <input id="bqsaia_a-num_identificacion" name="bqsaia_a@num_identificacion" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_a@num_identificacion" id="bqsaiaenlace_a-num_identificacion" value="y">
          </div>
        </div> 
