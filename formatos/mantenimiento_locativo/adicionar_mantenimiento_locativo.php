  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                     ...
                     <td class="celda_transparente"><textarea  tabindex='1'  name="describe_requerimiento" id="describe_requerimiento" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(3304)); ?></textarea></td>
                       ...
                       <td class="encabezado" width="20%" title="">FECHA ESPERADA DE SOLUCI&Oacute;N</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='2'  type="text" readonly="true"  name="fecha_solucion" id="fecha_solucion" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_solucion","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr id="tr_prioridad" >
