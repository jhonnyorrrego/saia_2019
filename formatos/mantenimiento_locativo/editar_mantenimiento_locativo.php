  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                     ...
                     <td class="celda_transparente"><textarea  tabindex='1'  name="describe_requerimiento" id="describe_requerimiento" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('describe_requerimiento',287,$_REQUEST['iddoc'])); ?></textarea></td>
                       ...
                       <td class="encabezado" width="20%" title="">FECHA ESPERADA DE SOLUCI&Oacute;N</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='2'  type="text" readonly="true"  name="fecha_solucion" id="fecha_solucion" tipo="fecha" value="<?php mostrar_valor_campo('fecha_solucion',287,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha_solucion","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr id="tr_prioridad" >
                     <td class="encabezado" width="20%" title="">PRIORIDAD</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(287,3306,$_REQUEST['iddoc']);?></td></tr><tr id="tr_soportes_anexos" >
