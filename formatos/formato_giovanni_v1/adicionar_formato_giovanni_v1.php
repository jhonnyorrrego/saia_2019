<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(7068)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(7069)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(7070)); ?>"><input type="hidden" name="idft_formato_giovanni_v1" value="<?php echo(validar_valor_campo(7073)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(426,7074);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(7075)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(7076)); ?>"><tr><td colspan='2'><?php submit_formato(426);?></td></tr></table></form></body>
