<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(7068)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(7069)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(7070)); ?>"><div class="form-group form-group-default "  style="width:25%;"  id="tr_pruebas_campo">
                            ...
                            <label title="">OTRO CAMPO*</label><?php genera_campo_listados_editar(426,7072,$_REQUEST['iddoc']);?><label id="-error" class="error" f or="otro_campo" style="display: none;"></label><br></div><input type="hidden" name="campo_descripcion" value="7071,7072"><tr><td colspan='2'><?php submit_formato(426);?></td></tr></table></form></body>
