<html><title>.: FORMATO DE GIOVANNI V1:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../../formatos/librerias/funciones_cliente.php"); ?><?php include_once("../../formatos/librerias/funciones_cliente.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA FORMATO DE GIOVANNI V1</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Formato de Giovanni V1">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_documento_iddocumento" id="bqsaiaenlace_documento_iddocumento" value="y" />
                    ...
                    </tr><tr id="tr_pruebas_campo"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_pruebas_campo',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_pruebas_campo',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_pruebas_campo" id="bqsaiaenlace_pruebas_campo" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">PRUEBAS DE CAMPO</td><input type="hidden" name="bksaiacondicion_pruebas_campo" id="bksaiacondicion_pruebas_campo" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="pruebas_campo" name="pruebas_campo"></select><script>
                     $(document).ready(function()
                      {
                      $("#pruebas_campo").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><tr id="tr_idft_formato_giovanni_v1"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_formato_giovanni_v1',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_formato_giovanni_v1',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_formato_giovanni_v1" id="bqsaiaenlace_idft_formato_giovanni_v1" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">FORMATO_GIOVANNI_V1</td><input type="hidden" name="bksaiacondicion_idft_formato_giovanni_v1" id="bksaiacondicion_idft_formato_giovanni_v1" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_formato_giovanni_v1" name="idft_formato_giovanni_v1"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_formato_giovanni_v1").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><tr id="tr_otro_campo"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_otro_campo',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_otro_campo',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_otro_campo" id="bqsaiaenlace_otro_campo" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">OTRO CAMPO</td><input type="hidden" name="bksaiacondicion_otro_campo" id="bksaiacondicion_otro_campo" value="like_total"><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,7072,'',1,'buscar');?></td></tr><input type="hidden" name="campo_descripcion" value="7071,7072"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
