<html><title>.:ADICIONAR TAREAS:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><?php include_once("../../calendario/calendario.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="STYLESHEET" type="text/css" href="../../css/dhtmlXTree.css"><script type="text/javascript" src="../../anexosdigitales/multiple-file-upload/jquery.MultiFile.js"></script><?php include_once("../../anexosdigitales/funciones_archivo.php"); ?><script type="text/javascript" src="../../anexosdigitales/highslide-4.0.10/highslide/highslide-with-html.js"></script><link rel="stylesheet" type="text/css" href="../../anexosdigitales/highslide-4.0.10/highslide/highslide.css" />
  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                       ...
                       <td class="encabezado" width="20%" title="">FECHA TAREA*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='1'  type="text" readonly="true"  class="required dateISO"  name="fecha_formato" id="fecha_formato" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_formato","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(2706)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(239,2705);?></tr><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(2688)); ?>"><tr>
                   ...
                   <a href="javascript:void(0)" onclick="tree_responsable.findItem(htmlentities(document.getElementById('stext_responsable').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_responsable"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_responsable" height="90%"></div><input type="hidden" maxlength="255"  name="responsable" id="responsable"   value="" ><label style="display:none" class="error" for="responsable">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                   ...
                   <a href="javascript:void(0)" onclick="tree_vinculados.findItem(htmlentities(document.getElementById('stext_vinculados').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_vinculados"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_vinculados" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="vinculados" id="vinculados"   value="" ><label style="display:none" class="error" for="vinculados">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                	...
                	--></script></td></tr><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='4'  type="text" size="100" id="tarea_asiganda" name="tarea_asiganda"  value="<?php echo(validar_valor_campo(2692)); ?>"></td>
                    </tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='5'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(2729)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">TIPO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(239,2695,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">PERIODICIDAD*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(239,2696,$_REQUEST['iddoc']);?></td></tr><tr>
                       <td class="encabezado" width="20%" title="">FECHA DE ENTREGA*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='6'  type="text" readonly="true"  class="required dateISO"  name="fecha_entraga" id="fecha_entraga" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_entraga","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr>
                     ...
                     <td class="encabezado" width="20%" title="">SEMANAS</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(239,2702,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="idft_recordar_tarea" value="<?php echo(validar_valor_campo(2703)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(2704)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(2707)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">ANEXOS</td>
                     <td class="celda_transparente"><input  tabindex='7'  type="file" maxlength="255"  class='multi'  name="anexos[]" accept="<?php echo $extensiones;?>"><?php recordatorio_funcion(239,NULL);?><input type="hidden" name="campo_descripcion" value="2729"><tr><td colspan='2'><?php submit_formato(239);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>