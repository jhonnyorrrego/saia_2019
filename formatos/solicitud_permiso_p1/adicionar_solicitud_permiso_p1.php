<html><title>.:ADICIONAR SOLICITUD PERMISO P1:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">SOLICITUD PERMISO P1</td></tr><tr id="tr_clase_permiso" >
                     <td class="encabezado" width="20%" title="">CLASE DE PERMISO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(512,6680,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="idft_solicitud_permiso_p1" value="<?php echo(validar_valor_campo(6658)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(6659)); ?>"><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(512,6660);?></tr><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(6661)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(6662)); ?>"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(6653)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(6654)); ?>"><tr id="tr_fecha_solicitud">
                    <td class="encabezado" width="20%" title="">FECHA DE SOLICITUD*</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='1'  type="text" readonly="true" name="fecha_solicitud"  class="required dateISO"  id="fecha_solicitud" value="<?php echo(date("Y-m-d H:i")); ?>"><?php selector_fecha("fecha_solicitud","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr id="tr_funcionario">
...
',$_REQUEST['iddoc']);?></div><br/>Buscar: <input  tabindex='2'  type="text" id="stext_funcionario" width="200px" size="25">
								...
								<a href="javascript:void(0)" onclick="tree_funcionario.findItem((document.getElementById('stext_funcionario').value))">
									<img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="255"  class="required"  name="funcionario" id="funcionario"   value="" ><label style="display:none" class="error" for="funcionario">Campo obligatorio.</label><div id="esperando_funcionario">
								...
								tree_funcionario.setOnLoadingEnd(fin_cargando_funcionario);tree_funcionario.enableSmartXMLParsing(true);tree_funcionario.loadXML("../../test.php?rol=1&sin_padre=1");tree_funcionario.setOnCheckHandler(onNodeSelect_funcionario);
                    ...
                    <td class="encabezado" width="20%" title="">FECHA DEL PERMISO*</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='3'  type="text" readonly="true" name="fecha_permiso"  class="required dateISO"  id="fecha_permiso" value="<?php echo(date("Y-m-d H:i")); ?>"><?php selector_fecha("fecha_permiso","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr id="tr_salida_porteria">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='4'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(6657)); ?></textarea></td></tr><tr id="tr_anexo_formato">
                     <td class="encabezado" width="20%" title="">ANEXOS DIGITALES</td>
                     <td class="celda_transparente"><div id="dz_campo_6652" class="saia_dz" data-nombre-campo="anexo_formato" data-idformato="512" data-idcampo-formato="6652" data-extensiones="<?php echo $extensiones;?>" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div></div></td></tr><input type="hidden" name="campo_descripcion" value="6656,6663,6680"><tr><td colspan='2'><?php submit_formato(512);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
