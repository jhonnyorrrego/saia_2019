...
',$_REQUEST['iddoc']);?></div><br/>Buscar: <input  tabindex='2'  type="text" id="stext_funcionario" width="200px" size="25">
                    ...
                    <td class="encabezado" width="20%" title="">FECHA DEL PERMISO*</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='3'  type="text" readonly="true" name="fecha_permiso"  class="required dateISO"  id="fecha_permiso" value="<?php echo(date("Y-m-d H:i")); ?>"><?php selector_fecha("fecha_permiso","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr id="tr_salida_porteria">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='4'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(6657)); ?></textarea></td>
                    </tr><tr id="tr_anexo_formato">
                     <td class="encabezado" width="20%" title="">ANEXOS DIGITALES</td>
                     <td class="celda_transparente"><div id="dz_campo_6652" class="saia_dz" data-nombre-campo="anexo_formato" data-idformato="512" data-idcampo-formato="6652" data-extensiones="<?php echo $extensiones;?>" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div></div></td></tr><input type="hidden" name="campo_descripcion" value="6656,6663,6680"><tr><td colspan='2'><?php submit_formato(512);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("512-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
