<html><title>.:BUSCAR OTROS DOCUMENTOS CALIDAD:.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script>
			<link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/>
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="6265"><?php submit_formato(493);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
