...
<td><?php mostrar_valor_campo('nombre',493,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado" valign="top">Documento Soporte:</td>
<td><?php mostrar_anexos_memo(493,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado">Secretarias Participantes:</td>
<td><?php mostrar_valor_campo('secretarias',493,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado">Estado</td>
<td><?php mostrar_valor_campo('estado',493,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado">Origen Documento</td>
<td><?php mostrar_valor_campo('origen_documento',493,$_REQUEST['iddoc']);?></td>
</tr>
</tbody>
