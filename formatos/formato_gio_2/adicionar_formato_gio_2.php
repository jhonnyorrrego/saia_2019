<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:ADICIONAR FORMATO GIO 2:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h4 class="text-black">FORMATO GIO 2</h4></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],428,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(7088)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(7089)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(7090)); ?>"><div class="form-group form-group-default "  style="width:50%;"  id="tr_numero">
                                        <label title="">NUMERO</label>
                                        <input class="form-control"  maxlength="11"   tabindex='1'  type="text"  style="width:50%;"  size="100" id="numero" name="numero"  value="<?php echo(validar_valor_campo(7091)); ?>">
                                       </div><input type="hidden" name="idft_formato_gio_2" value="<?php echo(validar_valor_campo(7092)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(428,7093);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(7094)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(7095)); ?>"><input type="hidden" name="campo_descripcion" value="7091"><tr><td colspan='2'><?php submit_formato(428);?></td></tr></table></form></body>
