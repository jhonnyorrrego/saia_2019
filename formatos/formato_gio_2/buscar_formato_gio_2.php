<html><title>.: FORMATO GIO 2:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA FORMATO GIO 2</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="FORMATO GIO 2">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_documento_iddocumento" id="bqsaiaenlace_documento_iddocumento" value="y" />
                    ...
                    </tr><tr id="tr_numero"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_numero" id="bqsaiaenlace_numero" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="">NUMERO</td><input type="hidden" name="bksaiacondicion_numero" id="bksaiacondicion_numero" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="numero" name="numero"></select><script>
                     $(document).ready(function()
                      {
                      $("#numero").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                    ...
                    </tr><tr id="tr_idft_formato_gio_2"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_formato_gio_2',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_formato_gio_2',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_formato_gio_2" id="bqsaiaenlace_idft_formato_gio_2" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">FORMATO_GIO_2</td><input type="hidden" name="bksaiacondicion_idft_formato_gio_2" id="bksaiacondicion_idft_formato_gio_2" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_formato_gio_2" name="idft_formato_gio_2"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_formato_gio_2").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="7091"><?php submit_formato(428);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
