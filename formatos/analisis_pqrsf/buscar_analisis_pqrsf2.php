<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Planeacion - Analisis de Causas</legend><br /><br /><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Analisis de Causas<input type="hidden" name="bksaiacondicion_g@analisis_causas" id="bksaiacondicion_g@analisis_causas" value="like_total"></b><div class="controls"><input type="text" id="analisis_causas" name="bqsaia_g@analisis_causas"><div class="btn-group" data-toggle="buttons-radio" >
