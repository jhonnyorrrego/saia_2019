<html><title>.:EDITAR ANTECEDENTES M&Eacute;DICOS:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type='text/javascript'>
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                     ...
                     <?php buscar_dependencia(281,3213,$_REQUEST['iddoc']);?></tr><tr>
                     ...
                     <td class="encabezado" width="20%" title="">ENFERMEDADES CARD&Iacute;ACAS</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3163,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">HIPERTENSI&Oacute;N ARTERIAL</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3164,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">ENFERMEDAD RESPIRATORIA</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3195,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">ENFERMEDAD RENAL</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3167,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">HEPATITIS</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3170,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">DIABETES</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3168,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">TRASTORNOS SANGU&Iacute;NEOS</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3173,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">FIEBRE REUMATICA</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3279,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">ALERGIAS</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3177,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">OBSTRUCCI&Oacute;N_NASAL</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3179,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">CIRUJ&Iacute;AS</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3181,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">ADENOIDES</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(281,3198,$_REQUEST['iddoc']);?></td></tr><tr>
