...
function link_agregar_campos($idformato, $iddoc) {
	global $conn, $ruta_db_superior;
		if(@$_REQUEST["tipo"] != 5 ){
    		...
    		<?php		    
			$enlace = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="highslide" onclick="return hs.htmlExpand(this, { objectType: \'iframe\',width: 900, height: 500,preserveContent:false} )" href="formatos/informe_contraloria/llenar_campos.php?iddoc=' . $iddoc . '&idformato=' . $idformato . '" >Agregar campos</a>';
			echo $enlace;
