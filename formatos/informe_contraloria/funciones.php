...
function link_agregar_campos($idformato, $iddoc) {
	global $conn, $ruta_db_superior;
		if(@$_REQUEST["tipo"] != 5 ){
    		...
    		<?php		    
			$enlace = '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="highslide" onclick="return hs.htmlExpand(this, { objectType: \'iframe\',width: 500, height: 250,preserveContent:false} )" href="'.$ruta_db_superior.'formatos/informe_contraloria/llenar_campos.php?iddoc=' . $iddoc . '&idformato=' . $idformato . '" >Agregar campos</a>';
			echo $enlace;
