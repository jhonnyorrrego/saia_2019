<html><title>.:EDITAR INFORME SEGUIMIENTO:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">INFORME SEGUIMIENTO</td></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',483,$_REQUEST['iddoc'])); ?>"><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(483,6132,$_REQUEST['iddoc']);?></tr><input type="hidden" name="municipio_informe" value="<?php echo(mostrar_valor_campo('municipio_informe',483,$_REQUEST['iddoc'])); ?>"><tr id="tr_fecha_compromisos">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="proceso_auditado" id="proceso_auditado" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('proceso_auditado',483,$_REQUEST['iddoc'])); ?></textarea></td></tr><input type="hidden" name="observaciones" value="<?php echo(mostrar_valor_campo('observaciones',483,$_REQUEST['iddoc'])); ?>"><tr id="tr_cumplimiento_plan"><td class="encabezado" width="20%" title="">PORCENTAJE DE CUMPLIMIENTO DEL PLAN*</td><?php porcentaje_plan(483,6139,$_REQUEST['iddoc']);?></tr><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',483,$_REQUEST['iddoc'])); ?>"><tr id="tr_jefe_control">
