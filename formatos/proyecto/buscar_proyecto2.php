<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Nombre del Proyecto<input type="hidden" name="bksaiacondicion_g@nombre_proyecto" id="bksaiacondicion_g@nombre_proyecto" value="like_total"></b><div class="controls"><input type="text" id="nombre_proyecto" name="bqsaia_g@nombre_proyecto"><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><b>Forma de pago<input type="hidden" name="bksaiacondicion_g@pago" id="bksaiacondicion_g@pago" value="like_total"></b><div class="controls"><input type="text" id="pago" name="bqsaia_g@pago"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_g@pago',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_g@pago',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_g@pago" id="bqsaiaenlace_g@pago" value="y" />
		</div></div></div><div class="control-group"><b>Tiempo de Duracion<input type="hidden" name="bksaiacondicion_g@duracion" id="bksaiacondicion_g@duracion" value="like_total"></b><div class="controls"><input type="text" id="duracion" name="bqsaia_g@duracion"></div></div><input type="hidden" name="campos_especiales" value="empresa_asociada@arbol"><input type="hidden" name="filtro_adicional" id="filtro_adicional" value=" ft_proyecto g @ AND  g.documento_iddocumento=iddocumento "></body><input type="hidden" name="idbusqueda_componente" value="115">