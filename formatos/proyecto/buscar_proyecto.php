<html><title>.:BUSCAR PROYECTO:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA PROYECTO</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_nombre_proyecto" id="condicion_nombre_proyecto"><option value="AND">Y</option><option value="OR">O</option></td>
                ...
                <div id="treeboxbox_empresa_asociada" height="90%"></div><input type="hidden"  name="empresa_asociada" id="empresa_asociada"   value="" ><label style="display:none" class="error" for="empresa_asociada">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                	...
                	--></script></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_moneda" id="condicion_moneda"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_pago" id="condicion_pago"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">FORMA DE PAGO</td><td class="encabezado">&nbsp;<select name="compara_pago" id="compara_pago"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="pago" name="pago"></select><script>
                     $(document).ready(function() 
                      {
                      $("#pago").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                     ...
                     <td class="encabezado" width="20%" title="">TIEMPO DE DURACION</td><td class="encabezado">&nbsp;<select name="compara_duracion" id="compara_duracion"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="2823,2824,2827"><?php submit_formato(247);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
