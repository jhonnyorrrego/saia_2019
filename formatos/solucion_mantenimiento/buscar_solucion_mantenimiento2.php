<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Soluci&oacute;n mantenimiento locativo</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="tipo"><b>Tipo<input type="hidden" name="bksaiacondicion_tipo" id="bksaiacondicion_tipo" value="like_total"></b></label><div class="controls"><?php genera_campo_listados_editar(288,3325,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
