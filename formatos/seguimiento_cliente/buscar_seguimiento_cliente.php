<html><title>.:BUSCAR 1. SEGUIMIENTO:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA 1. SEGUIMIENTO</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_fecha" id="condicion_fecha"><option value="AND">Y</option><option value="OR">O</option></td>
                     ...
                     <td class="encabezado" width="20%" title="">ESTADO DEL CLIENTE</td><td class="encabezado">&nbsp;<select name="compara_estado_cliente" id="compara_estado_cliente"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="estado_cliente" name="estado_cliente"></select><script>
                     $(document).ready(function() 
                      {
                      $("#estado_cliente").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_envio_propuesta" id="condicion_envio_propuesta"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">SE ENVI&Oacute; PROPUESTA</td><td class="encabezado">&nbsp;<select name="compara_envio_propuesta" id="compara_envio_propuesta"> <option value="LIKE|%|%">Similar</option><option value="LIKE|%|@">Inicia Con</option><option value="LIKE|@|%">Finaliza Con</option></select></td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(249,2844,'',1);?></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_nombre_propuesta" id="condicion_nombre_propuesta"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_estado_propuesta" id="condicion_estado_propuesta"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">ESTADO DE LA PROPUESTA</td><td class="encabezado">&nbsp;<select name="compara_estado_propuesta" id="compara_estado_propuesta"> <option value="=|@|@">Igual</option><option value="-|@|@">Menor</option><option value="+|@|@">Mayor</option><option value="!|@|@">Diferente</option></select></td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(249,2857,'',1);?></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_nombre_producto_servicio" id="condicion_nombre_producto_servicio"><option value="AND">Y</option><option value="OR">O</option></td>
                ...
                <div id="treeboxbox_empresa_asociada" height="90%"></div><input type="hidden"  name="empresa_asociada" id="empresa_asociada"   value="" ><label style="display:none" class="error" for="empresa_asociada">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="2850,2857"><?php submit_formato(249);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
