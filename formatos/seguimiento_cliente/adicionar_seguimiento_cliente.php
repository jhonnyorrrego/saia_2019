	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">1. SEGUIMIENTO</td></tr><input type="hidden" name="idft_seguimiento_cliente" value="<?php echo(validar_valor_campo(2852)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(2853)); ?>"><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><input  tabindex='6'  type="file" maxlength="255"  class='multi'  name="anexo_formato[]" accept="<?php echo $extensiones;?>"><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_registro_cliente"  value="<?php echo $_REQUEST["padre"]; ?>"><?php } ?><?php if($_REQUEST["anterior"]) {?><input type="hidden"  name="ft_registro_cliente"  value="<?php echo $_REQUEST["anterior"]; ?>"><?php }  else {listar_select_padres(ft_registro_cliente);} ?><?php actualizar_estado_cliente(249,NULL);?><input type="hidden" name="campo_descripcion" value="2850,2857"><tr><td colspan='2'><?php submit_formato(249);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>