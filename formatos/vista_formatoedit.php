				...
				<tr>
					...
					<td bgcolor="#F5F5F5"><span class="phpmaker">
							...
							if ($nombre["numcampos"])
								...
								$mostrar = "Ninguno";
							?>
							<input type="hidden" name="x_encabezado" id="x_encabezado" value="<?php if ($nombre["numcampos"]) echo $x_encabezado;
																								else echo ""; ?>">
				...
				<tr>
					...
					<td bgcolor="#F5F5F5"><span class="phpmaker">
							...
							if ($nombre["numcampos"])
								...
								$mostrar = "Ninguno";
							?>
							<input type="hidden" name="x_pie_pagina" id="x_pie_pagina" value="<?php if ($nombre["numcampos"]) echo $x_pie_pagina;
																								else echo ""; ?>">
