<html><title>.: SOLICITUD DE PRESTAMO:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../../formatos/librerias/header_formato.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA SOLICITUD DE PRESTAMO</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_dependencia"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_fecha" id="bqsaiaenlace_fecha" value="y" />
                       ...
                       <td class="encabezado" width="20%" title="">FECHA DE SOLICITUD</td><td class="encabezado">ENTRE &nbsp;</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input type="text" readonly="true"  name="fecha_1" id="fecha_1" tipo="fecha" value=""><?php selector_fecha("fecha_1","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?>&nbsp;&nbsp; Y &nbsp;&nbsp;<input type="text" readonly="true"  name="fecha_2" id="fecha_2" tipo="fecha" value=""><?php selector_fecha("fecha_2","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td></tr><tr><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_transferencia_presta',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_transferencia_presta',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_transferencia_presta" id="bqsaiaenlace_transferencia_presta" value="y" />
		</div>
                  <td class="encabezado" width="20%" title="">EXPEDIENTE VINCULADO</td><input type="hidden" name="bksaiacondicion_transferencia_presta" id="bksaiacondicion_transferencia_presta" value="like"><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,5205,'',1,'buscar');?></td></tr><tr id="tr_observaciones"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_observaciones" id="bqsaiaenlace_observaciones" value="y" />
                    ...
                    </tr><tr id="tr_documento_archivo"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_documento_archivo',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_documento_archivo',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_documento_archivo" id="bqsaiaenlace_documento_archivo" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">UBICACI&Oacute;N DEL DOCUMENTO</td><input type="hidden" name="bksaiacondicion_documento_archivo" id="bksaiacondicion_documento_archivo" value="="><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,5114,'',1,'buscar');?></td></tr><tr id="tr_firma"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_documento_iddocumento" id="bqsaiaenlace_documento_iddocumento" value="y" />
                    ...
                    </tr><tr id="tr_idft_solicitud_prestamo"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_solicitud_prestamo',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_solicitud_prestamo',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_solicitud_prestamo" id="bqsaiaenlace_idft_solicitud_prestamo" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">SOLICITUD_PRESTAMO</td><input type="hidden" name="bksaiacondicion_idft_solicitud_prestamo" id="bksaiacondicion_idft_solicitud_prestamo" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_solicitud_prestamo" name="idft_solicitud_prestamo"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_solicitud_prestamo").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Solicitud de Prestamo de documentos">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_fecha_prestamo_rep" id="bqsaiaenlace_fecha_prestamo_rep" value="y" />
                       ...
                       <td class="encabezado" width="20%" title="">FECHA REQUERIDA PARA PRESTAMO</td><td class="encabezado">ENTRE &nbsp;</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input type="text" readonly="true"  name="fecha_prestamo_rep_1" id="fecha_prestamo_rep_1" tipo="fecha" value=""><?php selector_fecha("fecha_prestamo_rep_1","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?>&nbsp;&nbsp; Y &nbsp;&nbsp;<input type="text" readonly="true"  name="fecha_prestamo_rep_2" id="fecha_prestamo_rep_2" tipo="fecha" value=""><?php selector_fecha("fecha_prestamo_rep_2","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td></tr><tr><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_fecha_devolucion_rep',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_fecha_devolucion_rep',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_fecha_devolucion_rep" id="bqsaiaenlace_fecha_devolucion_rep" value="y" />
		</div>
                       <td class="encabezado" width="20%" title="">FECHA DE DEVOLUCI&Oacute;N ESTIMADA</td><td class="encabezado">ENTRE &nbsp;</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input type="text" readonly="true"  name="fecha_devolucion_rep_1" id="fecha_devolucion_rep_1" tipo="fecha" value=""><?php selector_fecha("fecha_devolucion_rep_1","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?>&nbsp;&nbsp; Y &nbsp;&nbsp;<input type="text" readonly="true"  name="fecha_devolucion_rep_2" id="fecha_devolucion_rep_2" tipo="fecha" value=""><?php selector_fecha("fecha_devolucion_rep_2","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td></tr><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_anexos" id="bqsaiaenlace_anexos" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="">ANEXOS DIGITALES</td><input type="hidden" name="bksaiacondicion_anexos" id="bksaiacondicion_anexos" value="like">
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="5113"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
