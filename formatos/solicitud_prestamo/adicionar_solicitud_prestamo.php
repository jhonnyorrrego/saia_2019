<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h4 class="text-black">SOLICITUD DE PRESTAMO</h4></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],412,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><div class="form-group form-group-default required"  id="tr_highslide_1926201103">
                                        <label title="">HIGHSLIDE</label>
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="highslide_1926201103" name="highslide_1926201103" required value="<?php echo(validar_valor_campo(6703)); ?>">
...
<label title="">FECHA DE DEVOLUCI&Oacute;N ESTIMADA</label>
<div class="input-group">
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                       ...
                                       <div class="card-body no-scroll no-padding"><div id="dz_campo_5116" class="saia_dz dropzone no-margin" data-nombre-campo="anexos" data-idformato="412" data-idcampo-formato="5116" data-extensiones="<?php echo $extensiones;?>" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div></div></div></div><?php asignar_responsables(412,NULL);?><?php validar_fecha_prestamo(412,NULL);?><input type="hidden" name="campo_descripcion" value="5113"><tr><td colspan='2'><?php submit_formato(412);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body>
      <script type="text/javascript">
