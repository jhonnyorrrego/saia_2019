<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',424,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_pago" value="<?php echo(mostrar_valor_campo('fecha_pago',424,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="observaciones_check" value="<?php echo(mostrar_valor_campo('observaciones_check',424,$_REQUEST['iddoc'])); ?>"><div class="form-group form-group-default "  id="tr_total_factura">
                                        ...
                                        <input class="form-control"   class="required"   tabindex='2'  type="text"  size="100" id="fecha_radicado" name="fecha_radicado" required value="<?php echo(mostrar_valor_campo('fecha_radicado',424,$_REQUEST['iddoc'])); ?>">
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <input class="form-control"  maxlength="255"   tabindex='4'  type="text"  size="100" id="num_factura" name="num_factura" required value="<?php echo(mostrar_valor_campo('num_factura',424,$_REQUEST['iddoc'])); ?>">
                                        ...
                                        <textarea  tabindex='5'  name="descripcion" id="descripcion" cols="53" rows="3" class="form-control tiny_sin_tiny required"><?php echo(mostrar_valor_campo('descripcion',424,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group form-group-default required"  id="tr_num_folios">
                                        <label title="">N&Uacute;MERO DE FOLIOS</label>
                                        <input class="form-control"  maxlength="255"   tabindex='6'  type="text"  size="100" id="num_folios" name="num_folios" required value="<?php echo(mostrar_valor_campo('num_folios',424,$_REQUEST['iddoc'])); ?>">
                                       </div><div class="form-group" id="tr_anexos_fisicos">
                                        <label title="">ANEXOS F&Iacute;SICOS</label>
                                        <div class="celda_transparente">
                                        <textarea  tabindex='7'  name="anexos_fisicos" id="anexos_fisicos" cols="53" rows="3" class="form-control tiny_sin_tiny"><?php echo(mostrar_valor_campo('anexos_fisicos',424,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
                                ...
                                <a href="javascript:void(0)" onclick="tree_copia_electronica.findItem((document.getElementById('stext_copia_electronica').value))">
                                    <img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="255"  name="copia_electronica" id="copia_electronica"   value="<?php if(isset($_REQUEST["iddoc"])){cargar_seleccionados(424,7035,1,$_REQUEST['iddoc']);}?>" ><div id="esperando_copia_electronica">
...
</script></div></div><?php digitalizar_formato(424,NULL,$_REQUEST['iddoc']);?><?php validar_digitalizacion_formato(424,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('7047'); ?>"><input type="hidden" name="formato" value="424"><tr><td colspan='2'><?php submit_formato(424,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
