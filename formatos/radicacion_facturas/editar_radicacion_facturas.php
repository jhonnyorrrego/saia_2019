...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <div class="celda_transparente"><textarea  tabindex='5'  name="descripcion" id="descripcion" cols="53" rows="3" class="form-control required"><?php echo(mostrar_valor_campo('descripcion',424,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group form-group-default required"  id="tr_num_folios">
                                        ...
                                        <div class="celda_transparente"><textarea  tabindex='7'  name="anexos_fisicos" id="anexos_fisicos" cols="53" rows="3" class="form-control"><?php echo(mostrar_valor_campo('anexos_fisicos',424,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
