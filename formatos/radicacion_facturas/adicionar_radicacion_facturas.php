...
<label title="">FECHA DE EMISI&Oacute;N DE LA FACTURA</label>
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <input class="form-control"  maxlength="255"   tabindex='4'  type="text"  size="100" id="num_factura" name="num_factura" required value="<?php echo(validar_valor_campo(7049)); ?>">
                                        ...
                                        <textarea  tabindex='5'  name="descripcion" id="descripcion" cols="53" rows="3" class="form-control tiny_sin_tiny required"><?php echo(validar_valor_campo(7037)); ?></textarea></div></div><div class="form-group form-group-default required"  id="tr_num_folios">
                                        <label title="">N&Uacute;MERO DE FOLIOS</label>
                                        <input class="form-control"  maxlength="255"   tabindex='6'  type="text"  size="100" id="num_folios" name="num_folios" required value="<?php echo(validar_valor_campo(7050)); ?>">
                                       </div><div class="form-group" id="tr_anexos_fisicos">
                                        <label title="">ANEXOS F&Iacute;SICOS</label>
                                        <div class="celda_transparente">
                                        <textarea  tabindex='7'  name="anexos_fisicos" id="anexos_fisicos" cols="53" rows="3" class="form-control tiny_sin_tiny"><?php echo(validar_valor_campo(7034)); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
                                       ...
                                       <div class="card-body no-scroll no-padding"><div id="dz_campo_7033" class="saia_dz dropzone no-margin" data-nombre-campo="anexos_digitales" data-idformato="424" data-idcampo-formato="7033" data-extensiones="<?php echo $extensiones;?>" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div></div></div></div><div class="form-group" id="tr_copia_electronica">
                                <label title="">COPIA ELECTR&Oacute;NICA A</label><div class="form-control"><div id="seleccionados"><?php if(isset($_REQUEST["iddoc"])){mostrar_seleccionados(424,7035,'5',$_REQUEST['iddoc']);}?></div><br/>Buscar: <input  tabindex='9'  type="text" id="stext_copia_electronica" width="200px" size="25" onblur="closetree_copia_electronica()"> <input type="hidden" id="idclosetree_copia_electronica">
                                ...
                                <a href="javascript:void(0)" onclick="tree_copia_electronica.findItem((document.getElementById('stext_copia_electronica').value))">
                                    <img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="255"  name="copia_electronica" id="copia_electronica"   value="" ><label style="display:none" class="error" for="copia_electronica">Campo obligatorio.</label><div id="esperando_copia_electronica">
                                ...
                                }</script></div></div><?php digitalizar_formato(424,NULL);?><?php validar_digitalizacion_formato(424,NULL);?><?php add_edit(424,NULL);?><?php autocompletar_convenio_clasificacion(424,NULL);?><?php add_edit_item_facturas(424,NULL);?><input type="hidden" name="campo_descripcion" value="7047"><tr><td colspan='2'><?php submit_formato(424);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
