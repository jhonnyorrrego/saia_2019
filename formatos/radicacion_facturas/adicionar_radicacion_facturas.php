...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <div class="celda_transparente"><textarea  tabindex='5'  name="descripcion" id="descripcion" cols="53" rows="3" class="form-control required"><?php echo(validar_valor_campo(7037)); ?></textarea></div></div><div class="form-group form-group-default required"  id="tr_num_folios">
                                        ...
                                        <div class="celda_transparente"><textarea  tabindex='7'  name="anexos_fisicos" id="anexos_fisicos" cols="53" rows="3" class="form-control"><?php echo(validar_valor_campo(7034)); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
