...
<html>
  <body>
    ...
    <div class="container master-container">
        <legend>Filtrar seguimientos</legend>  
		<div class="container master-container">
	...
	<br>
        ...
        <div class="form-actions">    
          ...
          <input type="hidden" name="bqtipodato" value="date|fecha_seguimiento_x,fecha_seguimiento_y,fecha_seguimiento_x,fecha_seguimiento_y">
