                ...
                <table class="table-bordered" border="1" align="center">
                    ...
                    <tr>
                        <td colspan="2">
                            ...
                            <input type="hidden" name="enlace2" id="enlace2" value="<?php echo FORMATOS_CLIENTE;?>radicacion_entrada/radicacion_rapida.php">
                            <?php
$adicional='';
  ...
  <!--		
      ...
      if (window.navigator.userAgent.toLowerCase().match("gecko")) {
         browserType= "gecko"
            ...
            tree_equipos.setXMLAutoLoading("<?php echo($ruta_db_superior . FORMATOS_CLIENTE); ?>radicacion_entrada/test_radicacion_rapida.php");
      //tree_equipos.enableSmartXMLParsing(true);
			tree_equipos.loadXML("<?php echo($ruta_db_superior . FORMATOS_CLIENTE); ?>radicacion_entrada/test_radicacion_rapida.php");
