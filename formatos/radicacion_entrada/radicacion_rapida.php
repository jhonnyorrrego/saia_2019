...
?><link rel="STYLESHEET" type="text/css" href="css/dhtmlXTree.css">
  ...
  <!--		
      ...
      tree_equipos.setXMLAutoLoading("<?php echo($ruta_db_superior); ?>test_radicacion_rapida.php<?php echo $adicional; ?>");
      //tree_equipos.enableSmartXMLParsing(true);
			tree_equipos.loadXML("<?php echo($ruta_db_superior); ?>test_radicacion_rapida.php<?php echo $adicional; ?>");
