	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                   ...
                   <input type="hidden" maxlength="255"  class="required"  name="persona_natural" id="persona_natural" value=""><?php componente_ejecutor("37",@$_REQUEST["iddoc"]); ?></td>
                     ...
                     <td bgcolor="#F5F5F5"><input  maxlength="11"  class="required" min="0" max="1000"  tabindex='6'  type="input" id="numero_folios" name="numero_folios"  value="<?php echo(validar_valor_campo(4082)); ?>"></td>
                    </tr>
              ...
              $(document).ready(function(){
		            $("#numero_folios").spin({imageBasePath:'../../images/',min:0,max:1000,interval:1});
                     ...
                     <td class="celda_transparente"><textarea  tabindex='7'  name="descripcion_anexos" id="descripcion_anexos" cols="53" rows="3" class="tiny_sin_tiny"><?php echo(validar_valor_campo(41)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">ANEXOS DIGITALES</td>
                     <td class="celda_transparente"><input  tabindex='8'  type="file" maxlength="255"  class='multi'  name="anexos_digitales[]" accept="xls|doc|pdf|jpg|docx|xlsx|png"><tr>
