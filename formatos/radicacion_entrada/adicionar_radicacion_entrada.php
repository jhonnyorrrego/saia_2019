...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <textarea  tabindex='3'  name="descripcion" id="descripcion" cols="53" rows="3" class="form-control tiny_sin_tiny required"><?php echo(validar_valor_campo(39)); ?></textarea></div></div><div class="form-group" id="tr_descripcion_anexos">
                                        <label title="">ANEXOS FISICOS</label>
                                        <div class="celda_transparente">
                                        <textarea  tabindex='4'  name="descripcion_anexos" id="descripcion_anexos" cols="53" rows="3" class="form-control tiny_sin_tiny"><?php echo(validar_valor_campo(41)); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
