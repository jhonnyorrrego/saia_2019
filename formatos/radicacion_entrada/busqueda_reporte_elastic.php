  ...
  <body>
       ...
       <form accept-charset="UTF-8" id="kformulario_saia"  method="post" >
        <div class="control-group">
          <label class="string required control-label" for="numero">
			...
			<input type="hidden" name="bksaiacondicion_documento@numero" id="bksaiacondicion_numero" value="=">
          </label>
          <div class="controls">
            <input id="bqsaia_numero" name="bqsaia_documento@numero" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_documento@numero" id="bqsaiaenlace_numero" value="y">
          </div>
        </div>
        <div class="control-group">
          <label class="string required control-label" for="numero">
            <b>N&uacute;mero Item:</b>
            <input type="hidden" name="bksaiacondicion_ft_destino_radicacion@numero_item" id="bksaiacondicion_numero_item" value="=">
          </label>
          <div class="controls">
            <input id="bqsaia_numero" name="bqsaia_ft_destino_radicacion@numero_item" size="50" type="text">
            <input type="hidden" name="bqsaiaenlace_ft_destino_radicacion@numero_item" id="bqsaiaenlace_numero_item" value="y">
          </div>
        </div>
         <strong>Entre las fechas</strong>
            <input type="hidden" name="bksaiacondicion_ft_radicacion_entrada@fecha_radicacion_entrada_x" id="bksaiacondicion_fecha_radicacion_entrada_x" value="rango_fecha">
        <div class="controls">
            <input id="bqsaia_fecha_radicacion_entrada_x" name="bqsaia_ft_radicacion_entrada@fecha_radicacion_entrada_x" style="width:100px" type="text" value="" placeholder="Inicio">
            <?php selector_fecha("bqsaia_ft_radicacion_entrada@fecha_radicacion_entrada_x","kformulario_saia","Y-m-d",date("m"),date("Y"),"default.css","../../",""); ?>
            <!-- <input type="hidden" name="bqsaiaenlace_ft_radicacion_entrada@fecha_radicacion_entrada_x" id="bqsaiaenlace_fecha_radicacion_entrada_x" value="y" /> -->
            &nbsp;&nbsp;y&nbsp;&nbsp;
            <input type="hidden" name="bksaiacondicion_ft_radicacion_entrada@fecha_radicacion_entrada_y" id="bksaiacondicion_fecha_radicacion_entrada_y" value="rango_fecha">
            <input id="bqsaia_fecha_radicacion_entrada_y" name="bqsaia_ft_radicacion_entrada@fecha_radicacion_entrada_y" style="width:100px" type="text" value="" placeholder="Fin">
            <?php selector_fecha("bqsaia_ft_radicacion_entrada@fecha_radicacion_entrada_y","kformulario_saia","Y-m-d",date("m"),date("Y"),"default.css","../../",""); ?>
        </div>

        <!-- <input type="hidden" name="bqsaiaenlace_ft_radicacion_entrada@fecha_radicacion_entrada_y" id="bqsaiaenlace_fecha_radicacion_entrada_y" value="y" />  -->
        ...
        <div class="row">
          <div class="control-group radio_buttons span4">
            ...
            <input type="hidden" name="bksaiacondicion_ft_radicacion_entrada@tipo_origen" id="bksaiacondicion_ft_radicacion_entrada-tipo_origen" value="=">
            </label>
            <div class="controls">
              <label class="radio inline">
                <input class="radio_buttons optional" id="bqsaia_ft_radicacion_entrada-tipo_origen" name="bqsaia_ft_radicacion_entrada@tipo_origen" type="radio" value="1">Externo
              </label>
              <label class="radio inline">
                <input class="radio_buttons optional" id="bqsaia_ft_radicacion_entrada-tipo_origen2" name="bqsaia_ft_radicacion_entrada@tipo_origen" type="radio" value="2">Interno
              </label>
            </div>
          </div>
      </div>
	...
	<br>
        <div class="form-actions">
          ...
          <input type="hidden" name="bqtipodato" value="date|ft_radicacion_entrada@fecha_radicacion_entrada_x,ft_radicacion_entrada@fecha_radicacion_entrada_y">
