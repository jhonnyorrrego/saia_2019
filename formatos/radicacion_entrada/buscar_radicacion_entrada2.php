<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Correspondencia de Entrada</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="fecha_radicacion_entrada"><b>FECHA DE RADICACION<input type="hidden" name="bksaiacondicion_fecha_radicacion_entrada" id="bksaiacondicion_fecha_radicacion_entrada" value="like_total"></b></label><div class="controls">
