<?php
                  ...
                  <div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                      ...
                      <div class="card card-default">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>app/documento/class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="despachado" value="<?php echo(mostrar_valor_campo('despachado',3,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',3,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(3,48,$_REQUEST['iddoc']);?></div><div id="tr_etiqueta_datos_gener">
                            ...
                            <label title="">ORIGEN DEL DOCUMENTO*</label><?php genera_campo_listados_editar(3,4966,$_REQUEST['iddoc']);?><label id="tipo_origen-error" class="error" for="tipo_origen" style="display: none;"></label><br></div><div id="tr_etiqueta_origen">
...
<script type="text/javascript">
            $(function () {
                var configuracion={"defaultDate":"<?php echo(mostrar_valor_campo('fecha_oficio_entrada',,$_REQUEST['iddoc'])); ?>","format":"YYYY-MM-DD","locale":"es","useCurrent":true};
                ...
                $("#content_container").height($(window).height());
                                    ...
                                    "url" => "app/arbol/arbol_funcionario.php",
                            ...
                            <label title="">DISTRIBUIDO ENTRE SEDES*</label><?php genera_campo_listados_editar(3,8318,$_REQUEST['iddoc']);?><label id="distribuid_entre_sedes-error" class="error" for="distribuid_entre_sedes" style="display: none;"></label><br></div><div class="form-group "  id="tr_numero_oficio">
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                            ...
                            <label title="">REQUIERE SERVICIO DE RECOGIDA?</label><?php genera_campo_listados_editar(3,5199,$_REQUEST['iddoc']);?><label id="distribuid_entre_sedes-error" class="error" for="distribuid_entre_sedes" style="display: none;"></label><br></div><div class="form-group  " id="tr_tipo_mensajeria">
                            <label title="">REQUIERE SERVICIO DE ENTREGA?</label><?php genera_campo_listados_editar(3,4970,$_REQUEST['iddoc']);?><label id="distribuid_entre_sedes-error" class="error" for="distribuid_entre_sedes" style="display: none;"></label><br></div><div class="form-group "  id="tr_numero_guia">
                            ...
                            <label title="">DESTINO DEL DOCUMENTO*</label><?php genera_campo_listados_editar(3,4968,$_REQUEST['iddoc']);?><label id="tipo_destino-error" class="error" for="tipo_destino" style="display: none;"></label><br></div><div class="form-group  required" id="tr_destino">
