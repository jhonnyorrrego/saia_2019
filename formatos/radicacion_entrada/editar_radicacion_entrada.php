...
--></script></td></tr><tr>
                   ...
                   <input type="hidden" maxlength="255"  class="required"  name="persona_natural" id="persona_natural" value="<?php echo(mostrar_valor_campo('persona_natural',3,$_REQUEST['iddoc'])); ?>"><?php componente_ejecutor("37",@$_REQUEST["iddoc"]); ?></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='6'  name="descripcion_anexos" id="descripcion_anexos" cols="53" rows="3" class="tiny_sin_tiny"><?php echo(mostrar_valor_campo('descripcion_anexos',3,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
