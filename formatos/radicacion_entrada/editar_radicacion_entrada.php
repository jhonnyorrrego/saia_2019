<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:EDITAR RADICACI&Oacute;N DE CORRESPONDENCIA:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="despachado" value="<?php echo(mostrar_valor_campo('despachado',3,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',3,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(3,48,$_REQUEST['iddoc']);?></div><div id="tr_etiqueta_datos_gener">
                                      ...
                                      </div><div class="form-group" id="tr_fecha_radicacion_entrada"><label title="">FECHA DE RADICACI&Oacute;N*</label><?php fecha_formato(3,53,$_REQUEST['iddoc']);?></div><div class="form-group  required" id="tr_tipo_origen">
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <div class="celda_transparente"><textarea  tabindex='3'  name="descripcion" id="descripcion" cols="53" rows="3" class="form-control required"><?php echo(mostrar_valor_campo('descripcion',3,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group" id="tr_descripcion_anexos">
                                        <label title="">ANEXOS FISICOS</label>
                                        <div class="celda_transparente"><textarea  tabindex='4'  name="descripcion_anexos" id="descripcion_anexos" cols="53" rows="3" class="form-control"><?php echo(mostrar_valor_campo('descripcion_anexos',3,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
...
',$_REQUEST['iddoc']);}?></div><br/>Buscar: <input  tabindex='8'  type="text" id="stext_destino" width="200px" size="25" onblur="closetree_destino()"> <input type="hidden" id="idclosetree_destino">
                                ...
                                <a href="javascript:void(0)" onclick="tree_destino.findItem((document.getElementById('stext_destino').value))">
                                    <img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden"  name="destino" id="destino"   value="<?php if(isset($_REQUEST["iddoc"])){cargar_seleccionados(3,43,1,$_REQUEST['iddoc']);}?>" ><div id="esperando_destino">
                                    <img src="../../imagenes/cargando.gif">
                                </div>
                                ...
                                function cargando_destino() {
                                    ...
                                    document.poppedLayer.style.display = "";
                                        ...
                                        vector2="<?php if(isset($_REQUEST["iddoc"])){cargar_seleccionados(3,43,1,$_REQUEST['iddoc']);}?>";
                                        vector2=vector2.split(",");
                                        for(m=0;m<vector2.length;m++) {
