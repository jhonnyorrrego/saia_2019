...
function campos_adicionales_radicacion($idformato,$iddoc){
    ...
    $datos=busca_filtro_tabla("","ft_radicacion_entrada","documento_iddocumento=".$iddoc,"",$conn);
    $tabla='<table class="table-bordered adicionar_campo" style="width: 100%; font-size:10px; text-align:center;" border="1">';
    ...
    if($datos[0]['tipo_destino']==2){
        $copia=busca_filtro_tabla("concat(nombres,' ',apellidos) AS nombre","vfuncionario_dc","iddependencia_cargo IN(".$datos[0]['destino'].")","",$conn);
