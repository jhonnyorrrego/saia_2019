	...
	$(document).ready(function(){
	    ...
	    tree_serie_idserie.setOnLoadingEnd(cargar_arbol());
                ...
                setTimeout(function(){  
                    ...
                    tree_serie_idserie.loadXML("<?php echo($ruta_db_superior); ?>test_dependencia_serie.php?tabla=dependencia&admin=1&sin_padre=1&mostrar_nodos=dsa&uid=1477409126024&id=d"+dependencia_principal);
                }, 1000);
                }
