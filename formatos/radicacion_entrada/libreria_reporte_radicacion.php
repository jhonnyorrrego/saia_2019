...
function aceptar_recepcion($idft_destino_radicacion){
    ...
    if($datos[0]['recepcion']!=0){
        $input="<input type='checkbox' id='recepcion' name='recepcion' data-idftidft='$idft_destino_radicacion' value='".$cargo[0]['iddependencia_cargo']."' checked readonly='readonly'>";
    }else{
