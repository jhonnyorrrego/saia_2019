...
function mostrar_ruta_reporte($idft_destino_radicacion){
    ...
    if($datos[0]['tipo_destino']==1){
        $destino=busca_filtro_tabla("a.ciudada, a.direccion","datos_ejecutor a, ejecutor b","b.idejecutor=a.ejecutor_idejecutor AND a.iddatos_ejecutor=".$datos[0]['nombre_destino'],"",$conn);
