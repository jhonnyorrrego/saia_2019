                    ...
                    <script>
                     ...
                     $(document).ready(function() 
                      ...
                      $("#descripcion").fcbkcomplete({
                       ...
                       <td class="encabezado" width="20%" title="">FECHA L&Iacute;MITE DE RESPUESTA</td><td class="encabezado">ENTRE &nbsp;</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input type="text" readonly="true"  name="tiempo_respuesta_1" id="tiempo_respuesta_1" tipo="fecha" value=""><?php selector_fecha("tiempo_respuesta_1","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?>&nbsp;&nbsp; Y &nbsp;&nbsp;<input type="text" readonly="true"  name="tiempo_respuesta_2" id="tiempo_respuesta_2" tipo="fecha" value=""><?php selector_fecha("tiempo_respuesta_2","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_numero_folios" id="condicion_numero_folios"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">NUMERO DE FOLIOS</td><td class="encabezado">&nbsp;<select name="compara_numero_folios" id="compara_numero_folios"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
