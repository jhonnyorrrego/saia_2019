<html><title>.:EDITAR 3. MONITOREO Y REVISION:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../anexosdigitales/multiple-file-upload/jquery.MultiFile.js"></script><?php include_once("../../anexosdigitales/funciones_archivo.php"); ?><script type="text/javascript" src="../../anexosdigitales/highslide-4.0.10/highslide/highslide-with-html.js"></script><link rel="stylesheet" type="text/css" href="../../anexosdigitales/highslide-4.0.10/highslide/highslide.css" />
  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                     ...
                     <?php buscar_dependencia(396,4741,$_REQUEST['iddoc']);?></tr><tr>
                     <td class="encabezado" width="20%" title="">FECHA*</td>
                     <?php fecha_bloqueada_monitoreo(396,4742,$_REQUEST['iddoc']);?></tr><tr>
                     <td class="encabezado" width="20%" title="">RIESGO NRO*</td>
                     <?php obtener_numero_riesgo(396,4743,$_REQUEST['iddoc']);?></tr><tr>
                     <td class="encabezado" width="20%" title="">NOMBRE DEL RIESGO*</td>
                     <?php obtener_nombre_riesgo(396,4744,$_REQUEST['iddoc']);?></tr><tr id="tr_cambio_identificacion" >
                     ...
                     <td class="celda_transparente"><textarea  tabindex='1'  name="descripcion_cambio" id="descripcion_cambio" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('descripcion_cambio',396,$_REQUEST['iddoc'])); ?></textarea></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="descripcion_analisis" id="descripcion_analisis" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('descripcion_analisis',396,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">SE EVALUARON LOS CONTROLES EXISTENTES?*</td>
                     <?php obtener_controles_existentes_riesgo(396,4749,$_REQUEST['iddoc']);?></tr><tr>
                     <td class="encabezado" width="20%" title="">RESULTADOS DE LA EVALUACI&Oacute;N*</td>
                     <td class="celda_transparente"><textarea  tabindex='3'  name="resultado_evaluacion" id="resultado_evaluacion" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('resultado_evaluacion',396,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">SE CUMPLIERON LAS ACCIONES PROPUESTAS?*</td>
                     <?php obtener_acciones_propuestas_riesgo(396,4751,$_REQUEST['iddoc']);?></tr><tr>
                     <td class="encabezado" width="20%" title="">LOGROS ALCANZADOS Y/O OBSERVACIONES*</td>
                     <td class="celda_transparente"><textarea  tabindex='4'  name="logros_alcanzados" id="logros_alcanzados" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('logros_alcanzados',396,$_REQUEST['iddoc'])); ?></textarea></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='5'  name="descripcion_ncontrol" id="descripcion_ncontrol" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('descripcion_ncontrol',396,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">ADJUNTAR EVIDENCIA(S) DOCUMENTAL</td>
                     <td class="celda_transparente"><?php echo '<div class="textwrapper">
			<a href="../../anexosdigitales/anexos_documento_edit.php?key='.$_REQUEST["iddoc"].'&idformato=396&idcampo=4755" id="anexo_admin" class="highslide" onclick="return hs.htmlExpand( this, {
			objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
			</div>'; ?><tr>
                     <td class="encabezado" width="20%" title="">OBSERVACIONES GENERALES</td>
                     <td class="celda_transparente"><textarea  tabindex='7'  name="observaciones_generales" id="observaciones_generales" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('observaciones_generales',396,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><input type="hidden" name="idft_monitoreo_revision" value="<?php echo(mostrar_valor_campo('idft_monitoreo_revision',396,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',396,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',396,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',396,$_REQUEST['iddoc'])); ?>"><?php validar_tipo_seleccion_monitoreo(396,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('4742'); ?>"><input type="hidden" name="formato" value="396"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><input type="hidden" name="accion" value="editar" ><input type="hidden" name="item" value="<?php echo $_REQUEST["item"]; ?>" ><input type="hidden" name="anterior" value="<?php echo $_REQUEST["campo"]; ?>" ><tr><td colspan='2'><?php submit_formato(396,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>