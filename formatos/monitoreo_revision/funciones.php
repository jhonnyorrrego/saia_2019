...
function obtener_nombre_riesgo($idformato, $iddoc)
{
	...
	echo ("<td>
			...
			<input type='hidden' name='nombre_riesgo' id='nombre_riesgo' value='" . strip_tags(codifica_encabezado(html_entity_decode($riesgo[0]["riesgo"]))) . "' readonly>
		  </td>");
}
...
function obtener_acciones_propuestas_riesgo($idformato, $iddoc)
{
	...
	function validar_tipo_seleccion_monitoreo($idformato, $iddoc)
	{
		...
		function fecha_bloqueada_monitoreo($idformato, $iddoc)
		{ //A.A
