<html><title>.:ADICIONAR 3. MONITOREO Y REVISION:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../anexosdigitales/multiple-file-upload/jquery.MultiFile.js"></script><?php include_once("../../anexosdigitales/funciones_archivo.php"); ?><script type="text/javascript" src="../../anexosdigitales/highslide-4.0.10/highslide/highslide-with-html.js"></script><link rel="stylesheet" type="text/css" href="../../anexosdigitales/highslide-4.0.10/highslide/highslide.css" />
  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">3. MONITOREO Y REVISION</td></tr><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(5443)); ?>"><tr>
                     ...
                     <?php buscar_dependencia(435,5421);?></tr><tr>
                     <td class="encabezado" width="20%" title="">FECHA*</td>
                     <?php fecha_bloqueada_monitoreo(435,5422);?></tr><tr>
                     <td class="encabezado" width="20%" title="">RIESGO NRO*</td>
                     <?php obtener_numero_riesgo(435,5423);?></tr><tr>
                     <td class="encabezado" width="20%" title="">NOMBRE DEL RIESGO*</td>
                     <?php obtener_nombre_riesgo(435,5424);?></tr><tr id="tr_cambio_identificacion" >
                     ...
                     <td class="celda_transparente"><textarea  tabindex='1'  name="descripcion_cambio" id="descripcion_cambio" cols="53" rows="3" class="tiny_basico"><?php echo(validar_valor_campo(5426)); ?></textarea></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="descripcion_analisis" id="descripcion_analisis" cols="53" rows="3" class="tiny_basico"><?php echo(validar_valor_campo(5428)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">SE EVALUARON LOS CONTROLES EXISTENTES?*</td>
                     <?php obtener_controles_existentes_riesgo(435,5429);?></tr><tr>
                     <td class="encabezado" width="20%" title="">RESULTADOS DE LA EVALUACI&Oacute;N*</td>
                     <td class="celda_transparente"><textarea  tabindex='3'  name="resultado_evaluacion" id="resultado_evaluacion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5430)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">SE CUMPLIERON LAS ACCIONES PROPUESTAS?*</td>
                     <?php obtener_acciones_propuestas_riesgo(435,5431);?></tr><tr>
                     <td class="encabezado" width="20%" title="">LOGROS ALCANZADOS Y/O OBSERVACIONES*</td>
                     <td class="celda_transparente"><textarea  tabindex='4'  name="logros_alcanzados" id="logros_alcanzados" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5432)); ?></textarea></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='5'  name="descripcion_ncontrol" id="descripcion_ncontrol" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5434)); ?></textarea></td>
                    </tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='7'  name="observaciones_generales" id="observaciones_generales" cols="53" rows="3" class="tiny_basico"><?php echo(validar_valor_campo(5436)); ?></textarea></td>
                    </tr><input type="hidden" name="idft_monitoreo_revision" value="<?php echo(validar_valor_campo(5438)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(5439)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(5440)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(5441)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(5442)); ?>"><?php validar_tipo_seleccion_monitoreo(435,NULL);?><input type="hidden" name="campo_descripcion" value="5422"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><input type="hidden" name="accion" value="guardar_detalle" ><tr><td colspan='2'><?php submit_formato(435);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>