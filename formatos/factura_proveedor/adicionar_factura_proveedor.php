  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                    ...
                    </tr><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(2649)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(236,2650);?></tr><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(2652)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">ANEXOS DIGITALES</td>
                     <td class="celda_transparente"><input  tabindex='15'  type="file" maxlength="255"  class='multi'  name="anexo_formato[]" accept="<?php echo $extensiones;?>"><?php formatear_valor_numero(236,NULL);?><?php digitalizacion_factura_1(236,NULL);?><input type="hidden" name="campo_descripcion" value="2634,2635,2636,2637,2638,2640,2641,2644,2646"><tr><td colspan='2'><?php submit_formato(236);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>