<html><title>.:EDITAR FACTURA PROVEEDORES:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><?php include_once("../../calendario/calendario.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="STYLESHEET" type="text/css" href="../../css/dhtmlXTree.css"><script type="text/javascript" src="../../anexosdigitales/multiple-file-upload/jquery.MultiFile.js"></script><?php include_once("../../anexosdigitales/funciones_archivo.php"); ?><script type="text/javascript" src="../../anexosdigitales/highslide-4.0.10/highslide/highslide-with-html.js"></script><link rel="stylesheet" type="text/css" href="../../anexosdigitales/highslide-4.0.10/highslide/highslide.css" />
  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">FACTURA PROVEEDORES</td></tr><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',236,$_REQUEST['iddoc'])); ?>"><tr>
                   ...
                   <td class="encabezado" width="20%" title="">ENVIAR A*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(236,2637,'5',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_enviar.findItem(htmlentities(document.getElementById('stext_enviar').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_enviar"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_enviar" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="enviar" id="enviar"   value="<?php cargar_seleccionados(236,2637,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                  ...
                  vector2="<?php cargar_seleccionados(236,2637,1,$_REQUEST['iddoc']);?>";
...
--></script></td></tr><tr>
                    ...
                    </tr><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',236,$_REQUEST['iddoc'])); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(236,2650,$_REQUEST['iddoc']);?></tr><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',236,$_REQUEST['iddoc'])); ?>"><tr>
			...
			</div>'; ?><?php formatear_valor_numero(236,NULL,$_REQUEST['iddoc']);?><?php digitalizacion_factura_1(236,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('2634,2635,2636,2637,2638,2640,2641,2644,2646'); ?>"><input type="hidden" name="formato" value="236"><tr><td colspan='2'><?php submit_formato(236,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>