<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">FORMATO GIO 3</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],429,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="idft_formato_gio_3" value="<?php echo(mostrar_valor_campo('idft_formato_gio_3',429,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(429,7100,$_REQUEST['iddoc']);?></div><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',429,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',429,$_REQUEST['iddoc'])); ?>"><div class="form-group form-group-default "  id="tr_ddddd">
                                       ...
                                       </div><input type="hidden" name="campo_descripcion" value="<?php echo('7103,7108'); ?>"><input type="hidden" name="formato" value="429"><tr><td colspan='2'><?php submit_formato(429,$_REQUEST['iddoc']);?></td></tr></table></form></body>
