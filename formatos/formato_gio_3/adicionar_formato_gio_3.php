<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(7096)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(7097)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(7098)); ?>"><input type="hidden" name="idft_formato_gio_3" value="<?php echo(validar_valor_campo(7099)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(429,7100);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(7101)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(7102)); ?>"><div class="form-group form-group-default "  id="tr_ddddd">
                                        ...
                                        <label title=""></label>
                                        <input class="form-control"  maxlength="11"   tabindex='3'  type="text"  size="100" id="" name=""  value="<?php echo(validar_valor_campo(7123)); ?>">
                                       </div><div class="form-group" id="tr_select_675889465">
                                        <label title="">LISTA DESPLEGABLE*</label><?php genera_campo_listados_editar(429,7122,$_REQUEST['iddoc']);?></div><input type="hidden" name="campo_descripcion" value="7103,7108"><tr><td colspan='2'><?php submit_formato(429);?></td></tr></table></form></body>
      <script type="text/javascript">
      setInterval("auto_save('select_675889465','formato_gio_3')",300000);
      </script>
                        <script type="text/javascript">
