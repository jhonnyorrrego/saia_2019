<html><title>.: FORMATO PARA HACER PRUEBAS :.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA FORMATO PARA HACER PRUEBAS </td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_idft_forma_par_hace_prueba_"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_forma_par_hace_prueba_',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_forma_par_hace_prueba_',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_forma_par_hace_prueba_" id="bqsaiaenlace_idft_forma_par_hace_prueba_" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">FORMA_PAR_HACE_PRUEBA_</td><input type="hidden" name="bksaiacondicion_idft_forma_par_hace_prueba_" id="bksaiacondicion_idft_forma_par_hace_prueba_" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_forma_par_hace_prueba_" name="idft_forma_par_hace_prueba_"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_forma_par_hace_prueba_").fcbkcomplete({
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Formato para hacer pruebas ">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_documento_iddocumento" id="bqsaiaenlace_documento_iddocumento" value="y" />
                    ...
                    </tr><tr id="tr_datos"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_datos',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_datos',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_datos" id="bqsaiaenlace_datos" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">DATOS</td><input type="hidden" name="bksaiacondicion_datos" id="bksaiacondicion_datos" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="datos" name="datos"></select><script>
                     $(document).ready(function()
                      {
                      $("#datos").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
		  ...
		  <input type="hidden" name="bqsaiaenlace_dependencia" id="bqsaiaenlace_dependencia" value="y" />
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="8406"><?php submit_formato(452);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
