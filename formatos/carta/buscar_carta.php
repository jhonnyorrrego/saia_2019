<html><title>.:BUSCAR COMUNICACI&OACUTE;N EXTERNA:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/>
			...
			<link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/>
                    ...
                    </tr><tr id="tr_tipo_copia_interna"><td class="encabezado">&nbsp;<select name="condicion_tipo_copia_interna" id="condicion_tipo_copia_interna"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr id="tr_fecha_carta"><td class="encabezado">&nbsp;<select name="condicion_fecha_carta" id="condicion_fecha_carta"><option value="AND">Y</option><option value="OR">O</option></td>
