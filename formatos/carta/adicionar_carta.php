...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">COMUNICACION EXTERNA</td></tr><input type="hidden" name="tipo_copia_interna" value="<?php echo(validar_valor_campo(3421)); ?>"><input type="hidden" name="idflujo" value="<?php echo(validar_valor_campo(2216)); ?>"><input type="hidden" name="idft_carta" value="<?php echo(validar_valor_campo(17)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(16)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(15)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(14)); ?>"><tr>
