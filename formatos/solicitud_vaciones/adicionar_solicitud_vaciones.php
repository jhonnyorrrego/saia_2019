  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_gestio_humana.findItem(htmlentities(document.getElementById('stext_gestio_humana').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_gestio_humana"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_gestio_humana" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="gestio_humana" id="gestio_humana"   value="" ><label style="display:none" class="error" for="gestio_humana">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                	...
                	--></script></td></tr><tr>
                     ...
                     <?php fecha_formato(216,2318);?></tr><tr>
                       <td class="encabezado" width="20%" title="">INICIO DE VACACIONES*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='2'  type="text" readonly="true"  class="required dateISO"  name="fecha_ini_vacaciones" id="fecha_ini_vacaciones" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_ini_vacaciones","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr>
                       <td class="encabezado" width="20%" title="">FIN DE LAS VACACIONES*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='3'  type="text" readonly="true"  class="required dateISO"  name="fecha_fin_vaciones" id="fecha_fin_vaciones" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_fin_vaciones","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr>
                       <td class="encabezado" width="20%" title="">FECHA INICIO DE LABORES*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='4'  type="text" readonly="true"  class="required dateISO"  name="fecha_ini_labores" id="fecha_ini_labores" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_ini_labores","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(2305)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(2317)); ?>"><input type="hidden" name="idft_solicitud_vaciones" value="<?php echo(validar_valor_campo(2312)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(2302)); ?>"><input type="hidden" name="campo_descripcion" value="2297"><tr><td colspan='2'><?php submit_formato(216);?></td></tr></table></form></body></html>