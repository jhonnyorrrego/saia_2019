  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_gestio_humana.findItem(htmlentities(document.getElementById('stext_gestio_humana').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_gestio_humana"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_gestio_humana" height="90%"></div><input type="hidden"  class="required"  name="gestio_humana" id="gestio_humana"   value="" ><label style="display:none" class="error" for="gestio_humana">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
