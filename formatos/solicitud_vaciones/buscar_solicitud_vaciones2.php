<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato SOLICITUD DE VACACIONES</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><div class="controls"><b>RESPONSABLE<input type="hidden" name="bksaiacondicion_gestio_humana" id="bksaiacondicion_gestio_humana" value="like_total"></b><div id="esperando_gestio_humana"><img src="../../imagenes/cargando.gif"></div><div id="seleccionados"></div><input type="text" id="stext_gestio_humana" placeholder="Buscar" width="200px" size="25">
                   ...
                   <a href="javascript:void(0)" onclick="tree_gestio_humana.findItem(htmlentities(document.getElementById('stext_gestio_humana').value),0,1)"><img src="../../botones/general/buscar.png"border="0px"></a>
                          ...
                          <br /><br /><div id="treeboxbox_gestio_humana" height=""></div><input type="hidden"  name="g@gestio_humana" id="gestio_humana"   value="" ><label style="display:none" class="error" for="gestio_humana">Campo obligatorio.</b></label><script type="text/javascript">
                  <!--
                      var browserType;
