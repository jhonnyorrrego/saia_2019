<html><title>.:BUSCAR SOLICITUD COTIZACION :.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA SOLICITUD COTIZACION </td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_fecha_inicio" id="condicion_fecha_inicio"><option value="AND">Y</option><option value="OR">O</option></td>
                       <td class="encabezado" width="20%" title="Esta es la fecha en que inicia la solicitud de cotizaci&Atilde;ƒ&Acirc;&sup3;n">FECHA DE INICIO</td><td class="encabezado">ENTRE &nbsp;</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input type="text" readonly="true"  name="fecha_inicio_1" id="fecha_inicio_1" tipo="fecha" value=""><?php selector_fecha("fecha_inicio_1","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?>&nbsp;&nbsp; Y &nbsp;&nbsp;<input type="text" readonly="true"  name="fecha_inicio_2" id="fecha_inicio_2" tipo="fecha" value=""><?php selector_fecha("fecha_inicio_2","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_anexo" id="condicion_anexo"><option value="AND">Y</option><option value="OR">O</option></td>
