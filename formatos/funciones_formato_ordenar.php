...
for($i=0;$i<$campos["numcampos"];$i++){
  $texto.='<li class="lcampo" id="'.$campos[$i]["idfunciones_formato_accion"].'">'.$campos[$i]["orden"]."-".utf8_encode(strtoupper(html_entity_decode($campos[$i]["etiqueta"]." (".$campos[$i]["parametros"].") ".$campos[$i]["momento"]." ".$campos[$i]["accion"]))).'</li>';
}
$texto.='</ul>';
if(isset($_REQUEST["pantalla"])&&$_REQUEST["pantalla"]=="tiny")
