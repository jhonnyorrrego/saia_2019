...
<div class="celda_transparente">
     ...
     * <Responsabilidades>Crea un select para que se pueda elegir si la condiciï¿½n sobre el campo especificado es de obligatorio cumplimiento en la busqueda o no<Responsabilidades>
    ...
    private function generar_formato() {
        ...
        $data = array("adicionar_" . $formato[0]['nombre'] . ".php",
