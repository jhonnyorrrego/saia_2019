<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:EDITAR NOVEDAD DESPACHO MENSAJEROS:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(411,5094,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_fecha_novedad"><label title="">FECHA DE NOVEDAD*</label><?php fecha_formato(411,5173,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_item_radicacion"><label title="">ITEMS DE PLANILLA*</label><?php cargar_items_radicacion(411,5097,$_REQUEST['iddoc']);?></div><input type="hidden" name="idft_novedad_despacho" value="<?php echo(mostrar_valor_campo('idft_novedad_despacho',411,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_novedad"><label title="">NOVEDAD*</label><?php generar_select_novedad(411,5098,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_observaciones">
                                        <label title="">OBSERVACIONES*</label>
                                        <div class="celda_transparente"><textarea  tabindex='1'  name="observaciones" id="observaciones" cols="53" rows="3" class="form-control required"><?php echo(mostrar_valor_campo('observaciones',411,$_REQUEST['iddoc'])); ?></textarea><script>
                            var config = {
