<html><title>.:EDITAR NOVEDAD DESPACHO MENSAJEROS:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">NOVEDAD DESPACHO MENSAJEROS</td></tr><tr id="tr_dependencia">
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(411,5094,$_REQUEST['iddoc']);?></tr><tr id="tr_fecha_novedad">
                     <td class="encabezado" width="20%" title="">FECHA DE NOVEDAD*</td>
                     <?php fecha_formato(411,5173,$_REQUEST['iddoc']);?></tr><input type="hidden" name="idft_novedad_despacho" value="<?php echo(mostrar_valor_campo('idft_novedad_despacho',411,$_REQUEST['iddoc'])); ?>"><tr id="tr_item_radicacion">
                     <td class="encabezado" width="20%" title="">ITEMS DE PLANILLA*</td>
                     <?php cargar_items_radicacion(411,5097,$_REQUEST['iddoc']);?></tr><tr id="tr_novedad">
                     <td class="encabezado" width="20%" title="">NOVEDAD*</td>
                     <?php generar_select_novedad(411,5098,$_REQUEST['iddoc']);?></tr><tr id="tr_observaciones">
                     <td class="encabezado" width="20%" title="">OBSERVACIONES*</td>
                     <td class="celda_transparente"><textarea  tabindex='1'  name="observaciones" id="observaciones" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('observaciones',411,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',411,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',411,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',411,$_REQUEST['iddoc'])); ?>"><tr id="tr_anexo_soporte">
