<?php if(!isset($_REQUEST["tipo"]) || $_REQUEST["tipo"] != 5): ?><!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta content="" name="Cero K" /><?php include_once('../../librerias_saia.php'); ?><?php include_once('../../formatos/librerias/funciones_generales.php'); ?><?php include_once('../../class_transferencia.php'); ?><?php include_once('../carta/../librerias/encabezado_pie_pagina.php'); ?><?php include_once('../radicacion_entrada/../librerias/encabezado_pie_pagina.php'); ?><?php include_once('../memorando/../librerias/encabezado_pie_pagina.php'); ?><?php include_once('funciones.php'); ?><?php include_once('../../formatos/librerias/header_nuevo.php'); ?><table class="table table-bordered" style="width: 100%;" border="1">
<tbody>
<tr>
<td>FECHA DE NOVEDAD:</td>
<td><?php if(isset($_REQUEST["iddoc"])){mostrar_valor_campo('fecha_novedad',411,$_REQUEST['iddoc']);}?></td>
</tr>
<tr>
<td>ITEMS DE PLANILLA:</td>
<td><?php if(isset($_REQUEST["iddoc"])){mostrar_numero_item_novedad(411,$_REQUEST['iddoc']);}?></td>
</tr>
<tr>
<td>NOVEDAD:</td>
<td><?php if(isset($_REQUEST["iddoc"])){mostrar_valor_campo('novedad',411,$_REQUEST['iddoc']);}?></td>
</tr>
<tr>
<td>OBSERVACIONES:</td>
<td><?php if(isset($_REQUEST["iddoc"])){mostrar_valor_campo('observaciones',411,$_REQUEST['iddoc']);}?></td>
</tr>
<tr>
<td>ANEXOS / SOPORTE DE ENTREGA:</td>
<td><?php if(isset($_REQUEST["iddoc"])){mostrar_novedad_despacho_anexo_soporte(411,$_REQUEST['iddoc']);}?></td>
</tr>
</tbody>
</table>
<p><?php if(isset($_REQUEST["iddoc"])){mostrar_estado_proceso(411,$_REQUEST['iddoc']);}?></p><?php include_once('../../formatos/librerias/footer_nuevo.php'); ?><?php else: ?><?php
