<html><title>.: NOVEDAD DESPACHO MENSAJEROS:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../../formatos/librerias/header_formato.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA NOVEDAD DESPACHO MENSAJEROS</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_dependencia"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_dependencia" id="bqsaiaenlace_dependencia" value="y" />
                    ...
                    </tr><tr id="tr_fecha_novedad"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_fecha_novedad" id="bqsaiaenlace_fecha_novedad" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="">FECHA DE NOVEDAD</td><input type="hidden" name="bksaiacondicion_fecha_novedad" id="bksaiacondicion_fecha_novedad" value="like">
		  ...
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_novedad_despacho',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_novedad_despacho" id="bqsaiaenlace_idft_novedad_despacho" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">NOVEDAD_DESPACHO</td><input type="hidden" name="bksaiacondicion_idft_novedad_despacho" id="bksaiacondicion_idft_novedad_despacho" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_novedad_despacho" name="idft_novedad_despacho"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_novedad_despacho").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Novedad Despacho Mensajeros">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_item_radicacion" id="bqsaiaenlace_item_radicacion" value="y" />
                  ...
                  <td class="encabezado" width="20%" title="">ITEMS DE PLANILLA</td><input type="hidden" name="bksaiacondicion_item_radicacion" id="bksaiacondicion_item_radicacion" value="like"><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,5097,'',1,'buscar');?></td></tr><tr><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_novedad" id="bqsaiaenlace_novedad" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="">NOVEDAD</td><input type="hidden" name="bksaiacondicion_novedad" id="bksaiacondicion_novedad" value="like_total"><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,5098,'',1,'buscar');?></td></tr><tr id="tr_observaciones"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_observaciones" id="bqsaiaenlace_observaciones" value="y" />
                    ...
                    </tr><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_despacho_ingresados"  value="<?php echo $_REQUEST["padre"]; ?>"><?php } ?><?php if($_REQUEST["anterior"]) {?><input type="hidden"  name="ft_despacho_ingresados"  value="<?php echo $_REQUEST["anterior"]; ?>"><?php }  else {listar_select_padres(ft_despacho_ingresados);} ?><tr id="tr_documento_iddocumento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_anexo_soporte" id="bqsaiaenlace_anexo_soporte" value="y" />
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="5097"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
