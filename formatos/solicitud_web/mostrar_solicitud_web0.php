<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../memo/funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../librerias/header.php"); ?><?php include_once("../../class_transferencia.php"); ?><tr><td><p style="text-align: center;"><strong><?php mostrar_valor_campo('tipo_solicitud',78,$_REQUEST['iddoc']);?></strong></p>
...
<p>&nbsp;<?php responder_solicitud(78,$_REQUEST['iddoc']);?></p></td></tr><?php include_once("../librerias/footer.php"); ?>