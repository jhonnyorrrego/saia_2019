<html><title>.:EDITAR FUNCIONARIOS DE LA RUTA:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_item.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr id="tr_fecha_mensajero">
                     <td class="encabezado" width="20%" title="">FECHA*</td>
                     <?php fecha_formato(406,5008,$_REQUEST['iddoc']);?></tr><tr id="tr_mensajero_ruta">
