<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:EDITAR FUNCIONARIOS DE LA RUTA:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>formatos/librerias/funciones_item.php" enctype="multipart/form-data"><div class="form-group" id="tr_fecha_mensajero"><label title="">FECHA*</label><?php fecha_formato(406,5008,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_mensajero_ruta">
                                        <label title="">MENSAJERO*</label><?php genera_campo_listados_editar(406,5005,$_REQUEST['iddoc']);?></div><input type="hidden" name="estado_mensajero" value="<?php echo(mostrar_valor_campo('estado_mensajero',406,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="idft_funcionarios_ruta" value="<?php echo(mostrar_valor_campo('idft_funcionarios_ruta',406,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="formato" value="406"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="formato" value="funcionarios_ruta"><input type="hidden" name="accion" value="editar" ><input type="hidden" name="item" value="<?php echo $_REQUEST["item"]; ?>" ><input type="hidden" name="anterior" value="<?php echo $_REQUEST["campo"]; ?>" ><tr><td colspan='2'><?php submit_formato(406,$_REQUEST['iddoc']);?></td></tr></table></form></body>
