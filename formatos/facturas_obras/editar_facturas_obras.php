...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <div class="celda_transparente"><textarea  tabindex='3'  name="concepto_factura" id="concepto_factura" cols="53" rows="3" class="form-control required"><?php echo(mostrar_valor_campo('concepto_factura',422,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group form-group-default required"  id="tr_valor_factura">
                                        ...
                                        <div class="celda_transparente"><textarea  tabindex='7'  name="anexos_fisicos" id="anexos_fisicos" cols="53" rows="3" class="form-control"><?php echo(mostrar_valor_campo('anexos_fisicos',422,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
