...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <textarea  tabindex='3'  name="concepto_factura" id="concepto_factura" cols="53" rows="3" class="form-control tiny_sin_tiny required"><?php echo(validar_valor_campo(6980)); ?></textarea></div></div><div class="form-group form-group-default required"  id="tr_valor_factura">
                                        ...
                                        <div class="celda_transparente">
                                        <textarea  tabindex='7'  name="anexos_fisicos" id="anexos_fisicos" cols="53" rows="3" class="form-control tiny_sin_tiny"><?php echo(validar_valor_campo(6986)); ?></textarea></div></div><div class="form-group" id="tr_anexos_digitales">
