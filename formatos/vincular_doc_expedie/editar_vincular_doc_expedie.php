<html><title>.:EDITAR VINCULAR DOCUMENTOS A UN EXPEDIENTE:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">VINCULAR DOCUMENTOS A UN EXPEDIENTE</td></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',312,$_REQUEST['iddoc'])); ?>"><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(312,3657,$_REQUEST['iddoc']);?></tr><tr id="tr_fecha_documento"><td class="encabezado" width="20%" title="">FECHA*</td><?php fecha_formato(312,3662,$_REQUEST['iddoc']);?></tr><tr id="tr_asunto">
                    ...
                    </tr><tr id="tr_fk_idexpediente"><td class="encabezado" width="20%" title="Expediente al que va a estar vinculado">EXPEDIENTE VINCULADO*</td><?php fk_idexpediente_funcion(312,3663,$_REQUEST['iddoc']);?></tr><tr id="tr_anexos">
