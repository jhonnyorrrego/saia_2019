<html><title>.:BUSCAR VINCULAR DOCUMENTOS A UN EXPEDIENTE:.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA VINCULAR DOCUMENTOS A UN EXPEDIENTE</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_fecha_documento" id="condicion_fecha_documento"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">FECHA</td><td class="encabezado">&nbsp;<select name="compara_fecha_documento" id="compara_fecha_documento"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_fk_idexpediente" id="condicion_fk_idexpediente"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="Expediente al que va a estar vinculado">EXPEDIENTE VINCULADO</td><td class="encabezado">&nbsp;<select name="compara_fk_idexpediente" id="compara_fk_idexpediente"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     ...
                     <td class="encabezado" width="20%" title="">ADJUNTO</td><td class="encabezado">&nbsp;<select name="compara_anexos" id="compara_anexos"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
