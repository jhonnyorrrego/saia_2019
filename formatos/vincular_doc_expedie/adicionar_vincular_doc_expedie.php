<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h4 class="text-black">VINCULAR DOCUMENTOS A UN EXPEDIENTE</h4></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],312,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(4943)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(312,3657);?></div><div class="form-group" id="tr_fecha_documento"><label title="">FECHA*</label><?php fecha_formato(312,3662);?></div><div class="form-group form-group-default required"  id="tr_asunto">
                                        ...
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="asunto" name="asunto" required value="<?php echo(validar_valor_campo(3661)); ?>">
                                       </div><div class="form-group" id="tr_serie_idserie">
                                <label title="Vincular documentos a un expediente">EXPEDIENTE VINCULADO*</label><div class="form-control"><div id="seleccionados"><?php if(isset($_REQUEST["iddoc"])){mostrar_seleccionados(312,3654,'1',$_REQUEST['iddoc']);}?></div><br/>Buscar: <input  tabindex='2'  type="text" id="stext_serie_idserie" width="200px" size="25" onblur="closetree_serie_idserie()"> <input type="hidden" id="idclosetree_serie_idserie">
                                ...
                                <a href="javascript:void(0)" onclick="tree_serie_idserie.findItem((document.getElementById('stext_serie_idserie').value))">
                                    <img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="255"  class="required"  name="serie_idserie" id="serie_idserie"   value="" ><label style="display:none" class="error" for="serie_idserie">Campo obligatorio.</label><div id="esperando_serie_idserie">
                                ...
                                function cargando_serie_idserie() {
                                    ...
                                    document.poppedLayer.style.display = "";
                                       ...
                                       <div class="card-body no-scroll no-padding"><div id="dz_campo_3660" class="saia_dz dropzone no-margin" data-nombre-campo="anexos" data-idformato="312" data-idcampo-formato="3660" data-extensiones="<?php echo $extensiones;?>" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div><input type="hidden" class="required" id="anexos" name="anexos" value=""></div></div></div><div class="form-group" id="tr_observaciones">
                                        <label title="">OBSERVACIONES</label>
                                        <div class="celda_transparente">
                                        <textarea  tabindex='4'  name="observaciones" id="observaciones" cols="53" rows="3" class="form-control tiny_basico"><?php echo(validar_valor_campo(3664)); ?></textarea></div></div><input type="hidden" name="idft_vincular_doc_expedie" value="<?php echo(validar_valor_campo(3655)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(3656)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(3658)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(3659)); ?>"><?php add_edit_vincu_exp(312,NULL);?><?php cargar_serie_documental(312,NULL);?><input type="hidden" name="campo_descripcion" value="3661"><tr><td colspan='2'><?php submit_formato(312);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
