<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Vincular documentos a un expediente</legend><br /><br /><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="fecha_documento"><b>Fecha<input type="hidden" name="bksaiacondicion_g@fecha_documento" id="bksaiacondicion_g@fecha_documento" value="date"></b></label><div class="controls">
