...
<div class="form-group" id="tr_campo_texto_1922978464">
                     ...
                     <input class="form-control"  maxlength="255"  class="required"   tabindex='6'  type="text"  size="100" id="campo_texto_1922978464" name="campo_texto_1922978464"  value="<?php echo(validar_valor_campo(6890)); ?>">
