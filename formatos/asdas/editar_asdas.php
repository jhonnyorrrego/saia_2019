<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">ASDASD</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],417,"ingresar","ANTERIOR"); ?>
...
<label for="fecha_hora">FECHA CON HORA</label>
<label id="fecha_hora-error" class="error" for="fecha_hora" style="display: none;"></label>
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                            ...
                            </div></div><div class="form-group form-group-default " id="tr_moneda_1953843243">
...
<div class="form-group form-group-default required"  id="tr_campo_texto_1922978464">
                                        ...
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='6'  type="text"  size="100" id="campo_texto_1922978464" name="campo_texto_1922978464" required value="<?php echo(mostrar_valor_campo('campo_texto_1922978464',417,$_REQUEST['iddoc'])); ?>">
