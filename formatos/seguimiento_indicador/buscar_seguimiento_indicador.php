<html><title>.:BUSCAR SEGUIMIENTO INDICADOR:.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script>
			<link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/>
                    ...
                    </tr><tr id="tr_resultado"><td class="encabezado">&nbsp;<select name="condicion_resultado" id="condicion_resultado"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr id="tr_observaciones"><td class="encabezado">&nbsp;<select name="condicion_observaciones" id="condicion_observaciones"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="6215,6217"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><?php submit_formato(489);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
