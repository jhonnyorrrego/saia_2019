<html><title>.: SEGUIMIENTO INDICADOR:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../../formatos/librerias/header_formato.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA SEGUIMIENTO INDICADOR</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_dependencia"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_estado_documento" id="bqsaiaenlace_estado_documento" value="y" />
                    ...
                    </tr><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_formula_indicador"  value="<?php echo $_REQUEST["padre"]; ?>"><?php } ?><?php if($_REQUEST["anterior"]) {?><input type="hidden"  name="ft_formula_indicador"  value="<?php echo $_REQUEST["anterior"]; ?>"><?php }  else {listar_select_padres(ft_formula_indicador);} ?><tr id="tr_serie_idserie"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Seguimiento Indicador">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_fecha_seguimiento" id="bqsaiaenlace_fecha_seguimiento" value="y" />
                       ...
                       <td class="encabezado" width="20%" title="Por favor Ingrese la fecha en que se realiza el seguimiento">FECHA</td><td class="encabezado">ENTRE &nbsp;</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input type="text" readonly="true"  name="fecha_seguimiento_1" id="fecha_seguimiento_1" tipo="fecha" value=""><?php selector_fecha("fecha_seguimiento_1","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?>&nbsp;&nbsp; Y &nbsp;&nbsp;<input type="text" readonly="true"  name="fecha_seguimiento_2" id="fecha_seguimiento_2" tipo="fecha" value=""><?php selector_fecha("fecha_seguimiento_2","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td></tr><tr id="tr_linea_base"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_linea_base',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_linea_base',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_linea_base" id="bqsaiaenlace_linea_base" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">LIMITE INFERIOR</td><input type="hidden" name="bksaiacondicion_linea_base" id="bksaiacondicion_linea_base" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="linea_base" name="linea_base"></select><script>
                     $(document).ready(function()
                      {
                      $("#linea_base").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><tr id="tr_meta_indicador_actual"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_meta_indicador_actual',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_meta_indicador_actual',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_meta_indicador_actual" id="bqsaiaenlace_meta_indicador_actual" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="Meta actual del seguimiento">LIMITE SUPERIOR</td><input type="hidden" name="bksaiacondicion_meta_indicador_actual" id="bksaiacondicion_meta_indicador_actual" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_documento_iddocumento" id="bqsaiaenlace_documento_iddocumento" value="y" />
                    ...
                    </tr><tr id="tr_resultado"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_resultado',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_resultado',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_resultado" id="bqsaiaenlace_resultado" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="valores asignados a las variables de la f&oacute;rmula a la cual se hace seguimiento">RESULTADOS</td><input type="hidden" name="bksaiacondicion_resultado" id="bksaiacondicion_resultado" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_observaciones" id="bqsaiaenlace_observaciones" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="an&aacute;lisis de datos">AN&Aacute;LISIS DE DATOS</td><input type="hidden" name="bksaiacondicion_observaciones" id="bksaiacondicion_observaciones" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_encabezado" id="bqsaiaenlace_encabezado" value="y" />
                    ...
                    </tr><tr id="tr_idft_seguimiento_indicador"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_seguimiento_indicador',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_seguimiento_indicador',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_seguimiento_indicador" id="bqsaiaenlace_idft_seguimiento_indicador" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">SEGUIMIENTO_INDICADOR</td><input type="hidden" name="bksaiacondicion_idft_seguimiento_indicador" id="bksaiacondicion_idft_seguimiento_indicador" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_seguimiento_indicador" name="idft_seguimiento_indicador"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_seguimiento_indicador").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><input type="hidden" name="campo_descripcion" value="6215,6217"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
