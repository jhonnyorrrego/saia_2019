<html><title>.:ADICIONAR BASES DE CALIDAD:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("../carta/funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type='text/javascript'>
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                     ...
                     <td class="encabezado" width="20%" title="">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(387,4589,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4580)); ?>"><input type="hidden" name="idft_bases_calidad" value="<?php echo(validar_valor_campo(4581)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4582)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(4584)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(4585)); ?>"><?php asignar_responsables(387,NULL);?><input type="hidden" name="campo_descripcion" value="4586"><tr><td colspan='2'><?php submit_formato(387);?></td></tr></table></form></body></html>