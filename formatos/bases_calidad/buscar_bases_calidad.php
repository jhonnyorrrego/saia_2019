<html><title>.:BUSCAR BASES DE CALIDAD:.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA BASES DE CALIDAD</td></tr><tr id="tr_tipo_base_calidad"><td class="encabezado">&nbsp;<select name="condicion_tipo_base_calidad" id="condicion_tipo_base_calidad"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_descripcion_base" id="condicion_descripcion_base"><option value="AND">Y</option><option value="OR">O</option></td>
                     ...
                     <td class="encabezado" width="20%" title="">ESTADO</td><td class="encabezado">&nbsp;<select name="compara_estado_base_calidad" id="compara_estado_base_calidad"> <option value="LIKE|%|%">Similar</option><option value="LIKE|%|@">Inicia Con</option><option value="LIKE|@|%">Finaliza Con</option></select></td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(387,4589,'',1);?></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_anexo_soporte" id="condicion_anexo_soporte"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">SOPORTE</td><td class="encabezado">&nbsp;<select name="compara_anexo_soporte" id="compara_anexo_soporte"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
