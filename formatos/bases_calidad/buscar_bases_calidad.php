<html><title>.: BASES DE CALIDAD:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../../formatos/librerias/header_formato.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA BASES DE CALIDAD</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_dependencia"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_estado_documento" id="bqsaiaenlace_estado_documento" value="y" />
                    ...
                    </tr><tr id="tr_tipo_base_calidad"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_tipo_base_calidad',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_tipo_base_calidad',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_tipo_base_calidad" id="bqsaiaenlace_tipo_base_calidad" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">TIPO</td><input type="hidden" name="bksaiacondicion_tipo_base_calidad" id="bksaiacondicion_tipo_base_calidad" value="="><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,6050,'',1,'buscar');?></td></tr><tr id="tr_version_base_calidad"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_version_base_calidad',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_version_base_calidad',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_version_base_calidad" id="bqsaiaenlace_version_base_calidad" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">VERSI&Oacute;N</td><input type="hidden" name="bksaiacondicion_version_base_calidad" id="bksaiacondicion_version_base_calidad" value="like">
                    ...
                    </tr><tr id="tr_descripcion_base"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_descripcion_base',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_descripcion_base',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_descripcion_base" id="bqsaiaenlace_descripcion_base" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">DESCRIPCI&Oacute;N</td><input type="hidden" name="bksaiacondicion_descripcion_base" id="bksaiacondicion_descripcion_base" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_anexo_soporte" id="bqsaiaenlace_anexo_soporte" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="">MAPA DE PROCESO</td><input type="hidden" name="bksaiacondicion_anexo_soporte" id="bksaiacondicion_anexo_soporte" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Bases de Calidad">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
                    ...
                    </tr><tr id="tr_idft_bases_calidad"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_bases_calidad',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_bases_calidad',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_bases_calidad" id="bqsaiaenlace_idft_bases_calidad" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">BASES_CALIDAD</td><input type="hidden" name="bksaiacondicion_idft_bases_calidad" id="bksaiacondicion_idft_bases_calidad" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_bases_calidad" name="idft_bases_calidad"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_bases_calidad").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="6050"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
