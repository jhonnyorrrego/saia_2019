...
function enviar_mostrar_formato($idformato,$iddoc){
	...
	$documento=busca_filtro_tabla("B.nombre_tabla,B.nombre,B.ruta_mostrar,B.idformato","documento A, formato B","A.iddocumento=".$_REQUEST["doc_relacionado"]." AND lower(A.plantilla)=lower(B.nombre)","");
	?>
	<script>
