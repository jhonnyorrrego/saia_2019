<?php include_once("../librerias/funciones_generales.php"); ?><div class="container master-container"><legend>B&Uacute;SQUEDA CIRCULAR EXTERNA</legend><input type="hidden" name="adicionar_consulta" value="1">
