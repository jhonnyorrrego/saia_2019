...
?>
 <script src="<?php echo($ruta_db_superior);?>js/jquery.js"> </script>
  <script src="<?php echo($ruta_db_superior);?>js/jquery.validate.js"> </script>
...
$GLOBALS["x_aspectos_economicos"]= @$_POST["aspectos_economicos"];
$GLOBALS["x_conclusion_economica"]= @$_POST["conclusion_economica"];
$GLOBALS["x_economico"] = @$_POST["evaluador_economico"];
...
<form name="funcionarioadd" id="funcionarioadd" action="llenar_economico.php" method="post" enctype="multipart/form-data" onSubmit="return EW_checkMyForm(this);">
<p>
...
<tr>
        <td class="encabezado_list" title="Aspectos economicos."><span class="phpmaker" style="color: #FFFFFF;">ASPECTOS ECONOMICOS*</span></td>
        <td bgcolor="#F5F5F5"><span class="phpmaker">
<textarea name="aspectos_economicos" rows="10" cols="30" class="required" ><?php echo $datos[0]["aspectos_economicos"];?></textarea>

</span></td>
    </tr>
    <tr>
        <td class="encabezado_list" title="conclusion economica."><span class="phpmaker" style="color: #FFFFFF;">CONCLUSION ECONOMICA*</span></td>
        <td bgcolor="#F5F5F5"><span class="phpmaker">
<textarea name="conclusion_economica" rows="10" cols="30" class="required"><?php echo strip_tags($datos[0]["conclusion_economica"]);?></textarea>

</span></td>
    </tr>
    <tr>
                     <td class="encabezado" width="20%" title=""><b>REASIGNAR EVALUADOR ECONOMICO*</b></td>
                     <td bgcolor="#F5F5F5">	<br /><br />
<div id="treeboxbox_evaluador_economico"></div>	<input type="hidden" name="evaluador_economico" id="evaluador_economico"  class="required" obligatorio="obligatorio"  value="" >
  ...
  <!--		
			...
			tree_evaluador_economico.enableIEImageFix(true);
			tree_evaluador_economico.enableCheckBoxes(1);
			tree_evaluador_economico.enableRadioButtons(true);			
			tree_evaluador_economico.setXMLAutoLoading("../../test.php?rol=1");
			tree_evaluador_economico.loadXML("../../test.php?rol=1");
      ...
      {valor=document.getElementById("evaluador_economico");       
       ...
       if(valor.value!="")
         ...
         valor.value=nodeId;
      document.getElementById("evaluador_economico").value=valor.value;
      }	*/
     function onNodeSelect_evaluador_economico(nodeId)
...
{  
 ...
 if($GLOBALS["x_economico"]!=""){
$economico=busca_filtro_tabla("","dependencia_cargo a, funcionario b","a.iddependencia_cargo=".$GLOBALS["x_economico"]." and a.funcionario_idfuncionario=b.idfuncionario","",$conn);

$fieldList["nombre"] = 'TRANSFERIDO';
$fieldList["fecha"] = date("Y-m-d H:i:s");
$fieldList["notas"] ="Reasignacion evaluador economico";
...
$sql="update ft_acta_evaluacion set evaluador_economico=".$GLOBALS["x_economico"]." where documento_iddocumento=".$id;

phpmkr_query($sql);
 }else{ 
  //print_r($id);
  $aspectos_economicos="'".$GLOBALS["x_aspectos_economicos"]."'";
  $conclusion_economica="'".$GLOBALS["x_conclusion_economica"]."'";
 
    
  $sql="update ft_acta_evaluacion set aspectos_economicos=".$aspectos_economicos.", conclusion_economica=".$conclusion_economica.",aprobacion_economico='APROBADO' where documento_iddocumento=".$id;
