<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Nombre del proyecto<input type="hidden" name="bksaiacondicion_g@nombre_proyecto" id="bksaiacondicion_g@nombre_proyecto" value="like_total"></b><div class="controls"><input type="text" id="nombre_proyecto" name="bqsaia_g@nombre_proyecto"><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><b>Tiempo de Duraci&oacute;n<input type="hidden" name="bksaiacondicion_g@duracion" id="bksaiacondicion_g@duracion" value="like_total"></b><div class="controls"><input type="text" id="duracion" name="bqsaia_g@duracion"></div></div><input type="hidden" name="campos_especiales" value="empresa_asociada@arbol"><input type="hidden" name="filtro_adicional" id="filtro_adicional" value=" ft_proyecto_registro_cliente g @ AND  g.documento_iddocumento=iddocumento "></body><input type="hidden" name="idbusqueda_componente" value="116">