	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">2. PROYECTO</td></tr><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(2859)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(250,2869);?></tr><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(2870)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">NOMBRE DEL PROYECTO*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='1'  type="text" size="100" id="nombre_proyecto" name="nombre_proyecto"  value="<?php echo(validar_valor_campo(2862)); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">DESCRIPCI&Oacute;N PROYECTO</td>
                     <td class="celda_transparente"><textarea  tabindex='2'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico"><?php echo(validar_valor_campo(2860)); ?></textarea></td>
                    </tr><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='4'  type="text" size="100" id="valor" name="valor"  value="<?php echo(validar_valor_campo(2865)); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">FORMA DE PAGO</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='5'  type="text" size="100" id="forma_pago" name="forma_pago"  value="<?php echo(validar_valor_campo(2866)); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">TIEMPO DE DURACI&Oacute;N*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='6'  type="text" size="100" id="duracion" name="duracion"  value="<?php echo(validar_valor_campo(2861)); ?>"></td>
                    </tr><input type="hidden" name="idft_proyecto_registro_cliente" value="<?php echo(validar_valor_campo(2867)); ?>"><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_registro_cliente"  value="<?php echo $_REQUEST["padre"]; ?>"><?php } ?><?php if($_REQUEST["anterior"]) {?><input type="hidden"  name="ft_registro_cliente"  value="<?php echo $_REQUEST["anterior"]; ?>"><?php }  else {listar_select_padres(ft_registro_cliente);} ?><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(2868)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(2871)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">ANEXOS DIGITALES</td>
                     <td class="celda_transparente"><input  tabindex='7'  type="file" maxlength="255"  class='multi'  name="anexo_formato[]" accept="<?php echo $extensiones;?>"><?php separar_miles_proyecto(250,NULL);?><input type="hidden" name="campo_descripcion" value="2862"><tr><td colspan='2'><?php submit_formato(250);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>