<html><title>.:BUSCAR RUTAS DE DISTRIBUCI&OACUTE;N:.</title><head><?php echo(librerias_jquery('1.7')); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script>
			...
			<link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/>
			</head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA RUTAS DE DISTRIBUCI&Oacute;N</td></tr><tr id="tr_fecha_ruta_distribuc"><td class="encabezado">&nbsp;<select name="condicion_fecha_ruta_distribuc" id="condicion_fecha_ruta_distribuc"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr id="tr_nombre_ruta"><td class="encabezado">&nbsp;<select name="condicion_nombre_ruta" id="condicion_nombre_ruta"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr id="tr_descripcion_ruta"><td class="encabezado">&nbsp;<select name="condicion_descripcion_ruta" id="condicion_descripcion_ruta"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">DESCRIPCI&Oacute;N RUTA</td><td class="encabezado">&nbsp;<select name="compara_descripcion_ruta" id="compara_descripcion_ruta"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                   ...
                   <a href="javascript:void(0)" onclick="tree_asignar_dependencias.findItem((document.getElementById('stext_asignar_dependencias').value),0,1)"><img src="../../botones/general/buscar.png"border="0px"></a>
                          ...
                          <br /><br />
                <div id="treeboxbox_asignar_dependencias" height="90%"></div><input type="hidden"  name="asignar_dependencias" id="asignar_dependencias"   value="" ><label style="display:none" class="error" for="asignar_dependencias">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                	...
                	--></script></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_asignar_mensajeros" id="condicion_asignar_mensajeros"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">MENSAJEROS DE LA RUTA</td><td class="encabezado">&nbsp;<select name="compara_asignar_mensajeros" id="compara_asignar_mensajeros"> <option value="LIKE|%|%">Similar</option><option value="LIKE|%|@">Inicia Con</option><option value="LIKE|@|%">Finaliza Con</option></select></td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(404,4999,'',1);?></td></tr><input type="hidden" name="campo_descripcion" value="4987"><?php submit_formato(404);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
