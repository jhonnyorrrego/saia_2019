$(function() {
    ...
    $(document)
        ...
        .on('click', '#addmessage', function() {
            top.topModal({
                url:
                    'formatos/funcionarios_ruta/adicionar_funcionarios_ruta.php',
                params: {
                    pantalla: 'padre',
                ...
                onSuccess: function(data) {
                    $.ajax({
                        ...
                        url:
                            baseUrl +
                            'formatos/ruta_distribucion/funciones_item.php',
                        dataType: 'html',
                        data: {
    ...
    $(document)
        .off('click', '#adddependence')
        .on('click', '#adddependence', function() {
            top.topModal({
                url:
                    'formatos/dependencias_ruta/adicionar_dependencias_ruta.php',
                params: {
                    pantalla: 'padre',
                    idpadre: params.documentId,
                    padre: params.fk
