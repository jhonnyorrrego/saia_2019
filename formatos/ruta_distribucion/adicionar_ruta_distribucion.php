                  ...
                  <div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                      ...
                      <div class="card card-default">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(404,4991);?></div><div class="form-group" id="tr_fecha_ruta_distribuc"><label title="">FECHA*</label><?php fecha_formato(404,4986);?></div><div class="form-group "  id="tr_nombre_ruta">
                                        ...
                                        <textarea  tabindex='2'  name="descripcion_ruta" id="descripcion_ruta" cols="53" rows="3" class="form-control"><?php echo(validar_valor_campo(4988)); ?></textarea></div></div><div class="form-group" id="tr_asignar_mensajeros">
                                ...
                                echo $arbol_8336->generar_html();?></div><?php add_edit_ruta_dist(404,NULL);?><input type="hidden" name="campo_descripcion" value="4987"><tr><td colspan='2'><?php submit_formato(404);?></td></tr></table></form></body>
      <script type="text/javascript">
      setInterval("auto_save('asignar_dependencias','ruta_distribucion')",300000);
      </script>
                        <script type="text/javascript">
