                  ...
                  <div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                      ...
                      <div class="card card-default">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(404,4991);?></div><div class="form-group" id="tr_fecha_ruta_distribuc"><label title="">FECHA*</label><?php fecha_formato(404,4986);?></div><div class="form-group "  id="tr_nombre_ruta">
                                        ...
                                        <textarea  tabindex='2'  name="descripcion_ruta" id="descripcion_ruta" cols="53" rows="3" class="form-control"><?php echo(validar_valor_campo(4988)); ?></textarea></div></div><div class="form-group" id="tr_asignar_dependencias">
                                <label title="">DEPENDENCIAS DE LA RUTA*</label><div class="form-controls"><div id="seleccionados"><?php if(isset($_REQUEST["iddoc"])){mostrar_seleccionados(404,4998,'2',$_REQUEST['iddoc']);}?></div><br/>Buscar: <input  tabindex='3'  type="text" id="stext_asignar_dependencias" width="200px" size="25" onblur="closetree_asignar_dependencias()"> <input type="hidden" id="idclosetree_asignar_dependencias">
                                ...
                                <a href="javascript:void(0)" onclick="tree_asignar_dependencias.findItem((document.getElementById('stext_asignar_dependencias').value))">
                                    <img src="../../assets/images/siguiente.png"border="0px"></a><br/><input type="hidden"  class="required"  name="asignar_dependencias" id="asignar_dependencias"   value="" ><label style="display:none" class="error" for="asignar_dependencias">Campo obligatorio.</label><div id="esperando_asignar_dependencias">
