<html><title>.:EDITAR RUTAS DE DISTRIBUCI&Oacute;N:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">RUTAS DE DISTRIBUCIÓN</td></tr><tr id="tr_dependencia">
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(404,4991,$_REQUEST['iddoc']);?></tr><tr id="tr_fecha_ruta_distribuc">
                     <td class="encabezado" width="20%" title="">FECHA*</td>
                     <?php fecha_formato(404,4986,$_REQUEST['iddoc']);?></tr><tr id="tr_nombre_ruta">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="descripcion_ruta" id="descripcion_ruta" cols="53" rows="3" class="tiny_sin_tiny"><?php echo(mostrar_valor_campo('descripcion_ruta',404,$_REQUEST['iddoc'])); ?></textarea></td>
