<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h4 class="text-black">RUTAS DE DISTRIBUCIÓN</h4></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],404,"ingresar","ANTERIOR"); ?>
