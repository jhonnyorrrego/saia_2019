<?php include_once("../librerias/funciones_generales.php"); ?><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/><div class="container master-container"><legend>B&Uacute;SQUEDA EMPRESAS INVITADAS</legend><div class="control-group"><label class="string control-label" for="empresa">Empresa y/o proveedor<input type="hidden" name="bksaiacondicion_empresa" id="bksaiacondicion_empresa" value="like"></label><div class="controls"><select multiple  maxlength="255"   id="empresa" name="empresa"  ></select><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_empresa" id="bqsaiaenlace_empresa" value="" />
                    ...
                    <script>
                     ...
                     </script><div class="control-group"><label class="string control-label" for="entrega_cotizacion">Entrega cotizaci&oacute;n<input type="hidden" name="bksaiacondicion_entrega_cotizacion" id="bksaiacondicion_entrega_cotizacion" value="like"></label><div class="controls"><?php genera_campo_listados_editar(85,1049,'',1);?><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="formato" value="empresas"><input type="hidden" name="adicionar_consulta" value="1">
