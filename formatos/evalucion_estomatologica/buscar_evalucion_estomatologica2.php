<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Evaluacion estomatologica</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="proceso_odontologico"><b>&iquest;Le han realizado alg&uacute;n procedimiento odontol&oacute;gico anteriormente?<input type="hidden" name="bksaiacondicion_g@proceso_odontologico" id="bksaiacondicion_g@proceso_odontologico" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(284,3254,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
