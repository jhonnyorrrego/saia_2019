		...
		<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
			...
			<tr<?php echo $sItemRowClass; ?>>
				...
				<td><span class="phpmaker"><a href="<?php if ((!is_null($sKey))) {
																echo "campos_formatoview.php?idformato=" . @$_REQUEST["idformato"] . "&key=" . urlencode($sKey);
															} else {
																echo "javascript:alert('Invalid Record! Key is null');";
															} ?>">Ver</a></span></td>
				<td><span class="phpmaker"><a href="<?php if ((!is_null($sKey))) {
																echo "campos_formatoedit.php?idformato=" . @$_REQUEST["idformato"] . "&key=" . urlencode($sKey);
															} else {
																echo "javascript:alert('Invalid Record! Key is null');";
															} ?>">Editar</a></span></td>
				<td><span class="phpmaker"><a href="<?php if ((!is_null($sKey))) {
																echo "campos_formatoadd.php?idformato=" . @$_REQUEST["idformato"] . "&key=" . urlencode($sKey);
															} else {
																echo "javascript:alert('Invalid Record! Key is null');";
															} ?>">Copiar</a></span></td>
				<td><span class="phpmaker"><a href="<?php if ((!is_null($sKey))) {
																echo "campos_formatodelete.php?idformato=" . @$_REQUEST["idformato"] . "&key=" . urlencode($sKey);
															} else {
																echo "javascript:alert('Invalid Record! Key is null');";
															}  ?>">Borrar</a></span></td>
				</tr>
...
<?php } ?>
	...
	function BasicSearchSQL($Keyword)
	{
		...
		if (is_numeric($sKeyword)) {
			$BasicSearchSQL .= "formato_idformato = " . $sKeyword . " OR ";
		}
		...
		if (substr($BasicSearchSQL, -4) == " OR ") {
			$BasicSearchSQL = substr($BasicSearchSQL, 0, strlen($BasicSearchSQL) - 4);
		}
	...
	function SetUpBasicSearch()
	{
		...
		if (substr($sSrchBasic, -4) == " OR ") {
			$sSrchBasic = substr($sSrchBasic, 0, strlen($sSrchBasic) - 4);
		}
		if (substr($sSrchBasic, -5) == " AND ") {
			$sSrchBasic = substr($sSrchBasic, 0, strlen($sSrchBasic) - 5);
		}
	}
	...
	function SetUpSortOrder()
	{
		...
		if (strlen(@$_GET["order"]) > 0) {
			...
			if ($sOrder == "idcampos_formato") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_idcampos_formato_Sort"] <> "") {
					$_SESSION["campos_formato_x_idcampos_formato_Sort"] = "";
				}
			}
			...
			if ($sOrder == "formato_idformato") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_formato_idformato_Sort"] <> "") {
					$_SESSION["campos_formato_x_formato_idformato_Sort"] = "";
				}
			}
			...
			if ($sOrder == "nombre") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_nombre_Sort"] <> "") {
					$_SESSION["campos_formato_x_nombre_Sort"] = "";
				}
			}
			...
			if ($sOrder == "etiqueta") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_etiqueta_Sort"] <> "") {
					$_SESSION["campos_formato_x_etiqueta_Sort"] = "";
				}
			}
			...
			if ($sOrder == "tipo_dato") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_tipo_dato_Sort"] <> "") {
					$_SESSION["campos_formato_x_tipo_dato_Sort"] = "";
				}
			}
			...
			if ($sOrder == "longitud") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_longitud_Sort"] <> "") {
					$_SESSION["campos_formato_x_longitud_Sort"] = "";
				}
			}
			...
			if ($sOrder == "obligatoriedad") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_obligatoriedad_Sort"] <> "") {
					$_SESSION["campos_formato_x_obligatoriedad_Sort"] = "";
				}
			}
			...
			if ($sOrder == "acciones") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_acciones_Sort"] <> "") {
					$_SESSION["campos_formato_x_acciones_Sort"] = "";
				}
			}
			...
			if ($sOrder == "etiqueta_html") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_etiqueta_html_Sort"] <> "") {
					$_SESSION["campos_formato_x_etiqueta_html_Sort"] = "";
				}
			}
			...
			if ($sOrder == "predeterminado") {
				...
				if (!($bCtrl) && @$_SESSION["campos_formato_x_predeterminado_Sort"] <> "") {
					$_SESSION["campos_formato_x_predeterminado_Sort"] = "";
				}
			}
			if ($bCtrl) {
	...
	function ResetCmd()
	{
		...
		if (strlen(@$_GET["cmd"]) > 0) {
			...
			if (strtoupper($sCmd) == "RESET") {
				...
				$sOrderBy = "";
				$_SESSION["campos_formato_OrderBy"] = $sOrderBy;
				if (@$_SESSION["campos_formato_x_idcampos_formato_Sort"] <> "") {
					$_SESSION["campos_formato_x_idcampos_formato_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_formato_idformato_Sort"] <> "") {
					$_SESSION["campos_formato_x_formato_idformato_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_nombre_Sort"] <> "") {
					$_SESSION["campos_formato_x_nombre_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_etiqueta_Sort"] <> "") {
					$_SESSION["campos_formato_x_etiqueta_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_tipo_dato_Sort"] <> "") {
					$_SESSION["campos_formato_x_tipo_dato_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_longitud_Sort"] <> "") {
					$_SESSION["campos_formato_x_longitud_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_obligatoriedad_Sort"] <> "") {
					$_SESSION["campos_formato_x_obligatoriedad_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_acciones_Sort"] <> "") {
					$_SESSION["campos_formato_x_acciones_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_etiqueta_html_Sort"] <> "") {
					$_SESSION["campos_formato_x_etiqueta_html_Sort"] = "";
				}
				if (@$_SESSION["campos_formato_x_predeterminado_Sort"] <> "") {
					$_SESSION["campos_formato_x_predeterminado_Sort"] = "";
				}
			}
