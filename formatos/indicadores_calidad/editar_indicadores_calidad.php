<html>
			<title>.:EDITAR INDICADOR(ES) DE CALIDAD:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">INDICADOR(ES) DE CALIDAD</td></tr><tr id="tr_dependencia">
                     ...
                     <td class="encabezado" width="20%" title="">TIPO DE INDICADOR</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(487,6188,$_REQUEST['iddoc']);?></td></tr><tr id="tr_responsable_analisis">
								<td class="encabezado" width="20%" title="Responsable del an&aacute;lisis">RESPONSABLE DEL AN&Aacute;LISIS*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(487,6189,'0',$_REQUEST['iddoc']);?></div><br/>Buscar: <input  tabindex='4'  type="text" id="stext_responsable_analisis" width="200px" size="25">
								...
								<a href="javascript:void(0)" onclick="tree_responsable_analisis.findItem((document.getElementById('stext_responsable_analisis').value))">
									<img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="2000"  class="required"  name="responsable_analisis" id="responsable_analisis"   value="<?php cargar_seleccionados(487,6189,1,$_REQUEST['iddoc']);?>" ><div id="esperando_responsable_analisis">
			...
			<td colspan='2'><?php submit_formato(487,$_REQUEST['iddoc']);?></td>
		</tr>
		</table></form>
</body>
