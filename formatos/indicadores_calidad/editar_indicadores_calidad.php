<html><title>.:EDITAR INDICADOR(ES) DE CALIDAD:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">INDICADOR(ES) DE CALIDAD</td></tr><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(487,6180,$_REQUEST['iddoc']);?></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',487,$_REQUEST['iddoc'])); ?>"><tr id="tr_dependencia_indicador">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="fuente_datos" id="fuente_datos" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('fuente_datos',487,$_REQUEST['iddoc'])); ?></textarea></td></tr><tr id="tr_objetivo_calidad_indicador">
                     <td class="encabezado" width="20%" title="Objetivo del Indicador">OBJETIVO DE CALIDAD DEL INDICADOR*</td>
                     <td class="celda_transparente"><textarea  tabindex='3'  name="objetivo_calidad_indicador" id="objetivo_calidad_indicador" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('objetivo_calidad_indicador',487,$_REQUEST['iddoc'])); ?></textarea></td></tr><tr id="tr_tipo_grafico" >
