  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                	...
                	--></script></td></tr><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4567)); ?>"><input type="hidden" name="idft_indicadores_calidad" value="<?php echo(validar_valor_campo(4568)); ?>"><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_proceso"  value="<?php echo $_REQUEST["padre"]; ?>"><?php } ?><?php if($_REQUEST["anterior"]) {?><input type="hidden"  name="ft_proceso"  value="<?php echo $_REQUEST["anterior"]; ?>"><?php }  else {listar_select_padres(ft_proceso);} ?><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4570)); ?>"><tr>
