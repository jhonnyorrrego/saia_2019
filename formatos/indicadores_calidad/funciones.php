...
if ($formulas["numcampos"]) {
	for ($i = 0; $i < $formulas["numcampos"]; $i++) {
		echo "<table width='100%' cellpadding=5 class='phpmaker'><tr class='encabezado_list'><td colspan='7'>Formula del Calculo:<br />" . $formulas[$i]["nombre"] . "</td></tr><tr class='encabezado_list'><td>Fecha</td><td>Meta</td><td>Resultado</td><td>Cumplimiento</td><td>An&aacute;lisis de Datos</td><td colspan=2></td></tr>";
		$DataSet = new pData;
