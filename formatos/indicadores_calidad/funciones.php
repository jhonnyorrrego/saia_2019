...
function formula_calculo($idformato,$iddoc){
  ...
  $texto.='<tr class="encabezado_list"><td style="font-size:10pt;">Form</td><td>Formula del calculo</td><td>Unidad</td><td>Naturaleza</td><td>Periocidad</td><td>Descripci&oacute;n de varialbes</td><td>Observaciones</td></tr>';
