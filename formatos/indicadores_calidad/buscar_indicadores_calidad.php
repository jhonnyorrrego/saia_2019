<html><title>.:BUSCAR INDICADOR(ES) DE CALIDAD:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA INDICADOR(ES) DE CALIDAD</td></tr><tr id="tr_estado"><td class="encabezado">&nbsp;<select name="condicion_estado" id="condicion_estado"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_objetivo_indicador" id="condicion_objetivo_indicador"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="Obejtivo del indicador">OBJETIVO DEL INDICADOR</td><td class="encabezado">&nbsp;<select name="compara_objetivo_indicador" id="compara_objetivo_indicador"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="objetivo_indicador" name="objetivo_indicador"></select><script>
                     $(document).ready(function() 
                      {
                      $("#objetivo_indicador").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                ...
                <div id="treeboxbox_responsable_analisis" height="90%"></div><input type="hidden" maxlength="2000"  name="responsable_analisis" id="responsable_analisis"   value="" ><label style="display:none" class="error" for="responsable_analisis">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                	...
                	--></script></td></tr><input type="hidden" name="campo_descripcion" value="4561"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><?php submit_formato(385);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
