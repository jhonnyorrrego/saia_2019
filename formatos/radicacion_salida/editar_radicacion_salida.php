  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_area_responsable.findItem(htmlentities(document.getElementById('stext_area_responsable').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_area_responsable"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_area_responsable" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="area_responsable" id="area_responsable"   value="<?php cargar_seleccionados(207,2196,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
...
--></script></td></tr><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',207,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="idft_radicacion_salida" value="<?php echo(mostrar_valor_campo('idft_radicacion_salida',207,$_REQUEST['iddoc'])); ?>"><tr>
                   ...
                   <input type="hidden" maxlength="255"  class="required"  name="persona_natural" id="persona_natural" value="<?php echo(mostrar_valor_campo('persona_natural',207,$_REQUEST['iddoc'])); ?>"><?php componente_ejecutor("2190",@$_REQUEST["iddoc"]); ?></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="descripcion_anexos" id="descripcion_anexos" cols="53" rows="3" class="tiny_sin_tiny"><?php echo(mostrar_valor_campo('descripcion_anexos',207,$_REQUEST['iddoc'])); ?></textarea></td>
