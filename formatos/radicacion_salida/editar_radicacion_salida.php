<html><title>.:EDITAR SALIDA:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">SALIDA</td></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',207,$_REQUEST['iddoc'])); ?>"><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(207,2199,$_REQUEST['iddoc']);?></tr><tr id="tr_fecha_radicacion_entrada"><td class="encabezado" width="20%" title="">FECHA DE RADICACION*</td><?php fecha_formato(207,2194,$_REQUEST['iddoc']);?></tr><tr id="tr_numero_radicado"><td class="encabezado" width="20%" title="">NUMERO DE RADICADO</td><?php mostrar_radicado_salida(207,2195,$_REQUEST['iddoc']);?></tr><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',207,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',207,$_REQUEST['iddoc'])); ?>"><tr id="tr_area_responsable">
                   ...
                   <input type="hidden" maxlength="255"  class="required"  name="persona_natural" id="persona_natural" value="<?php echo(mostrar_valor_campo('persona_natural',207,$_REQUEST['iddoc'])); ?>"><?php componente_ejecutor("2190",@$_REQUEST["iddoc"]); ?></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="descripcion_salida" id="descripcion_salida" cols="53" rows="3" class="tiny_sin_tiny required"><?php echo(mostrar_valor_campo('descripcion_salida',207,$_REQUEST['iddoc'])); ?></textarea></td></tr><tr id="tr_num_folios">
              ...
              $(document).ready(function(){
		            $("#num_folios").spin({imageBasePath:'../../images/',min:0,max:1000,interval:1});
                     ...
                     <td class="celda_transparente"><textarea  tabindex='4'  name="descripcion_anexos" id="descripcion_anexos" cols="53" rows="3" class="tiny_sin_tiny"><?php echo(mostrar_valor_campo('descripcion_anexos',207,$_REQUEST['iddoc'])); ?></textarea></td></tr><tr id="tr_tipo_mensajeria" >
                     <td class="encabezado" width="20%" title="">TIPO DE MENSAJERIA*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(207,2202,$_REQUEST['iddoc']);?></td></tr><tr id="tr_mensajeros"><td class="encabezado" width="20%" title="">MENSAJEROS</td><?php mostrar_mensajeros(207,2203,$_REQUEST['iddoc']);?></tr><input type="hidden" name="estado_radicado" value="<?php echo(mostrar_valor_campo('estado_radicado',207,$_REQUEST['iddoc'])); ?>"><?php digitalizacion_formato_salida(207,NULL,$_REQUEST['iddoc']);?><?php quitar_descripcion_salida(207,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('2191'); ?>"><input type="hidden" name="formato" value="207"><tr><td colspan='2'><?php submit_formato(207,$_REQUEST['iddoc']);?></td></tr></table></form></body>
