  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                    ...
                    </tr><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(5070)); ?>"><?php validar_devolucion_factura(237,NULL);?><input type="hidden" name="campo_descripcion" value="2669"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><input type="hidden" name="accion" value="guardar_detalle" ><tr><td colspan='2'><?php submit_formato(237);?></td></tr></table></form></body></html>