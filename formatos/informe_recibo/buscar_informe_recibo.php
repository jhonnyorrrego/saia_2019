<html><title>.:BUSCAR INFORME DE RECIBO:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA INFORME DE RECIBO</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_bien_servicio" id="condicion_bien_servicio"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_califica_servicio" id="condicion_califica_servicio"><option value="AND">Y</option><option value="OR">O</option></td>
                ...
                <div id="treeboxbox_otro_responsable" height="90%"></div><input type="hidden" maxlength="255"  name="otro_responsable" id="otro_responsable"   value="" ><label style="display:none" class="error" for="otro_responsable">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                	...
                	--></script></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_requiere_op" id="condicion_requiere_op"><option value="AND">Y</option><option value="OR">O</option></td>
