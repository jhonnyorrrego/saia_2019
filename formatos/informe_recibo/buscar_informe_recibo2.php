<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="bien_servicio"><b>Bien  o servicio<input type="hidden" name="bksaiacondicion_g@bien_servicio" id="bksaiacondicion_g@bien_servicio" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(237,2660,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
