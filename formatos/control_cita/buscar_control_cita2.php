<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend" style="font-size:9pt;">B&uacute;squeda en formato Control de cita</legend><br /><br /><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Nombre Del Paciente<input type="hidden" name="bksaiacondicion_g@nombre_paciente_control" id="bksaiacondicion_g@nombre_paciente_control" value="like_total"></b><div class="controls"><input type="text" id="nombre_paciente_control" name="bqsaia_g@nombre_paciente_control"><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><b>Descripci&oacute;n<input type="hidden" name="bksaiacondicion_g@descripcion_control_cita" id="bksaiacondicion_g@descripcion_control_cita" value="like_total"></b><div class="controls"><textarea    id="descripcion_control_cita" name="bqsaia_g@descripcion_control_cita"  style="width:500px;height:100px"></textarea></div></div><input type="hidden" name="filtro_adicional" id="filtro_adicional" value=" ft_control_cita g @ AND  g.documento_iddocumento=iddocumento "></body><input type="hidden" name="idbusqueda_componente" value="179">