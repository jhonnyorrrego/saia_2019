<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:ADICIONAR ITEM DESPACHO INGRESADOS:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><?php llama_funcion_accion(@$_REQUEST["iddoc"],407,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>formatos/librerias/funciones_item.php" enctype="multipart/form-data"><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_despacho_ingresados"  value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden"  name="idpadre"  value="<?php echo $_REQUEST["idpadre"]; ?>"><?php } ?><input type="hidden" name="ft_destino_radicacio" value="<?php echo(validar_valor_campo(5015)); ?>"><input type="hidden" name="idft_item_despacho_ingres" value="<?php echo(validar_valor_campo(5016)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(5019)); ?>"><div "form-group"><label>ACCION A SEGUIR LUEGO DE GUARDAR</label><div class="radio radio-success"><input type="radio" name="opcion_item" id="opcion_item1" value="adicionar"><label for="opcion_item1">Adicionar otro</label><input type="radio" name="opcion_item" id="opcion_item" value="terminar" checked><label for="opcion_item">Terminar</label></div></div><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="formato" value="item_despacho_ingres"><input type="hidden" name="accion" value="guardar_item" ><tr><td colspan='2'><?php submit_formato(407);?></td></tr></table></form></body>
