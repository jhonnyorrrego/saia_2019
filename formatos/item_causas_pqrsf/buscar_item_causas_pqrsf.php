<html><title>.: ITEMS ANALISIS DE CAUSAS PQRSF:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../calendario/calendario.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA ITEMS ANALISIS DE CAUSAS PQRSF</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_transferido"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_analisis_pqrsf"  value="<?php echo $_REQUEST["padre"]; ?>"><?php } ?><?php if($_REQUEST["anterior"]) {?><input type="hidden"  name="ft_analisis_pqrsf"  value="<?php echo $_REQUEST["anterior"]; ?>"><?php }  else {listar_select_padres(ft_analisis_pqrsf);} ?><tr id="tr_serie_idserie"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Items Analisis de Causas PQRSF">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
                    ...
                    </tr><tr id="tr_idft_item_causas_pqrsf"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_item_causas_pqrsf',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_item_causas_pqrsf',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_item_causas_pqrsf" id="bqsaiaenlace_idft_item_causas_pqrsf" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">ITEM_CAUSAS_PQRSF</td><input type="hidden" name="bksaiacondicion_idft_item_causas_pqrsf" id="bksaiacondicion_idft_item_causas_pqrsf" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_item_causas_pqrsf" name="idft_item_causas_pqrsf"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_item_causas_pqrsf").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_dependencia" id="bqsaiaenlace_dependencia" value="y" />
                    ...
                    </tr><tr id="tr_accion_causa"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_accion_causa',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_accion_causa',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_accion_causa" id="bqsaiaenlace_accion_causa" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">ACCION</td><input type="hidden" name="bksaiacondicion_accion_causa" id="bksaiacondicion_accion_causa" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="accion_causa" name="accion_causa"></select><script>
                     $(document).ready(function()
                      {
                      $("#accion_causa").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_responsable" id="bqsaiaenlace_responsable" value="y" />
                   ...
                   <td class="encabezado" width="20%" title="">RESPONSABLE</td><input type="hidden" name="bksaiacondicion_responsable" id="bksaiacondicion_responsable" value="like"><td bgcolor="#F5F5F5"><div id="esperando_responsable"><img src="../../imagenes/cargando.gif"></div><div id="seleccionados"><?php mostrar_seleccionados(,3685,'0',$_REQUEST['iddoc']);?></div>
		  ...
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_fecha_limite',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_fecha_limite',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_fecha_limite" id="bqsaiaenlace_fecha_limite" value="y" />
		</div>
                       <td class="encabezado" width="20%" title="">FECHA LIMITE</td><td class="encabezado">ENTRE &nbsp;</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input type="text" readonly="true"  name="fecha_limite_1" id="fecha_limite_1" tipo="fecha" value=""><?php selector_fecha("fecha_limite_1","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?>&nbsp;&nbsp; Y &nbsp;&nbsp;<input type="text" readonly="true"  name="fecha_limite_2" id="fecha_limite_2" tipo="fecha" value=""><?php selector_fecha("fecha_limite_2","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td></tr><input type="hidden" name="campo_descripcion" value="3683"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="formato" value="item_causas_pqrsf"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
