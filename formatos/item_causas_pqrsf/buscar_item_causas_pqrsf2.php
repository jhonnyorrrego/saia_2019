<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Items Analisis de Causas PQRSF</legend><br /><br /><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Accion<input type="hidden" name="bksaiacondicion_g@accion_causa" id="bksaiacondicion_g@accion_causa" value="like_total"></b><div class="controls"><input type="text" id="accion_causa" name="bqsaia_g@accion_causa"><div class="btn-group" data-toggle="buttons-radio" >
