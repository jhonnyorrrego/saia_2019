...
if (@$_REQUEST['continuar']) {
    ...
    $info=busca_filtro_tabla("d.numero,d.estado,".fecha_db_obtener("d.fecha","Y-m")." as fecha,d.ejecutor,d.pdf, ft.*","ft_correo_saia ft,documento d"," ft.documento_iddocumento=d.iddocumento and d.iddocumento=".$iddoc,"",$conn);
    $datos_anexo=array();
    ...
    $idcampos_format=busca_filtro_tabla('idcampos_formato','campos_formato','nombre like "adjunto_imagen" AND formato_idformato='.$idformato,'',$conn);
