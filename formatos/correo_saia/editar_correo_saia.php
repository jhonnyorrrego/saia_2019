  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_transferencia_correo.findItem(htmlentities(document.getElementById('stext_transferencia_correo').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_transferencia_correo"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_transferencia_correo" height="90%"></div><input type="hidden" maxlength="11"  name="transferencia_correo" id="transferencia_correo"   value="<?php cargar_seleccionados(348,4084,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                    ...
                    tree_transferencia_correo.enableRadioButtons(true);tree_transferencia_correo.setOnLoadingStart(cargando_transferencia_correo);
                      tree_transferencia_correo.setOnLoadingEnd(fin_cargando_transferencia_correo);tree_transferencia_correo.enableSmartXMLParsing(true);tree_transferencia_correo.loadXML("../../test.php?rol=1",checkear_arbol);
...
--></script></td></tr><tr>
                   ...
                   <a href="javascript:void(0)" onclick="tree_copia_correo.findItem(htmlentities(document.getElementById('stext_copia_correo').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_copia_correo"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_copia_correo" height="90%"></div><input type="hidden" maxlength="255"  name="copia_correo" id="copia_correo"   value="<?php cargar_seleccionados(348,4085,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
