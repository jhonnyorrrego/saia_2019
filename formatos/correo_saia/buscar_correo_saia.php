<html><title>.: CORREO SAIA:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../../formatos/librerias/header_formato.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA CORREO SAIA</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_asunto" id="bqsaiaenlace_asunto" value="y" />
                    ...
                    </tr><tr id="tr_fecha_oficio_entrada"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_fecha_oficio_entrada" id="bqsaiaenlace_fecha_oficio_entrada" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Fecha de entrada del oficio">FECHA OFICIO ENTRADA</td><input type="hidden" name="bksaiacondicion_fecha_oficio_entrada" id="bksaiacondicion_fecha_oficio_entrada" value="like">
                    ...
                    </tr><tr id="tr_de"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_transferencia_correo" id="bqsaiaenlace_transferencia_correo" value="y" />
                   ...
                   <td class="encabezado" width="20%" title="">TRANSFERIR</td><input type="hidden" name="bksaiacondicion_transferencia_correo" id="bksaiacondicion_transferencia_correo" value="like"><td bgcolor="#F5F5F5"><div id="esperando_transferencia_correo"><img src="../../imagenes/cargando.gif"></div><div id="seleccionados"><?php mostrar_seleccionados(,4084,'5',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_transferencia_correo.findItem((document.getElementById('stext_transferencia_correo').value),0,1)"><img src="../../botones/general/buscar.png"border="0px"></a>
                          ...
                          <br /><br /><div id="treeboxbox_transferencia_correo" height="90%"></div><input type="hidden" maxlength="11"  name="transferencia_correo" id="transferencia_correo"   value="" ><label style="display:none" class="error" for="transferencia_correo">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
		  ...
		  <input type="hidden" name="bqsaiaenlace_copia_correo" id="bqsaiaenlace_copia_correo" value="y" />
                   ...
                   <td class="encabezado" width="20%" title="">CON COPIA</td><input type="hidden" name="bksaiacondicion_copia_correo" id="bksaiacondicion_copia_correo" value="like"><td bgcolor="#F5F5F5"><div id="esperando_copia_correo"><img src="../../imagenes/cargando.gif"></div><div id="seleccionados"><?php mostrar_seleccionados(,4085,'5',$_REQUEST['iddoc']);?></div>
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="4031"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
