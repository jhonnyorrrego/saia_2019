        ...
        <table style="width: 100%;" border="1" cellspacing="0">
            <tbody>
                <tr>
                    ...
                    <td style="text-align: left;">&nbsp;<?php if (isset($_REQUEST["iddoc"])) {
                                                                mostrar_valor_campo('asunto', 348, $_REQUEST['iddoc']);
                                                            } ?></td>
                </tr>
                <tr>
                    <td class="encabezado_list" style="text-align: left;">Fecha Oficio Entrada</td>
                    <td style="text-align: left;">&nbsp;<?php if (isset($_REQUEST["iddoc"])) {
                                                                mostrar_valor_campo('fecha_oficio_entrada', 348, $_REQUEST['iddoc']);
                                                            } ?></td>
                </tr>
                <tr>
                    <td class="encabezado_list" style="text-align: left;">De</td>
                    <td style="text-align: left;">&nbsp;<?php if (isset($_REQUEST["iddoc"])) {
                                                                mostrar_valor_campo('de', 348, $_REQUEST['iddoc']);
                                                            } ?></td>
                </tr>
                <tr>
                    <td class="encabezado_list" style="text-align: left;">Para</td>
                    <td style="text-align: left;">&nbsp;<?php if (isset($_REQUEST["iddoc"])) {
                                                                mostrar_valor_campo('para', 348, $_REQUEST['iddoc']);
                                                            } ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align: left;">&nbsp;<?php if (isset($_REQUEST["iddoc"])) {
                                                                mostrar_valor_campo('comentario', 348, $_REQUEST['iddoc']);
                                                            } ?></td>
                </tr>
            </tbody>
        </table>
        <p><?php if (isset($_REQUEST["iddoc"])) {
                    mostrar_estado_proceso(348, $_REQUEST['iddoc']);
                } ?></p>
        <p><?php if (isset($_REQUEST["iddoc"])) {
                    mostrar_anexos_correo(348, $_REQUEST['iddoc']);
                } ?></p>
