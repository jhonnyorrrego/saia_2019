<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="ingresar_datos_factu" value="<?php echo(validar_valor_campo(6959)); ?>"><input type="hidden" name="fecha_datos" value="<?php echo(validar_valor_campo(6960)); ?>"><input type="hidden" name="responsable_datos_fa" value="<?php echo(validar_valor_campo(6961)); ?>"><input type="hidden" name="uid_correo" value="<?php echo(validar_valor_campo(6962)); ?>"><input type="hidden" name="buzon_correo" value="<?php echo(validar_valor_campo(6963)); ?>"><input type="hidden" name="fecha_factura" value="<?php echo(validar_valor_campo(6964)); ?>"><input type="hidden" name="cant_dias" value="<?php echo(validar_valor_campo(6965)); ?>"><input type="hidden" name="fecha_venc_fact" value="<?php echo(validar_valor_campo(6966)); ?>"><input type="hidden" name="concepto_fact" value="<?php echo(validar_valor_campo(6967)); ?>"><input type="hidden" name="valor_factura" value="<?php echo(validar_valor_campo(6968)); ?>"><input type="hidden" name="pago_desde" value="<?php echo(validar_valor_campo(6969)); ?>"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(4823)); ?>"><input type="hidden" name="idft_correo_saia" value="<?php echo(validar_valor_campo(4036)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4037)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(4039)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(4040)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(348,4038);?></div><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4030)); ?>"><div class="form-group form-group-default required"  id="tr_asunto">
                                        ...
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="asunto" name="asunto" required value="<?php echo(validar_valor_campo(4031)); ?>">
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
                                        ...
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='3'  type="text"  size="100" id="de" name="de" required value="<?php echo(validar_valor_campo(4033)); ?>">
                                       </div><div class="form-group form-group-default required"  id="tr_para">
                                        <label title="">PARA</label>
                                        <input class="form-control"   class="required"   tabindex='4'  type="text"  size="100" id="para" name="para" required value="<?php echo(validar_valor_campo(4034)); ?>">
	            ...
	            success: function(res) {
	                callback(res);
                                ...
                                <a href="javascript:void(0)" onclick="tree_copia_correo.findItem((document.getElementById('stext_copia_correo').value))">
                                    <img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="255"  name="copia_correo" id="copia_correo"   value="" ><label style="display:none" class="error" for="copia_correo">Campo obligatorio.</label><div id="esperando_copia_correo">
                                ...
                                tree_copia_correo.setOnLoadingEnd(fin_cargando_copia_correo);tree_copia_correo.setXMLAutoLoading("../../test_funcionario.php?rol=1&cargar_partes=1");tree_copia_correo.loadXML("../../test_funcionario.php?rol=1&cargar_partes=1");tree_copia_correo.setOnCheckHandler(onNodeSelect_copia_correo);
                            ...
                            if(data['error']){
                                ...
                                function cargando_copia_correo() {
                                    ...
                                    document.poppedLayer.style.display = "";
                                        ...
                                        <textarea  tabindex='6'  name="comentario" id="comentario" cols="53" rows="3" class="form-control tiny_basico"><?php echo(validar_valor_campo(4042)); ?></textarea></div></div><input type="hidden" name="anexos" value="<?php echo(validar_valor_campo(4035)); ?>"><input type="hidden" name="no_factura" value="<?php echo(validar_valor_campo(6955)); ?>"><input type="hidden" name="nit_proveedor" value="<?php echo(validar_valor_campo(6956)); ?>"><input type="hidden" name="centro_costo" value="<?php echo(validar_valor_campo(6957)); ?>"><input type="hidden" name="adjunto_imagen" value="<?php echo(validar_valor_campo(6958)); ?>"><?php recibir_datos(348,NULL);?><input type="hidden" name="campo_descripcion" value="4031"><tr><td colspan='2'><?php submit_formato(348);?></td></tr></table></form></body>
                        <script type="text/javascript">
                            $(document).ready(function() {
