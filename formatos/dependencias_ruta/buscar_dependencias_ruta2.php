<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Dependencias de la Ruta</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="fecha_item_dependenc"><b>Fecha<input type="hidden" name="bksaiacondicion_g@fecha_item_dependenc" id="bksaiacondicion_g@fecha_item_dependenc" value="date"></b></label><div class="controls">
                   <input type="text" readonly="true" style="width: 100px;" name="bqsaia_g@fecha_item_dependenc" id="fecha_item_dependenc" tipo="fecha" value=""><?php selector_fecha("fecha_item_dependenc","kformulario_saia","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></form><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_g@fecha_item_dependenc',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_g@fecha_item_dependenc',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_g@fecha_item_dependenc" id="bqsaiaenlace_g@fecha_item_dependenc" value="y" />
