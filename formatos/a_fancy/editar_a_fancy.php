<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:EDITAR FORMATO CON &Aacute;RBOL FT:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">FORMATO CON ÁRBOL FT</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],418,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="serie_idserie" value="<?php echo(mostrar_valor_campo('serie_idserie',418,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="idft_a_fancy" value="<?php echo(mostrar_valor_campo('idft_a_fancy',418,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',418,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(418,6878,$_REQUEST['iddoc']);?></div><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',418,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',418,$_REQUEST['iddoc'])); ?>"><div class="form-group form-group-default required"  id="tr_campo_texto_676046059">
                                        <label title="">CAMPO DE TEXTO</label>
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="campo_texto_676046059" name="campo_texto_676046059" required value="<?php echo(mostrar_valor_campo('campo_texto_676046059',418,$_REQUEST['iddoc'])); ?>">
                                       </div><input type="hidden" name="formato" value="418"><tr><td colspan='2'><?php submit_formato(418,$_REQUEST['iddoc']);?></td></tr></table></form></body>
