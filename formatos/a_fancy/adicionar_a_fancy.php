<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:ADICIONAR FORMATO CON &Aacute;RBOL FT:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(6873)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(6874)); ?>"><input type="hidden" name="idft_a_fancy" value="<?php echo(validar_valor_campo(6876)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(6877)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(418,6878);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(6879)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(6880)); ?>"><div class="form-group form-group-default required"  id="tr_campo_texto_676046059">
                                        <label title="">CAMPO DE TEXTO</label>
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="campo_texto_676046059" name="campo_texto_676046059" required value="<?php echo(validar_valor_campo(6896)); ?>">
                                       </div><tr><td colspan='2'><?php submit_formato(418);?></td></tr></table></form></body>
      <script type="text/javascript">
      setInterval("auto_save('arbol_fancytree_2085165938,campo_texto_676046059','a_fancy')",300000);
      </script>
                        <script type="text/javascript">
