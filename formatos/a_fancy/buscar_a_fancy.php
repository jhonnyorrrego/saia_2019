<html><title>.: FORMATO CON &AACUTE;RBOL FT:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA FORMATO CON &Aacute;RBOL FT</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Formato con &aacute;rbol FT">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
                    ...
                    </tr><tr id="tr_idft_a_fancy"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_a_fancy',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_a_fancy',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_a_fancy" id="bqsaiaenlace_idft_a_fancy" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">A_FANCY</td><input type="hidden" name="bksaiacondicion_idft_a_fancy" id="bksaiacondicion_idft_a_fancy" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_a_fancy" name="idft_a_fancy"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_a_fancy").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><tr id="tr_arbol_fancytree_2085165938"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_arbol_fancytree_2085165938',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_arbol_fancytree_2085165938',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_arbol_fancytree_2085165938" id="bqsaiaenlace_arbol_fancytree_2085165938" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">ARBOL FANCY</td><input type="hidden" name="bksaiacondicion_arbol_fancytree_2085165938" id="bksaiacondicion_arbol_fancytree_2085165938" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="arbol_fancytree_2085165938" name="arbol_fancytree_2085165938"></select><script>
                     $(document).ready(function()
                      {
                      $("#arbol_fancytree_2085165938").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><tr id="tr_campo_texto_676046059"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_campo_texto_676046059',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_campo_texto_676046059',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_campo_texto_676046059" id="bqsaiaenlace_campo_texto_676046059" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">CAMPO DE TEXTO</td><input type="hidden" name="bksaiacondicion_campo_texto_676046059" id="bksaiacondicion_campo_texto_676046059" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="campo_texto_676046059" name="campo_texto_676046059"></select><script>
                     $(document).ready(function()
                      {
                      $("#campo_texto_676046059").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><?php submit_formato(418);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
