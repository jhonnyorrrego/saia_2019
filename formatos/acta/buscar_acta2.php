<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato ACTA</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><b>Grupo que se reune<input type="hidden" name="bksaiacondicion_g@grupo_reunido" id="bksaiacondicion_g@grupo_reunido" value="like_total"></b><div class="controls"><input type="text" id="grupo_reunido" name="bqsaia_g@grupo_reunido"><div class="btn-group" data-toggle="buttons-radio" >
