<html><title>.:EDITAR MACRO PROCESO:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">MACRO PROCESO</td></tr><tr id="tr_dependencia">
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(478,6038,$_REQUEST['iddoc']);?></tr><tr id="tr_nombre">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="des_formato" id="des_formato" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('des_formato',478,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',478,$_REQUEST['iddoc'])); ?>"><tr id="tr_caracterizacion">
			...
			</div>'; ?></td></tr><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',478,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',478,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="idft_macroproceso_calidad" value="<?php echo(mostrar_valor_campo('idft_macroproceso_calidad',478,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',478,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="formato" value="478"><tr><td colspan='2'><?php submit_formato(478,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("478-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
