<html><title>.: MACRO PROCESO:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../../formatos/librerias/header_formato.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA MACRO PROCESO</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_dependencia"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                    ...
                    </tr><tr id="tr_des_formato"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_des_formato',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_des_formato',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_des_formato" id="bqsaiaenlace_des_formato" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">DESCRIPCION</td><input type="hidden" name="bksaiacondicion_des_formato" id="bksaiacondicion_des_formato" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_estado_documento" id="bqsaiaenlace_estado_documento" value="y" />
                    ...
                    </tr><tr id="tr_caracterizacion"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_caracterizacion',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_caracterizacion',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_caracterizacion" id="bqsaiaenlace_caracterizacion" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">CARACTERIZACI&Oacute;N</td><input type="hidden" name="bksaiacondicion_caracterizacion" id="bksaiacondicion_caracterizacion" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_encabezado" id="bqsaiaenlace_encabezado" value="y" />
                    ...
                    </tr><tr id="tr_idft_macroproceso_calidad"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_macroproceso_calidad',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_macroproceso_calidad',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_macroproceso_calidad" id="bqsaiaenlace_idft_macroproceso_calidad" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">MACROPROCESO_CALIDAD</td><input type="hidden" name="bksaiacondicion_idft_macroproceso_calidad" id="bksaiacondicion_idft_macroproceso_calidad" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_macroproceso_calidad" name="idft_macroproceso_calidad"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_macroproceso_calidad").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
