  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">DATOS DEL VEH&Iacute;CULO</td></tr><input type="hidden" name="idft_datos_vehiculo" value="<?php echo(mostrar_valor_campo('idft_datos_vehiculo',258,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',258,$_REQUEST['iddoc'])); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(258,2941,$_REQUEST['iddoc']);?></tr><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',258,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',258,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',258,$_REQUEST['iddoc'])); ?>"><tr>
                   ...
                   <a href="javascript:void(0)" onclick="tree_nombre_vehiculo.findItem(htmlentities(document.getElementById('stext_nombre_vehiculo').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_nombre_vehiculo"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_nombre_vehiculo" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="nombre_vehiculo" id="nombre_vehiculo"   value="<?php cargar_seleccionados(258,2932,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                    ...
                    tree_nombre_vehiculo.enableRadioButtons(true);tree_nombre_vehiculo.setOnLoadingStart(cargando_nombre_vehiculo);
                      tree_nombre_vehiculo.setOnLoadingEnd(fin_cargando_nombre_vehiculo);tree_nombre_vehiculo.enableSmartXMLParsing(true);tree_nombre_vehiculo.loadXML("../../test_serie.php?sin_padre=1&id=940&tabla=serie",checkear_arbol);
                  ...
                  vector2="<?php cargar_seleccionados(258,2932,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_nombre_vehiculo.setCheck(vector2[m],true);
                    }}
--></script></td></tr><tr>
                   ...
                   <a href="javascript:void(0)" onclick="tree_color_vehiculo.findItem(htmlentities(document.getElementById('stext_color_vehiculo').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_color_vehiculo"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_color_vehiculo" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="color_vehiculo" id="color_vehiculo"   value="<?php cargar_seleccionados(258,2934,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                    ...
                    tree_color_vehiculo.enableRadioButtons(true);tree_color_vehiculo.setOnLoadingStart(cargando_color_vehiculo);
                      tree_color_vehiculo.setOnLoadingEnd(fin_cargando_color_vehiculo);tree_color_vehiculo.enableSmartXMLParsing(true);tree_color_vehiculo.loadXML("../../test_serie.php?sin_padre=1&id=937&tabla=serie",checkear_arbol);
                  ...
                  function checkear_arbol(){
                  vector2="<?php cargar_seleccionados(258,2934,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_color_vehiculo.setCheck(vector2[m],true);
                    }}
--></script></td></tr><tr>
                     <td class="encabezado" width="20%" title="">MOTOR*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='3'  type="text" size="100" id="motor_vehiculo" name="motor_vehiculo"  value="<?php echo(mostrar_valor_campo('motor_vehiculo',258,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">SERIE / CHAS&Iacute;S*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='4'  type="text" size="100" id="serie_chasis_vehiculo" name="serie_chasis_vehiculo"  value="<?php echo(mostrar_valor_campo('serie_chasis_vehiculo',258,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">VALOR DEL VEH&Iacute;CULO*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="15"  class="required"   tabindex='5'  type="text" size="100" id="valor_vehiculo" name="valor_vehiculo"  value="<?php echo(mostrar_valor_campo('valor_vehiculo',258,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">IMAGEN DEL VEH&Iacute;CULO</td>
                     <td class="celda_transparente"><?php echo '<div class="textwrapper">
			<a href="../../anexosdigitales/anexos_documento_edit.php?key='.$_REQUEST["iddoc"].'&idformato=258&idcampo=2937" id="anexo_admin" class="highslide" onclick="return hs.htmlExpand( this, {
			objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
			</div>'; ?><?php separar_miles_valor_vehiculo(258,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('2932'); ?>"><input type="hidden" name="formato" value="258"><tr><td colspan='2'><?php submit_formato(258,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>