<?php
                    ...
                    ?>
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:ADICIONAR PRUEBA NUEVO FORMATO:.</title>
                                    <meta name="viewport"
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" class="form-horizontal" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(6705)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(6706)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(6707)); ?>"><input type="hidden" name="idft_un_formato" value="<?php echo(validar_valor_campo(6710)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(413,6711);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(6712)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(6713)); ?>"><div class="form-group" id="tr_Nombre">
                     <label title="">CAMPO DE TEXTO*</label>
                     <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text" size="100" id="Nombre" name="Nombre"  value="<?php echo(validar_valor_campo(6708)); ?>">
                    </div><div class="form-group" id="tr_link_1265888503">
                     <label title="">LINK*</label><textarea form-control cols="40" rows="3" name="link_1265888503" id="link_1265888503" maxlength="255"  class="required url" ><?php echo(validar_valor_campo(6726)); ?></textarea></div><div class="form-group" id="tr_password_117256542">
                     <label title="">PASSWORD*</label>
                     <input class="form-control"  tabindex='2'  type="password" name="password_117256542"  maxlength="255"  class="required"   value="<?php echo(validar_valor_campo(6727)); ?>">
                    </div><div class="form-group" id="tr_contador_1067652812">
                     <label title="">CONTADOR</label>
                     <input class="form-control"  maxlength="255"   tabindex='3'  type="input" id="contador_1067652812" name="contador_1067652812"  value="<?php echo(validar_valor_campo(6730)); ?>">
                    </div>
...
<div class="celda_transparente"><textarea  tabindex='4'  name="area_texto_cke" id="area_texto_cke" cols="53" rows="3" class="form-control required"><?php echo(validar_valor_campo(6861)); ?></textarea><script>
...
<div class="celda_transparente">
                     <textarea  tabindex='5'  name="textarea_tiny_1323651124" id="textarea_tiny_1323651124" cols="53" rows="3" class="form-control tiny_avanzado required"><?php echo(validar_valor_campo(6864)); ?></textarea></div></div><tr><td colspan='2'><?php submit_formato(413);?></td></tr></table></form></body>
      <script type="text/javascript">
      setInterval("auto_save('Nombre,link_1265888503,password_117256542,contador_1067652812,area_texto_cke,textarea_tiny_1323651124','un_formato')",360000);
      </script>
                		</html>