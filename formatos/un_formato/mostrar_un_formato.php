<?php if($_REQUEST["tipo"] == 5 || 0 == 0): ?><!DOCTYPE html>
                        <html>
                            <head>
                                ...
                                <meta content="" name="Cero K" /><?php include_once('../../librerias_saia.php'); ?><?php include_once('../../formatos/librerias/funciones_generales.php'); ?><?php include_once('../../class_transferencia.php'); ?><?php include_once('../../formatos/librerias/header_nuevo.php'); ?><p>Campo: <?php if(isset($_REQUEST["iddoc"])){mostrar_valor_campo('nombre',413,$_REQUEST['iddoc']);}?></p>
<p>Pass: <?php if(isset($_REQUEST["iddoc"])){mostrar_valor_campo('password',413,$_REQUEST['iddoc']);}?></p><?php include_once('../../formatos/librerias/footer_nuevo.php'); ?><?php else: ?><?php
