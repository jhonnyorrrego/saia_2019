<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="idft_un_formato" value="<?php echo(mostrar_valor_campo('idft_un_formato',413,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(413,6711,$_REQUEST['iddoc']);?></div><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',413,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',413,$_REQUEST['iddoc'])); ?>"><div class="form-group form-group-default required"  id="tr_nombre">
                                        ...
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="nombre" name="nombre" required value="<?php echo(mostrar_valor_campo('nombre',413,$_REQUEST['iddoc'])); ?>">
                                       </div><div class="form-group form-group-default required" id="tr_password">
                                        <label title="">PASSWORD*</label>
                                        <input class="form-control"  tabindex='2'  type="password" name="password" required maxlength="255"  class="required"   value="<?php echo(mostrar_valor_campo('password',413,$_REQUEST['iddoc'])); ?>">
                                       </div><input type="hidden" name="formato" value="413"><tr><td colspan='2'><?php submit_formato(413,$_REQUEST['iddoc']);?></td></tr></table></form></body>
