<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Fecha Creacion<input type="hidden" name="bksaiacondicion_g@fecha_creacion" id="bksaiacondicion_g@fecha_creacion" value="like_total"></b><div class="controls"><input type="text" id="fecha_creacion" name="bqsaia_g@fecha_creacion"><div class="btn-group" data-toggle="buttons-radio" >
