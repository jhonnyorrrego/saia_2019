	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><input  tabindex='4'  type="file" maxlength="255"  class='multi'  name="anexo_formato[]" accept="<?php echo $extensiones;?>"><tr id="tr_varios_radicados" >
