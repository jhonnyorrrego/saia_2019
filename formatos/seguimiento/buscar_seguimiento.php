<html><title>.: REPORTE DE AVANCE ACCIONES:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../../class_transferencia.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../../formatos/librerias/header_formato.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA REPORTE DE AVANCE ACCIONES</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Seguimiento Plan de Mejoramiento">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_dependencia" id="bqsaiaenlace_dependencia" value="y" />
                    ...
                    </tr><tr id="tr_idft_seguimiento"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_seguimiento',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_seguimiento',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_seguimiento" id="bqsaiaenlace_idft_seguimiento" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">SEGUIMIENTO</td><input type="hidden" name="bksaiacondicion_idft_seguimiento" id="bksaiacondicion_idft_seguimiento" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_seguimiento" name="idft_seguimiento"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_seguimiento").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><?php if($_REQUEST["padre"]) {?><input type="hidden"  name="ft_hallazgo"  value="<?php echo $_REQUEST["padre"]; ?>"><?php } ?><?php if($_REQUEST["anterior"]) {?><input type="hidden"  name="ft_hallazgo"  value="<?php echo $_REQUEST["anterior"]; ?>"><?php }  else {listar_select_padres(ft_hallazgo);} ?><tr id="tr_firma"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_encabezado" id="bqsaiaenlace_encabezado" value="y" />
                    ...
                    </tr><tr id="tr_porcentaje"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_porcentaje',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_porcentaje',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_porcentaje" id="bqsaiaenlace_porcentaje" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">PORCENTAJE</td><input type="hidden" name="bksaiacondicion_porcentaje" id="bksaiacondicion_porcentaje" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="porcentaje" name="porcentaje"></select><script>
                     $(document).ready(function()
                      {
                      $("#porcentaje").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO</td><input type="hidden" name="bksaiacondicion_estado" id="bksaiacondicion_estado" value="like_total"><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,6127,'',1,'buscar');?></td></tr><tr id="tr_logros_alcanzados"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_logros_alcanzados',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_logros_alcanzados',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_logros_alcanzados" id="bqsaiaenlace_logros_alcanzados" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">LOGROS ALCANZADOS</td><input type="hidden" name="bksaiacondicion_logros_alcanzados" id="bksaiacondicion_logros_alcanzados" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_observaciones" id="bqsaiaenlace_observaciones" value="y" />
                    ...
                    </tr><tr id="tr_evidencia_documental"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_evidencia_documental',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_evidencia_documental',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_evidencia_documental" id="bqsaiaenlace_evidencia_documental" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="Adjuntar evidencia documental">ADJUNTAR EVIDENCIA DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_evidencia_documental" id="bksaiacondicion_evidencia_documental" value="like">
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="6126,6128"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
