<html><title>.:EDITAR DISTRIBUCI&Oacute;N F&Iacute;&SHY;SICA:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">DISTRIBUCIÓN FÍ&SHY;SICA</td></tr><input type="hidden" name="fecha_recibido" value="<?php echo(mostrar_valor_campo('fecha_recibido',272,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="usuario_recibido" value="<?php echo(mostrar_valor_campo('usuario_recibido',272,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_entregado" value="<?php echo(mostrar_valor_campo('fecha_entregado',272,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="usuario_entregado" value="<?php echo(mostrar_valor_campo('usuario_entregado',272,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',272,$_REQUEST['iddoc'])); ?>"><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(272,3131,$_REQUEST['iddoc']);?></tr><tr id="tr_fecha_documento"><td class="encabezado" width="20%" title="">FECHA*</td><?php fecha_formato(272,3125,$_REQUEST['iddoc']);?></tr><tr id="tr_nombre_mensajero">
