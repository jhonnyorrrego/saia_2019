...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">MAPA DE PROCESO</td></tr><input type="hidden" name="fecha_aprobacion_rie" value="<?php echo(validar_valor_campo(4118)); ?>"><input type="hidden" name="fecha_revision_riesg" value="<?php echo(validar_valor_campo(4119)); ?>"><tr>
