...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">MAPA DE PROCESOS</td></tr><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(4863)); ?>"><input type="hidden" name="fecha_aprobacion_rie" value="<?php echo(validar_valor_campo(4118)); ?>"><input type="hidden" name="fecha_revision_riesg" value="<?php echo(validar_valor_campo(4119)); ?>"><tr>
...
',$_REQUEST['iddoc']);?></div>
                  ...
                  <!--
                   ...
                   <a href="javascript:void(0)" onclick="tree_revisado_por.findItem(htmlentities(document.getElementById('stext_revisado_por').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_revisado_por"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_revisado_por" height="90%"></div><input type="hidden" maxlength="255"  name="revisado_por" id="revisado_por"   value="" ><label style="display:none" class="error" for="revisado_por">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                	...
                	--></script></td></tr><tr>
                    <td class="encabezado" width="20%" title="Fecha en que se revis&oacute;">FECHA EN QUE SE REVIS&Oacute;</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='16'  type="text" readonly="true" name="fecha_revision"  id="fecha_revision" value="<?php echo(date("Y-m-d H:i")); ?>"><?php selector_fecha("fecha_revision","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     <td class="encabezado" width="20%" title="">MACROPROCESO</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(194,2609,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(1999)); ?>"><input type="hidden" name="campo_descripcion" value="2003,2006"><tr><td colspan='2'><?php submit_formato(194);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>