<html><title>.:ADICIONAR 5. MAPA DE PROCESOS:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><?php include_once("../../calendario/calendario.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="STYLESHEET" type="text/css" href="../../css/dhtmlXTree.css"><script type="text/javascript" src="../../anexosdigitales/multiple-file-upload/jquery.MultiFile.js"></script><?php include_once("../../anexosdigitales/funciones_archivo.php"); ?><script type="text/javascript" src="../../anexosdigitales/highslide-4.0.10/highslide/highslide-with-html.js"></script><link rel="stylesheet" type="text/css" href="../../anexosdigitales/highslide-4.0.10/highslide/highslide.css" />
  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">5. MAPA DE PROCESOS</td></tr><input type="hidden" name="fecha_aprobacion_rie" value="<?php echo(validar_valor_campo(4118)); ?>"><input type="hidden" name="fecha_revision_riesg" value="<?php echo(validar_valor_campo(4119)); ?>"><tr>
                     <td class="encabezado" width="20%" title="Vigencia del proceso">VIGENCIA</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='1'  type="text" size="100" id="vigencia" name="vigencia"  value="<?php echo(validar_valor_campo(4120)); ?>"></td>
                    </tr><tr>
                     ...
                     <td class="celda_transparente"><input  tabindex='2'  type="file" maxlength="255"  class='multi'  name="descripcion_proceso[]" accept="<?php echo $extensiones;?>"><tr>
                     <td class="encabezado" width="20%" title="Este es el alcance del proceso la delimitacion">ALCANCE*</td>
                     <td class="celda_transparente"><textarea  tabindex='3'  name="alcance" id="alcance" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(4122)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Listado Maestro de documentos">LISTADO MAESTRO UNIFICADO DE DOCUMENTOS Y REGISTROS</td>
                     <td class="celda_transparente"><input  tabindex='4'  type="file" maxlength="255"  class='multi'  name="listado_maestro_documentos[]" accept="<?php echo $extensiones;?>"><input type="hidden" name="listado_maestro_registros" value="<?php echo(validar_valor_campo(4124)); ?>"><tr>
                     <td class="encabezado" width="20%" title="Acta que se genera para aprobar el Proceso">ACTA</td>
                     <td class="celda_transparente"><input  tabindex='5'  type="file" maxlength="255"  class='multi'  name="acta[]" accept="<?php echo $extensiones;?>"><tr>
                  ...
                  <!--
                    ...
                    <td class="encabezado" width="20%" title="Fecha en que se aprob&oacute;">FECHA EN QUE SE APROB&Oacute;</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='7'  type="text" readonly="true" name="fecha_aprobacion"  id="fecha_aprobacion" value="<?php echo(date("0000-00-00 00:00")); ?>"><?php selector_fecha("fecha_aprobacion","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input    tabindex='8'  type="text" size="100" id="fecha_revision" name="fecha_revision"  value="<?php echo(validar_valor_campo(4128)); ?>"></td>
                    </tr><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='12'  type="text" size="100" id="coordenadas" name="coordenadas"  value="<?php echo(validar_valor_campo(2015)); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Nombre del proceso">NOMBRE*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='13'  type="text" size="100" id="nombre" name="nombre"  value="<?php echo(validar_valor_campo(2006)); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Hace referencia al Codigo del Proceso (Campos Alfa Numericos)">C&Oacute;DIGO</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='14'  type="text" size="100" id="codigo" name="codigo"  value="<?php echo(validar_valor_campo(2003)); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Version del Documento">VERSI&Oacute;N</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='15'  type="text" size="100" id="version" name="version"  value="<?php echo(validar_valor_campo(2007)); ?>"></td>
                    </tr><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='18'  name="objetivo" id="objetivo" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(2008)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">DESCRIPCI&Oacute;N*</td>
                     <td class="celda_transparente"><textarea  tabindex='19'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(2004)); ?></textarea></td>
                    </tr><tr>
...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(194,2001,$_REQUEST['iddoc']);?></td></tr><tr>
                     ...
                     <td class="celda_transparente"><input  tabindex='22'  type="file" maxlength="255"  class='multi'  name="anexos[]" accept="<?php echo $extensiones;?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(1999)); ?>"><input type="hidden" name="idft_proceso" value="<?php echo(validar_valor_campo(2010)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(2011)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(2013)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(2014)); ?>"><input type="hidden" name="campo_descripcion" value="2003,2006,2608"><tr><td colspan='2'><?php submit_formato(194);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>