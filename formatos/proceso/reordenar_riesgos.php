...
include_once("../../db.php");
if($_REQUEST["padre"])
{$riesgos=busca_filtro_tabla("idft_riesgos_proceso,consecutivo","ft_riesgos_proceso r,documento d","documento_iddocumento=iddocumento and d.estado<>'ELIMINADO' and ft_proceso=".$_REQUEST["padre"]." AND r.estado<>'INACTIVO'","consecutivo asc");
