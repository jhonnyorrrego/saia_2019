  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                     ...
                     <?php buscar_dependencia(194,2012,$_REQUEST['iddoc']);?></tr><tr>
                       <td class="encabezado" width="20%" title="">FECHA*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='1'  type="text" readonly="true"  class="required dateISO"  name="fecha" id="fecha" tipo="fecha" value="<?php mostrar_valor_campo('fecha',194,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><input type="hidden" name="coordenadas" value="<?php echo(mostrar_valor_campo('coordenadas',194,$_REQUEST['iddoc'])); ?>"><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='3'  type="text" size="100" id="codigo" name="codigo"  value="<?php echo(mostrar_valor_campo('codigo',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">VERSI&Oacute;N*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="11"  class="required"   tabindex='4'  type="text" size="100" id="version" name="version"  value="<?php echo(mostrar_valor_campo('version',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
...
--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='7'  name="objetivo" id="objetivo" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('objetivo',194,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">DESCRIPCI&Oacute;N*</td>
                     <td class="celda_transparente"><textarea  tabindex='8'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('descripcion',194,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">POLITICA DE OPERACION</td>
                     <td class="celda_transparente"><textarea  tabindex='9'  name="politica_operacion" id="politica_operacion" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('politica_operacion',194,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
