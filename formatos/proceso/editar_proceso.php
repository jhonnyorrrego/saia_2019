...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">MAPA DE PROCESOS</td></tr><input type="hidden" name="fecha_aprobacion_rie" value="<?php echo(mostrar_valor_campo('fecha_aprobacion_rie',194,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_revision_riesg" value="<?php echo(mostrar_valor_campo('fecha_revision_riesg',194,$_REQUEST['iddoc'])); ?>"><tr>
...
--></script></td></tr><tr>
                    <td class="encabezado" width="20%" title="Fecha en que se aprob&oacute;">FECHA EN QUE SE APROB&Oacute;</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='14'  type="text" readonly="true" name="fecha_aprobacion"  id="fecha_aprobacion" value="<?php mostrar_valor_campo('fecha_aprobacion',194,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha_aprobacion","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input    tabindex='15'  type="text" size="100" id="fecha_revision" name="fecha_revision"  value="<?php echo(mostrar_valor_campo('fecha_revision',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
...
--></script></td></tr><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='19'  type="text" size="100" id="coordenadas" name="coordenadas"  value="<?php echo(mostrar_valor_campo('coordenadas',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
