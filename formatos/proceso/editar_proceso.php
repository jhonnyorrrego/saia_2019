  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">5. MAPA DE PROCESOS</td></tr><input type="hidden" name="fecha_aprobacion_rie" value="<?php echo(mostrar_valor_campo('fecha_aprobacion_rie',194,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_revision_riesg" value="<?php echo(mostrar_valor_campo('fecha_revision_riesg',194,$_REQUEST['iddoc'])); ?>"><tr>
                     <td class="encabezado" width="20%" title="Vigencia del proceso">VIGENCIA</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='1'  type="text" size="100" id="vigencia" name="vigencia"  value="<?php echo(mostrar_valor_campo('vigencia',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
			...
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="alcance" id="alcance" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('alcance',194,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
			...
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
                   ...
                   <td class="encabezado" width="20%" title="Nombre y Cargo de quienes Aprueban el documento de Calidad">APROBADO POR</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(194,4126,'5',$_REQUEST['iddoc']);?></div>
                          <br />  Buscar: <input  tabindex='6'  type="text" id="stext_aprobado_por" width="200px" size="25"><a href="javascript:void(0)" onclick="tree_aprobado_por.findItem(htmlentities(document.getElementById('stext_aprobado_por').value),1)"> <img src="../../botones/general/anterior.png"border="0px"></a>
...
--></script></td></tr><tr>
                    <td class="encabezado" width="20%" title="Fecha en que se aprob&oacute;">FECHA EN QUE SE APROB&Oacute;</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='7'  type="text" readonly="true" name="fecha_aprobacion"  id="fecha_aprobacion" value="<?php mostrar_valor_campo('fecha_aprobacion',194,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha_aprobacion","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr>
                     <td class="encabezado" width="20%" title="Fecha en que se revis&oacute;">FECHA EN QUE SE REVIS&Oacute;</td>
                     <td bgcolor="#F5F5F5"><input    tabindex='8'  type="text" size="100" id="fecha_revision" name="fecha_revision"  value="<?php echo(mostrar_valor_campo('fecha_revision',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                   <td class="encabezado" width="20%" title="Secretarias Vinculadas ">SECRETARIAS VINCULADAS *</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(194,4129,'2',$_REQUEST['iddoc']);?></div>
                          <br />  Buscar: <input  tabindex='9'  type="text" id="stext_secretarias" width="200px" size="25"><a href="javascript:void(0)" onclick="tree_secretarias.findItem(htmlentities(document.getElementById('stext_secretarias').value),1)"> <img src="../../botones/general/anterior.png"border="0px"></a>
                   ...
                   <a href="javascript:void(0)" onclick="tree_secretarias.findItem(htmlentities(document.getElementById('stext_secretarias').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_secretarias"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_secretarias" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="secretarias" id="secretarias"   value="<?php cargar_seleccionados(194,4129,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                      ...
                      tree_secretarias.setOnLoadingEnd(fin_cargando_secretarias);tree_secretarias.enableSmartXMLParsing(true);tree_secretarias.loadXML("../arboles/test_secretarias.xml",checkear_arbol);
                  ...
                  function checkear_arbol(){
                  vector2="<?php cargar_seleccionados(194,4129,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
...
--></script></td></tr><tr>
                   <td class="encabezado" width="20%" title="">PERMISOS DE ACCESO</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(194,4130,'0',$_REQUEST['iddoc']);?></div>
                          <br />  Buscar: <input  tabindex='10'  type="text" id="stext_permisos_acceso" width="200px" size="25"><a href="javascript:void(0)" onclick="tree_permisos_acceso.findItem(htmlentities(document.getElementById('stext_permisos_acceso').value),1)"> <img src="../../botones/general/anterior.png"border="0px"></a>
...
--></script></td></tr><tr>
                     ...
                     <?php buscar_dependencia(194,2012,$_REQUEST['iddoc']);?></tr><tr>
                       <td class="encabezado" width="20%" title="">FECHA*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='11'  type="text" readonly="true"  class="required dateISO"  name="fecha" id="fecha" tipo="fecha" value="<?php mostrar_valor_campo('fecha',194,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr>
                     <td class="encabezado" width="20%" title="">COORDENADAS</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='12'  type="text" size="100" id="coordenadas" name="coordenadas"  value="<?php echo(mostrar_valor_campo('coordenadas',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Nombre del proceso">NOMBRE*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='13'  type="text" size="100" id="nombre" name="nombre"  value="<?php echo(mostrar_valor_campo('nombre',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Hace referencia al Codigo del Proceso (Campos Alfa Numericos)">C&Oacute;DIGO</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='14'  type="text" size="100" id="codigo" name="codigo"  value="<?php echo(mostrar_valor_campo('codigo',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="Version del Documento">VERSI&Oacute;N</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='15'  type="text" size="100" id="version" name="version"  value="<?php echo(mostrar_valor_campo('version',194,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                   <td class="encabezado" width="20%" title="Funcionario que queda encargado para liderar el proceso">L&Iacute;DER DEL PROCESO*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(194,2000,'5',$_REQUEST['iddoc']);?></div>
                          <br />  Buscar: <input  tabindex='16'  type="text" id="stext_lider_proceso" width="200px" size="25"><a href="javascript:void(0)" onclick="tree_lider_proceso.findItem(htmlentities(document.getElementById('stext_lider_proceso').value),1)"> <img src="../../botones/general/anterior.png"border="0px"></a>
...
--></script></td></tr><tr>
                   <td class="encabezado" width="20%" title="Responsable o responsables del Proceso">RESPONSABLE*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(194,2607,'5',$_REQUEST['iddoc']);?></div>
                          <br />  Buscar: <input  tabindex='17'  type="text" id="stext_responsable" width="200px" size="25"><a href="javascript:void(0)" onclick="tree_responsable.findItem(htmlentities(document.getElementById('stext_responsable').value),1)"> <img src="../../botones/general/anterior.png"border="0px"></a>
...
--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='18'  name="objetivo" id="objetivo" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('objetivo',194,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">DESCRIPCI&Oacute;N*</td>
                     <td class="celda_transparente"><textarea  tabindex='19'  name="descripcion" id="descripcion" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('descripcion',194,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">POLITICA DE OPERACION</td>
                     <td class="celda_transparente"><textarea  tabindex='20'  name="politica_operacion" id="politica_operacion" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('politica_operacion',194,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
...
--></script></td></tr><tr>
                     <td class="encabezado" width="20%" title="">MACROPROCESO</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(194,2609,$_REQUEST['iddoc']);?></td></tr><tr id="tr_estado" >
...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(194,2001,$_REQUEST['iddoc']);?></td></tr><tr>
			...
			objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
			</div>'; ?><input type="hidden" name="idft_proceso" value="<?php echo(mostrar_valor_campo('idft_proceso',194,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',194,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',194,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',194,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="campo_descripcion" value="<?php echo('2003,2006,2608'); ?>"><input type="hidden" name="formato" value="194"><tr><td colspan='2'><?php submit_formato(194,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>