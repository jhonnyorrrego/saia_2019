...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">PROCESO</td></tr><input type="hidden" name="fecha_aprobacion_rie" value="<?php echo(mostrar_valor_campo('fecha_aprobacion_rie',194,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_revision_riesg" value="<?php echo(mostrar_valor_campo('fecha_revision_riesg',194,$_REQUEST['iddoc'])); ?>"><tr>
