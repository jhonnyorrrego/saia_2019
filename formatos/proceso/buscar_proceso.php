<html><title>.:BUSCAR MAPA DE PROCESOS:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA MAPA DE PROCESOS</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_fecha_aprobacion_rie" id="condicion_fecha_aprobacion_rie"><option value="AND">Y</option><option value="OR">O</option></td>
