<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Fecha y Hora de Radicacion<input type="hidden" name="bksaiacondicion_g@fecha_radicacion_doc" id="bksaiacondicion_g@fecha_radicacion_doc" value="like_total"></b><div class="controls"><input type="text" id="fecha_radicacion_doc" name="bqsaia_g@fecha_radicacion_doc"><div class="btn-group" data-toggle="buttons-radio" >
