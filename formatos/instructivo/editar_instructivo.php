...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(491,6242,$_REQUEST['iddoc']);?></td></tr><?php no_permitir_adicion_formatos_acalidad(491,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('6241'); ?>"><input type="hidden" name="formato" value="491"><tr><td colspan='2'><?php submit_formato(491,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("491-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
