...
<td><?php mostrar_valor_campo('nombre',491,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado" valign="top">Documento Soporte:</td>
<td><?php mostrar_anexos_memo(491,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado">Secretarias Participantes:</td>
<td><?php mostrar_valor_campo('secretarias',491,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado">Estado</td>
<td><?php mostrar_valor_campo('estado',491,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
