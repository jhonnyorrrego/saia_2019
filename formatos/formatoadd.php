...
<p><span class="phpmaker">Crear Formato<br><br></p>
...
<input type="text" maxlength="20" name="x_nombre" id="x_nombre" class="required" value="<?php echo htmlspecialchars(@$x_nombre) ?>">
</span></td>
	</tr>
	<tr>
		<td class="encabezado"><span class="phpmaker" style="color: #FFFFFF;">Etiqueta*</span></td>
		<td bgcolor="#F5F5F5"><span class="phpmaker">
<input type="text" name="x_etiqueta" id="x_etiqueta" value="<?php echo htmlspecialchars(@$x_etiqueta) ?>" class="required">
</span></td>
	</tr>
	<tr>
...
<input type="text" name="x_librerias" id="x_librerias" value="<?php echo htmlspecialchars(@$x_librerias) ?>">
	...
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="phpmaker">
		  <input type="checkbox" name="x_item" id="x_item" value="1">Item
      ...
      <input type="checkbox" name="x_banderas[]" id="x_banderas" value="r" >Tomar el asuse nto del padre al responder<br>
...
<tr>
  ...
  <input type="radio" name="x_mostrar_pdf"  value="1" checked> Si
  <input type="radio" name="x_mostrar_pdf"  value="0" > No
	</td></tr>
  	<tr>
	<td class="encabezado">Tiempo Autoguardado (ms)*</td><td bgcolor="#F5F5F5">
  <input type="text" class="required" name="x_autoguardado" id="x_autoguardado" value="300000" > 
	</td></tr><tr>
...
?>
	...
	<tr>
		...
		<td bgcolor="#F5F5F5"><span class="phpmaker">
		<input type="checkbox" name="x_funcion_predeterminada[]" value="1">Varios responsables
		<input type="checkbox" name="x_funcion_predeterminada[]" value="2">Digitalizaci&oacute;n
...
{
  global $enter2tab,$x_autoguardado,$x_mostrar_pdf,$x_item,$x_idformato, $x_nombre, $x_etiqueta, $x_contador_idcontador, $x_ruta_mostrar, $x_ruta_editar,	$x_ruta_adicionar, $x_librerias, $x_encabezado,	$x_cuerpo, $x_pie_pagina, $x_margenes, $x_orientacion, $x_papel, $x_exportar, $x_tabla, $x_detalle, $x_cod_padre,$x_serie_idserie,$x_banderas,$x_font_size,$x_mostrar,$x_tipo_edicion,$x_firma_digital,$x_fk_categoria_formato,$x_flujo_idflujo,$x_funcion_predeterminada;
...
function crear_modulo_formato($idformato){
	...
	if($modulo_formato["numcampos"]){
		...
		if(!$submodulo_formato["numcampos"]){
          ...
          $sql="INSERT INTO modulo(nombre,tipo,imagen,etiqueta,enlace,destino,cod_padre,orden,ayuda) VALUES ('".$datos_formato[0]["nombre"]."','secundario','botones/formatos/modulo.gif','".$datos_formato[0]["etiqueta"]."','formatos/".$datos_formato[0]["ruta_mostrar"]."','centro','".$papa."','1','Permite administrar el formato ".$datos_formato[0]["etiqueta"].".')";
