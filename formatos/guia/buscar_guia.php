<html><title>.: GUIAS:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA GUIAS</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_serie_idserie"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Guias">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
                    ...
                    </tr><tr id="tr_idft_guia"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_guia',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_guia',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_guia" id="bqsaiaenlace_idft_guia" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">GUIA</td><input type="hidden" name="bksaiacondicion_idft_guia" id="bksaiacondicion_idft_guia" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_guia" name="idft_guia"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_guia").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_nombre" id="bqsaiaenlace_nombre" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Nombre de la guia ">NOMBRE</td><input type="hidden" name="bksaiacondicion_nombre" id="bksaiacondicion_nombre" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_origen_documento" id="bqsaiaenlace_origen_documento" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="">ORIGEN DOCUMENTO</td><input type="hidden" name="bksaiacondicion_origen_documento" id="bksaiacondicion_origen_documento" value="="><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,6568,'',1,'buscar');?></td></tr><tr><div class="btn-group" data-toggle="buttons-radio" >
...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO</td><input type="hidden" name="bksaiacondicion_estado" id="bksaiacondicion_estado" value="like_total"><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(,6176,'',1,'buscar');?></td></tr><input type="hidden" name="campo_descripcion" value="6175"><?php submit_formato();?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
