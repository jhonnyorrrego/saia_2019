<html><title>.:BUSCAR GUIAS:.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script>
			<link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/>
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="6175"><?php submit_formato(486);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
