...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">GUIAS</td></tr><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4361)); ?>"><input type="hidden" name="idft_guia" value="<?php echo(validar_valor_campo(4362)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4363)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(373,4364);?></tr><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(4365)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(4366)); ?>"><tr>
                     <td class="encabezado" width="20%" title="Nombre de la guia ">NOMBRE</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='1'  type="text" size="100" id="nombre" name="nombre"  value="<?php echo(validar_valor_campo(4367)); ?>"></td>
                    </tr><tr id="tr_estado" >
...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(373,4368,$_REQUEST['iddoc']);?></td></tr><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><input type="hidden" name="campo_descripcion" value="4367"><tr><td colspan='2'><?php submit_formato(373);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>