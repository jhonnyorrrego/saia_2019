...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(486,6176,$_REQUEST['iddoc']);?></td></tr><?php no_permitir_adicion_formatos_acalidad(486,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('6175'); ?>"><input type="hidden" name="formato" value="486"><tr><td colspan='2'><?php submit_formato(486,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("486-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
