  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                	...
                	--></script></td></tr><input type="hidden" name="fk_idexpediente" value="<?php echo(validar_valor_campo(3122)); ?>"><input type="hidden" name="datos_remitente" value="<?php echo(validar_valor_campo(3068)); ?>"><input type="hidden" name="identifica_afiliado" value="<?php echo(validar_valor_campo(3118)); ?>"><input type="hidden" name="fecha_inicial_verifi" value="<?php echo(validar_valor_campo(3070)); ?>"><input type="hidden" name="numero_folios_verifi" value="<?php echo(validar_valor_campo(3069)); ?>"><input type="hidden" name="numero_folios_recibi" value="<?php echo(validar_valor_campo(3119)); ?>"><tr id="tr_presenta_inconsisten" >
