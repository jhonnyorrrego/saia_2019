<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Verificaci&oacute;n de Informaci&oacute;n</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="presenta_inconsisten"><b>Presenta Inconsistencias<input type="hidden" name="bksaiacondicion_g@presenta_inconsisten" id="bksaiacondicion_g@presenta_inconsisten" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(269,3120,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
