  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_gestion_humana.findItem(htmlentities(document.getElementById('stext_gestion_humana').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_gestion_humana"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_gestion_humana" height="90%"></div><input type="hidden" maxlength="255"  name="gestion_humana" id="gestion_humana"   value="" ><label style="display:none" class="error" for="gestion_humana">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                	...
                	--></script></td></tr><tr>
                     ...
                     <?php fecha_formato(215,2316);?></tr><tr>
                    <td class="encabezado" width="20%" title="">FECHA Y HORA DE LA CITA*</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='2'  type="text" readonly="true" name="fecha_hora_cita"  class="required dateISO"  id="fecha_hora_cita" value="<?php echo(date("0000-00-00 00:00")); ?>"><?php selector_fecha("fecha_hora_cita","formulario_formatos","Y-m-d H:i",date("m"),date("Y"),"default.css","../../","AD:VALOR"); ?></span></font></td><tr>
                   ...
                   <a href="javascript:void(0)" onclick="tree_motivo_permiso.findItem(htmlentities(document.getElementById('stext_motivo_permiso').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_motivo_permiso"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_motivo_permiso" height="90%"></div><input type="hidden" maxlength="11"  name="motivo_permiso" id="motivo_permiso"   value="" ><label style="display:none" class="error" for="motivo_permiso">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                	...
                	--></script></td></tr><tr>
                     ...
                     <td bgcolor="#F5F5F5"><input    tabindex='4'  type="text" size="100" id="motivo_otro" name="motivo_otro"  value="<?php echo(validar_valor_campo(2290)); ?>"></td>
                    </tr><tr>
                    <td class="encabezado" width="20%" title="">HORA ENTRADA*</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='5'  type="text"  name="hora_entrada"  class="required"  id="hora_entrada" value=""></span></font><script type="text/javascript">
                      $(function(){
                        var now = new Date();
                        var h=(now.getHours());
                    ...
                    <td class="encabezado" width="20%" title="">HORA DE SALIDA*</td><td colspan="2" bgcolor="#F5F5F5"><font size="1,5" face="Verdana, Arial, Helvetica, sans-serif"><span ><input  tabindex='6'  type="text"  name="hora_salida"  class="required"  id="hora_salida" value=""></span></font><script type="text/javascript">
                      $(function(){
                        var now = new Date();
                        var h=(now.getHours());
                        var m=now.getMinutes();
                      ...
                      </script></td><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(2284)); ?>"><input type="hidden" name="campo_descripcion" value="2286"><tr><td colspan='2'><?php submit_formato(215);?></td></tr></table></form></body></html>