...
for($i=0;$i<$dato["numcampos"];$i++){
 ...
 if($estado[0][0]<>"ELIMINADO") 
  ...
  $texto.=strip_tags('text="'. str_replace('"','',decodifica(mostrar_valor_campo($campo[0]["nombre"],$arreglo[0],$dato[$i]["documento_iddocumento"],1))).'" id="'.$llave.'" tooltip="'.decodifica($tips)).'">';
