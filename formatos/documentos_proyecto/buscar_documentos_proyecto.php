<html><title>.:BUSCAR DOCUMENTOS DEL PROYECTO:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA DOCUMENTOS DEL PROYECTO</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_fecha_documento" id="condicion_fecha_documento"><option value="AND">Y</option><option value="OR">O</option></td>
                   ...
                   <a href="javascript:void(0)" onclick="tree_tipo_documento.findItem(htmlentities(document.getElementById('stext_tipo_documento').value),0,1)"><img src="../../botones/general/buscar.png"border="0px"></a>
                          ...
                          <br /><br />
                <div id="treeboxbox_tipo_documento" height="90%"></div><input type="hidden" maxlength="11"  name="tipo_documento" id="tipo_documento"   value="" ><label style="display:none" class="error" for="tipo_documento">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                      var browserType;
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="2912"><?php submit_formato(254);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
