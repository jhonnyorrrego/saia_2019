<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:EDITAR DESPACHO FISICO:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',352,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_despacho" value="<?php echo(mostrar_valor_campo('fecha_despacho',352,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(352,4069,$_REQUEST['iddoc']);?></div><input type="hidden" name="docs_seleccionados" value="<?php echo(mostrar_valor_campo('docs_seleccionados',352,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_mensajero">
