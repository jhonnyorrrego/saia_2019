<html><title>.: DESPACHO FISICO:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../librerias/encabezado_pie_pagina.php"); ?><?php include_once("../../pantallas/qr/librerias.php"); ?><?php include_once("funciones.php"); ?><?php echo(librerias_jquery('1.8')); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA DESPACHO FISICO</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(librerias_jquery('1.7')); ?><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_estado_documento" id="bqsaiaenlace_estado_documento" value="y" />
                    ...
                    </tr><tr id="tr_fecha_despacho"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_fecha_despacho',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_fecha_despacho',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_fecha_despacho" id="bqsaiaenlace_fecha_despacho" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">FECHA</td><input type="hidden" name="bksaiacondicion_fecha_despacho" id="bksaiacondicion_fecha_despacho" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="fecha_despacho" name="fecha_despacho"></select><script>
                     $(document).ready(function()
                      {
                      $("#fecha_despacho").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="Despacho fisico">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_mensajero" id="bqsaiaenlace_mensajero" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="">SELECCIONE MENSAJERO</td><input type="hidden" name="bksaiacondicion_mensajero" id="bksaiacondicion_mensajero" value="="><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(352,4066,'',1,'buscar');?></td></tr><tr id="tr_idft_despacho_fisico"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_despacho_fisico',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_despacho_fisico',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_despacho_fisico" id="bqsaiaenlace_idft_despacho_fisico" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">DESPACHO_FISICO</td><input type="hidden" name="bksaiacondicion_idft_despacho_fisico" id="bksaiacondicion_idft_despacho_fisico" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_despacho_fisico" name="idft_despacho_fisico"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_despacho_fisico").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="4081"><?php submit_formato(352);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
