<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:ADICIONAR DESPACHO FISICO:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h4 class="text-black">DESPACHO FISICO</h4></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],352,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(4828)); ?>"><input type="hidden" name="fecha_despacho" value="<?php echo(validar_valor_campo(4081)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(352,4069);?></div><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4064)); ?>"><input type="hidden" name="docs_seleccionados" value="<?php echo(validar_valor_campo(4065)); ?>"><div class="form-group" id="tr_mensajero">
                                        <label title="">SELECCIONE MENSAJERO</label><?php genera_campo_listados_editar(352,4066,$_REQUEST['iddoc']);?></div><input type="hidden" name="idft_despacho_fisico" value="<?php echo(validar_valor_campo(4067)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4068)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(4070)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(4071)); ?>"><?php campos_ocultos_despacho(352,NULL);?><input type="hidden" name="campo_descripcion" value="4081"><tr><td colspan='2'><?php submit_formato(352);?></td></tr></table></form></body>
