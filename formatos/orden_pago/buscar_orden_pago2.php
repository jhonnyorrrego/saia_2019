<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><b>Adicionales<input type="hidden" name="bksaiacondicion_g@adicionales_orden" id="bksaiacondicion_g@adicionales_orden" value="="></b><div class="controls"><input type="text" id="adicionales_orden" name="bqsaia_g@adicionales_orden"><div class="btn-group" data-toggle="buttons-radio" >
