<html><title>.:BUSCAR ORDEN DE PAGO:.</title><head><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA ORDEN DE PAGO</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_adicionales_orden" id="condicion_adicionales_orden"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr id="tr_urgencia_pago"><td class="encabezado">&nbsp;<select name="condicion_urgencia_pago" id="condicion_urgencia_pago"><option value="AND">Y</option><option value="OR">O</option></td>
