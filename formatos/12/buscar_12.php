<html><title>.: 12:.</title><head><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(jquery()); ?><?php echo(jquery()); ?><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA 12</td></tr><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../../formatos/librerias/estilo_formulario.php"); ?><script type="text/javascript" src="../../formatos/librerias/funciones_formatos.js"></script><?php echo(jquery()); ?><tr id="tr_estado_documento"><div class="btn-group" data-toggle="buttons-radio" >
		  ...
		  <input type="hidden" name="bqsaiaenlace_serie_idserie" id="bqsaiaenlace_serie_idserie" value="y" />
                     ...
                     <td class="encabezado" width="20%" title="12">SERIE DOCUMENTAL</td><input type="hidden" name="bksaiacondicion_serie_idserie" id="bksaiacondicion_serie_idserie" value="like">
		  ...
		  <input type="hidden" name="bqsaiaenlace_documento_iddocumento" id="bqsaiaenlace_documento_iddocumento" value="y" />
                    ...
                    </tr><tr id="tr_idft_12"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_idft_12',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_idft_12',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_idft_12" id="bqsaiaenlace_idft_12" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="Identificador unico del formato (llave primaria)">IDENTIFICADOR DE FORMATO</td><input type="hidden" name="bksaiacondicion_idft_12" id="bksaiacondicion_idft_12" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="idft_12" name="idft_12"></select><script>
                     $(document).ready(function()
                      {
                      $("#idft_12").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_firma" id="bqsaiaenlace_firma" value="y" />
                    ...
                    </tr><tr id="tr_arbol_fancytree_18416097"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_arbol_fancytree_18416097',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_arbol_fancytree_18416097',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_arbol_fancytree_18416097" id="bqsaiaenlace_arbol_fancytree_18416097" value="y" />
		</div>
                     <td class="encabezado" width="20%" title="">&Aacute;RBOL DE SELECCI&Oacute;N</td><input type="hidden" name="bksaiacondicion_arbol_fancytree_18416097" id="bksaiacondicion_arbol_fancytree_18416097" value="like">
                     <td bgcolor="#F5F5F5"><select multiple id="arbol_fancytree_18416097" name="arbol_fancytree_18416097"></select><script>
                     $(document).ready(function()
                      {
                      $("#arbol_fancytree_18416097").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
		  ...
		  <input type="hidden" name="bqsaiaenlace_dependencia" id="bqsaiaenlace_dependencia" value="y" />
                    ...
                    </tr><input type="hidden" name="campo_descripcion" value="7236"><?php submit_formato(441);?></table><?php if(@$_REQUEST["campo__retorno"]){ ?>
