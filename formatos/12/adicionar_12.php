    ...
    vertical-align: middle !important;
                  ...
                  <div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                      ...
                      <div class="card card-default">
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(7232)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(7233)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(7234)); ?>"><input type="hidden" name="idft_12" value="<?php echo(validar_valor_campo(7235)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(7238)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(7239)); ?>"><div class="form-group  " id="tr_arbol_fancytree_18416097">
                                ...
                                $extensiones_7236 = array(
                                    "filter" => array()
                                );
                                $arbol_7236 = new ArbolFt("arbol_fancytree_18416097", $origen_7236, $opciones_arbol_7236, $extensiones_7236);
                                echo $arbol_7236->generar_html();?></div><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(441,7237);?></div><input type="hidden" name="campo_descripcion" value="7236"><tr><td colspan='2'><?php submit_formato(441);?></td></tr></table></form></body>
      <script type="text/javascript">
      setInterval("auto_save('arbol_fancytree_18416097','12')",300000);
      </script>
                        <script type="text/javascript">
