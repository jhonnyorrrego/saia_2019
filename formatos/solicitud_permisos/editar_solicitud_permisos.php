<?php
                    ...
                    ?>
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><h5>SOLICITUD DE PERMISOS</h5><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" class="form-horizontal" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><div class="card-body" id="tr_etiqueta_titulo_1100262650">
...
<label class="etiqueta_campo" title="">Fecha del permiso*</label>
<div class="input-group">
<input  tabindex="1 " type="text" class="form-control"  id="fecha_permiso" name="fecha_permiso">
...
<script type="text/javascript">
            $(function () {
                ...
                $("#content_container").height($(window).height());
				                        ...
				                        <label class="etiqueta_campo" title="por favor seleccione UN permiso">Elija el tipo de permiso*</label>
                                     <?php genera_campo_listados_editar(419,6936,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_adjunte_la_prueba">
                     <label class="etiqueta_campo" title="">Adjunte la prueba</label>
                     <div class="tools">
