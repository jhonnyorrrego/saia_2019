<?php
                        ...
                        <!DOCTYPE html>
                            <html>
                                <head>
                                    ...
                                    <meta charset="utf-8" />
                                    <title>.:ADICIONAR SOLICITUD DE PERMISOS:.</title>
                                    <meta name="viewport"
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">SOLICITUD DE PERMISOS</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],419,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(6928)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(6929)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(6930)); ?>"><div id="tr_etiqueta_titulo_1100262650">
                                        <h5 title="Info general del titulo" id="etiqueta_titulo_1100262650"><label >INFORMACI&Oacute;N PRINCIPAL</label></h5>
                                      </div><input type="hidden" name="idft_solicitud_permisos" value="<?php echo(validar_valor_campo(6940)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(419,6941);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(6942)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(6943)); ?>"><hr class="border" id="etiqueta_linea_1872295254"><div id="tr_etiqueta_titulo_625604532">
                                        <h5 title="" id="etiqueta_titulo_625604532"><label ></label></h5>
                                      </div><div class="form-group" id="tr_fecha_permiso">
<label for="fecha_permiso">FECHA DEL PERMISO</label>
<label id="fecha_permiso-error" class="error" for="fecha_permiso" style="display: none;"></label>
...
</div><div class="form-group  required" id="tr_elija_el_tipo_permiso">
                            <label title="por favor seleccione UN permiso">ELIJA EL TIPO DE PERMISO*</label><?php genera_campo_listados_editar(419,6936,$_REQUEST['iddoc']);?><label id="-error" class="error" f or="elija_el_tipo_permiso" style="display: none;"></label><br></div><div class="form-group" id="tr_adjunte_la_prueba">
