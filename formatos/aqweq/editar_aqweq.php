<?php
                    ...
                    ?>
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" class="form-horizontal" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="idft_aqweq" value="<?php echo(mostrar_valor_campo('idft_aqweq',421,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label class="etiqueta_campo" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(421,6952,$_REQUEST['iddoc']);?></div><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',421,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',421,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="formato" value="421"><tr><td colspan='2'><?php submit_formato(421,$_REQUEST['iddoc']);?></td></tr></table></form></body>
