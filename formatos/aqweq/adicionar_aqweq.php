    ...
    vertical-align: middle !important;
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">AQWEQ</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],421,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(6948)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(6949)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(6950)); ?>"><input type="hidden" name="idft_aqweq" value="<?php echo(validar_valor_campo(6951)); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(421,6952);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(6953)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(6954)); ?>"><div class="form-group form-group-default "  id="tr_">
                                        <label title=""></label>
                                        <input class="form-control"  maxlength="11"   tabindex='1'  type="text"  size="100" id="" name=""  value="<?php echo(validar_valor_campo(7012)); ?>">
                                       </div><div class="form-group" id="tr_textarea_cke_1900682255">
                                        <label title="">TEXTO CON FORMATO*</label>
                                        <div class="celda_transparente"><textarea  tabindex='2'  name="textarea_cke_1900682255" id="textarea_cke_1900682255" cols="53" rows="3" class="form-control required"><?php echo(validar_valor_campo(7028)); ?></textarea><script>
                            var config = {
                            ...
                            </div></div><div class="form-group form-group-default " id="tr_moneda_302700784">
...
<input class="form-control"     tabindex="3 " type="number" id="moneda_302700784" name="moneda_302700784"  value="">
                                        ...
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='4'  type="text"  size="100" id="campo_texto_668517301" name="campo_texto_668517301" required value="<?php echo(validar_valor_campo(7030)); ?>">
                                       </div><div class="form-group  required" id="tr_arbol_fancytree_1421261091">
                                        <label title="">&Aacute;RBOL DE SELECCI&Oacute;N*</label><?php $origen_7031 = array(
                                    "url" => "arboles/arbol_funcionario.php?idcampofun=1",
                                    "ruta_db_superior" => $ruta_db_superior,"params" => array("idcampofun" => "1",),);$opciones_arbol_7031 = array(
                                ...
                                echo $arbol_7031->generar_html();?></div><div class="form-group form-group-default " id="tr_monedita">
...
</div><input type="hidden" name="campo_descripcion" value="7032"><tr><td colspan='2'><?php submit_formato(421);?></td></tr></table></form></body>
      <script type="text/javascript">
      setInterval("auto_save('textarea_cke_1900682255,moneda_302700784,campo_texto_668517301,arbol_fancytree_1421261091,monedita','aqweq')",300000);
      </script>
                        <script type="text/javascript">
