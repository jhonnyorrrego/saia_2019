...
function reporte(){
	...
	if($_REQUEST["idformato"]!='' & $_REQUEST["tipo"]!=5){
		$tabla.='<a href="'.$ruta_db_superior.'class_impresion.php?url=http://'.RUTA_PDF.'/formatos/plan_mejoramiento/reporte_hallazgos_cumplimiento.php?tipo=5|iddoc='.$iddoc.'|idformato='.$idformato.'&horizontal=1&tipo=5&landscape=horizontal" target="_blank"><img src="http://'.RUTA_PDF.'/enlaces/imprimir.gif"></a>';
	}
