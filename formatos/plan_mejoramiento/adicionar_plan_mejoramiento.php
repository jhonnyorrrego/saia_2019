<html><title>.:ADICIONAR PLAN DE MEJORAMIENTO:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><?php include_once("../../calendario/calendario.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="STYLESHEET" type="text/css" href="../../css/dhtmlXTree.css"><script type="text/javascript" src="../../anexosdigitales/multiple-file-upload/jquery.MultiFile.js"></script><?php include_once("../../anexosdigitales/funciones_archivo.php"); ?><script type="text/javascript" src="../../anexosdigitales/highslide-4.0.10/highslide/highslide-with-html.js"></script><link rel="stylesheet" type="text/css" href="../../anexosdigitales/highslide-4.0.10/highslide/highslide.css" />
  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">PLAN DE MEJORAMIENTO</td></tr><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(5268)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(5267)); ?>"><input type="hidden" name="estado_terminado" value="<?php echo(validar_valor_campo(5269)); ?>"><input type="hidden" name="fecha_elaborado" value="<?php echo(validar_valor_campo(5270)); ?>"><input type="hidden" name="fecha_aprobado" value="<?php echo(validar_valor_campo(5271)); ?>"><input type="hidden" name="fecha_revisado" value="<?php echo(validar_valor_campo(5272)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(428,5273);?></tr><tr id="tr_tipo_plan" >
                     <td class="encabezado" width="20%" title="">TIPO DE PLAN*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(428,5274,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(5275)); ?>"><input type="hidden" name="idft_plan_mejoramiento" value="<?php echo(validar_valor_campo(5276)); ?>"><tr>
                     <td class="encabezado" width="20%" title="">FECHA DE SUSCRIPCION*</td>
                     <?php fecha_formato(428,5277);?></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="descripcion_otros" id="descripcion_otros" cols="53" rows="3" class="tiny_basico"><?php echo(validar_valor_campo(5282)); ?></textarea></td>
                    </tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='4'  name="descripcion_plan" id="descripcion_plan" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5283)); ?></textarea></td>
                    </tr><input type="hidden" name="estado_plan_mejoramiento" value="<?php echo(validar_valor_campo(5284)); ?>"><tr>
                     <td class="encabezado" width="20%" title="Periodo que cubri&oacute; la auditor&iacute;a">PERIODO EVALUADO*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='5'  type="text" size="100" id="periodo_evaluado" name="periodo_evaluado"  value="<?php echo(validar_valor_campo(5286)); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">OBJETIVO GENERAL*</td>
                     <td class="celda_transparente"><textarea  tabindex='6'  name="objetivo" id="objetivo" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5287)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">OBJETIVOS ESPECIFICOS*</td>
                     <td class="celda_transparente"><textarea  tabindex='7'  name="objetivos_especificos" id="objetivos_especificos" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5288)); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">OBSERVACIONES</td>
                     <td class="celda_transparente"><textarea  tabindex='8'  name="observaciones" id="observaciones" cols="53" rows="3" class="tiny_basico"><?php echo(validar_valor_campo(5289)); ?></textarea></td>
                    </tr><tr>
                  ...
                  <!--
                	...
                	--></script></td></tr><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(5293)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(5294)); ?>"><input type="hidden" name="version" value="<?php echo(validar_valor_campo(5295)); ?>"><?php seguimiento_indicador(428,NULL);?><?php ver_campo_estado(428,NULL);?><input type="hidden" name="campo_descripcion" value="5277,5283"><tr><td colspan='2'><?php submit_formato(428);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html>