<html><title>.:EDITAR PLAN DE MEJORAMIENTO:.</title>
  ...
  $(document).ready(function() {
			...
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="descripcion_plan" id="descripcion_plan" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('descripcion_plan',480,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><input type="hidden" name="estado_plan_mejoramiento" value="<?php echo(mostrar_valor_campo('estado_plan_mejoramiento',480,$_REQUEST['iddoc'])); ?>"><tr id="tr_periodo_evaluado">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='5'  name="objetivo" id="objetivo" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('objetivo',480,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr id="tr_objetivos_especificos">
                     <td class="encabezado" width="20%" title="">OBJETIVOS ESPECIFICOS</td>
                     <td class="celda_transparente"><textarea  tabindex='6'  name="objetivos_especificos" id="objetivos_especificos" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('objetivos_especificos',480,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr id="tr_observaciones">
                     <td class="encabezado" width="20%" title="">OBSERVACIONES</td>
                     <td class="celda_transparente"><textarea  tabindex='7'  name="observaciones" id="observaciones" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('observaciones',480,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr id="tr_revisado">
