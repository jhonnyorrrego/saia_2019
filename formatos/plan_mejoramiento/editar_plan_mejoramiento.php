...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">PLAN DE MEJORAMIENTO</td></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',428,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',428,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="estado_terminado" value="<?php echo(mostrar_valor_campo('estado_terminado',428,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_elaborado" value="<?php echo(mostrar_valor_campo('fecha_elaborado',428,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_aprobado" value="<?php echo(mostrar_valor_campo('fecha_aprobado',428,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_revisado" value="<?php echo(mostrar_valor_campo('fecha_revisado',428,$_REQUEST['iddoc'])); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(428,5273,$_REQUEST['iddoc']);?></tr><tr id="tr_tipo_plan" >
                     <td class="encabezado" width="20%" title="">TIPO DE PLAN*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(428,5274,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',428,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="idft_plan_mejoramiento" value="<?php echo(mostrar_valor_campo('idft_plan_mejoramiento',428,$_REQUEST['iddoc'])); ?>"><tr>
                     <td class="encabezado" width="20%" title="">FECHA DE SUSCRIPCION*</td>
                     <?php fecha_formato(428,5277,$_REQUEST['iddoc']);?></tr><tr>
                       <td class="encabezado" width="20%" title="">FECHA RECEPCI&Oacute;N INFORME FINAL*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='1'  type="text" readonly="true"  class="required dateISO"  name="fecha_informe" id="fecha_informe" tipo="fecha" value="<?php mostrar_valor_campo('fecha_informe',428,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha_informe","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr>
                     <td class="encabezado" width="20%" title="Anexar informes auditoria">ANEXAR INFORMES AUDITORIA</td>
                     <td class="celda_transparente"><?php echo '<div class="textwrapper">
			<a href="../../anexosdigitales/anexos_documento_edit.php?key='.$_REQUEST["iddoc"].'&idformato=428&idcampo=5279" id="anexo_admin" class="highslide" onclick="return hs.htmlExpand( this, {
			objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
			</div>'; ?><tr>
                     <td class="encabezado" width="20%" title="Plan de Mejoramiento Institucional, Funcional o Individual">TIPO DE AUDITORIA*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(428,5280,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">AUDITOR*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(428,5281,$_REQUEST['iddoc']);?></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="descripcion_otros" id="descripcion_otros" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('descripcion_otros',428,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='4'  name="descripcion_plan" id="descripcion_plan" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('descripcion_plan',428,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><input type="hidden" name="estado_plan_mejoramiento" value="<?php echo(mostrar_valor_campo('estado_plan_mejoramiento',428,$_REQUEST['iddoc'])); ?>"><tr id="tr_estado" >
                     <td class="encabezado" width="20%" title="Estado Actual del Proceso :
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(428,5285,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="Periodo que cubri&oacute; la auditor&iacute;a">PERIODO EVALUADO*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='5'  type="text" size="100" id="periodo_evaluado" name="periodo_evaluado"  value="<?php echo(mostrar_valor_campo('periodo_evaluado',428,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">OBJETIVO GENERAL*</td>
                     <td class="celda_transparente"><textarea  tabindex='6'  name="objetivo" id="objetivo" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('objetivo',428,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">OBJETIVOS ESPECIFICOS*</td>
                     <td class="celda_transparente"><textarea  tabindex='7'  name="objetivos_especificos" id="objetivos_especificos" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('objetivos_especificos',428,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">OBSERVACIONES</td>
                     <td class="celda_transparente"><textarea  tabindex='8'  name="observaciones" id="observaciones" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('observaciones',428,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                   <td class="encabezado" width="20%" title="">ELABORADO POR*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(428,5290,'0',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_elaborado.findItem(htmlentities(document.getElementById('stext_elaborado').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_elaborado"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_elaborado" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="elaborado" id="elaborado"   value="<?php cargar_seleccionados(428,5290,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                  ...
                  vector2="<?php cargar_seleccionados(428,5290,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_elaborado.setCheck(vector2[m],true);
                    }}
--></script></td></tr><tr>
                   <td class="encabezado" width="20%" title="">REVISADO POR*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(428,5291,'0',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_revisado.findItem(htmlentities(document.getElementById('stext_revisado').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_revisado"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_revisado" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="revisado" id="revisado"   value="<?php cargar_seleccionados(428,5291,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                  ...
                  function checkear_arbol(){
                  vector2="<?php cargar_seleccionados(428,5291,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_revisado.setCheck(vector2[m],true);
                    }}
--></script></td></tr><tr>
                   <td class="encabezado" width="20%" title="">APROBADO POR*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(428,5292,'0',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_aprobado.findItem(htmlentities(document.getElementById('stext_aprobado').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_aprobado"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_aprobado" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="aprobado" id="aprobado"   value="<?php cargar_seleccionados(428,5292,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                  ...
                  function checkear_arbol(){
                  vector2="<?php cargar_seleccionados(428,5292,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_aprobado.setCheck(vector2[m],true);
                    }}
--></script></td></tr><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',428,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="version" value="<?php echo(mostrar_valor_campo('version',428,$_REQUEST['iddoc'])); ?>"><?php ver_campo_estado(428,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('5277,5283'); ?>"><input type="hidden" name="formato" value="428"><tr><td colspan='2'><?php submit_formato(428,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>