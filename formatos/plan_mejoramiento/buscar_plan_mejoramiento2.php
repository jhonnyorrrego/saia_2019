<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Plan de Mejoramiento</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="tipo_plan"><b>Tipo de Plan<input type="hidden" name="bksaiacondicion_g@tipo_plan" id="bksaiacondicion_g@tipo_plan" value="like_total"></b></label><div class="controls"><?php genera_campo_listados_editar(379,4459,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><b>Descripci&oacute;n Auditor Otros/Autoevaluaci&oacute;n/Retroalimentaci&oacute;n cliente.<input type="hidden" name="bksaiacondicion_g@descripcion_otros" id="bksaiacondicion_g@descripcion_otros" value="like_total"></b><div class="controls"><textarea  maxlength="3000"   id="descripcion_otros" name="bqsaia_g@descripcion_otros"  style="width:500px;height:100px"></textarea><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_g@descripcion_otros',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_g@descripcion_otros',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_g@descripcion_otros" id="bqsaiaenlace_g@descripcion_otros" value="y" />
