<?php
                    ...
                    ?>
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><h5></h5><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" class="form-horizontal" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>app/documento/class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(6798)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(6799)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(6800)); ?>"><input type="hidden" name="idft_como_quiera" value="<?php echo(validar_valor_campo(6803)); ?>"><div class="form-group" id="tr_dependencia"><label class="etiqueta_campo" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(417,6804);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(6805)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(6806)); ?>"><div class="form-group" id="tr_su_nombre">
                     <label class="etiqueta_campo" title="">Su nombre*</label>
                     <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="su_nombre" name="su_nombre"  value="<?php echo(validar_valor_campo(6802)); ?>">
                    </div><input type="hidden" name="campo_descripcion" value="6802"><tr><td colspan='2'><?php submit_formato(417);?></td></tr></table></form></body>
      <script type="text/javascript">
      setInterval("auto_save('su_nombre','como_quiera')",300000);
      </script>
                		</html>