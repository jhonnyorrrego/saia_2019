<?php
                    ...
                    ?>
                       ...
                       <form name="formulario_formatos" id="formulario_formatos" class="form-horizontal" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="estado_documento" value="<?php echo(validar_valor_campo(6798)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(6799)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(6800)); ?>"><input type="hidden" name="idft_como_quiera" value="<?php echo(validar_valor_campo(6803)); ?>"><div class="form-group" id="tr_dependencia"><label class="etiqueta_campo" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(417,6804);?></div><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(6805)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(6806)); ?>"><div class="form-group" id="tr_su_nombre">
