  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_serie.findItem(htmlentities(document.getElementById('stext_serie').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_serie"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_serie" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="serie" id="serie"   value="<?php cargar_seleccionados(306,3586,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                    ...
                    tree_serie.enableRadioButtons(true);tree_serie.setOnLoadingStart(cargando_serie);
                      tree_serie.setOnLoadingEnd(fin_cargando_serie);tree_serie.enableSmartXMLParsing(true);tree_serie.loadXML("../../test_serie.php?tabla=serie&id=1034",checkear_arbol);
...
--></script></td></tr><tr>
                   ...
                   <a href="javascript:void(0)" onclick="tree_responsable.findItem(htmlentities(document.getElementById('stext_responsable').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_responsable"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_responsable" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="responsable" id="responsable"   value="<?php cargar_seleccionados(306,3585,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
