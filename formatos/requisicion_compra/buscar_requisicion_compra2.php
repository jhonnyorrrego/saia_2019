<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../../calendario/calendario.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato requisicion orden de compra</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><b>Estado<input type="hidden" name="bksaiacondicion_g@phstat" id="bksaiacondicion_g@phstat" value="like_total"></b><div class="controls"><input type="text" id="phstat" name="bqsaia_g@phstat"><div class="btn-group" data-toggle="buttons-radio" >
