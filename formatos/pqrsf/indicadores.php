	...
	<form accept-charset="UTF-8" id="kformulario_saia"  method="post" class="form-horizontal">			
			<div class="control-group">
				<label class="string required control-label" for="rango_fecha">Seleccion un rango de fechas:
					<input type="hidden" name="bqsaia_a@fecha_x" id="bqsaia_a-fecha_x" value="">
					<input type="hidden" name="bksaiacondicion_a@fecha_x" id="bksaiacondicion_a-fecha_x" value=">=">
		      <input type="hidden" name="bqsaia_a@fecha_y" id="bqsaia_a-fecha_y" value="" >
...
moment.lang('es', {
    ...
    $('#fecha').daterangepicker({
     ...
     function(start,end){
        ...
        $('#bqsaia_a-fecha_x').val(start.format('YYYY-MM-DD'));
        $('#bqsaia_a-fecha_y').val(end.format('YYYY-MM-DD'));
     }
  );
});
</script>