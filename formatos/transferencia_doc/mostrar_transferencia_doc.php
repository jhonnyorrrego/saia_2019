...
if(
    ...
    <html>
        <head>
            ...
            <p><?php if(isset($_REQUEST["iddoc"])){expedientes_vinculados_funcion(343,$_REQUEST['iddoc']);}?>&nbsp;</p>
<p><?php if(isset($_REQUEST["iddoc"])){mostrar_estado_proceso(343,$_REQUEST['iddoc']);}?></p>
