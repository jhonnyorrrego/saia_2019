<html><title>.:BUSCAR TRANSFERENCIA DOCUMENTAL:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA TRANSFERENCIA DOCUMENTAL</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_expediente_vinculado" id="condicion_expediente_vinculado"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">EXPEDIENTE VINCULADO</td><td class="encabezado">&nbsp;<select name="compara_expediente_vinculado" id="compara_expediente_vinculado"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_unidad_admin" id="condicion_unidad_admin"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">UNIDAD ADMINISTRATIVA</td><td class="encabezado">&nbsp;<select name="compara_unidad_admin" id="compara_unidad_admin"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="unidad_admin" name="unidad_admin"></select><script>
                     $(document).ready(function() 
                      {
                      $("#unidad_admin").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     ...
                     <td class="encabezado" width="20%" title="">OFICINA PRODUCTORA</td><td class="encabezado">&nbsp;<select name="compara_oficina_productora" id="compara_oficina_productora"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="oficina_productora" name="oficina_productora"></select><script>
                     $(document).ready(function() 
                      {
                      $("#oficina_productora").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
