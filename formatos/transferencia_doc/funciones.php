	...
	*/
    ...
    if(!$expedientes['numcampos']){
        ...
        if ($pos !== false) {  //son cajas //fue encontrada
            ...
            $expedientes=busca_filtro_tabla("a.*,a.codigo as codigo_numero,a.no_consecutivo as nombre,a.no_carpeta as no_carpetas,a.idcaja as fk_idcaja","caja a","a.idcaja IN(".$ids_caja.")","",$conn);
        }    
    }	
