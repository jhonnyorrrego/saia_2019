<html><title>.:EDITAR TRANSFERENCIA DOCUMENTAL:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">TRANSFERENCIA DOCUMENTAL</td></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',343,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="idft_transferencia_doc" value="<?php echo(mostrar_valor_campo('idft_transferencia_doc',343,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',343,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',343,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',343,$_REQUEST['iddoc'])); ?>"><tr id="tr_dependencia"><td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td><?php buscar_dependencia(343,3992,$_REQUEST['iddoc']);?></tr><tr id="tr_expediente_vinculado"><td class="encabezado" width="20%" title="">TRANSFERENCIA VINCULADA*</td><?php guardar_expedientes_add(343,3995,$_REQUEST['iddoc']);?></tr><tr id="tr_oficina_productora">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="observaciones" id="observaciones" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('observaciones',343,$_REQUEST['iddoc'])); ?></textarea></td></tr><tr id="tr_anexos">
			...
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
                     ...
                     <td class="encabezado" width="20%" title="">TRANSFERIR A*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(343,4002,$_REQUEST['iddoc']);?></td></tr><?php validacion_js_transferencia(343,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('3997'); ?>"><input type="hidden" name="formato" value="343"><tr><td colspan='2'><?php submit_formato(343,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
