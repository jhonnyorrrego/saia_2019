...
<div class="celda_transparente">
                     <textarea  tabindex='2'  name="observaciones" id="observaciones" cols="53" rows="3" class="form-control tiny_basico"><?php echo(mostrar_valor_campo('observaciones',343,$_REQUEST['iddoc'])); ?></textarea></div></div><div class="form-group" id="tr_anexos">
