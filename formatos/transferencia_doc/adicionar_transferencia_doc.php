<?php
                    ...
                    ?>
                     ...
                     <label class="etiqueta_campo" title="">Observaciones</label>
<div class="celda_transparente">
                     <textarea  tabindex='2'  name="observaciones" id="observaciones" cols="53" rows="3" class="form-control tiny_basico"><?php echo(validar_valor_campo(3998)); ?></textarea></div></div><div class="form-group" id="tr_anexos">
                    ...
                    <div class="card-body no-scroll no-padding"><div id="dz_campo_3999" class="saia_dz dropzone no-margin" data-nombre-campo="anexos" data-idformato="343" data-idcampo-formato="3999" data-extensiones="<?php echo $extensiones;?>" data-multiple="unico"><div class="dz-message"><span>Arrastra el anexo hasta aqu&iacute;. </br> O si prefieres...</br></br> <span class="boton_upload">Elije un anexo para subir.</span> </span></div></div></div></div><div class="form-group" id="tr_entregado_por">
                     ...
                     <label class="etiqueta_campo" title="">Transferir a*</label><?php genera_campo_listados_editar(343,4002,$_REQUEST['iddoc']);?></div><div class="form-group" id="tr_agrupador">
                                <label class="etiqueta_campo" title="">Agrupador</label><div class="form-control"><div id="seleccionados"><?php if(isset($_REQUEST["iddoc"])){mostrar_seleccionados(343,6752,'3',$_REQUEST['iddoc']);}?></div><br/>Buscar: <input  tabindex='6'  type="text" id="stext_agrupador" width="200px" size="25" onblur="closetree_agrupador()"> <input type="hidden" id="idclosetree_agrupador">
