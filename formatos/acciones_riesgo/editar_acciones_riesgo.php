  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                   ...
                   <a href="javascript:void(0)" onclick="tree_reponsables.findItem(htmlentities(document.getElementById('stext_reponsables').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_reponsables"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_reponsables" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="reponsables" id="reponsables"   value="<?php cargar_seleccionados(395,4728,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                  ...
                  vector2="<?php cargar_seleccionados(395,4728,1,$_REQUEST['iddoc']);?>";
...
--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="acciones_accion" id="acciones_accion" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('acciones_accion',395,$_REQUEST['iddoc'])); ?></textarea></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="indicador" id="indicador" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('indicador',395,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><input type="hidden" name="idft_acciones_riesgo" value="<?php echo(mostrar_valor_campo('idft_acciones_riesgo',395,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',395,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',395,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',395,$_REQUEST['iddoc'])); ?>"><tr>
                       <td class="encabezado" width="20%" title="">FECHA DE SUSCRIPCI&Oacute;N DE LA ACCI&Oacute;N*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='4'  type="text" readonly="true"  class="required dateISO"  name="fecha_accion" id="fecha_accion" tipo="fecha" value="<?php mostrar_valor_campo('fecha_accion',395,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha_accion","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr>
                       <td class="encabezado" width="20%" title="">FECHA DE CUMPLIMIENTO*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='5'  type="text" readonly="true"  class="required dateISO"  name="fecha_cumplimiento" id="fecha_cumplimiento" tipo="fecha" value="<?php mostrar_valor_campo('fecha_cumplimiento',395,$_REQUEST['iddoc']); ?>"><?php selector_fecha("fecha_cumplimiento","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><?php validar_edicion_adicion_formatos_riesgo_aprobados(395,NULL,$_REQUEST['iddoc']);?><?php validar_opciones_administrativas(395,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('4729'); ?>"><input type="hidden" name="formato" value="395"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><input type="hidden" name="accion" value="editar" ><input type="hidden" name="item" value="<?php echo $_REQUEST["item"]; ?>" ><input type="hidden" name="anterior" value="<?php echo $_REQUEST["campo"]; ?>" ><tr><td colspan='2'><?php submit_formato(395,$_REQUEST['iddoc']);?></td></tr></table></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>