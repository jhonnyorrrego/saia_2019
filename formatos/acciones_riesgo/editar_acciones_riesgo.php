...
--></script></td></tr><tr>
                    ...
                    </tr><input type="hidden" name="idft_ft_acciones_riesgo" value="<?php echo(mostrar_valor_campo('idft_ft_acciones_riesgo',395,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',395,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',395,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',395,$_REQUEST['iddoc'])); ?>"><tr>
