<html><title>.:ADICIONAR 2. ACCIONES:.</title><head><script type="text/javascript" src="../librerias/funciones_formatos.js"></script><script type="text/javascript" src="../../js/cmxforms.js"></script><?php include_once("../riesgos_proceso/funciones.php"); ?><?php include_once("funciones.php"); ?><?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/funciones_acciones.php"); ?><?php include_once("../librerias/estilo_formulario.php"); ?><?php include_once("../librerias/header_formato.php"); ?><?php include_once("../../calendario/calendario.php"); ?><script type="text/javascript" src="../../js/jquery.js"></script><script type="text/javascript" src="../../js/jquery.validate.js"></script><script type="text/javascript" src="../../js/title2note.js"></script><script type="text/javascript" src="../../js/dhtmlXCommon.js"></script><script type="text/javascript" src="../../js/dhtmlXTree.js"></script><link rel="STYLESHEET" type="text/css" href="../../css/dhtmlXTree.css"><script type='text/javascript'>
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                     ...
                     <td class="celda_transparente"><textarea  tabindex='1'  name="acciones_accion" id="acciones_accion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(6414)); ?></textarea></td>
...
Si va a establecer una Acci&oacute;n sobre un control existente por favor seleccionelo de la lista desplegable. Si se requiere un Nuevo Control, favor seleccione esta opci&oacute;n.">CONTROL*</td>
                     <?php control_funcion(501,6415);?></tr><tr id="tr_fecha_accion">
                       <td class="encabezado" width="20%" title="">FECHA DE SUSCRIPCION DE LA ACCION*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='2'  type="text" readonly="true"  class="required dateISO"  name="fecha_accion" id="fecha_accion" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_accion","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr id="tr_fecha_cumplimiento">
                       <td class="encabezado" width="20%" title="">FECHA DE CUMPLIMIENTO*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='3'  type="text" readonly="true"  class="required dateISO"  name="fecha_cumplimiento" id="fecha_cumplimiento" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_cumplimiento","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><tr id="tr_indicador">
...
Resultados obtenidos en la medici&oacute;n del indicador, para evaluar el cumplimiento de las acciones de control.">INDICADOR*</td>
                     <td class="celda_transparente"><textarea  tabindex='4'  name="indicador" id="indicador" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(6418)); ?></textarea></td>
