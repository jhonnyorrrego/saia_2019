	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                	...
                	--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="acciones_accion" id="acciones_accion" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5387)); ?></textarea></td>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='3'  name="indicador" id="indicador" cols="53" rows="3" class="tiny_basico required"><?php echo(validar_valor_campo(5389)); ?></textarea></td>
                    </tr><input type="hidden" name="idft_ft_acciones_riesgo" value="<?php echo(validar_valor_campo(5390)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(5391)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(5392)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(5394)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(5395)); ?>"><tr>
                       ...
                       <td class="encabezado" width="20%" title="">FECHA DE CUMPLIMIENTO*</td><td colspan="2" bgcolor="#F5F5F5"><span class="phpmaker"><input  tabindex='5'  type="text" readonly="true"  class="required dateISO"  name="fecha_cumplimiento" id="fecha_cumplimiento" tipo="fecha" value="<?php echo(date("0000-00-00")); ?>"><?php selector_fecha("fecha_cumplimiento","formulario_formatos","Y-m-d",date("m"),date("Y"),"default.css","../../","AD:VALOR","VENTANA",FALSE,FALSE); ?></span></font></td><?php validar_edicion_adicion_formatos_riesgo_aprobados(433,NULL);?><?php validar_entrada_acciones_riesgo(433,NULL);?><?php validar_opciones_administrativas(433,NULL);?><?php validar_revision_aprobacion_acciones_riesgo(433,NULL);?><input type="hidden" name="campo_descripcion" value="5387"><input type="hidden" name="padre" value="<?php echo $_REQUEST["padre"]; ?>"><input type="hidden" name="anterior" value="<?php echo $_REQUEST["anterior"]; ?>"><input type="hidden" name="accion" value="guardar_detalle" ><tr><td colspan='2'><?php submit_formato(433);?></td></tr></table></form></body></html>