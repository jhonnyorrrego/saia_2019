  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
                  ...
                  <!--
                    ...
                    </tr><input type="hidden" name="idft_ft_acciones_riesgo" value="<?php echo(validar_valor_campo(4732)); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(validar_valor_campo(4733)); ?>"><input type="hidden" name="firma" value="<?php echo(validar_valor_campo(4734)); ?>"><input type="hidden" name="serie_idserie" value="<?php echo(validar_valor_campo(4736)); ?>"><input type="hidden" name="encabezado" value="<?php echo(validar_valor_campo(4737)); ?>"><tr>
