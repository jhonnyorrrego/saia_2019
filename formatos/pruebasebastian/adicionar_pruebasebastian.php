<?php
                    ...
                    ?>
                     ...
                     <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="campo_texto_1220423661" name="campo_texto_1220423661"  value="<?php echo(validar_valor_campo(7083)); ?>">
