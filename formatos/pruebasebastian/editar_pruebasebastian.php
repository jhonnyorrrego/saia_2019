<?php
                	...
                	<div class="container-fluid container-fixed-lg col-lg-8" style="overflow: auto;" id="content_container">
                    	...
                    	<div class="card card-default">
                            <div class="card-body"><center><h5 class="text-black">PRUEBA_SEBASTIAN</h5></center><?php llama_funcion_accion(@$_REQUEST["iddoc"],427,"ingresar","ANTERIOR"); ?>
                       <form name="formulario_formatos" id="formulario_formatos" role="form" autocomplete="off" method="post" action="<?= $ruta_db_superior ?>class_transferencia.php"" enctype="multipart/form-data"><input type="hidden" name="idft_pruebasebastian" value="<?php echo(mostrar_valor_campo('idft_pruebasebastian',427,$_REQUEST['iddoc'])); ?>"><div class="form-group" id="tr_dependencia"><label title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</label><?php buscar_dependencia(427,7085,$_REQUEST['iddoc']);?></div><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',427,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',427,$_REQUEST['iddoc'])); ?>"><div class="form-group form-group-default required"  id="tr_campo_texto_1220423661">
                                        <label title="">TEXTO EN UNA L&Iacute;NEA</label>
                                        <input class="form-control"  maxlength="255"  class="required"   tabindex='1'  type="text"  size="100" id="campo_texto_1220423661" name="campo_texto_1220423661" required value="<?php echo(mostrar_valor_campo('campo_texto_1220423661',427,$_REQUEST['iddoc'])); ?>">
                                       </div><div id="tr_etiqueta_titulo_1857734299">
                                        <h5 title="" id="etiqueta_titulo_1857734299"><label ></label></h5>
                                      </div><div id="tr_etiqueta_titulo_915487093">
                                        <h5 title="" id="etiqueta_titulo_915487093"><label ></label></h5>
                                      </div><p id="etiqueta_parrafo_1504496047"></p><input type="hidden" name="formato" value="427"><tr><td colspan='2'><?php submit_formato(427,$_REQUEST['iddoc']);?></td></tr></table></form></body>
