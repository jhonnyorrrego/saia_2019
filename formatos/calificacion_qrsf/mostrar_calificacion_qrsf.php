<?php include_once("../../librerias_saia.php"); ?>
			...
			<?php include_once("../librerias/funciones_cliente.php"); ?>
			<?php include_once("../librerias/header_nuevo.php"); ?>
			<tr><td><table class="table table-bordered" style="; width: 100%;" border="0">
<tbody>
<tr>
...
<p>&nbsp;</p>
<p><?php mostrar_estado_proceso(342,$_REQUEST['iddoc']);?></p></td></tr><?php include_once("../librerias/footer_nuevo.php"); ?>
