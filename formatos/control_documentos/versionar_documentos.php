	...
	if($datos_documento_calidad[0]['iddocumento']){		
		...
		if(file_exists($ruta_db_superior.$nuevo_anexo[0]['ruta'])){
			...
			if(phpmkr_insert_id()){					
				...
				curl_setopt($ch, CURLOPT_URL, "http://intranet.risaralda.gov.co:100/Apps/SAIA/CEROK2_PRUEBAS/saia/versionamiento/crear_version.php?key=".$datos_documento_calidad[0]['iddocumento']."&no_menu=1&no_redirecciona=1&eliminar_anexo=".$anexo[0]['idanexos']);
