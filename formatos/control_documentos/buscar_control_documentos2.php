<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Solicitud de elaboraci&Atilde;&sup3;n, modificaci&Atilde;&sup3;n, eliminaci&Atilde;&sup3;n de documentos</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="tipo_solicitud"><b>tipo solicitud<input type="hidden" name="bksaiacondicion_g@tipo_solicitud" id="bksaiacondicion_g@tipo_solicitud" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(388,4597,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
