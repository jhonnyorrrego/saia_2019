<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Solicitud de elaboracion, modificacion, eliminacion de documentos</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><b>Serie documental<input type="hidden" name="bksaiacondicion_g@serie_doc_control" id="bksaiacondicion_g@serie_doc_control" value="like_total"></b><div class="controls"><input type="text" id="serie_doc_control" name="bqsaia_g@serie_doc_control"><div class="btn-group" data-toggle="buttons-radio" >
		  <!--button type="button" class="btn btn-mini" data-toggle="button" id="y" onclick="llenar_valor('bqsaiaenlace_g@serie_doc_control',this.id)">
		    Y
		  </button>
		  <button type="button" class="btn btn-mini" data-toggle="button" id="o" onclick="llenar_valor('bqsaiaenlace_g@serie_doc_control',this.id)">
		    O
		  </button-->
		  <input type="hidden" name="bqsaiaenlace_g@serie_doc_control" id="bqsaiaenlace_g@serie_doc_control" value="y" />
		</div></div></div><div class="control-group"><label class="string control-label" style="font-size:9pt" for="tipo_solicitud"><b>tipo solicitud<input type="hidden" name="bksaiacondicion_g@tipo_solicitud" id="bksaiacondicion_g@tipo_solicitud" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(378,4430,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><b>version<input type="hidden" name="bksaiacondicion_g@version" id="bksaiacondicion_g@version" value="="></b><div class="controls"><input type="text" id="version" name="bqsaia_g@version"><div class="btn-group" data-toggle="buttons-radio" >
