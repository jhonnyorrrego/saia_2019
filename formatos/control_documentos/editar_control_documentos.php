...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">SOLICITUD DE ELABORACI&Atilde;&SUP3;N, MODIFICACI&Atilde;&SUP3;N, ELIMINACI&Atilde;&SUP3;N DE DOCUMENTOS</td></tr><input type="hidden" name="idformato_calidad" value="<?php echo(mostrar_valor_campo('idformato_calidad',388,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="iddocumento_calidad" value="<?php echo(mostrar_valor_campo('iddocumento_calidad',388,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_aprobacion" value="<?php echo(mostrar_valor_campo('fecha_aprobacion',388,$_REQUEST['iddoc'])); ?>"><tr>
