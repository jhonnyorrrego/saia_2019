  ...
  $().ready(function() {
	...
	$('#formulario_formatos').validate();
...
</script> </head><body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">SOLICITUD DE ELABORACION, MODIFICACION, ELIMINACION DE DOCUMENTOS</td></tr><input type="hidden" name="idformato_calidad" value="<?php echo(mostrar_valor_campo('idformato_calidad',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="iddocumento_calidad" value="<?php echo(mostrar_valor_campo('iddocumento_calidad',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_aprobacion" value="<?php echo(mostrar_valor_campo('fecha_aprobacion',378,$_REQUEST['iddoc'])); ?>"><tr>
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(378,4427,$_REQUEST['iddoc']);?></tr><tr>
                     <td class="encabezado" width="20%" title="">SERIE DOCUMENTAL*</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"  class="required"   tabindex='1'  type="text" size="100" id="serie_doc_control" name="serie_doc_control"  value="<?php echo(mostrar_valor_campo('serie_doc_control',378,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr id="tr_tipo_solicitud" >
                     <td class="encabezado" width="20%" title="">TIPO SOLICITUD*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(378,4430,$_REQUEST['iddoc']);?></td></tr><tr>
                   <td class="encabezado" width="20%" title="">SECRETARIA</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(378,4431,'2',$_REQUEST['iddoc']);?></div>
                          <br />  Buscar: <input  tabindex='2'  type="text" id="stext_secretaria" width="200px" size="25"><a href="javascript:void(0)" onclick="tree_secretaria.findItem(htmlentities(document.getElementById('stext_secretaria').value),1)"> <img src="../../botones/general/anterior.png"border="0px"></a>
                   ...
                   <a href="javascript:void(0)" onclick="tree_secretaria.findItem(htmlentities(document.getElementById('stext_secretaria').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_secretaria"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_secretaria" height="90%"></div><input type="hidden" maxlength="255"  name="secretaria" id="secretaria"   value="<?php cargar_seleccionados(378,4431,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      ...
                      tree_secretaria.setOnLoadingEnd(fin_cargando_secretaria);tree_secretaria.enableSmartXMLParsing(true);tree_secretaria.loadXML("../../test_secretarias_fondos.php?no_fondos=1&tabla=dependencia&condicion=tipo=1",checkear_arbol);
                  ...
                  vector2="<?php cargar_seleccionados(378,4431,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_secretaria.setCheck(vector2[m],true);
                    }}
--></script></td></tr><tr id="tr_origen_documento" >
                     <td class="encabezado" width="20%" title="">ORIGEN DOCUMENTO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(378,4432,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">VERSION</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="11"   tabindex='3'  type="text" size="100" id="version" name="version"  value="<?php echo(mostrar_valor_campo('version',378,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">VIGENCIA</td>
                     <td bgcolor="#F5F5F5"><input  maxlength="255"   tabindex='4'  type="text" size="100" id="vigencia" name="vigencia"  value="<?php echo(mostrar_valor_campo('vigencia',378,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr id="tr_tipo_documento" >
                     <td class="encabezado" width="20%" title="">TIPO DOCUMENTO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(378,4435,$_REQUEST['iddoc']);?></td></tr><tr id="tr_otros_documentos" >
                     <td class="encabezado" width="20%" title="">OTROS DOCUMENTOS</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(378,4436,$_REQUEST['iddoc']);?></td></tr><tr>
                  <td class="encabezado" width="20%" title="">ALMACENAMIENTO</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(378,4437,$_REQUEST['iddoc']);?></td></tr><tr>
                     <td class="encabezado" width="20%" title="">NOMBRE DOCUMENTO*</td>
                     <td bgcolor="#F5F5F5"><input   class="required"   tabindex='5'  type="text" size="100" id="nombre_documento" name="nombre_documento"  value="<?php echo(mostrar_valor_campo('nombre_documento',378,$_REQUEST['iddoc'])); ?>"></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">PROCESO/SUBPROCESO*</td>
                     <?php listar_macroprocesos_and_procesos(378,4439,$_REQUEST['iddoc']);?></tr><tr>
                   <td class="encabezado" width="20%" title="">DOCUMENTO DE CALIDAD VINCULADO*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(378,4440,'2',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_documento_calidad.findItem(htmlentities(document.getElementById('stext_documento_calidad').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_documento_calidad"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_documento_calidad" height="90%"></div><input type="hidden"  class="required"  name="documento_calidad" id="documento_calidad"   value="<?php cargar_seleccionados(378,4440,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                  ...
                  function checkear_arbol(){
                  vector2="<?php cargar_seleccionados(378,4440,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
...
--></script></td></tr><tr>
                     ...
                     <td class="celda_transparente"><textarea  tabindex='7'  name="justificacion" id="justificacion" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('justificacion',378,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">PROPUESTA*</td>
                     <td class="celda_transparente"><textarea  tabindex='8'  name="propuesta" id="propuesta" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('propuesta',378,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr>
                     <td class="encabezado" width="20%" title="">ANEXO FORMATO</td>
                     <td class="celda_transparente"><?php echo '<div class="textwrapper">
			<a href="../../anexosdigitales/anexos_documento_edit.php?key='.$_REQUEST["iddoc"].'&idformato=378&idcampo=4443" id="anexo_admin" class="highslide" onclick="return hs.htmlExpand( this, {
			objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
			</div>'; ?><tr>
                   <td class="encabezado" width="20%" title="">REVISADO POR*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(378,4444,'0',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_revisado.findItem(htmlentities(document.getElementById('stext_revisado').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_revisado"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_revisado" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="revisado" id="revisado"   value="<?php cargar_seleccionados(378,4444,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                  ...
                  function checkear_arbol(){
                  vector2="<?php cargar_seleccionados(378,4444,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_revisado.setCheck(vector2[m],true);
                    }}
--></script></td></tr><tr>
                   <td class="encabezado" width="20%" title="">APROBADO POR*</td><td bgcolor="#F5F5F5"><div id="seleccionados"><?php mostrar_seleccionados(378,4445,'0',$_REQUEST['iddoc']);?></div>
                   ...
                   <a href="javascript:void(0)" onclick="tree_aprobado.findItem(htmlentities(document.getElementById('stext_aprobado').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_aprobado"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_aprobado" height="90%"></div><input type="hidden" maxlength="255"  class="required"  name="aprobado" id="aprobado"   value="<?php cargar_seleccionados(378,4445,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
                  ...
                  function checkear_arbol(){
                  vector2="<?php cargar_seleccionados(378,4445,1,$_REQUEST['iddoc']);?>";
                  vector2=vector2.split(",");
                  for(m=0;m<vector2.length;m++)
                    {tree_aprobado.setCheck(vector2[m],true);
                    }}
--></script></td></tr><input type="hidden" name="idft_control_documentos" value="<?php echo(mostrar_valor_campo('idft_control_documentos',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="iddocumento_creado" value="<?php echo(mostrar_valor_campo('iddocumento_creado',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_vigencia" value="<?php echo(mostrar_valor_campo('fecha_vigencia',378,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="fecha_confirmacion" value="<?php echo(mostrar_valor_campo('fecha_confirmacion',378,$_REQUEST['iddoc'])); ?>"><?php validar_tipo_documento(378,NULL,$_REQUEST['iddoc']);?><?php crear_arbol_procesos_calidad(378,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('4430,4438'); ?>"><input type="hidden" name="formato" value="378"><tr><td colspan='2'><?php submit_formato(378,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>