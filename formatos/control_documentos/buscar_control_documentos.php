<html><title>.:BUSCAR SOLICITUD DE ELABORACI&OACUTE;N, MODIFICACI&OACUTE;N, ELIMINACI&OACUTE;N DE DOCUMENTOS:.</title><head><link rel="stylesheet" type="text/css" href="../../css/dhtmlXTree.css"/><script type="text/javascript" src="../../js/jquery.fcbkcomplete.js"></script><link rel="stylesheet" type="text/css" href="../../css/style_fcbkcomplete.css"/></head><body bgcolor="#F5F5F5"><form name="formulario_formatos" id="formulario_formatos" method="post" action="../librerias/funciones_buscador.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4" border="0"><tr><td colspan="4" class="encabezado_list">B&Uacute;SQUEDA SOLICITUD DE ELABORACI&Oacute;N, MODIFICACI&Oacute;N, ELIMINACI&Oacute;N DE DOCUMENTOS</td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_idformato_calidad" id="condicion_idformato_calidad"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_iddocumento_calidad" id="condicion_iddocumento_calidad"><option value="AND">Y</option><option value="OR">O</option></td>
                     ...
                     <td class="encabezado" width="20%" title="">FECHA APROBACION</td><td class="encabezado">&nbsp;<select name="compara_fecha_aprobacion" id="compara_fecha_aprobacion"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="fecha_aprobacion" name="fecha_aprobacion"></select><script>
                     $(document).ready(function() 
                      {
                      $("#fecha_aprobacion").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                ...
                <div id="treeboxbox_secretaria" height="90%"></div><input type="hidden" maxlength="255"  name="secretaria" id="secretaria"   value="" ><label style="display:none" class="error" for="secretaria">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                	...
                	--></script></td></tr><tr id="tr_origen_documento"><td class="encabezado">&nbsp;<select name="condicion_origen_documento" id="condicion_origen_documento"><option value="AND">Y</option><option value="OR">O</option></td>
                     ...
                     <td class="encabezado" width="20%" title="">VIGENCIA</td><td class="encabezado">&nbsp;<select name="compara_vigencia" id="compara_vigencia"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     ...
                     $(document).ready(function() 
                      {
                      $("#serie_doc_control").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                ...
                <div id="treeboxbox_documento_calidad" height="90%"></div><input type="hidden"  name="documento_calidad" id="documento_calidad"   value="" ><label style="display:none" class="error" for="documento_calidad">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                	...
                	--></script></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_justificacion" id="condicion_justificacion"><option value="AND">Y</option><option value="OR">O</option></td>
                    ...
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_propuesta" id="condicion_propuesta"><option value="AND">Y</option><option value="OR">O</option></td>
                ...
                <div id="treeboxbox_aprobado" height="90%"></div><input type="hidden" maxlength="255"  name="aprobado" id="aprobado"   value="" ><label style="display:none" class="error" for="aprobado">Campo obligatorio.</label><script type="text/javascript">
                  <!--
                	...
                	--></script></td></tr><tr><td class="encabezado">&nbsp;<select name="condicion_iddocumento_creado" id="condicion_iddocumento_creado"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">IDDOCUMENTO_CREADO</td><td class="encabezado">&nbsp;<select name="compara_iddocumento_creado" id="compara_iddocumento_creado"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="iddocumento_creado" name="iddocumento_creado"></select><script>
                     $(document).ready(function() 
                      {
                      $("#iddocumento_creado").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_fecha_vigencia" id="condicion_fecha_vigencia"><option value="AND">Y</option><option value="OR">O</option></td>
                     <td class="encabezado" width="20%" title="">FECHA VIGENCIA</td><td class="encabezado">&nbsp;<select name="compara_fecha_vigencia" id="compara_fecha_vigencia"> <option value="or">Alguno</option><option value="and">Todos</option></select></td>
                     <td bgcolor="#F5F5F5"><select multiple id="fecha_vigencia" name="fecha_vigencia"></select><script>
                     $(document).ready(function() 
                      {
                      $("#fecha_vigencia").fcbkcomplete({
                        complete_text:"Presione enter para agregar una palabra.",
                        newel: true
                      });
                      });
                     </script></td>
                    </tr><tr><td class="encabezado">&nbsp;<select name="condicion_fecha_confirmacion" id="condicion_fecha_confirmacion"><option value="AND">Y</option><option value="OR">O</option></td>
