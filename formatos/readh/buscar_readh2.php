<?php include_once("../../formatos/librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><script type="text/javascript" src="../librerias/dependientes.js"></script><legend id="label_formato" class="legend">B&uacute;squeda en formato Registro especial de archivo (READH)</legend><br /><br /><?php include_once("../../formatos/librerias/funciones_generales.php"); ?><div class="control-group"><label class="string control-label" style="font-size:9pt" for="tipo_entidad"><b>Tipo de entidad<input type="hidden" name="bksaiacondicion_g@tipo_entidad" id="bksaiacondicion_g@tipo_entidad" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(317,3715,'',1,'buscar');?><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><label class="string control-label" style="font-size:9pt" for="palabras_clave"><b>Palabras clave<input type="hidden" name="bksaiacondicion_g@palabras_clave" id="bksaiacondicion_g@palabras_clave" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(317,3724,'',1,'buscar');?></div></div><input type="hidden" name="campos_especiales" value="nombre_entidad@ejecutor"><input type="hidden" name="filtro_adicional" id="filtro_adicional" value=" ft_readh g @ AND  g.documento_iddocumento=iddocumento "></body><input type="hidden" name="idbusqueda_componente" value="">