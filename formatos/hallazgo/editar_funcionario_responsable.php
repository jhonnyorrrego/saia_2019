...
<div class="container bs-docs-example">
	<form class="form-horizontal" id="formulario_formatos">
		<div class="control-group">
			...
			<div class="controls">
				<?php generar_arbol('actualizar_funcionario', 'test.php?sin_padre=1'); ?>
			</div>
		</div>
		<div class="form-actions">
			...
			<button class="btn btn-primary" id="enviar_formulario">
				Aceptar
			</button>
		</div>
	</form>
...
<br>
<a href="javascript:void(0)" onclick="tree_<?php echo $campo; ?>.findItem((document.getElementById('stext_<?php echo $campo; ?>').value),0,1)"> Buscar</a> | <a href="javascript:void(0)" onclick="tree_<?php echo $campo; ?>.findItem((document.getElementById('stext_<?php echo $campo; ?>').value))"> Siguiente</a> | <a href="javascript:void(0)" onclick="tree_<?php echo $campo; ?>.findItem((document.getElementById('stext_<?php echo $campo; ?>').value),1)"> Anterior</a>
<br />
<div id="esperando_<?php echo $campo; ?>"><img src="<?php echo $ruta_db_superior; ?>imagenes/cargando.gif">
</div>
<div class="quitar_borde_arbol">
