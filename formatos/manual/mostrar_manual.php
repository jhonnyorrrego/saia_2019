...
<td><?php mostrar_valor_campo('nombre',365,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado_list" style="text-align: left;">Estado</td>
<td><?php mostrar_valor_campo('estado',365,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado_list" style="text-align: left;">Soporte</td>
<td><?php mostrar_valor_campo('soporte',365,$_REQUEST['iddoc']);?></td>
</tr>
<tr>
<td class="encabezado_list" style="text-align: left;">Secretarias Vinculadas</td>
<td><?php mostrar_valor_campo('secretarias',365,$_REQUEST['iddoc']);?></td>
</tr>
</tbody>
