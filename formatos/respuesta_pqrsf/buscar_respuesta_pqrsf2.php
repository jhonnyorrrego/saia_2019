<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato 2. Respuesta PQRSF</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><b>para<input type="hidden" name="bksaiacondicion_g@para" id="bksaiacondicion_g@para" value="like_total"></b><div class="controls"><input type="text" id="para" name="bqsaia_g@para"><div class="btn-group" data-toggle="buttons-radio" >
