<?php include_once("../librerias/funciones_generales.php"); ?><?php include_once("../librerias/header_formato.php"); ?><legend id="label_formato" class="legend">B&uacute;squeda en formato Notificaci&oacute;n  interna</legend><br /><br /><?php include_once("../librerias/funciones_generales.php"); ?><div class="control-group"><b>Dependencia<input type="hidden" name="bksaiacondicion_g@dependencia" id="bksaiacondicion_g@dependencia" value="="></b><div class="controls"><input type="text" id="dependencia" name="bqsaia_g@dependencia"><div class="btn-group" data-toggle="buttons-radio" >
		...
		</div></div></div><div class="control-group"><label class="string control-label" style="font-size:9pt" for="origen"><b>De<input type="hidden" name="bksaiacondicion_g@origen" id="bksaiacondicion_g@origen" value="="></b></label><div class="controls"><?php genera_campo_listados_editar(242,2753,'',1,'buscar');?></div></div><input type="hidden" name="campos_especiales" value="destino@arbol,copia_a@arbol"><input type="hidden" name="filtro_adicional" id="filtro_adicional" value=" ft_notificacion_interna g @ AND  g.documento_iddocumento=iddocumento "></body>