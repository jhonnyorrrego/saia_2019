...
<span class="phpmaker"><img class="imagen_internos" src="../botones/configuracion/crear_documentos.png" border="0">Listado de Formatos
 ...
 <table border="0" cellspacing="0" cellpadding="0">
    ...
    <td><span class="phpmaker"><a href="llamado_formatos.php?acciones_formato=adicionar,buscar,editar,mostrar&accion=generar">Recrear Todos los Formatos</a></span></td>	  
</tr>
</table>
<?php
if (@$_SESSION["ewmsg"] <> "") {
...
<td><span class="phpmaker"><a href="<?php if ((!is_null($sKey))) { echo "llamado_formatos.php?acciones_formato=adicionar,buscar,editar,mostrar&accion=generar&condicion=idformato@" . urlencode($sKey); } else { echo "javascript:alert('Invalid Record! Key is null');";  } ?>">Recrear</a></span></td>
</tr>
<?php
	}
}
