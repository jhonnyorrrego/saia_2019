...
function SetUpSortOrder()
{
	...
	if (strlen(@$_GET["order"]) > 0) {
		...
		if ($sOrder == "idformato") {
			...
			if (@$_SESSION["formato_x_idformato_Sort"] <> "") {
				@$_SESSION["formato_x_idformato_Sort"] = "";
			}
		}
		...
		if ($sOrder == "nombre") {
			...
			if (@$_SESSION["formato_x_nombre_Sort"] <> "") {
				@$_SESSION["formato_x_nombre_Sort"] = "";
			}
		}
		...
		if ($sOrder == "etiqueta") {
			...
			if (@$_SESSION["formato_x_etiqueta_Sort"] <> "") {
				@$_SESSION["formato_x_etiqueta_Sort"] = "";
			}
		}
		...
		if ($sOrder == "contador_idcontador") {
			...
			if (@$_SESSION["formato_x_contador_idcontador_Sort"] <> "") {
				@$_SESSION["formato_x_contador_idcontador_Sort"] = "";
			}
		}
		...
		if ($sOrder == "margenes") {
			...
			if (@$_SESSION["formato_x_margenes_Sort"] <> "") {
				@$_SESSION["formato_x_margenes_Sort"] = "";
			}
		}
		// Field padre
		if ($sOrder == "cod_padre") {
			...
			if (@$_SESSION["formato_x_padre_Sort"] <> "") {
				@$_SESSION["formato_x_padre_Sort"] = "";
			}
		}
		// Field orientacion
		if ($sOrder == "orientacion") {
			...
			if (@$_SESSION["formato_x_orientacion_Sort"] <> "") {
				@$_SESSION["formato_x_orientacion_Sort"] = "";
			}
		}
		...
		if ($sOrder == "papel") {
			...
			if (@$_SESSION["formato_x_papel_Sort"] <> "") {
				@$_SESSION["formato_x_papel_Sort"] = "";
			}
		}
		...
		if ($sOrder == "exportar") {
			...
			if (@$_SESSION["formato_x_exportar_Sort"] <> "") {
				@$_SESSION["formato_x_exportar_Sort"] = "";
			}
		}
