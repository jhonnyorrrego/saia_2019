		...
		<p>
			...
			<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
				...
				<tr>
					...
					<td bgcolor="#F5F5F5">
						<span class="phpmaker">
							<input type="checkbox" name="x_banderas[]" <?php if (in_array("u", $x_banderas)) {
																			echo ("CHECKED");
																		} ?> value="u">&Uacute;inco
							<input type="checkbox" name="x_banderas[]" <?php if (in_array("i", $x_banderas)) {
																			echo ("CHECKED");
																		} ?> value="i"> Indice
							<input type="checkbox" name="x_banderas[]" <?php if (in_array("pdfa", $x_banderas)) {
																			echo ("CHECKED");
																		} ?> value="pdfa"> PDF/A
							<!--input type="checkbox" name="x_banderas[]"  <?php if (in_array("pk", $x_banderas)) {
																				echo ("CHECKED");
																			} ?> value="pk"> Llave Primaria
        <input type="checkbox" name="x_banderas[]"  <?php if (in_array("ai", $x_banderas)) {
														echo ("CHECKED");
													} ?> value="ai"> Auto incremental -->
						</span>
					</td>
				</tr>
				<tr>
					...
					<td bgcolor="#F5F5F5">
						<span class="phpmaker">
							<input type="radio" name="x_banderas[]" <?php if (in_array("ffc", $x_banderas)) {
																		echo ("CHECKED");
																	} ?> value="ffc">funcionario_codigo
							<input type="radio" name="x_banderas[]" <?php if (in_array("fdc", $x_banderas)) {
																		echo ("CHECKED");
																	} ?> value="fdc">iddependencia_cargo
							<input type="radio" name="x_banderas[]" <?php if (in_array("fid", $x_banderas)) {
																		echo ("CHECKED");
																	} ?> value="fid">idfuncionario
							<input type="radio" name="x_banderas[]" <?php if (in_array("fc", $x_banderas)) {
																		echo ("CHECKED");
																	} ?> value="fc">idcargo
							...
							<table width="100%">
								<tr>
									...
									<td>
										...
										<?php echo "fecha"; ?>
										<?php echo EditOptionSeparator(11); ?></td>
									<td>
										<?php
