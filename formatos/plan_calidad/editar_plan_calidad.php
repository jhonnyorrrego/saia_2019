...
ELABORACION,REVISION,APROBACION,DISTRIBUCION,INACTIVO ">ESTADO*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(494,6278,$_REQUEST['iddoc']);?></td></tr><?php no_permitir_adicion_formatos_acalidad(494,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('6277'); ?>"><input type="hidden" name="formato" value="494"><tr><td colspan='2'><?php submit_formato(494,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''><input type='hidden' name='form_uuid'       id='form_uuid'       value='<?php echo (uniqid("494-") . "-" . uniqid());?>'></form></body><script type='text/javascript'>
