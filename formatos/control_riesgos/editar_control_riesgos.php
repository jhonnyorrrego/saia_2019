<html>
			<title>.:EDITAR 1. VALORACION CONTROLES RIESGOS:.</title>
  ...
  $(document).ready(function() {
			...
			<body bgcolor="#F5F5F5"><?php llama_funcion_accion(@$_REQUEST["iddoc"],@$_REQUEST["idformato"],"ingresar","ANTERIOR");?><form name="formulario_formatos" id="formulario_formatos" method="post" action="../../class_transferencia.php" enctype="multipart/form-data"><table width="100%" cellspacing="1" cellpadding="4"><tr><td colspan="2" class="encabezado_list">1. VALORACION CONTROLES RIESGOS</td></tr><input type="hidden" name="estado_documento" value="<?php echo(mostrar_valor_campo('estado_documento',500,$_REQUEST['iddoc'])); ?>"><tr id="tr_dependencia">
                     <td class="encabezado" width="20%" title="">DEPENDENCIA DEL CREADOR DEL DOCUMENTO*</td>
                     <?php buscar_dependencia(500,6384,$_REQUEST['iddoc']);?></tr><tr id="tr_consecutivo_control">
                     <td class="encabezado" width="20%" title="">CONSECUTIVO</td>
                     <?php consecutivo_funcion_control(500,6385,$_REQUEST['iddoc']);?></tr><tr id="tr_fecha_valoracion">
                     <td class="encabezado" width="20%" title="">FECHA VALORACION*</td>
                     <?php fecha_bloqueada_valoracion(500,6386,$_REQUEST['iddoc']);?></tr><tr id="tr_descripcion_control">
...
Hacer una descripci&oacute;n en  forma detallada del control Existente que se tiene implementado.">DESCRIPCION DEL CONTROL EXISTENTE*</td>
                     <td class="celda_transparente"><textarea  tabindex='1'  name="descripcion_control" id="descripcion_control" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('descripcion_control',500,$_REQUEST['iddoc'])); ?></textarea></td>
...
Es por ello que se debe seleccionar si el control existente me permite disminuir el nivel de probabilidad o el nivel de impacto.">EL CONTROL AFECTA?*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(500,6388,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="desplazamiento" value="<?php echo(mostrar_valor_campo('desplazamiento',500,$_REQUEST['iddoc'])); ?>"><tr id="tr_herramientas_ejercer">
                     ...
                     <td class="celda_transparente"><textarea  tabindex='2'  name="desc_herramienta" id="desc_herramienta" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('desc_herramienta',500,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr id="tr_anexar_herramienta">
                     <td class="encabezado" width="20%" title="">ANEXAR HERRAMIENTA</td>
                     <td class="celda_transparente"><?php echo '<div class="textwrapper">
			<a href="../../anexosdigitales/anexos_documento_edit.php?key='.$_REQUEST["iddoc"].'&idformato=500&idcampo=6395" id="anexo_admin" class="highslide" onclick="return hs.htmlExpand( this, {
			objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
			</div>'; ?><tr id="tr_procedimiento_herram" >
                     ...
                     <td class="celda_transparente"><textarea  tabindex='4'  name="desc_documento" id="desc_documento" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('desc_documento',500,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><tr id="tr_anexar_documento">
                     <td class="encabezado" width="20%" title="">ANEXAR DOCUMENTO</td>
                     <td class="celda_transparente"><?php echo '<div class="textwrapper">
			<a href="../../anexosdigitales/anexos_documento_edit.php?key='.$_REQUEST["iddoc"].'&idformato=500&idcampo=6398" id="anexo_admin" class="highslide" onclick="return hs.htmlExpand( this, {
			objectType: \'iframe\', outlineType: \'rounded-white\', wrapperClassName: \'highslide-wrapper drag-header\',
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
			</div>'; ?><tr id="tr_herramienta_efectiva" >
                     ...
                     <td class="celda_transparente"><textarea  tabindex='6'  name="pregunta_porque" id="pregunta_porque" cols="53" rows="3" class="tiny_basico required"><?php echo(mostrar_valor_campo('pregunta_porque',500,$_REQUEST['iddoc'])); ?></textarea></td>
                     ...
                     <td class="encabezado" width="20%" title="">4. ESTAN DEFINIDOS LOS RESPONSABLES DE LA EJECUCION DEL CONTROL Y DEL SEGUIMIENTO?*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(500,6402,$_REQUEST['iddoc']);?></td></tr><tr id="tr_responsable_seg">
								...
								<a href="javascript:void(0)" onclick="tree_responsable_seg.findItem((document.getElementById('stext_responsable_seg').value))">
									<img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="255"  name="responsable_seg" id="responsable_seg"   value="<?php cargar_seleccionados(500,6403,1,$_REQUEST['iddoc']);?>" ><div id="esperando_responsable_seg">
								...
								tree_responsable_seg.setOnLoadingEnd(fin_cargando_responsable_seg);tree_responsable_seg.enableSmartXMLParsing(true);tree_responsable_seg.loadXML("../../test.php?rol=1&sin_padre=1",checkear_arbol);
								...
								function cargando_responsable_seg() {
									...
									document.poppedLayer.style.display = "";
										...
										vector2="<?php cargar_seleccionados(500,6403,1,$_REQUEST['iddoc']);?>";
										vector2=vector2.split(",");
										for(m=0;m<vector2.length;m++) {
											tree_responsable_seg.setCheck(vector2[m],true);
										}
									}
								...
								<a href="javascript:void(0)" onclick="tree_respon_seguimiento.findItem((document.getElementById('stext_respon_seguimiento').value))">
									<img src="../../botones/general/siguiente.png"border="0px"></a><br/><input type="hidden" maxlength="255"  name="respon_seguimiento" id="respon_seguimiento"   value="<?php cargar_seleccionados(500,6404,1,$_REQUEST['iddoc']);?>" ><div id="esperando_respon_seguimiento">
									<img src="../../imagenes/cargando.gif">
								</div>
								...
								tree_respon_seguimiento.setOnLoadingEnd(fin_cargando_respon_seguimiento);tree_respon_seguimiento.enableSmartXMLParsing(true);tree_respon_seguimiento.loadXML("../../test.php?rol=1&sin_padre=1",checkear_arbol);
								...
								function cargando_respon_seguimiento() {
									...
									document.poppedLayer.style.display = "";
										...
										vector2="<?php cargar_seleccionados(500,6404,1,$_REQUEST['iddoc']);?>";
										vector2=vector2.split(",");
										for(m=0;m<vector2.length;m++) {
											tree_respon_seguimiento.setCheck(vector2[m],true);
										}
									}
                     ...
                     <td class="celda_transparente"><textarea  tabindex='9'  name="cual_frecuencia" id="cual_frecuencia" cols="53" rows="3" class="tiny_basico"><?php echo(mostrar_valor_campo('cual_frecuencia',500,$_REQUEST['iddoc'])); ?></textarea></td>
                    </tr><input type="hidden" name="idft_control_riesgos" value="<?php echo(mostrar_valor_campo('idft_control_riesgos',500,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',500,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',500,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',500,$_REQUEST['iddoc'])); ?>"><?php llenar_orientacion(500,NULL,$_REQUEST['iddoc']);?><?php validar_tipo_riesgo(500,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('6387'); ?>"><input type="hidden" name="formato" value="500"><tr>
			<td colspan='2'><?php submit_formato(500,$_REQUEST['iddoc']);?></td>
		</tr>
