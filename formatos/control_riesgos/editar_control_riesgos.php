...
Es por ello que se debe seleccionar si el control existente me permite disminuir el nivel de probabilidad o el nivel de impacto.">EL CONTROL AFECTA?*</td><td bgcolor="#F5F5F5"><?php genera_campo_listados_editar(500,6388,$_REQUEST['iddoc']);?></td></tr><input type="hidden" name="desplazamiento" value="<?php echo(mostrar_valor_campo('desplazamiento',500,$_REQUEST['iddoc'])); ?>"><tr id="tr_herramientas_ejercer">
			...
			outlineWhileAnimating: true, preserveContent: false, width: 400 } )">Administrar Anexos</a>
                   ...
                   <a href="javascript:void(0)" onclick="tree_responsable_seg.findItem((document.getElementById('stext_responsable_seg').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_responsable_seg"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_responsable_seg" height="90%"></div><input type="hidden" maxlength="255"  name="responsable_seg" id="responsable_seg"   value="<?php cargar_seleccionados(500,6403,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
...
--></script></td></tr><tr id="tr_respon_seguimiento">
                   ...
                   <a href="javascript:void(0)" onclick="tree_respon_seguimiento.findItem((document.getElementById('stext_respon_seguimiento').value))"><img src="../../botones/general/siguiente.png"border="0px"></a> 
                          <br /><div id="esperando_respon_seguimiento"><img src="../../imagenes/cargando.gif"></div><div id="treeboxbox_respon_seguimiento" height="90%"></div><input type="hidden" maxlength="255"  name="respon_seguimiento" id="respon_seguimiento"   value="<?php cargar_seleccionados(500,6404,1,$_REQUEST['iddoc']);?>" ><script type="text/javascript">
                  <!--
                      var browserType;
                      if (document.layers) {browserType = "nn4"}
                      if (document.all) {browserType = "ie"}
...
--></script></td></tr><tr id="tr_frecuencia_ejecucion" >
                    ...
                    </tr><input type="hidden" name="idft_control_riesgos" value="<?php echo(mostrar_valor_campo('idft_control_riesgos',500,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="documento_iddocumento" value="<?php echo(mostrar_valor_campo('documento_iddocumento',500,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="encabezado" value="<?php echo(mostrar_valor_campo('encabezado',500,$_REQUEST['iddoc'])); ?>"><input type="hidden" name="firma" value="<?php echo(mostrar_valor_campo('firma',500,$_REQUEST['iddoc'])); ?>"><?php llenar_orientacion(500,NULL,$_REQUEST['iddoc']);?><?php validar_tipo_riesgo(500,NULL,$_REQUEST['iddoc']);?><input type="hidden" name="campo_descripcion" value="<?php echo('6387'); ?>"><input type="hidden" name="formato" value="500"><tr><td colspan='2'><?php submit_formato(500,$_REQUEST['iddoc']);?></td></tr></table><input type='hidden' name='permisos_anexos' id='permisos_anexos' value=''></form></body></html><?php include_once("../librerias/footer_plantilla.php");?>