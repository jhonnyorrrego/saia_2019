...
function envio_mensaje()
{
 ...
 for($j=3; $j<$func["numcampos"]; $j++) 
 {
  ...
  $destino[0]=1; 
 enviar_mensaje("origen",$destino,$texto,$tipo);   //c:\xampp\php\php ejecutar_tareas.php
 $texto = ""; 
  //die($texto);         
 } 
}
...
function hoja_vida()
{
 ...
 if($hojas["numcampos"]>0)
  ...
  { $texto ="";
    ...
    //print_r($estructura);
    if($estructura["numcampos"]>0)
     { $texto.="<br />2.Documentos Pendientes:<br /><ul>";
