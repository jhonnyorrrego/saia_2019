...
if(!defined("RUTA_PDF")) {
	define("RUTA_PDF", $ruta . "/saia_basic3/saia");
}
if(!defined("RUTA_PDF_LOCAL")) {
	define("RUTA_PDF_LOCAL", "basic3.netsaia.loc:82/saia_basic3/saia");
}
...
define("RUTA_SCRIPT", "saia_basic3");
date_default_timezone_set("America/Bogota");
define("RUTA_DISCO", "..");
define("SO", "linux");
define("CARPETA_SAIA", "saia_basic3");
define("LLAVE_SAIA_CRYPTO", "cerok_saia421_5");
define("RUTA_VERSIONES", "local:///vol2/almacenamiento/VERSIONES/");
define("RUTA_ARCHIVOS", "local:///vol2/almacenamiento/");
define("RUTA_PDFS", "local:///vol2/almacenamiento/");
define("RUTA_IMAGENES", "local:///vol2/almacenamiento/");
define("RUTA_QR", "local:///vol2/almacenamiento/");
define("RUTA_INFO_QR", PROTOCOLO_CONEXION . "basic3.netsaia.loc:82/saia_basic3/saia/webservice_saia_clientes/info_qr_cliente/info_qr.php");

define("RUTA_BACKUP", "local:///vol2/almacenamiento/backup/");
...
define("RUTA_EVENTO_FORMATO", "local:///vol2/almacenamiento/configuracion/evento_formato/");

/* NUEVA CONSTANTE PARA CONFIGURACION */
define("RUTA_CONFIGURACION", "local:///vol2/almacenamiento/configuracion/");

/* CONSTANTES QUE DEPENDEN DE LA CONSTANTE "RUTA_CONFIGURACION" */
define("RUTA_ARCHIVOS_BPMN", "local:///vol2/almacenamiento/configuracion/archivos_bpmn/"); //Flujos saia
...
define("RUTA_FOTOGRAFIA_FUNCIONARIO", "local:///vol2/almacenamiento/configuracion/adicionales_funcionario/fotografia/");
define("RUTA_NOTICIA_IMAGENES", "local:///vol2/almacenamiento/configuracion/noticia_imagenes/"); //Imagenes cargadas en las noticias que se visualizan en el login
define("RUTA_LOGO_SAIA", "local:///vol2/almacenamiento/configuracion/logo_saia/");
//No es posible modificar la carga de imagenes del tiny. Se usa la ruta local
define("RUTA_TINY_IMAGENES", "local:///vol2/almacenamiento/configuracion/imagenes_areatexto/"); //Imagenes cargadas a travez del tiny
define("RUTA_CARRUSEL_IMAGENES", "local:///vol2/almacenamiento/configuracion/imagenes_carrusel/"); //Carrusel saia
