...
include_once("db.php");
global $conn;
$datos=busca_filtro_tabla("","busquedas","idbusquedas=4","",$conn);
$funciones=busca_filtro_tabla("idfunciones_busqueda","funciones_busqueda","busquedas_idbusqueda=4","",$conn);
if($funciones<>"")
...
<input type="hidden" name="tabla" value="dependencia_cargo,cargo,funcionario,dependencia">
