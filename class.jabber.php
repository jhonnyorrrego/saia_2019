...
class Jabber
{
    ...
    function Jabber()
    {      // CAMBIAR LA DIRECCION DEL DESTINO EN envia.php
        //conexion servidor remoto eep
        
  $this->server				= "200.21.94.202";
	$this->port             = "5222";
	$this->username				= "ok";
	$this->password				= "cerok_saia";
	$this->resource				= "clasjabber"; 
     
        // CAMBIAR LA DIRECCION DEL DESTINO EN envia.php
        //conexion servidor local  
/*        $this->server				= "172.25.2.21";
	$this->port                             = "5222";
	$this->username				= "admin";
	$this->password				= "epsaia%";
	$this->resource				= "clasjabber"; 
*/        
        ...
        $this->iq_sleep_timer        = 4;
        $this->delay_disconnect        = 4;
