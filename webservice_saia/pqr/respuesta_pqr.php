...
function consultar_ciudad($datos) {
	...
	switch($datos->tipo) {
		case 1 :
			...
			$datos = array("pais" => $select_pais, "departamento" => $select_departementos, "municipio" => $select_municipios);
			break;
		case 2 :
			...
			$datos = array("departamento" => $select_departementos, "municipio" => $select_municipios);
			break;
		case 3 :
			...
			$datos = array("municipio" => $select_municipios);
			break;
	}
