...
$serviceName = "Web Service Importar Exportar Reporte SAIA";
...
//$soap_address = "http://localhost/~giovanni/saia_reborn/saia/webservice_saia/digitalizacion/impexprep_service.php";
$soap_address = $protocol .  $_SERVER["SERVER_NAME"] . $port . dirname($_SERVER['PHP_SELF']) . "/impexprep_service.php";
$functions[] = array(
        "funcName" => "consultar_info",
        "doc" => "Consultar informacion para migrar reporte.",
        "inputParams" => array(
                array(
                        "name" => "usuario",
                        "type" => "string"
