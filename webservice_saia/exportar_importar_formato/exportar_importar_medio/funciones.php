...
if(!defined("SERVIDOR_IMPORTAR")){
	define("SERVIDOR_IMPORTAR","http://192.168.0.51/jaramillo_mora_pruebas/saia/webservice_saia/exportar_importar_formato/importar_formato/receptor_importar.php");
}
