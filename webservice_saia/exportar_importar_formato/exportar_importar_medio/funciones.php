...
if(!defined("SERVIDOR_IMPORTAR")){
	define("SERVIDOR_IMPORTAR","http://sigma.superpack.com.co/saia_desarrollo/saia/webservice_saia/exportar_importar_formato/importar_formato/receptor_importar.php");
}
