...
var $monthYearDivider=" "; // the divider between month and year in the months title
/*
********************************************************************************
...
********************************************************************************
*/
function setEvent($year,$month,$day,$id=false,$url=false,$target=NULL){
...
function mkMonthTitle(){
	if (!$this->monthNav){
		...
		$out.=$this->monthNavBack."</td><td class=\"".$this->cssMonthNav."\" colspan=\"5\">";
		$out.="<form name=\"".$this->cssPickerForm."\" class=\"".$this->cssPickerForm."\" action=\"".$this->urlPicker."\" method=\"post\">\n";
		if (!$yearpicker){
			$out.="<select name=\"".$this->monthID."\" onChange=\"document.".$this->cssPickerForm.".submit();\" class=\"".$this->cssPickerMonth."\">\n";
			for ($z=1;$z<=12;$z++){
		...
		$out.="<select name=\"".$this->yearID."\" onChange=\"document.".$this->cssPickerForm.".submit();\" class=\"".$this->cssPickerYear."\">\n";
