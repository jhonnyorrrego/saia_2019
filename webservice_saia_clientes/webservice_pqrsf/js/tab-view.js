	...
	************************************************************************************************************/		
	...
	{ 		
    if(tabView_countTabs[parentId]==3)
		  tabView_maxNumberOfTabs=4;
		else  
		  tabView_maxNumberOfTabs=3;
    if(tabView_countTabs[parentId]>=tabView_maxNumberOfTabs)			  
     return;	// Maximum number of tabs reached - return		} 
    var div = document.createElement('DIV');    		
		var iframe = document.createElement('IFRAME');        		
		div.className = 'dhtmlgoodies_aTab';
		iframe.className = 'dhtmlgoodies_aTab1';
		iframe.src=tabContentUrl;		
    ...
    var tabId = initTabs(parentId,Array(tabTitle),0,'620','85',Array(closeButton),true);    
