...
<form name="asigpermiso" id="asigpermiso" action="formato_permiso_add.php" method="POST">
    ...
    <table aling="center">
        ...
        <tr>
            <td>Propietario</td>
            <td><input name="prop_l" type="checkbox" id="prop_l" value="l" checked> </td>
        </tr>
        <tr>
            <td>Dependencia</td>
            <td><input name="dep_l" type="checkbox" id="dep_l" value="l"> </td>
        </tr>
        <tr>
            <td>Cargo&nbsp;&nbsp;&nbsp;</td>
            <td><input name="car_l" type="checkbox" id="car_l" value="l">
        </tr>
        <tr>
            <td>Todos&nbsp;&nbsp;&nbsp;</td>
            <td><input name="tod_l" type="checkbox" id="tod_l" value="l" checked> </td>
        </tr>
        <tr>
            <td><input type="hidden" name="idformato" value="<?php echo $_REQUEST["idformato"]; ?>"></td>
        </tr>
        <tr>
            <td><input type="hidden" name="numanexo" value="<?php echo $_REQUEST["numanexo"]; ?>"></td>
        </tr>
        <tr>
