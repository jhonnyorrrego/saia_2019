        ...
        <div class="col-12">
            ...
            <form id="formulario" name="formulario" class="form-horizontal">
              ...
              <div class="row">
                  ...
                  <button class="btn btn-primary" id="vincularSerie">Vincular</button>
                </div>
              </div>
            </form>
      ...
      $(document).ready(function (){
        ...
        var loadTable=function(){
          $.ajax({
            ...
            data: {nameInstance:'CajaController',methodInstance:'getCajaEntidadSerieCont',idcaja:params.idcaja},
            dataType: 'json',
        ...
        $(document).on("click",".btn-danger",function(){
          if(confirm("Esta seguro de desvincular la Dependencia/serie?")){
            ...
            $.ajax({
              ...
              async:false,
              url: `${params.baseUrl}pantallas/ejecutar_acciones.php`,
              data: {nameInstance:'CajaController',methodInstance:'deleteVinCajaEntidadSerieCont',idcaja_entidadserie:idvinculo},
              dataType: 'json',
              success: function(response){
                if(response.exito){
                  loadTable();
        ...
        $("#formulario").validate({
          ...
          submitHandler : function(form) {
            ...
            $.ajax({
              ...
              async:false,
              url: `${params.baseUrl}pantallas/ejecutar_acciones.php`,
              data: {nameInstance:'CajaController',methodInstance:'insertCajaEntidadSerieCont',idcaja:idcaja,ids:idfk_entidadSerie},
              dataType: 'json',
              success: function(response){
                if(response.exito){
                  loadTable();
