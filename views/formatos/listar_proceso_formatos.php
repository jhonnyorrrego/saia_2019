...
$consulta = busca_filtro_tabla('idcategoria_formato,nombre', 'categoria_formato', 'cod_padre=2 and estado=1', 'nombre ASC');
$adicional = "";
$request = array();
...
<div class="panel-body">
	<div class="block-nav">
		...
		for ($i = 0; $i < $consulta["numcampos"]; $i++) {
			...
			$mostrar = 0;
			$cuantos_formatos = busca_filtro_tabla("nombre,ruta_adicionar", "formato", "mostrar=1 AND (fk_categoria_formato like'" . $idcategoria_formato . "' OR   fk_categoria_formato like'%," . $idcategoria_formato . "'  OR   fk_categoria_formato like'" . $idcategoria_formato . ",%' OR   fk_categoria_formato like'%," . $idcategoria_formato . ",%') AND (fk_categoria_formato like'2' OR   fk_categoria_formato like '%,2'  OR   fk_categoria_formato like'2,%' OR   fk_categoria_formato like'%,2,%') ", "etiqueta ASC");
			...
			if ($mostrar) {
				$etiqueta_formato = ucfirst(strtolower($consulta[$i]["nombre"]));
