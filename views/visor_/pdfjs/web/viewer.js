...
function webViewerInitialized() {
  var appConfig = PDFViewerApplication.appConfig;
  var file = void 0;
  var data = JSON.parse(document.querySelector("script[data-params]").dataset.params);
  var queryString = data.temporal;
  ...
  _createClass(Toolbar, [{
    ...
    value: function _bindListeners() {
      ...
      items.btn_notas_pdf.addEventListener('click', function () {
        let data = JSON.parse(document.querySelector("script[data-params]").dataset.params);
        window.open(data.annotate, '_self');
      });
    }
  }, {
    key: '_localized',
