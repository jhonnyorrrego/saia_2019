...
<head>
    ...
    <link rel="stylesheet" href="<?= $ruta_db_superior ?>views/visor/pdfjs/web/viewer.css">

    <link rel="resource" type="application/l10n"
        href="<?= $ruta_db_superior ?>views/visor/pdfjs/web/locale/locale.properties">
</head>

<body tabindex="1" class="loadingInProgress">
    <div id="outerContainer">
        <input type="hidden" name="url_pdf" id="url_pdf" value="<?= $url_pdf ?>">
                ...
                <div id="toolbarContainer">
                    <div id="toolbarViewer">
                        ...
                        <div id="toolbarViewerMiddle">
                            ...
                            <div class="splitToolbarButtonSeparator"></div>
                            <button id="btn_notas_pdf" class="toolbarButton notas_pdf" title="Notas"
                                data-l10n-id="notas_pdf" enlace="<?= $annotateRoute ?>">
                                <span>Notas PDF</span>
                            </button>
                            <div class="splitToolbarButtonSeparator"></div>
    ...
    <?= jquery() ?>
    <script src="<?= $ruta_db_superior ?>views/visor/pdfjs/build/pdf.js"></script>
    <script type="text/javascript" data-params=''>
    $(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    response.data.annotate = baseUrl+response.data.annotate;
                    response.data.temporal = `file=${baseUrl+response.data.temporal}`;

                    let data = JSON.stringify(response.data);
                    $('script[data-params]').attr('data-params', data);
                    $.getScript(`${baseUrl}views/visor/pdfjs/web/viewer.js`);
                } else {
                    top.notification({
