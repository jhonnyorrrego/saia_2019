$(function() {
                    ...
                    formatter: function(value, row, index, field) {
                        return `<div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-left bg-white" role="menu">
                                <a href="#" class="dropdown-item new_action" data-type="edit" data-id="${
                                    row.id
                                }">
                                    <i class="fa fa-edit"></i> Editar
                                </a>
                                <a href="#" class="dropdown-item new_action" data-type="add_role" data-id="${
                                    row.id
                                }">
    ...
    function showFunctionForm(functionId = 0) {
        top.topModal({
            url: `${baseUrl}views/funciones/adicionar.php`,
            params: {
