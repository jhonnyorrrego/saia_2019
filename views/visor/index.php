    ...
    <div class="container mw-100 px-0 mx-0" id="pdf_editor">
        <div class="row mx-0 sticky-top" id="toolbar_container">
            <div class="col-12 toolbar" id="toolbar">
                <select class="scale search_toggler" id="select_scale">
                ...
                <div class="spacer search_toggler"></div>
                <button class="fa fa-comment search_toggler" type="button" title="Comment" data-tooltype="point"></button>
                <div class="spacer search_toggler"></div>
                <button class="fa fa-undo rotate-ccw search_toggler" type="button" title="Girar" data-tooltype="turn"></button>
                <button class="fa fa-refresh rotate-cw search_toggler" type="button" title="Girar" data-tooltype="turn"></button>
                <div class="spacer search_toggler"></div>
                <button class="fa fa-download download search_toggler" type="button" title="Descargar"
                    data-tooltype="download"></button>
                <div class="spacer search_toggler"></div>
                <button class="fa fa-image thumbnails search_toggler" type="button" title="Miniaturas" data-tooltype=""></button>
                <div class="spacer search_toggler"></div>
                <button class="fa fa-print print d-none d-md-inline" id="print_pdf" type="button" title="Imprimir" data-tooltype=""></button>
                <div class="spacer d-none d-md-inline search_toggler"></div>
                <input id="search_content" type="text" class="d-none d-md-inline search_toggler">
                <button class="fa fa-search search" id="search_tool" type="button" title="Buscar" data-tooltype=""></button>
                <div class="spacer" id="search_spacer"></div>
                <button class="fa fa-hand-o-up active" id="cursor_tool" type="button" title="Cursor" data-tooltype="cursor"></button>
            </div>
        </div>
        <div class="row mx-0">
            <div class="col-5 col-md-2 d-none px-1">
