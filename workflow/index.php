...
<html>
    ...
    <head>
        ...
        <script type="text/javascript" src="./lib/canvasprops.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/style.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/primitives.js?<?php  echo time()?>"></script>
		<script type="text/javascript" src="./lib/ImageFrame.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/matrix.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/util.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/key.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/groups.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/stack.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/connections.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/connectionManagers.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/handles.js?<?php  echo time()?>"></script>
        
        <script type="text/javascript" src="./lib/builder.js?<?php  echo time()?>"></script>        
        <script type="text/javascript" src="./lib/text.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/log.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/text.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/sets/basic.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/sets/secondary.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/sets/experimental.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/browserReady.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/main.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/minimap.js?<?php  echo time()?>"></script>

        <script type="text/javascript" src="./lib/commands/History.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/CanvasResizeCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/ConnectCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/ConnectorHandleCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/CreateCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/DeleteCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/GroupCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/MatrixCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/PropertyCommand.js?<?php  echo time()?>"></script>
        <script type="text/javascript" src="./lib/commands/ZOrderCommand.js?<?php  echo time()?>"></script>
...
*/
			...
			{
				var id_diagrama = "";
				 <?php if( is_numeric($_REQUEST['diagramId'])){?>
				...
				<?php $_SESSION['id_diagrama'] = $_REQUEST['diagramId']; ?>
...
//                alert(svgDiagram);
                ...
                $.post("common/controller.php",
                    ...
                    function(data){
                        ...
                        window.open("exporter/exporter.php?diagrama="+id_diagramax+"&tipo=jpg");
                            //Log.info('saved!');
                            alert('Guardado!');
                        }
                        else{
			...
			function validarFlujo(){  
              window.open("validar_flujo.php?iddiagram="+'<?php  echo $_REQUEST['diagramId']?>',"_self");
            }
...
//                var $diagram = {c:canvas.save(), s:stack, m:CONNECTOR_MANAGER};
    ...
    <body onload="init();generarfigura()" id="body">
        ...
        <div id="menu">
            <table border="0" cellpadding="3" cellspacing="0">
                <tr>
                    ...
                    <!--td valign="middle">
                        <a style="text-decoration: none;" href="./common/controller.php?action=newDiagramExe"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/icon_new.jpg" border="0" width="20" height="21"/><span class="menuText">Nuevo</span></a>
                    </td>
                    <td width="20" align="center">
                        <img style="vertical-align:middle;" src="assets/images/upper_bar_separator.jpg" border="0" width="2" height="16"/>
                    </td>
                    <td valign="middle">
                        <a style="text-decoration: none;" href="./myDiagrams.php"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/icon_open.jpg" border="0" width="20" height="21"/><span class="menuText">Abrir</span></a>
                    </td>
                    <td width="20" align="center">
                        <img style="vertical-align:middle;" src="assets/images/upper_bar_separator.jpg" border="0" width="2" height="16"/>
                    </td-->
                    <td valign="middle">
                        <a style="text-decoration: none;" href="javascript:save();"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/icon_save.jpg" border="0" width="22" height="22"/><span class="menuText">Guardar</span></a>
                    </td>
                    <td width="20" align="center">
                        <img style="vertical-align:middle;" src="assets/images/upper_bar_separator.jpg" border="0" width="2" height="16"/>
                    </td>
                    <td valign="middle">
                        <a style="text-decoration: none;" href="javascript:validarFlujo();"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/validar.jpg" border="0" width="22" height="22"/><span class="menuText">Validar Flujo</span></a>
                    </td>
                    <td width="20" align="center">
                        <img style="vertical-align:middle;" src="assets/images/upper_bar_separator.jpg" border="0" width="2" height="16"/>
                    </td>
                    ...
                    <?php if(is_numeric($_REQUEST['diagramId']) ){//option available ony when the diagram was saved?>
                    <!--td valign="middle">
                        <a style="text-decoration: none;" href="./exportDiagram.php?diagramId=<?php  echo $_REQUEST['diagramId']; ?>"><img style="vertical-align:middle; margin-right: 3px;" src="assets/images/icon_export.jpg" border="0" width="22" height="22"/><span class="menuText">Exportar</span></a>
                    </td>
                    ...
                    <td width="20" align="center">
                     ...
                     <td align="center" vlign="middle">
                       <?php $dato_diagrama=busca_filtro_tabla("","diagram","id=".$_REQUEST['diagramId'],"",$conn);
                       if($dato_diagrama["numcampos"]){
                          echo('<span class="menuText"><b>Diagrama Flujo :</b> '.$dato_diagrama[0]["title"].'</span>');
                       }?>
                    </td>
                    ...
                    <?php if(is_numeric($_REQUEST['diagramId']) ){ //these options should appear ONLY if we have a saved diagram
        ...
        <div id="actions">
			<a href="javascript: var conf = guardar_figura(); if(conf != false) createFigure(figure_Rectangle);" id='rectan'><img src="assets/images/figures/basic/rectangle.png" border="0" height="22px" /></a>
            ...
            -->
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('front');"><img src="assets/images/icon_front.gif" border="0"/></a>
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('back');"><img src="assets/images/icon_back.gif" border="0"/></a>
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('moveforward');"><img src="assets/images/icon_forward.gif" border="0"/></a>
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('moveback');"><img src="assets/images/icon_backward.gif" border="0"/></a>

            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('connector-straight');"><img src="assets/images/icon_connector_straight.gif" border="0"/></a>

            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('connector-jagged');"><img src="assets/images/icon_connector_jagged.gif" border="0"/></a>

            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('group');"><img src="assets/images/group.gif" border="0"/></a>
            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('ungroup');"><img src="assets/images/ungroup.gif" border="0"/></a>

            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) createFigure(figure_Text);"><img  src="assets/images/text.gif" border="0" height ="16"/></a>
			<img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>
			<!--<a href="javascript:createFigure(figure_SimpleImage);">Imagen</a>

            <img class="separator" src="assets/images/toolbar_separator.gif" border="0" width="1" height="16"/>-->

            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('undo');"><img src="assets/images/arrow_undo.png" border="0"/></a>
            <a href="javascript: var conf = guardar_figura(); if(conf != false) action('redo');"><img src="assets/images/arrow_redo.png" border="0"/></a>
            <!--
        ...
        <div id="editor">
            ...
            <div style="width: 100%">
                <div  id="container" style="position:absolute;left:0px;top:-55px;width:80%">
                    <canvas id="a" name='canvas1' width="600" height="200" 
