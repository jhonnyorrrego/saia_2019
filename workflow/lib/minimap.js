/*
  ...
  *
  * @see /editor/documents/specs/minimap.jpg for a visual representation of the minimap architecture
  * @see minimap.css to fully understand the CSS positioning
 */
function Minimap(bigCanvas, minimapContainer){
    this.selected = false;
    this.bigCanvas = bigCanvas; // you can get it also by document.getElementById('map');
    this.minimapContainer = minimapContainer; //you can get it also by document.getElementById('minimap');

    //create selection rectangle (as a div)
