...
class Jabber {
	...
	var $_server_host		= "mensajero.risaralda.gov.co";
	var $_server_ip			= "10.1.7.31";
	var $_server_port		= 5222;
	var $_connect_timeout	= DEFAULT_CONNECT_TIMEOUT;
	var $_username			= "ok";
	var $_password			= "cerok_saia";
	var $_resource			= "";
	var $_remote_ip			= "190.128.91.170";
	...
	//	
	//
	function connect($server_host,$server_port=5222,$connect_timeout=15,$alternate_ip=false) {
    ...
    //die("<br />".$this->_server_ip." - ".$this->_server_port." - ".$this->_connect_timeout);	
