...
{ // Get fields from form
  ...
  $x_emailejecutor = @$_POST["x_codigoejecutor"];
  ////////////////////////////////////////////////////////////
	...
	case "A": // Add
      ...
      foreach($vector as $fila){
       ...
       // Add New Record		
			...
			if($x_escaneo==1)
			  {
			   redirecciona("colilla.php?enlace=paginaadd.php&key=$docu");	
			  }
       else{ 			
...
function LoadData($sKey,$conn)
{
  ...
  global $x_descripcion_anexo;
	global $x_municipio;
	global $x_paginas,$x_oficio,$x_fecha_oficio,$x_dias;
...
function AddData($conn)
{
	...
	global $x_descripcion_anexo, $x_dias, $x_archivos, $x_funcionario_destino;
...
// 	$theValue = (!get_magic_quotes_gpc()) ? intval($x_ejecutor) : "NULL"; 
  ...
  $doc=radicar_documento_prueba("radicacion_entrada",$fieldList,$x_archivos);
  if(!$doc)
