<?php
include_once("db.php");
$datos=busca_filtro_tabla("","busquedas","idbusquedas=54","",$conn);
$funciones=busca_filtro_tabla("idfunciones_busqueda","funciones_busqueda","busquedas_idbusqueda=54","",$conn);
if($funciones<>"")
...
<input type="submit" disabled name="" value="Cargando...">
</form>  
<script>
form1.submit();
</script>
