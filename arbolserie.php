  ...
  <!--
      ...
      if (window.navigator.userAgent.toLowerCase().match("gecko")) {
         browserType= "gecko"
			...
			tree2.setXMLAutoLoading("test_dependencia_serie.php?tabla=dependencia&admin=1&estado=1&carga_partes_dependencia=1");
			tree2.loadXML("test_dependencia_serie.php?tabla=dependencia&admin=1&estado=1&carga_partes_dependencia=1");
