	...
	<body>
		...
		<span style="font-family: Verdana; font-size: 9px;">
			...
			<input type="text" id="stext_serie_idserie" width="200px" size="25">
				<a href="javascript:void(0)" onclick="tree2.findItem((document.getElementById('stext_serie_idserie').value),1)"><img src="botones/general/anterior.png" alt="Buscar Anterior" border="0px"></a>
				<a href="javascript:void(0)" onclick="buscar_nodo();"> <img src="botones/general/buscar.png" alt="Buscar" border="0px"></a>
		...
		<script type="text/javascript">	
			...
			function fin_cargando_serie(opt) {
				...
				if(idNodes){
					$.each( idNodes, function( key, value ) {
						tree2.setItemColor(value,'red','red');
					});
				}
			}
			...
			function buscar_nodo() {
				...
				$.ajax({
					...
					success : function(data) {
						idNodes=data["idserie"];				
						tree2.openItemsDynamic(data["datos"], false);
					}
				});
			}
		</script>
