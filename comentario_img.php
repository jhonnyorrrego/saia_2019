...
{ $x_comentario = $_POST["x_comentario"];
  $add = "INSERT INTO comentario_img (documento_iddocumento,comentario,tipo,pagina,posx,posy,funcionario,fecha) VALUES (".$_POST["key"].",'".htmlentities($x_comentario)."','".$_POST["tipo"]."',".$_POST["pag"].",0,0,'".$usuactual."',".fecha_db_almacenar(date("Y-m-d H:i:s"),"Y-m-d H:i:s").")";
...
{ $x_comentario = $_GET["x_comentario"];      
  $editar = "UPDATE comentario_img SET comentario='".htmlentities($x_comentario)."' WHERE idcomentario_img=".$_GET["id"];
