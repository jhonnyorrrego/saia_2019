...
$conexion1 = phpmkr_db_connect_externo('saia-aguas.ct00qljbq3lp.us-east-1.rds.amazonaws.com', "saia", "cerok_saia421_5", "saia_release1", "MySql", 3306, "saia_release1");
$conexion2 = phpmkr_db_connect_externo('saia-aguas.ct00qljbq3lp.us-east-1.rds.amazonaws.com', "saia", "cerok_saia421_5", "saia_carder_release", "MySql", 3306, "saia_carder_release");
comparar_tablas($conexion1, $conexion2, false);
phpmkr_db_close_externo($conexion1);
phpmkr_db_close_externo($conexion2);
//echo(librerias_bootstrap());
echo("<hr>" . $texto_alter);

function comparar_tablas($conexion1, $conexion2, $con_formatos = true) {
    global $texto_alter;
    ...
    for ($i = 0; $i < $tablas["cantidad"]; $i++) {
        ...
        $existe_tabla = " 0k ";
        $needle = "ft_";
        $nombre_tabla = $tablas["tablas"][$i];
        if(!$con_formatos && substr($nombre_tabla, 0, strlen($needle)) === $needle) {
            continue;
        }
