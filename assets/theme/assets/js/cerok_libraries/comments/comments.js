class Comments {
        ...
        let form = `<div class="row">
            <div class="col">
                <div class="form-group">
                    <textarea class="form-control" id="comment_content" rows="3" placeholder="${this.options.placeholder}"></textarea>
                </div>
            </div>
    ...
    createTemplate(){
        ...
        return  this.options.order == 'desc' ? data.reverse().join('') : data.join('');
    }
                    ...
                    <div class="media">
                        <div class="media-body pl-3">
                            <p class="my-2 text-justify" style="line-height:1">
                                ...
                                <span class="float-right pr-3 hint-text">${this.activeComment.temporality}</span>
                            </p>
                        </div>
                        <img class="align-self-center ml-1 mr-2 rounded-circle" src="${baseUrl + this.activeComment.user.image}" style="width:32px;height:32px;">
                    </div>
                </div>
            </div>`;    
        } else {
                ...
                <div class="col-10 px-0 bg-master-lighter" style="border-radius:5px">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <div class="m-0 p-0">
                                <span class="bold">${this.activeComment.user.name}</span>
                            </div>
    ...
    static getTemporality() {
        ...
        let response = date.getDate() + '-';
            ...
            response += date.getHours() > 12 ? date.getHours() - 12 : date.getHours() + ':';
    ...
    static resetForm() {
        ...
        document.querySelector('#comment_content').dispatchEvent(new Event('keyup'));
    }
}