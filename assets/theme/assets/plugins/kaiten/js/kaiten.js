...
Kaiten = /**@lends jQuery.ui.kaiten.prototype*/{
    ...
    _initState: function () {
        ...
        var fullPath = $('script[src*="kaiten.js"]').prop('src'), // find this script's absolute path
        ...
        connectors: [
            ...
            // load content (referenced by a url) in an iframe
            {
                ...
                loader: function (data, $panel, $kaiten) {
                    ...
                    var html = '<div class="' + panelSelectors.bodyClass + '" optimal-width="900px">' +
...
(function ($) {
    ...
    $.widget("ui.kbreadcrumb",/** @lends jQuery.ui.kbreadcrumb.prototype */{
        ...
        _create: function () {
            ...
            this.element.delegate('button', 'click', function (e) {
                var parts = $(this).parent().attr('id').split('-'),
                    $panel = self.$K.find('#' + parts[1]);
                
                $panel.kpanel("destroy", null, null, null, true);
            });
