...
var DISABLE_AUTO_FETCH_LOADING_BAR_TIMEOUT = 500;
...
function validateFileURL(file) {
  try {
    ...
    if (fileOrigin !== viewerOrigin) {
      throw new Error('file origin does not match viewer\'s fileOrigin='+fileOrigin+"   -----   ViewOrigin"+viewerOrigin);
    }
  } catch (e) {
...
function webViewerInitialized() {
  ...
  var locale = "es-MX"; //PDFJS.locale || navigator.language;
