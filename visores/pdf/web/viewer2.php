...
if (@$_REQUEST['files']) {
	$ruta64 = base64_decode($_REQUEST["files"]);
	$json=json_decode($ruta64);
 	if(is_object($json)){
		$_REQUEST["file"] = $ruta_db_superior . "filesystem/mostrar_binario.php?ruta=".$_REQUEST["files"];
	}else{
		$_REQUEST["file"] = $ruta_db_superior . $ruta64;
	}
	$url = $_REQUEST["file"];
		...
		<div id="outerContainer">
			...
			<div id="mainContainer">
				<div class="findbar hidden doorHanger hiddenSmallView" id="findbar">
					...
					id="findResultsCount" class="toolbarLabel hidden"></span><span
						...
						<div id="toolbarViewer">
							...
							<div id="toolbarViewerRight">
								...
								tabindex="32" data-l10n-id="open_file">
									<span
									data-l10n-id="open_fileAPROBADO/2016-01/13872/pdf/registro_pqrs_124_2016-01-28.pdf_label">Open</span>
								</button>
							...
							<div class="outerCenter">
								<div class="innerCenter" id="toolbarViewerMiddle">
									<button id="transferir" class="toolbarButton transferir"
									title="Transferir" tabindex="21"
									enlace="<?php echo($ruta_db_superior . 'transferenciaadd.php?doc=' . @$_REQUEST['iddocumento'] . '&mostrar=1&key=' . $_REQUEST['iddocumento'] . '&ruta_pdf=' . urlencode($ruta)); ?>"
									data-l10n-id="transferir">
										<span data-l10n-id="transferir_label">Transferir</span>
									</button>
									<div class="splitToolbarButtonSeparator"></div>
									<button id="cambio_visor" class="toolbarButton cambiar_visor"
									title="Cambiar Visor" tabindex="23"
									iddocumento="<?php echo($id_archivo); ?>"
									tipo="<?php echo($tipo_visor); ?>" data-l10n-id="cambio_visor">
									...
									<span id="scaleSelectContainer" class="dropdownToolbarButton">
										<select
										id="scaleSelect" title="Zoom" tabindex="23" data-l10n-id="zoom">
					...
					<div class="dialog">
						<div class="row">
							<p id="passwordText" data-l10n-id="password_label">
								Enter the
								password to open this PDF file:
							</p>
						</div>
						<div class="row">
