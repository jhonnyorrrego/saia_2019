		...
		<div id="mainContainer">
			<div class="findbar hidden doorHanger hiddenSmallView" id="findbar">
				...
				<input type="checkbox" id="findHighlightAll" class="toolbarField"
					tabindex="94"> <label for="findHighlightAll" class="toolbarLabel"
					data-l10n-id="find_highlight">Highlight all</label> <input
					type="checkbox" id="findMatchCase" class="toolbarField"
					tabindex="95"> <label for="findMatchCase" class="toolbarLabel"
			...
			<div id="errorWrapper" hidden='true'>
				<div id="errorMessageLeft">
					...
					<button id="errorShowMore" data-l10n-id="error_more_info">More
						Information</button>
