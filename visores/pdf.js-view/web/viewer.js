...
function webViewerInitialized() {
  ...
  var queryString = document.getElementById("url_pdf").value;
...
function getViewerConfiguration() {
  return {
    ...
    toolbar: {
      ...
      btn_transferir: document.getElementById('btn_transferir'),
      btn_notas_pdf: document.getElementById('btn_notas_pdf'),      
...
var Toolbar = function () {
  ...
  _createClass(Toolbar, [{
    ...
    value: function _bindListeners() {
      ...
      items.btn_transferir.addEventListener('click', function () {
				parent.window.open(btn_transferir.getAttribute("enlace")+"&pag_pdf="+document.getElementById('pageNumber').value,"detalles");
      });
      
      items.btn_notas_pdf.addEventListener('click', function () {
      	window.open(btn_notas_pdf.getAttribute("enlace"),'_self');
      });
