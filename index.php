						...
						<form method="post" name="loguin" id="formulario_login" action="login.php">
							...
							<table width="700" border="0" cellspacing="0" cellpadding="0">
								...
								<tr>
									...
									<div id="CustomerLogoContainer" align="center"><img src="<?php echo($ruta_logo); ?>" style="max-height:100%;">
									</div></td>
								...
								<tr>
									...
									<table width="100%" border="0" cellspacing="0" cellpadding="0">
										<tr>
											...
											<p>
												<input type="hidden" name="boton_ui" value="Acceder">
												<button name="boton_ui" type="button" class="btn btn-primary" id="ingresar">
		...
		<div class="footer_login">
			<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
				<tr class="footer_login_text">
					...
					<td>Para mayor información: <?php echo($mayor_informacion[0]["valor"]); ?><
					/td>
					<td>
					</td>
					<?php
