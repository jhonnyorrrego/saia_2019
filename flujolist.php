...
include_once("db.php");
$modulo=busca_filtro_tabla("","modulo","nombre='listado_flujos'","",$conn);
abrir_url($modulo[0]["enlace"],"centro");
$idbusqueda=120;

$datos=busca_filtro_tabla("","busquedas","idbusquedas=".$idbusqueda,"",$conn);

$funciones=busca_filtro_tabla("idfunciones_busqueda","funciones_busqueda","busquedas_idbusqueda=".$idbusqueda,"",$conn);
