...
?>	
	...
	<div id="seleccionados"></div>
                          ...
                          <br />  Buscar: <input  tabindex='5'  type="text" id="stext_padre" width="200px" size="25"><a href="javascript:void(0)" onclick="tree_padre.findItem((document.getElementById('stext_padre').value),1)"> <img src="assets/images/anterior.png"border="0px"></a>
                   <a href="javascript:void(0)" onclick="tree_padre.findItem((document.getElementById('stext_padre').value),0,1)"><img src="assets/images/buscar.png"border="0px"></a>                          
                   <a href="javascript:void(0)" onclick="tree_padre.findItem((document.getElementById('stext_padre').value))"><img src="assets/images/siguiente.png"border="0px"></a> 
