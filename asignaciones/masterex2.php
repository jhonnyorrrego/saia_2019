...
//$("#t_list10").append("<a href=\"example.html\" onclick=\"return hs.htmlExpand(this, { objectType: 'iframe' } )\" target=\"centro\">PP</a>");
jQuery("#list10_d").jqGrid({
 height: 45,
   	url:'detalle.php?id=0',
	datatype: "json",
   	colNames:['Accion','Periodicidad', 'Anticipacion','Ejecutar Hasta', 'Ejecutar'],
   	colModel:[
