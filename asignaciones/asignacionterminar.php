...
if(isset($_REQUEST["Action"]))
  { 
    if($_REQUEST["justificacion"]=='')
      ...
      if($accion=="ELIMINA")
          elimina_asignacion($sKey,"ELIMINA",$_REQUEST["justificacion"]);
      elseif($accion=="REPROGRAMA")
          elimina_asignacion($sKey,"REPROGRAMA",$_REQUEST["justificacion"]);
...
<form action="asignacionterminar.php" method="post">
<p>
...
<p><b>JUSTIFICACI&Oacute;N DE LA TERMINACI&Oacute;N</b></p>
<textarea cols="100" rows="2" name="justificacion" id="justificacion" >
</textarea> <br>

<table border="0" width="80%" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr class="encabezado_list">
		...
		<td valign="top">TIPO DE PERIODICIDAD</td>
	</tr>
<?php
$nRecCount = 0;
...
<td colspan="5">
<?php 
   if($x_periocidad !='' && $x_periocidad != NULL  && $x_periocidad !=0)
     {
       echo "<p style='color:#cc0022; font-weight:bold; font-size:11px;'><br>La tarea SERA REPROGRAMADA<p>";
       echo '<input type="hidden" name="accion" value="REPROGRAMA" >'; 
      }
    else 
     { echo '<input type="hidden" name="accion" value="ELIMINA" >';
       echo "<p style='color:#cc0022; font-weight:bold; font-size:11px;'><br>Dado que la tarea no es peri&oacute;dica, la tarea NO SER&Aacute; REPROGRAMADA. Si requiere un control futuro de esta actividad, el administrador debe crearla nuevamente <p>";
      }  
 ?>
</td>
</tr>
...
<br />
<input type="submit" name="Action" value="Confirmar Terminacion">
</form>
<?php
...
{   
	global $_SESSION,$x_asignacion,$x_accion,$x_periocidad,$x_tipo_periocidad,$x_fecha_inicio,$x_fecha_final,$x_estado,
$x_entidad,$x_llave;
