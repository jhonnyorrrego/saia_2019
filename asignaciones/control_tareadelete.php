...
$sDbWhere .= "idcontrol_tarea=" . trim($sKey) . "";
...
<p><span class="phpmaker">Borrar .:: control tarea<br><br><a href="control_tarealist.php">Regresar al listado</a></span></p>
<form action="control_tareadelete.php" method="post">
<p>
...
<table border="0" cellspacing="1" cellpadding="4" bgcolor="#CCCCCC">
	<tr bgcolor="#666666">
		<td valign="top"><span class="phpmaker" style="color: #FFFFFF;">idcontrol tarea</span></td>
		...
		<td valign="top"><span class="phpmaker" style="color: #FFFFFF;">tarea idtarea</span></td>
		<td valign="top"><span class="phpmaker" style="color: #FFFFFF;">fecha inicial</span></td>
		<td valign="top"><span class="phpmaker" style="color: #FFFFFF;">fecha actualizacion</span></td>
	</tr>
<?php
$nRecCount = 0;
...
function DeleteData($sqlKey,$conn)
{
	...
	$sSql = "Delete FROM control_tarea";
	$sSql .= " WHERE " . $sqlKey;
	$sGroupBy = "";
	$sHaving = "";
	$sOrderBy = "";
