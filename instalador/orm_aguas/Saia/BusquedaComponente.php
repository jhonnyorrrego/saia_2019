 ...
 * BusquedaComponente
 *
 * @ORM\Table(name="BUSQUEDA_COMPONENTE", indexes={@ORM\Index(name="i_busqueda_c_info_ctx", columns={"INFO"}), @ORM\Index(name="i_busqueda_c_exportar_ctx", columns={"EXPORTAR"})})
 * @ORM\Entity
 */
