...
class Busqueda
{
     ...
     * @var string
     *
     * @ORM\Column(name="CAMPOS", type="string", length=1000, nullable=true)
     */
    private $campos;
     ...
     * @var string
     *
     * @ORM\Column(name="TABLAS", type="string", length=1000, nullable=true)
     */
    private $tablas;
     ...
     * @var string
     *
     * @ORM\Column(name="BADGE_CANTIDADES", type="string", length=255, nullable=true)
     */
