...
/**
 * FtCertificaContribucionTm1
 *
 * @ORM\Table(name="FT_CERTIFICA_CONTRIBUCION_TM1", indexes={@ORM\Index(name="ft_certifica_contribucion_doc", columns={"DOCUMENTO_IDDOCUMENTO"}), @ORM\Index(name="i_certifica_co", columns={"DEPENDENCIA"})})
 * @ORM\Entity
 */
class FtCertificaContribucionTm1
{
    /**
     * @var integer
     *
     ...
     */
    private $otrosConsiderandos = 'EMPTY_CLOB()';
     ...
     */
    private $otrosResuelve = 'EMPTY_CLOB()';
     ...
     * @ORM\SequenceGenerator(sequenceName="FT_CERTIFICA_CONTRIBUCION_TM1_", allocationSize=1, initialValue=1)
     */
