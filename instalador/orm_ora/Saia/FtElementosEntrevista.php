...
/**
 * FtElementosEntrevista
 *
 * @ORM\Table(name="FT_ELEMENTOS_ENTREVISTA", indexes={@ORM\Index(name="ft_elementos_entrevista_doc", columns={"DOCUMENTO_IDDOCUMENTO"}), @ORM\Index(name="i_elementos_en", columns={"DEPENDENCIA"})})
 * @ORM\Entity
 */
class FtElementosEntrevista
{
    /**
     * @var integer
     *
     ...
     */
    private $serieIdserie = '308';

    /**
     * @var integer
     *
     * @ORM\Column(name="IDFT_ELEMENTOS_ENTREVISTA", type="integer", nullable=false)
     * @ORM\Id
     * @ORM\GeneratedValue(strategy="SEQUENCE")
     * @ORM\SequenceGenerator(sequenceName="FT_ELEMENTOS_ENTREVISTA_IDFT_E", allocationSize=1, initialValue=1)
     */
    private $idftElementosEntrevista;
