 ...
 * FtSolicitudServicio
 *
 * @ORM\Table(name="ft_solicitud_servicio", indexes={@ORM\Index(name="i_solicitud_servicio_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_solicitud_servicio_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
