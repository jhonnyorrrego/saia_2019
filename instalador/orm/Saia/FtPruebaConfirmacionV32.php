 ...
 *
 * @ORM\Table(name="ft_prueba_confirmacion_v32", indexes={@ORM\Index(name="i_prueba_confirmacion_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_prueba_confirmacion_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
