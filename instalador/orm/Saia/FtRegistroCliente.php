 ...
 * FtRegistroCliente
 *
 * @ORM\Table(name="ft_registro_cliente", indexes={@ORM\Index(name="i_registro_cliente_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_registro_cliente_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
