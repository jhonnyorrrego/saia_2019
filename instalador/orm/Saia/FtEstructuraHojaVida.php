 ...
 *
 * @ORM\Table(name="ft_estructura_hoja_vida", indexes={@ORM\Index(name="i_ft_estructura_hoja_vida_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_estructura_hoja_vida_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
