 ...
 * FtSolicitAsistenc
 *
 * @ORM\Table(name="ft_solicit_asistenc", indexes={@ORM\Index(name="i_solicit_asistenc_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_solicit_asistenc_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
