 ...
 * FtReadh
 *
 * @ORM\Table(name="ft_readh", indexes={@ORM\Index(name="i_readh_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_readh_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
class FtReadh
{
