 ...
 * FtSalidaPlanta
 *
 * @ORM\Table(name="ft_salida_planta", indexes={@ORM\Index(name="i_salida_planta_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_salida_planta_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
