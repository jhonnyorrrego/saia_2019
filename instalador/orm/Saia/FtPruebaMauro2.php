 ...
 * FtPruebaMauro2
 *
 * @ORM\Table(name="ft_prueba_mauro2", indexes={@ORM\Index(name="i_prueba_mauro2_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_prueba_mauro2_prueba_mau", columns={"ft_prueba_mauro1"}), @ORM\Index(name="i_prueba_mauro2_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
