 ...
 * FtDatosCliente
 *
 * @ORM\Table(name="ft_datos_cliente", indexes={@ORM\Index(name="i_ft_datos_cliente_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_datos_cliente_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
