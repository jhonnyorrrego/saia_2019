 ...
 * FtRequisicionCompra
 *
 * @ORM\Table(name="ft_requisicion_compra", indexes={@ORM\Index(name="i_requisicion_compra_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_requisicion_compra_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
