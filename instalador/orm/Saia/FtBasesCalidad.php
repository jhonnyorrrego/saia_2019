 ...
 * FtBasesCalidad
 *
 * @ORM\Table(name="ft_bases_calidad", indexes={@ORM\Index(name="i_ft_bases_calidad_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_bases_calidad_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
