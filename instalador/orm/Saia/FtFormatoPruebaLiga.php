 ...
 * FtFormatoPruebaLiga
 *
 * @ORM\Table(name="ft_formato_prueba_liga", indexes={@ORM\Index(name="i_ft_formato_prueba_liga_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_formato_prueba_liga_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
