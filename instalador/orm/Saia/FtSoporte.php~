 ...
 * FtSoporte
 *
 * @ORM\Table(name="ft_soporte", indexes={@ORM\Index(name="i_soporte_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_soporte_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
class FtSoporte
{
