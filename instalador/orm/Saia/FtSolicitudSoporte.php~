 ...
 * FtSolicitudSoporte
 *
 * @ORM\Table(name="ft_solicitud_soporte", indexes={@ORM\Index(name="i_solicitud_soporte_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_solicitud_soporte_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
