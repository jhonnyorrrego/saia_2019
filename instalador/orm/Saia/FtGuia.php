 ...
 * FtGuia
 *
 * @ORM\Table(name="ft_guia", indexes={@ORM\Index(name="i_ft_guia_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_guia_proceso", columns={"ft_proceso"}), @ORM\Index(name="i_guia_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
class FtGuia
{
     ...
     * @var integer
     *
     * @ORM\Column(name="idft_guia", type="integer", nullable=false)
     * @ORM\Id
     ...
     * @return integer
     */
    public function getIdftGuia()
    {
        return $this->idftGuia;
    }
