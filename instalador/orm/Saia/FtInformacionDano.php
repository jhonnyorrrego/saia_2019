 ...
 * FtInformacionDano
 *
 * @ORM\Table(name="ft_informacion_dano", indexes={@ORM\Index(name="i_informacion_dano_orden_trab", columns={"ft_orden_trabajo_vehiculo"}), @ORM\Index(name="i_informacion_dano_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
