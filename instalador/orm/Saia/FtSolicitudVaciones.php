 ...
 * FtSolicitudVaciones
 *
 * @ORM\Table(name="ft_solicitud_vaciones", indexes={@ORM\Index(name="i_solicitud_vaciones_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_solicitud_vaciones_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
