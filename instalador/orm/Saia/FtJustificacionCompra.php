 ...
 *
 * @ORM\Table(name="ft_justificacion_compra", indexes={@ORM\Index(name="i_ft_justificacion_compra_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_justificacion_compra_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
