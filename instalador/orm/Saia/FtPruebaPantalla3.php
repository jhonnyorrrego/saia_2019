 ...
 * FtPruebaPantalla3
 *
 * @ORM\Table(name="ft_prueba_pantalla3", indexes={@ORM\Index(name="i_prueba_pantalla3_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_prueba_pantalla3_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
