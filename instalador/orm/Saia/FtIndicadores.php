 ...
 * FtIndicadores
 *
 * @ORM\Table(name="ft_indicadores", indexes={@ORM\Index(name="i_ft_indicadores_doc", columns={"documento_iddocumento"})})
 * @ORM\Entity
 */
class FtIndicadores
{
     ...
     * @var string
     *
     * @ORM\Column(name="version", type="string", length=11, nullable=false)
     */
    private $version = '1';
     ...
     * @return integer
     */
    public function getIdftIndicadores()
    {
        return $this->idftIndicadores;
    }
