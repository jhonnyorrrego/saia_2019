 ...
 * FtPruebaPermiso
 *
 * @ORM\Table(name="ft_prueba_permiso", indexes={@ORM\Index(name="i_prueba_permiso_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_prueba_permiso_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
