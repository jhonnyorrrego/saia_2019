 ...
 * FtMacroproceso
 *
 * @ORM\Table(name="ft_macroproceso", indexes={@ORM\Index(name="i_ft_macroproceso_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_macroproceso_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
class FtMacroproceso
{
     ...
     * @var integer
     *
     * @ORM\Column(name="idft_macroproceso", type="integer", nullable=false)
     * @ORM\Id
