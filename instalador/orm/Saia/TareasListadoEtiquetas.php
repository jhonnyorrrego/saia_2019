 ...
 *
 * @ORM\Table(name="tareas_listado_etiquetas", indexes={@ORM\Index(name="etiqueta_idetiqueta", columns={"etiqueta_idetiqueta"}), @ORM\Index(name="i_tle_doc_iddocumento", columns={"tareas_listado_fk"})})
 * @ORM\Entity
 */
