 ...
 *
 * @ORM\Table(name="ft_evalucion_estomatologica", indexes={@ORM\Index(name="i_ft_evalucion_estomatologica_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_evalucion_estomatol_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
