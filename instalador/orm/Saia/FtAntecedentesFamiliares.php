 ...
 *
 * @ORM\Table(name="ft_antecedentes_familiares", indexes={@ORM\Index(name="i_ft_antecedentes_familiares_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_antecedentes_famili_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
