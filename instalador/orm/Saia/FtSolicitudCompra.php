 ...
 * FtSolicitudCompra
 *
 * @ORM\Table(name="ft_solicitud_compra", indexes={@ORM\Index(name="i_solicitud_compra_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_solicitud_compra_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
