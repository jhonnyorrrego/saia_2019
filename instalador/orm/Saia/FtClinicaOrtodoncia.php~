 ...
 * FtClinicaOrtodoncia
 *
 * @ORM\Table(name="ft_clinica_ortodoncia", indexes={@ORM\Index(name="i_ft_clinica_ortodoncia_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_clinica_ortodoncia_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
