 ...
 * FtPruebaMauro1
 *
 * @ORM\Table(name="ft_prueba_mauro1", indexes={@ORM\Index(name="i_prueba_mauro1_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_prueba_mauro1_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
