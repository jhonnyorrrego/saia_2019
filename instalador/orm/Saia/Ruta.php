 ...
 * Ruta
 *
 * @ORM\Table(name="ruta", indexes={@ORM\Index(name="origen", columns={"origen"}), @ORM\Index(name="destino", columns={"destino"}), @ORM\Index(name="i_ruta_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_ruta_tipo_desti", columns={"tipo_destino"})})
 * @ORM\Entity
 */
class Ruta
{
