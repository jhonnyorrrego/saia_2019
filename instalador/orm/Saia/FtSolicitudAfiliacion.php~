 ...
 *
 * @ORM\Table(name="ft_solicitud_afiliacion", indexes={@ORM\Index(name="i_solicitud_afiliacion_documento_", columns={"documento_iddocumento"}), @ORM\Index(name="i_solicitud_afiliacion_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
