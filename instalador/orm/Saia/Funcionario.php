 ...
 * Funcionario
 *
 * @ORM\Table(name="funcionario", uniqueConstraints={@ORM\UniqueConstraint(name="funcionario_codigo", columns={"funcionario_codigo"}), @ORM\UniqueConstraint(name="funcionario_login", columns={"login"})})
 * @ORM\Entity
 */
class Funcionario
{
