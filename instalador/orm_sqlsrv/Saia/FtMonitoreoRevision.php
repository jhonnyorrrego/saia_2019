 ...
 * FtMonitoreoRevision
 *
 * @ORM\Table(name="ft_monitoreo_revision")
 * @ORM\Entity
 */
class FtMonitoreoRevision
{
     ...
     * @var integer
     *
     * @ORM\Column(name="cambio_identificacio", type="integer", nullable=false)
     */
    private $cambioIdentificacio;
     ...
     * @var string
     *
     * @ORM\Column(name="observaciones_genera", type="text", length=65535, nullable=true)
     */
    private $observacionesGenera;
