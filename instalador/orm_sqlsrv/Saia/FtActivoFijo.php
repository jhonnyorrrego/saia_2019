 ...
 * FtActivoFijo
 *
 * @ORM\Table(name="ft_activo_fijo", indexes={@ORM\Index(name="i_ft_activo_fijo_doc", columns={"documento_iddocumento"}), @ORM\Index(name="i_activo_fijo_serie_idse", columns={"serie_idserie"})})
 * @ORM\Entity
 */
class FtActivoFijo
{
