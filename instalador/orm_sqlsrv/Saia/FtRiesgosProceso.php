 ...
 * FtRiesgosProceso
 *
 * @ORM\Table(name="ft_riesgos_proceso")
 * @ORM\Entity
 */
class FtRiesgosProceso
{
     ...
     * @var string
     *
     * @ORM\Column(name="controles", type="text", length=65535, nullable=true)
     */
    private $controles;
     ...
     * @var string
     *
     * @ORM\Column(name="riesgo", type="text", length=65535, nullable=false)
     */
    private $riesgo;
