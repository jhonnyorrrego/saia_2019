...
<script src='<?php echo $ruta_db_superior?>js/jquery-ui.custom.min.js'></script>
<script src='<?php echo $ruta_db_superior?>js/moment.js'></script>
<script src='<?php echo $ruta_db_superior?>js/fullcalendar.js'></script>
...
$(document).ready(function() {
    ...
    $('#calendar').fullCalendar({
       ...
       *  actualización calendario saia)
       */   
       events: "<?php echo $configuracion[0]['datos']; ?>?start="+Math.round(start.getTime() / 1000 )+'&end='+Math.round(end.getTime() / 1000)+"&iddoc=<?php echo($_REQUEST['iddoc'])?>",     
      /*
