...
<form name="graficoadd" id="graficoadd" action="graficoadd.php" method="post" onSubmit="return EW_checkMyForm(this);">
<p>
...
Debe poseer una mascara valor y un llamada dato en cada uno de los campos qeu se desean implementar ej: SELECT DISTINCT count(A.iddocumento) AS valor,A.estado AS dato FROM documento A,ft_factura B WHERE B.documento_iddocumento=A.iddocumento GROUP BY dato, en este caso se desean contar el numero de Facturas (eje y) agrupadas por estado(eje x)"><span class="phpmaker" style="color: #FFFFFF;">SQL DEL GRAFICO</span></td>
      ...
      <span class="phpmaker">
		...
		<td bgcolor="#F5F5F5">
      <span class="phpmaker">
        <input type=radio name="x_tipo_grafico" value="Column2D" id="tipo_grafico_barra"><label for="tipo_grafico_barra">BARRA</label> 
        <input type=radio name="x_tipo_grafico" value="Column3D" id="tipo_grafico_barra"><label for="tipo_grafico_barra">BARRA 3D</label> 
        <input type=radio name="x_tipo_grafico" value="Pie2D" id="tipo_grafico_torta"><label for="tipo_grafico_torta">TORTA</label>
        <input type=radio name="x_tipo_grafico" value="Pie3D" id="tipo_grafico_torta" checked><label for="tipo_grafico_torta">TORTA 3D</label> <br>
        <input type=radio name="x_tipo_grafico" value="Line" id="tipo_grafico_torta"><label for="tipo_grafico_torta">LINEA</label>
        <input type=radio name="x_tipo_grafico" value="Area2D" id="tipo_grafico_torta"><label for="tipo_grafico_torta">AREA</label>
      </span>
    </td>
	</tr>
	<tr>
	...
	<!--tr>
		<td class="encabezado" title="Precision que adapta el nuevo grafico (numero de decimales)."><span class="phpmaker" style="color: #FFFFFF;">PRECISION</span></td>
		<td bgcolor="#F5F5F5">
      <span class="phpmaker">
        <input type="text" name="x_precision" id="x_precision" size="30" maxlength="255" value="<?php echo htmlspecialchars(@$x_precision) ?>">
      </span>
    </td>
	</tr-->
	<tr>
		...
		<td bgcolor="#F5F5F5">
      <span class="phpmaker">
        <input type=radio name="x_direccion_titulo" value="1" id="x_direccion_titulo1"><label for="x_direccion_titulo1">Vertical</label> 
        <input type=radio name="x_direccion_titulo" value="0" id="x_direccion_titulo2" checked><label for="x_direccion_titulo2">Horizontal</label>
      </span>
    </td>
	</tr>
	<tr>
...
if($fila["numcampos"]){
  ...
  $x_sql_grafico = $fila[0]["sql_grafico"];
